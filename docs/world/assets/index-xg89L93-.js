...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function Fd(i,e,t){const n=new Float32Array(ei),r=new $(0,1,0);return new pn({name:"SphericalGaussianBlur",defines:{n:ei,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Xr(),fragmentShader:`
...
#define LOW_PRECISION`),e}const Qp={[Dr]:"SHADOWMAP_TYPE_PCF",[Yi]:"SHADOWMAP_TYPE_VSM"};function jp(i){return Qp[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const em={[ni]:"ENVMAP_TYPE_CUBE",[Di]:"ENVMAP_TYPE_CUBE",[Wr]:"ENVMAP_TYPE_CUBE_UV"};function tm(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":em[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const nm={[Di]:"ENVMAP_MODE_REFRACTION"};function im(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":nm[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const rm={[ba]:"ENVMAP_BLENDING_MULTIPLY",[Tc]:"ENVMAP_BLENDING_MIX",[Ac]:"ENVMAP_BLENDING_ADD"};function sm(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":rm[i.combine]||"ENVMAP_BLENDING_NONE"}function am(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function om(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=jp(t),c=tm(t),p=im(t),f=sm(t),h=am(t),_=Wp(t),v=Xp(s),w=r.createProgram();let m,u,A=t.glslVersion?"#version "+t.glslVersion+`
...
}`,bm=[new $(1,0,0),new $(-1,0,0),new $(0,1,0),new $(0,-1,0),new $(0,0,1),new $(0,0,-1)],Tm=[new $(0,-1,0),new $(0,-1,0),new $(0,0,1),new $(0,0,-1),new $(0,-1,0),new $(0,-1,0)],ol=new pt,Xi=new $,Ps=new $;function Am(i,e,t){let n=new Ba;const r=new Ze,s=new Ze,a=new vt,o=new Du,l=new Iu,c={},p=t.maxTextureSize,f={[wn]:Bt,[Bt]:wn,[ln]:ln},h=new pn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ze},radius:{value:4}},vertexShader:ym,fragmentShader:Em}),_=h.clone();_.defines.HORIZONTAL_PASS=1;const v=new mn;v.setAttribute("position",new zt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const w=new Xt(v,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Dr;let u=this.type;this.render=function(y,R,g){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||y.length===0)return;this.type===ac&&(ze("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Dr);const M=i.getRenderTarget(),L=i.getActiveCubeFace(),P=i.getActiveMipmapLevel(),N=i.state;N.setBlending(bn),N.buffers.depth.getReversed()===!0?N.buffers.color.setClear(0,0,0,0):N.buffers.color.setClear(1,1,1,1),N.buffers.depth.setTest(!0),N.setScissorTest(!1);const k=u!==this.type;k&&R.traverse(function(V){V.material&&(Array.isArray(V.material)?V.material.forEach(I=>I.needsUpdate=!0):V.material.needsUpdate=!0)});for(let V=0,I=y.length;V<I;V++){const F=y[V],U=F.shadow;if(U===void 0){ze("WebGLShadowMap:",F,"has no shadow.");continue}if(U.autoUpdate===!1&&U.needsUpdate===!1)continue;r.copy(U.mapSize);const q=U.getFrameExtents();r.multiply(q),s.copy(U.mapSize),(r.x>p||r.y>p)&&(r.x>p&&(s.x=Math.floor(p/q.x),r.x=s.x*q.x,U.mapSize.x=s.x),r.y>p&&(s.y=Math.floor(p/q.y),r.y=s.y*q.y,U.mapSize.y=s.y));const Q=i.state.buffers.depth.getReversed();if(U.camera._reversedDepth=Q,U.map===null||k===!0){if(U.map!==null&&(U.map.depthTexture!==null&&(U.map.depthTexture.dispose(),U.map.depthTexture=null),U.map.dispose()),this.type===Yi){if(F.isPointLight){ze("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}U.map=new hn(r.x,r.y,{format:ii,type:Rn,minFilter:Ct,magFilter:Ct,generateMipmaps:!1}),U.map.texture.name=F.name+".shadowMap",U.map.depthTexture=new Ii(r.x,r.y,tn),U.map.depthTexture.name=F.name+".shadowMapDepth",U.map.depthTexture.format=Cn,U.map.depthTexture.compareFunction=null,U.map.depthTexture.minFilter=Et,U.map.depthTexture.magFilter=Et}else F.isPointLight?(U.map=new Bl(r.x),U.map.depthTexture=new Tu(r.x,dn)):(U.map=new hn(r.x,r.y),U.map.depthTexture=new Ii(r.x,r.y,dn)),U.map.depthTexture.name=F.name+".shadowMap",U.map.depthTexture.format=Cn,this.type===Dr?(U.map.depthTexture.compareFunction=Q?Ia:Da,U.map.depthTexture.minFilter=Ct,U.map.depthTexture.magFilter=Ct):(U.map.depthTexture.compareFunction=null,U.map.depthTexture.minFilter=Et,U.map.depthTexture.magFilter=Et);U.camera.updateProjectionMatrix()}const se=U.map.isWebGLCubeRenderTarget?6:1;for(let te=0;te<se;te++){if(U.map.isWebGLCubeRenderTarget)i.setRenderTarget(U.map,te),i.clear();else{te===0&&(i.setRenderTarget(U.map),i.clear());const pe=U.getViewport(te);a.set(s.x*pe.x,s.y*pe.y,s.x*pe.z,s.y*pe.w),N.viewport(a)}if(F.isPointLight){const pe=U.camera,Oe=U.matrix,Je=F.distance||pe.far;Je!==pe.far&&(pe.far=Je,pe.updateProjectionMatrix()),Xi.setFromMatrixPosition(F.matrixWorld),pe.position.copy(Xi),Ps.copy(pe.position),Ps.add(bm[te]),pe.up.copy(Tm[te]),pe.lookAt(Ps),pe.updateMatrixWorld(),Oe.makeTranslation(-Xi.x,-Xi.y,-Xi.z),ol.multiplyMatrices(pe.projectionMatrix,pe.matrixWorldInverse),U._frustum.setFromProjectionMatrix(ol,pe.coordinateSystem,pe.reversedDepth)}else U.updateMatrices(F);n=U.getFrustum(),x(R,g,U.camera,F,this.type)}U.isPointLightShadow!==!0&&this.type===Yi&&A(U,g),U.needsUpdate=!1}u=this.type,m.needsUpdate=!1,i.setRenderTarget(M,L,P)};function A(y,R){const g=e.update(w);h.defines.VSM_SAMPLES!==y.blurSamples&&(h.defines.VSM_SAMPLES=y.blurSamples,_.defines.VSM_SAMPLES=y.blurSamples,h.needsUpdate=!0,_.needsUpdate=!0),y.mapPass===null&&(y.mapPass=new hn(r.x,r.y,{format:ii,type:Rn})),h.uniforms.shadow_pass.value=y.map.depthTexture,h.uniforms.resolution.value=y.mapSize,h.uniforms.radius.value=y.radius,i.setRenderTarget(y.mapPass),i.clear(),i.renderBufferDirect(R,null,g,h,w,null),_.uniforms.shadow_pass.value=y.mapPass.texture,_.uniforms.resolution.value=y.mapSize,_.uniforms.radius.value=y.radius,i.setRenderTarget(y.map),i.clear(),i.renderBufferDirect(R,null,g,_,w,null)}function C(y,R,g,M){let L=null;const P=g.isPointLight===!0?y.customDistanceMaterial:y.customDepthMaterial;if(P!==void 0)L=P;else if(L=g.isPointLight===!0?l:o,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const N=L.uuid,k=R.uuid;let V=c[N];V===void 0&&(V={},c[N]=V);let I=V[k];I===void 0&&(I=L.clone(),V[k]=I,R.addEventListener("dispose",b)),L=I}if(L.visible=R.visible,L.wireframe=R.wireframe,M===Yi?L.side=R.shadowSide!==null?R.shadowSide:R.side:L.side=R.shadowSide!==null?R.shadowSide:f[R.side],L.alphaMap=R.alphaMap,L.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,L.map=R.map,L.clipShadows=R.clipShadows,L.clippingPlanes=R.clippingPlanes,L.clipIntersection=R.clipIntersection,L.displacementMap=R.displacementMap,L.displacementScale=R.displacementScale,L.displacementBias=R.displacementBias,L.wireframeLinewidth=R.wireframeLinewidth,L.linewidth=R.linewidth,g.isPointLight===!0&&L.isMeshDistanceMaterial===!0){const N=i.properties.get(L);N.light=g}return L}function x(y,R,g,M,L){if(y.visible===!1)return;if(y.layers.test(R.layers)&&(y.isMesh||y.isLine||y.isPoints)&&(y.castShadow||y.receiveShadow&&L===Yi)&&(!y.frustumCulled||n.intersectsObject(y))){y.modelViewMatrix.multiplyMatrices(g.matrixWorldInverse,y.matrixWorld);const k=e.update(y),V=y.material;if(Array.isArray(V)){const I=k.groups;for(let F=0,U=I.length;F<U;F++){const q=I[F],Q=V[q.materialIndex];if(Q&&Q.visible){const se=C(y,Q,M,L);y.onBeforeShadow(i,y,R,g,k,se,q),i.renderBufferDirect(g,null,k,se,y,q),y.onAfterShadow(i,y,R,g,k,se,q)}}}else if(V.visible){const I=C(y,V,M,L);y.onBeforeShadow(i,y,R,g,k,I,null),i.renderBufferDirect(g,null,k,I,y,null),y.onAfterShadow(i,y,R,g,k,I,null)}}const N=y.children;for(let k=0,V=N.length;k<V;k++)x(N[k],R,g,M,L)}function b(y){y.target.removeEventListener("dispose",b);for(const g in c){const M=c[g],L=y.target.uuid;L in M&&(M[L].dispose(),delete M[L])}}}function wm(i,e){function t(){let z=!1;const ge=new vt;let ee=null;const me=new vt(0,0,0,0);return{setMask:function(ve){ee!==ve&&!z&&(i.colorMask(ve,ve,ve,ve),ee=ve)},setLocked:function(ve){z=ve},setClear:function(ve,ne,we,Ae,_t){_t===!0&&(ve*=Ae,ne*=Ae,we*=Ae),ge.set(ve,ne,we,Ae),me.equals(ge)===!1&&(i.clearColor(ve,ne,we,Ae),me.copy(ge))},reset:function(){z=!1,ee=null,me.set(-1,0,0,0)}}}function n(){let z=!1,ge=!1,ee=null,me=null,ve=null;return{setReversed:function(ne){if(ge!==ne){const we=e.get("EXT_clip_control");ne?we.clipControlEXT(we.LOWER_LEFT_EXT,we.ZERO_TO_ONE_EXT):we.clipControlEXT(we.LOWER_LEFT_EXT,we.NEGATIVE_ONE_TO_ONE_EXT),ge=ne;const Ae=ve;ve=null,this.setClear(Ae)}},getReversed:function(){return ge},setTest:function(ne){ne?oe(i.DEPTH_TEST):De(i.DEPTH_TEST)},setMask:function(ne){ee!==ne&&!z&&(i.depthMask(ne),ee=ne)},setFunc:function(ne){if(ge&&(ne=zc[ne]),me!==ne){switch(ne){case Ns:i.depthFunc(i.NEVER);break;case Fs:i.depthFunc(i.ALWAYS);break;case Os:i.depthFunc(i.LESS);break;case Li:i.depthFunc(i.LEQUAL);break;case Bs:i.depthFunc(i.EQUAL);break;case zs:i.depthFunc(i.GEQUAL);break;case Hs:i.depthFunc(i.GREATER);break;case ks:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}me=ne}},setLocked:function(ne){z=ne},setClear:function(ne){ve!==ne&&(ve=ne,ge&&(ne=1-ne),i.clearDepth(ne))},reset:function(){z=!1,ee=null,me=null,ve=null,ge=!1}}}function r(){let z=!1,ge=null,ee=null,me=null,ve=null,ne=null,we=null,Ae=null,_t=null;return{setTest:function(ot){z||(ot?oe(i.STENCIL_TEST):De(i.STENCIL_TEST))},setMask:function(ot){ge!==ot&&!z&&(i.stencilMask(ot),ge=ot)},setFunc:function(ot,Ht,qt){(ee!==ot||me!==Ht||ve!==qt)&&(i.stencilFunc(ot,Ht,qt),ee=ot,me=Ht,ve=qt)},setOp:function(ot,Ht,qt){(ne!==ot||we!==Ht||Ae!==qt)&&(i.stencilOp(ot,Ht,qt),ne=ot,we=Ht,Ae=qt)},setLocked:function(ot){z=ot},setClear:function(ot){_t!==ot&&(i.clearStencil(ot),_t=ot)},reset:function(){z=!1,ge=null,ee=null,me=null,ve=null,ne=null,we=null,Ae=null,_t=null}}}const s=new t,a=new n,o=new r,l=new WeakMap,c=new WeakMap;let p={},f={},h={},_=new WeakMap,v=[],w=null,m=!1,u=null,A=null,C=null,x=null,b=null,y=null,R=null,g=new Qe(0,0,0),M=0,L=!1,P=null,N=null,k=null,V=null,I=null;const F=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let U=!1,q=0;const Q=i.getParameter(i.VERSION);Q.indexOf("WebGL")!==-1?(q=parseFloat(/^WebGL (\d)/.exec(Q)[1]),U=q>=1):Q.indexOf("OpenGL ES")!==-1&&(q=parseFloat(/^OpenGL ES (\d)/.exec(Q)[1]),U=q>=2);let se=null,te={};const pe=i.getParameter(i.SCISSOR_BOX),Oe=i.getParameter(i.VIEWPORT),Je=new vt().fromArray(pe),Be=new vt().fromArray(Oe);function j(z,ge,ee,me){const ve=new Uint8Array(4),ne=i.createTexture();i.bindTexture(z,ne),i.texParameteri(z,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(z,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let we=0;we<ee;we++)z===i.TEXTURE_3D||z===i.TEXTURE_2D_ARRAY?i.texImage3D(ge,0,i.RGBA,1,1,me,0,i.RGBA,i.UNSIGNED_BYTE,ve):i.texImage2D(ge+we,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ve);return ne}const le={};le[i.TEXTURE_2D]=j(i.TEXTURE_2D,i.TEXTURE_2D,1),le[i.TEXTURE_CUBE_MAP]=j(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),le[i.TEXTURE_2D_ARRAY]=j(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),le[i.TEXTURE_3D]=j(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),oe(i.DEPTH_TEST),a.setFunc(Li),st(!1),ft(Qa),oe(i.CULL_FACE),Ye(bn);function oe(z){p[z]!==!0&&(i.enable(z),p[z]=!0)}function De(z){p[z]!==!1&&(i.disable(z),p[z]=!1)}function Ue(z,ge){return h[z]!==ge?(i.bindFramebuffer(z,ge),h[z]=ge,z===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=ge),z===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=ge),!0):!1}function Re(z,ge){let ee=v,me=!1;if(z){ee=_.get(ge),ee===void 0&&(ee=[],_.set(ge,ee));const ve=z.textures;if(ee.length!==ve.length||ee[0]!==i.COLOR_ATTACHMENT0){for(let ne=0,we=ve.length;ne<we;ne++)ee[ne]=i.COLOR_ATTACHMENT0+ne;ee.length=ve.length,me=!0}}else ee[0]!==i.BACK&&(ee[0]=i.BACK,me=!0);me&&i.drawBuffers(ee)}function at(z){return w!==z?(i.useProgram(z),w=z,!0):!1}const Ve={[Qn]:i.FUNC_ADD,[lc]:i.FUNC_SUBTRACT,[cc]:i.FUNC_REVERSE_SUBTRACT};Ve[uc]=i.MIN,Ve[fc]=i.MAX;const Ge={[hc]:i.ZERO,[dc]:i.ONE,[pc]:i.SRC_COLOR,[Is]:i.SRC_ALPHA,[Mc]:i.SRC_ALPHA_SATURATE,[xc]:i.DST_COLOR,[gc]:i.DST_ALPHA,[mc]:i.ONE_MINUS_SRC_COLOR,[Us]:i.ONE_MINUS_SRC_ALPHA,[vc]:i.ONE_MINUS_DST_COLOR,[_c]:i.ONE_MINUS_DST_ALPHA,[Sc]:i.CONSTANT_COLOR,[yc]:i.ONE_MINUS_CONSTANT_COLOR,[Ec]:i.CONSTANT_ALPHA,[bc]:i.ONE_MINUS_CONSTANT_ALPHA};function Ye(z,ge,ee,me,ve,ne,we,Ae,_t,ot){if(z===bn){m===!0&&(De(i.BLEND),m=!1);return}if(m===!1&&(oe(i.BLEND),m=!0),z!==oc){if(z!==u||ot!==L){if((A!==Qn||b!==Qn)&&(i.blendEquation(i.FUNC_ADD),A=Qn,b=Qn),ot)switch(z){case Ri:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ja:i.blendFunc(i.ONE,i.ONE);break;case eo:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case to:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:nt("WebGLState: Invalid blending: ",z);break}else switch(z){case Ri:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ja:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case eo:nt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case to:nt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:nt("WebGLState: Invalid blending: ",z);break}C=null,x=null,y=null,R=null,g.set(0,0,0),M=0,u=z,L=ot}return}ve=ve||ge,ne=ne||ee,we=we||me,(ge!==A||ve!==b)&&(i.blendEquationSeparate(Ve[ge],Ve[ve]),A=ge,b=ve),(ee!==C||me!==x||ne!==y||we!==R)&&(i.blendFuncSeparate(Ge[ee],Ge[me],Ge[ne],Ge[we]),C=ee,x=me,y=ne,R=we),(Ae.equals(g)===!1||_t!==M)&&(i.blendColor(Ae.r,Ae.g,Ae.b,_t),g.copy(Ae),M=_t),u=z,L=!1}function Xe(z,ge){z.side===ln?De(i.CULL_FACE):oe(i.CULL_FACE);let ee=z.side===Bt;ge&&(ee=!ee),st(ee),z.blending===Ri&&z.transparent===!1?Ye(bn):Ye(z.blending,z.blendEquation,z.blendSrc,z.blendDst,z.blendEquationAlpha,z.blendSrcAlpha,z.blendDstAlpha,z.blendColor,z.blendAlpha,z.premultipliedAlpha),a.setFunc(z.depthFunc),a.setTest(z.depthTest),a.setMask(z.depthWrite),s.setMask(z.colorWrite);const me=z.stencilWrite;o.setTest(me),me&&(o.setMask(z.stencilWriteMask),o.setFunc(z.stencilFunc,z.stencilRef,z.stencilFuncMask),o.setOp(z.stencilFail,z.stencilZFail,z.stencilZPass)),ct(z.polygonOffset,z.polygonOffsetFactor,z.polygonOffsetUnits),z.alphaToCoverage===!0?oe(i.SAMPLE_ALPHA_TO_COVERAGE):De(i.SAMPLE_ALPHA_TO_COVERAGE)}function st(z){P!==z&&(z?i.frontFace(i.CW):i.frontFace(i.CCW),P=z)}function ft(z){z!==rc?(oe(i.CULL_FACE),z!==N&&(z===Qa?i.cullFace(i.BACK):z===sc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):De(i.CULL_FACE),N=z}function mt(z){z!==k&&(U&&i.lineWidth(z),k=z)}function ct(z,ge,ee){z?(oe(i.POLYGON_OFFSET_FILL),(V!==ge||I!==ee)&&(V=ge,I=ee,a.getReversed()&&(ge=-ge),i.polygonOffset(ge,ee))):De(i.POLYGON_OFFSET_FILL)}function it(z){z?oe(i.SCISSOR_TEST):De(i.SCISSOR_TEST)}function D(z){z===void 0&&(z=i.TEXTURE0+F-1),se!==z&&(i.activeTexture(z),se=z)}function T(z,ge,ee){ee===void 0&&(se===null?ee=i.TEXTURE0+F-1:ee=se);let me=te[ee];me===void 0&&(me={type:void 0,texture:void 0},te[ee]=me),(me.type!==z||me.texture!==ge)&&(se!==ee&&(i.activeTexture(ee),se=ee),i.bindTexture(z,ge||le[z]),me.type=z,me.texture=ge)}function fe(){const z=te[se];z!==void 0&&z.type!==void 0&&(i.bindTexture(z.type,null),z.type=void 0,z.texture=void 0)}function de(){try{i.compressedTexImage2D(...arguments)}catch(z){nt("WebGLState:",z)}}function E(){try{i.compressedTexImage3D(...arguments)}catch(z){nt("WebGLState:",z)}}function d(){try{i.texSubImage2D(...arguments)}catch(z){nt("WebGLState:",z)}}function O(){try{i.texSubImage3D(...arguments)}catch(z){nt("WebGLState:",z)}}function H(){try{i.compressedTexSubImage2D(...arguments)}catch(z){nt("WebGLState:",z)}}function Y(){try{i.compressedTexSubImage3D(...arguments)}catch(z){nt("WebGLState:",z)}}function re(){try{i.texStorage2D(...arguments)}catch(z){nt("WebGLState:",z)}}function ue(){try{i.texStorage3D(...arguments)}catch(z){nt("WebGLState:",z)}}function B(){try{i.texImage2D(...arguments)}catch(z){nt("WebGLState:",z)}}function W(){try{i.texImage3D(...arguments)}catch(z){nt("WebGLState:",z)}}function ce(z){return f[z]!==void 0?f[z]:i.getParameter(z)}function xe(z,ge){f[z]!==ge&&(i.pixelStorei(z,ge),f[z]=ge)}function he(z){Je.equals(z)===!1&&(i.scissor(z.x,z.y,z.z,z.w),Je.copy(z))}function ae(z){Be.equals(z)===!1&&(i.viewport(z.x,z.y,z.z,z.w),Be.copy(z))}function ie(z,ge){let ee=c.get(ge);ee===void 0&&(ee=new WeakMap,c.set(ge,ee));let me=ee.get(z);me===void 0&&(me=i.getUniformBlockIndex(ge,z.name),ee.set(z,me))}function _e(z,ge){const me=c.get(ge).get(z);l.get(ge)!==me&&(i.uniformBlockBinding(ge,me,z.__bindingPointIndex),l.set(ge,me))}function Ne(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),p={},f={},se=null,te={},h={},_=new WeakMap,v=[],w=null,m=!1,u=null,A=null,C=null,x=null,b=null,y=null,R=null,g=new Qe(0,0,0),M=0,L=!1,P=null,N=null,k=null,V=null,I=null,Je.set(0,0,i.canvas.width,i.canvas.height),Be.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:oe,disable:De,bindFramebuffer:Ue,drawBuffers:Re,useProgram:at,setBlending:Ye,setMaterial:Xe,setFlipSided:st,setCullFace:ft,setLineWidth:mt,setPolygonOffset:ct,setScissorTest:it,activeTexture:D,bindTexture:T,unbindTexture:fe,compressedTexImage2D:de,compressedTexImage3D:E,texImage2D:B,texImage3D:W,pixelStorei:xe,getParameter:ce,updateUBOMapping:ie,uniformBlockBinding:_e,texStorage2D:re,texStorage3D:ue,texSubImage2D:d,texSubImage3D:O,compressedTexSubImage2D:H,compressedTexSubImage3D:Y,scissor:he,viewport:ae,reset:Ne}}function Rm(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ze,p=new WeakMap,f=new Set;let h;const _=new WeakMap;let v=!1;try{v=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function w(E,d){return v?new OffscreenCanvas(E,d):nr("canvas")}function m(E,d,O){let H=1;const Y=de(E);if((Y.width>O||Y.height>O)&&(H=O/Math.max(Y.width,Y.height)),H<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){const re=Math.floor(H*Y.width),ue=Math.floor(H*Y.height);h===void 0&&(h=w(re,ue));const B=d?w(re,ue):h;return B.width=re,B.height=ue,B.getContext("2d").drawImage(E,0,0,re,ue),ze("WebGLRenderer: Texture has been resized from ("+Y.width+"x"+Y.height+") to ("+re+"x"+ue+")."),B}else return"data"in E&&ze("WebGLRenderer: Image in DataTexture is too big ("+Y.width+"x"+Y.height+")."),E;return E}function u(E){return E.generateMipmaps}function A(E){i.generateMipmap(E)}function C(E){return E.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:E.isWebGL3DRenderTarget?i.TEXTURE_3D:E.isWebGLArrayRenderTarget||E.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function x(E,d,O,H,Y,re=!1){if(E!==null){if(i[E]!==void 0)return i[E];ze("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let ue;H&&(ue=e.get("EXT_texture_norm16"),ue||ze("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let B=d;if(d===i.RED&&(O===i.FLOAT&&(B=i.R32F),O===i.HALF_FLOAT&&(B=i.R16F),O===i.UNSIGNED_BYTE&&(B=i.R8),O===i.UNSIGNED_SHORT&&ue&&(B=ue.R16_EXT),O===i.SHORT&&ue&&(B=ue.R16_SNORM_EXT)),d===i.RED_INTEGER&&(O===i.UNSIGNED_BYTE&&(B=i.R8UI),O===i.UNSIGNED_SHORT&&(B=i.R16UI),O===i.UNSIGNED_INT&&(B=i.R32UI),O===i.BYTE&&(B=i.R8I),O===i.SHORT&&(B=i.R16I),O===i.INT&&(B=i.R32I)),d===i.RG&&(O===i.FLOAT&&(B=i.RG32F),O===i.HALF_FLOAT&&(B=i.RG16F),O===i.UNSIGNED_BYTE&&(B=i.RG8),O===i.UNSIGNED_SHORT&&ue&&(B=ue.RG16_EXT),O===i.SHORT&&ue&&(B=ue.RG16_SNORM_EXT)),d===i.RG_INTEGER&&(O===i.UNSIGNED_BYTE&&(B=i.RG8UI),O===i.UNSIGNED_SHORT&&(B=i.RG16UI),O===i.UNSIGNED_INT&&(B=i.RG32UI),O===i.BYTE&&(B=i.RG8I),O===i.SHORT&&(B=i.RG16I),O===i.INT&&(B=i.RG32I)),d===i.RGB_INTEGER&&(O===i.UNSIGNED_BYTE&&(B=i.RGB8UI),O===i.UNSIGNED_SHORT&&(B=i.RGB16UI),O===i.UNSIGNED_INT&&(B=i.RGB32UI),O===i.BYTE&&(B=i.RGB8I),O===i.SHORT&&(B=i.RGB16I),O===i.INT&&(B=i.RGB32I)),d===i.RGBA_INTEGER&&(O===i.UNSIGNED_BYTE&&(B=i.RGBA8UI),O===i.UNSIGNED_SHORT&&(B=i.RGBA16UI),O===i.UNSIGNED_INT&&(B=i.RGBA32UI),O===i.BYTE&&(B=i.RGBA8I),O===i.SHORT&&(B=i.RGBA16I),O===i.INT&&(B=i.RGBA32I)),d===i.RGB&&(O===i.UNSIGNED_SHORT&&ue&&(B=ue.RGB16_EXT),O===i.SHORT&&ue&&(B=ue.RGB16_SNORM_EXT),O===i.UNSIGNED_INT_5_9_9_9_REV&&(B=i.RGB9_E5),O===i.UNSIGNED_INT_10F_11F_11F_REV&&(B=i.R11F_G11F_B10F)),d===i.RGBA){const W=re?kr:tt.getTransfer(Y);O===i.FLOAT&&(B=i.RGBA32F),O===i.HALF_FLOAT&&(B=i.RGBA16F),O===i.UNSIGNED_BYTE&&(B=W===lt?i.SRGB8_ALPHA8:i.RGBA8),O===i.UNSIGNED_SHORT&&ue&&(B=ue.RGBA16_EXT),O===i.SHORT&&ue&&(B=ue.RGBA16_SNORM_EXT),O===i.UNSIGNED_SHORT_4_4_4_4&&(B=i.RGBA4),O===i.UNSIGNED_SHORT_5_5_5_1&&(B=i.RGB5_A1)}return(B===i.R16F||B===i.R32F||B===i.RG16F||B===i.RG32F||B===i.RGBA16F||B===i.RGBA32F)&&e.get("EXT_color_buffer_float"),B}function b(E,d){let O;return E?d===null||d===dn||d===er?O=i.DEPTH24_STENCIL8:d===tn?O=i.DEPTH32F_STENCIL8:d===ji&&(O=i.DEPTH24_STENCIL8,ze("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):d===null||d===dn||d===er?O=i.DEPTH_COMPONENT24:d===tn?O=i.DEPTH_COMPONENT32F:d===ji&&(O=i.DEPTH_COMPONENT16),O}function y(E,d){return u(E)===!0||E.isFramebufferTexture&&E.minFilter!==Et&&E.minFilter!==Ct?Math.log2(Math.max(d.width,d.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?d.mipmaps.length:1}function R(E){const d=E.target;d.removeEventListener("dispose",R),M(d),d.isVideoTexture&&p.delete(d),d.isHTMLTexture&&f.delete(d)}function g(E){const d=E.target;d.removeEventListener("dispose",g),P(d)}function M(E){const d=n.get(E);if(d.__webglInit===void 0)return;const O=E.source,H=_.get(O);if(H){const Y=H[d.__cacheKey];Y.usedTimes--,Y.usedTimes===0&&L(E),Object.keys(H).length===0&&_.delete(O)}n.remove(E)}function L(E){const d=n.get(E);i.deleteTexture(d.__webglTexture);const O=E.source,H=_.get(O);delete H[d.__cacheKey],a.memory.textures--}function P(E){const d=n.get(E);if(E.depthTexture&&(E.depthTexture.dispose(),n.remove(E.depthTexture)),E.isWebGLCubeRenderTarget)for(let H=0;H<6;H++){if(Array.isArray(d.__webglFramebuffer[H]))for(let Y=0;Y<d.__webglFramebuffer[H].length;Y++)i.deleteFramebuffer(d.__webglFramebuffer[H][Y]);else i.deleteFramebuffer(d.__webglFramebuffer[H]);d.__webglDepthbuffer&&i.deleteRenderbuffer(d.__webglDepthbuffer[H])}else{if(Array.isArray(d.__webglFramebuffer))for(let H=0;H<d.__webglFramebuffer.length;H++)i.deleteFramebuffer(d.__webglFramebuffer[H]);else i.deleteFramebuffer(d.__webglFramebuffer);if(d.__webglDepthbuffer&&i.deleteRenderbuffer(d.__webglDepthbuffer),d.__webglMultisampledFramebuffer&&i.deleteFramebuffer(d.__webglMultisampledFramebuffer),d.__webglColorRenderbuffer)for(let H=0;H<d.__webglColorRenderbuffer.length;H++)d.__webglColorRenderbuffer[H]&&i.deleteRenderbuffer(d.__webglColorRenderbuffer[H]);d.__webglDepthRenderbuffer&&i.deleteRenderbuffer(d.__webglDepthRenderbuffer)}const O=E.textures;for(let H=0,Y=O.length;H<Y;H++){const re=n.get(O[H]);re.__webglTexture&&(i.deleteTexture(re.__webglTexture),a.memory.textures--),n.remove(O[H])}n.remove(E)}let N=0;function k(){N=0}function V(){return N}function I(E){N=E}function F(){const E=N;return E>=r.maxTextures&&ze("WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+r.maxTextures),N+=1,E}function U(E){const d=[];return d.push(E.wrapS),d.push(E.wrapT),d.push(E.wrapR||0),d.push(E.magFilter),d.push(E.minFilter),d.push(E.anisotropy),d.push(E.internalFormat),d.push(E.format),d.push(E.type),d.push(E.generateMipmaps),d.push(E.premultiplyAlpha),d.push(E.flipY),d.push(E.unpackAlignment),d.push(E.colorSpace),d.join()}function q(E,d){const O=n.get(E);if(E.isVideoTexture&&T(E),E.isRenderTargetTexture===!1&&E.isExternalTexture!==!0&&E.version>0&&O.__version!==E.version){const H=E.image;if(H===null)ze("WebGLRenderer: Texture marked for update but no image data found.");else if(H.complete===!1)ze("WebGLRenderer: Texture marked for update but image is incomplete");else{De(O,E,d);return}}else E.isExternalTexture&&(O.__webglTexture=E.sourceTexture?E.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,O.__webglTexture,i.TEXTURE0+d)}function Q(E,d){const O=n.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&O.__version!==E.version){De(O,E,d);return}else E.isExternalTexture&&(O.__webglTexture=E.sourceTexture?E.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,O.__webglTexture,i.TEXTURE0+d)}function se(E,d){const O=n.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&O.__version!==E.version){De(O,E,d);return}t.bindTexture(i.TEXTURE_3D,O.__webglTexture,i.TEXTURE0+d)}function te(E,d){const O=n.get(E);if(E.isCubeDepthTexture!==!0&&E.version>0&&O.__version!==E.version){Ue(O,E,d);return}t.bindTexture(i.TEXTURE_CUBE_MAP,O.__webglTexture,i.TEXTURE0+d)}const pe={[Qi]:i.REPEAT,[En]:i.CLAMP_TO_EDGE,[Gs]:i.MIRRORED_REPEAT},Oe={[Et]:i.NEAREST,[wc]:i.NEAREST_MIPMAP_NEAREST,[lr]:i.NEAREST_MIPMAP_LINEAR,[Ct]:i.LINEAR,[jr]:i.LINEAR_MIPMAP_NEAREST,[cn]:i.LINEAR_MIPMAP_LINEAR},Je={[Pc]:i.NEVER,[Nc]:i.ALWAYS,[Lc]:i.LESS,[Da]:i.LEQUAL,[Dc]:i.EQUAL,[Ia]:i.GEQUAL,[Ic]:i.GREATER,[Uc]:i.NOTEQUAL};function Be(E,d){if(d.type===tn&&e.has("OES_texture_float_linear")===!1&&(d.magFilter===Ct||d.magFilter===jr||d.magFilter===lr||d.magFilter===cn||d.minFilter===Ct||d.minFilter===jr||d.minFilter===lr||d.minFilter===cn)&&ze("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(E,i.TEXTURE_WRAP_S,pe[d.wrapS]),i.texParameteri(E,i.TEXTURE_WRAP_T,pe[d.wrapT]),(E===i.TEXTURE_3D||E===i.TEXTURE_2D_ARRAY)&&i.texParameteri(E,i.TEXTURE_WRAP_R,pe[d.wrapR]),i.texParameteri(E,i.TEXTURE_MAG_FILTER,Oe[d.magFilter]),i.texParameteri(E,i.TEXTURE_MIN_FILTER,Oe[d.minFilter]),d.compareFunction&&(i.texParameteri(E,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(E,i.TEXTURE_COMPARE_FUNC,Je[d.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(d.magFilter===Et||d.minFilter!==lr&&d.minFilter!==cn||d.type===tn&&e.has("OES_texture_float_linear")===!1)return;if(d.anisotropy>1||n.get(d).__currentAnisotropy){const O=e.get("EXT_texture_filter_anisotropic");i.texParameterf(E,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(d.anisotropy,r.getMaxAnisotropy())),n.get(d).__currentAnisotropy=d.anisotropy}}}function j(E,d){let O=!1;E.__webglInit===void 0&&(E.__webglInit=!0,d.addEventListener("dispose",R));const H=d.source;let Y=_.get(H);Y===void 0&&(Y={},_.set(H,Y));const re=U(d);if(re!==E.__cacheKey){Y[re]===void 0&&(Y[re]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,O=!0),Y[re].usedTimes++;const ue=Y[E.__cacheKey];ue!==void 0&&(Y[E.__cacheKey].usedTimes--,ue.usedTimes===0&&L(d)),E.__cacheKey=re,E.__webglTexture=Y[re].texture}return O}function le(E,d,O){return Math.floor(Math.floor(E/O)/d)}function oe(E,d,O,H){const re=E.updateRanges;if(re.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,d.width,d.height,O,H,d.data);else{re.sort((xe,he)=>xe.start-he.start);let ue=0;for(let xe=1;xe<re.length;xe++){const he=re[ue],ae=re[xe],ie=he.start+he.count,_e=le(ae.start,d.width,4),Ne=le(he.start,d.width,4);ae.start<=ie+1&&_e===Ne&&le(ae.start+ae.count-1,d.width,4)===_e?he.count=Math.max(he.count,ae.start+ae.count-he.start):(++ue,re[ue]=ae)}re.length=ue+1;const B=t.getParameter(i.UNPACK_ROW_LENGTH),W=t.getParameter(i.UNPACK_SKIP_PIXELS),ce=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,d.width);for(let xe=0,he=re.length;xe<he;xe++){const ae=re[xe],ie=Math.floor(ae.start/4),_e=Math.ceil(ae.count/4),Ne=ie%d.width,z=Math.floor(ie/d.width),ge=_e,ee=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,Ne),t.pixelStorei(i.UNPACK_SKIP_ROWS,z),t.texSubImage2D(i.TEXTURE_2D,0,Ne,z,ge,ee,O,H,d.data)}E.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,B),t.pixelStorei(i.UNPACK_SKIP_PIXELS,W),t.pixelStorei(i.UNPACK_SKIP_ROWS,ce)}}function De(E,d,O){let H=i.TEXTURE_2D;(d.isDataArrayTexture||d.isCompressedArrayTexture)&&(H=i.TEXTURE_2D_ARRAY),d.isData3DTexture&&(H=i.TEXTURE_3D);const Y=j(E,d),re=d.source;t.bindTexture(H,E.__webglTexture,i.TEXTURE0+O);const ue=n.get(re);if(re.version!==ue.__version||Y===!0){if(t.activeTexture(i.TEXTURE0+O),(typeof ImageBitmap<"u"&&d.image instanceof ImageBitmap)===!1){const ee=tt.getPrimaries(tt.workingColorSpace),me=d.colorSpace===kn?null:tt.getPrimaries(d.colorSpace),ve=d.colorSpace===kn||ee===me?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,d.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,d.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ve)}t.pixelStorei(i.UNPACK_ALIGNMENT,d.unpackAlignment);let W=m(d.image,!1,r.maxTextureSize);W=fe(d,W);const ce=s.convert(d.format,d.colorSpace),xe=s.convert(d.type);let he=x(d.internalFormat,ce,xe,d.normalized,d.colorSpace,d.isVideoTexture);Be(H,d);let ae;const ie=d.mipmaps,_e=d.isVideoTexture!==!0,Ne=ue.__version===void 0||Y===!0,z=re.dataReady,ge=y(d,W);if(d.isDepthTexture)he=b(d.format===ti,d.type),Ne&&(_e?t.texStorage2D(i.TEXTURE_2D,1,he,W.width,W.height):t.texImage2D(i.TEXTURE_2D,0,he,W.width,W.height,0,ce,xe,null));else if(d.isDataTexture)if(ie.length>0){_e&&Ne&&t.texStorage2D(i.TEXTURE_2D,ge,he,ie[0].width,ie[0].height);for(let ee=0,me=ie.length;ee<me;ee++)ae=ie[ee],_e?z&&t.texSubImage2D(i.TEXTURE_2D,ee,0,0,ae.width,ae.height,ce,xe,ae.data):t.texImage2D(i.TEXTURE_2D,ee,he,ae.width,ae.height,0,ce,xe,ae.data);d.generateMipmaps=!1}else _e?(Ne&&t.texStorage2D(i.TEXTURE_2D,ge,he,W.width,W.height),z&&oe(d,W,ce,xe)):t.texImage2D(i.TEXTURE_2D,0,he,W.width,W.height,0,ce,xe,W.data);else if(d.isCompressedTexture)if(d.isCompressedArrayTexture){_e&&Ne&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ge,he,ie[0].width,ie[0].height,W.depth);for(let ee=0,me=ie.length;ee<me;ee++)if(ae=ie[ee],d.format!==Ut)if(ce!==null)if(_e){if(z)if(d.layerUpdates.size>0){const ve=Bo(ae.width,ae.height,d.format,d.type);for(const ne of d.layerUpdates){const we=ae.data.subarray(ne*ve/ae.data.BYTES_PER_ELEMENT,(ne+1)*ve/ae.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ee,0,0,ne,ae.width,ae.height,1,ce,we)}d.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ee,0,0,0,ae.width,ae.height,W.depth,ce,ae.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,ee,he,ae.width,ae.height,W.depth,0,ae.data,0,0);else ze("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else _e?z&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,ee,0,0,0,ae.width,ae.height,W.depth,ce,xe,ae.data):t.texImage3D(i.TEXTURE_2D_ARRAY,ee,he,ae.width,ae.height,W.depth,0,ce,xe,ae.data)}else{_e&&Ne&&t.texStorage2D(i.TEXTURE_2D,ge,he,ie[0].width,ie[0].height);for(let ee=0,me=ie.length;ee<me;ee++)ae=ie[ee],d.format!==Ut?ce!==null?_e?z&&t.compressedTexSubImage2D(i.TEXTURE_2D,ee,0,0,ae.width,ae.height,ce,ae.data):t.compressedTexImage2D(i.TEXTURE_2D,ee,he,ae.width,ae.height,0,ae.data):ze("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):_e?z&&t.texSubImage2D(i.TEXTURE_2D,ee,0,0,ae.width,ae.height,ce,xe,ae.data):t.texImage2D(i.TEXTURE_2D,ee,he,ae.width,ae.height,0,ce,xe,ae.data)}else if(d.isDataArrayTexture)if(_e){if(Ne&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ge,he,W.width,W.height,W.depth),z)if(d.layerUpdates.size>0){const ee=Bo(W.width,W.height,d.format,d.type);for(const me of d.layerUpdates){const ve=W.data.subarray(me*ee/W.data.BYTES_PER_ELEMENT,(me+1)*ee/W.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,me,W.width,W.height,1,ce,xe,ve)}d.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,W.width,W.height,W.depth,ce,xe,W.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,he,W.width,W.height,W.depth,0,ce,xe,W.data);else if(d.isData3DTexture)_e?(Ne&&t.texStorage3D(i.TEXTURE_3D,ge,he,W.width,W.height,W.depth),z&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,W.width,W.height,W.depth,ce,xe,W.data)):t.texImage3D(i.TEXTURE_3D,0,he,W.width,W.height,W.depth,0,ce,xe,W.data);else if(d.isFramebufferTexture){if(Ne)if(_e)t.texStorage2D(i.TEXTURE_2D,ge,he,W.width,W.height);else{let ee=W.width,me=W.height;for(let ve=0;ve<ge;ve++)t.texImage2D(i.TEXTURE_2D,ve,he,ee,me,0,ce,xe,null),ee>>=1,me>>=1}}else if(d.isHTMLTexture){if("texElementImage2D"in i){const ee=i.canvas;if(ee.hasAttribute("layoutsubtree")||ee.setAttribute("layoutsubtree","true"),W.parentNode!==ee){ee.appendChild(W),f.add(d),ee.onpaint=me=>{const ve=me.changedElements;for(const ne of f)ve.includes(ne.image)&&(ne.needsUpdate=!0)},ee.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,W);else{const ve=i.RGBA,ne=i.RGBA,we=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,ve,ne,we,W)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(ie.length>0){if(_e&&Ne){const ee=de(ie[0]);t.texStorage2D(i.TEXTURE_2D,ge,he,ee.width,ee.height)}for(let ee=0,me=ie.length;ee<me;ee++)ae=ie[ee],_e?z&&t.texSubImage2D(i.TEXTURE_2D,ee,0,0,ce,xe,ae):t.texImage2D(i.TEXTURE_2D,ee,he,ce,xe,ae);d.generateMipmaps=!1}else if(_e){if(Ne){const ee=de(W);t.texStorage2D(i.TEXTURE_2D,ge,he,ee.width,ee.height)}z&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ce,xe,W)}else t.texImage2D(i.TEXTURE_2D,0,he,ce,xe,W);u(d)&&A(H),ue.__version=re.version,d.onUpdate&&d.onUpdate(d)}E.__version=d.version}function Ue(E,d,O){if(d.image.length!==6)return;const H=j(E,d),Y=d.source;t.bindTexture(i.TEXTURE_CUBE_MAP,E.__webglTexture,i.TEXTURE0+O);const re=n.get(Y);if(Y.version!==re.__version||H===!0){t.activeTexture(i.TEXTURE0+O);const ue=tt.getPrimaries(tt.workingColorSpace),B=d.colorSpace===kn?null:tt.getPrimaries(d.colorSpace),W=d.colorSpace===kn||ue===B?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,d.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,d.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,d.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,W);const ce=d.isCompressedTexture||d.image[0].isCompressedTexture,xe=d.image[0]&&d.image[0].isDataTexture,he=[];for(let ne=0;ne<6;ne++)!ce&&!xe?he[ne]=m(d.image[ne],!0,r.maxCubemapSize):he[ne]=xe?d.image[ne].image:d.image[ne],he[ne]=fe(d,he[ne]);const ae=he[0],ie=s.convert(d.format,d.colorSpace),_e=s.convert(d.type),Ne=x(d.internalFormat,ie,_e,d.normalized,d.colorSpace),z=d.isVideoTexture!==!0,ge=re.__version===void 0||H===!0,ee=Y.dataReady;let me=y(d,ae);Be(i.TEXTURE_CUBE_MAP,d);let ve;if(ce){z&&ge&&t.texStorage2D(i.TEXTURE_CUBE_MAP,me,Ne,ae.width,ae.height);for(let ne=0;ne<6;ne++){ve=he[ne].mipmaps;for(let we=0;we<ve.length;we++){const Ae=ve[we];d.format!==Ut?ie!==null?z?ee&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,we,0,0,Ae.width,Ae.height,ie,Ae.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,we,Ne,Ae.width,Ae.height,0,Ae.data):ze("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):z?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,we,0,0,Ae.width,Ae.height,ie,_e,Ae.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,we,Ne,Ae.width,Ae.height,0,ie,_e,Ae.data)}}}else{if(ve=d.mipmaps,z&&ge){ve.length>0&&me++;const ne=de(he[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,me,Ne,ne.width,ne.height)}for(let ne=0;ne<6;ne++)if(xe){z?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,0,0,he[ne].width,he[ne].height,ie,_e,he[ne].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,Ne,he[ne].width,he[ne].height,0,ie,_e,he[ne].data);for(let we=0;we<ve.length;we++){const _t=ve[we].image[ne].image;z?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,we+1,0,0,_t.width,_t.height,ie,_e,_t.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,we+1,Ne,_t.width,_t.height,0,ie,_e,_t.data)}}else{z?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,0,0,ie,_e,he[ne]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,Ne,ie,_e,he[ne]);for(let we=0;we<ve.length;we++){const Ae=ve[we];z?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,we+1,0,0,ie,_e,Ae.image[ne]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,we+1,Ne,ie,_e,Ae.image[ne])}}}u(d)&&A(i.TEXTURE_CUBE_MAP),re.__version=Y.version,d.onUpdate&&d.onUpdate(d)}E.__version=d.version}function Re(E,d,O,H,Y,re){const ue=s.convert(O.format,O.colorSpace),B=s.convert(O.type),W=x(O.internalFormat,ue,B,O.normalized,O.colorSpace),ce=n.get(d),xe=n.get(O);if(xe.__renderTarget=d,!ce.__hasExternalTextures){const he=Math.max(1,d.width>>re),ae=Math.max(1,d.height>>re);Y===i.TEXTURE_3D||Y===i.TEXTURE_2D_ARRAY?t.texImage3D(Y,re,W,he,ae,d.depth,0,ue,B,null):t.texImage2D(Y,re,W,he,ae,0,ue,B,null)}t.bindFramebuffer(i.FRAMEBUFFER,E),D(d)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,H,Y,xe.__webglTexture,0,it(d)):(Y===i.TEXTURE_2D||Y>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Y<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,H,Y,xe.__webglTexture,re),t.bindFramebuffer(i.FRAMEBUFFER,null)}function at(E,d,O){if(i.bindRenderbuffer(i.RENDERBUFFER,E),d.depthBuffer){const H=d.depthTexture,Y=H&&H.isDepthTexture?H.type:null,re=b(d.stencilBuffer,Y),ue=d.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;D(d)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,it(d),re,d.width,d.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,it(d),re,d.width,d.height):i.renderbufferStorage(i.RENDERBUFFER,re,d.width,d.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,ue,i.RENDERBUFFER,E)}else{const H=d.textures;for(let Y=0;Y<H.length;Y++){const re=H[Y],ue=s.convert(re.format,re.colorSpace),B=s.convert(re.type),W=x(re.internalFormat,ue,B,re.normalized,re.colorSpace);D(d)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,it(d),W,d.width,d.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,it(d),W,d.width,d.height):i.renderbufferStorage(i.RENDERBUFFER,W,d.width,d.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Ve(E,d,O){const H=d.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,E),!(d.depthTexture&&d.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const Y=n.get(d.depthTexture);if(Y.__renderTarget=d,(!Y.__webglTexture||d.depthTexture.image.width!==d.width||d.depthTexture.image.height!==d.height)&&(d.depthTexture.image.width=d.width,d.depthTexture.image.height=d.height,d.depthTexture.needsUpdate=!0),H){if(Y.__webglInit===void 0&&(Y.__webglInit=!0,d.depthTexture.addEventListener("dispose",R)),Y.__webglTexture===void 0){Y.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),Be(i.TEXTURE_CUBE_MAP,d.depthTexture);const ce=s.convert(d.depthTexture.format),xe=s.convert(d.depthTexture.type);let he;d.depthTexture.format===Cn?he=i.DEPTH_COMPONENT24:d.depthTexture.format===ti&&(he=i.DEPTH24_STENCIL8);for(let ae=0;ae<6;ae++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,he,d.width,d.height,0,ce,xe,null)}}else q(d.depthTexture,0);const re=Y.__webglTexture,ue=it(d),B=H?i.TEXTURE_CUBE_MAP_POSITIVE_X+O:i.TEXTURE_2D,W=d.depthTexture.format===ti?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(d.depthTexture.format===Cn)D(d)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,W,B,re,0,ue):i.framebufferTexture2D(i.FRAMEBUFFER,W,B,re,0);else if(d.depthTexture.format===ti)D(d)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,W,B,re,0,ue):i.framebufferTexture2D(i.FRAMEBUFFER,W,B,re,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Ge(E){const d=n.get(E),O=E.isWebGLCubeRenderTarget===!0;if(d.__boundDepthTexture!==E.depthTexture){const H=E.depthTexture;if(d.__depthDisposeCallback&&d.__depthDisposeCallback(),H){const Y=()=>{delete d.__boundDepthTexture,delete d.__depthDisposeCallback,H.removeEventListener("dispose",Y)};H.addEventListener("dispose",Y),d.__depthDisposeCallback=Y}d.__boundDepthTexture=H}if(E.depthTexture&&!d.__autoAllocateDepthBuffer)if(O)for(let H=0;H<6;H++)Ve(d.__webglFramebuffer[H],E,H);else{const H=E.texture.mipmaps;H&&H.length>0?Ve(d.__webglFramebuffer[0],E,0):Ve(d.__webglFramebuffer,E,0)}else if(O){d.__webglDepthbuffer=[];for(let H=0;H<6;H++)if(t.bindFramebuffer(i.FRAMEBUFFER,d.__webglFramebuffer[H]),d.__webglDepthbuffer[H]===void 0)d.__webglDepthbuffer[H]=i.createRenderbuffer(),at(d.__webglDepthbuffer[H],E,!1);else{const Y=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,re=d.__webglDepthbuffer[H];i.bindRenderbuffer(i.RENDERBUFFER,re),i.framebufferRenderbuffer(i.FRAMEBUFFER,Y,i.RENDERBUFFER,re)}}else{const H=E.texture.mipmaps;if(H&&H.length>0?t.bindFramebuffer(i.FRAMEBUFFER,d.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,d.__webglFramebuffer),d.__webglDepthbuffer===void 0)d.__webglDepthbuffer=i.createRenderbuffer(),at(d.__webglDepthbuffer,E,!1);else{const Y=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,re=d.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,re),i.framebufferRenderbuffer(i.FRAMEBUFFER,Y,i.RENDERBUFFER,re)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Ye(E,d,O){const H=n.get(E);d!==void 0&&Re(H.__webglFramebuffer,E,E.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),O!==void 0&&Ge(E)}function Xe(E){const d=E.texture,O=n.get(E),H=n.get(d);E.addEventListener("dispose",g);const Y=E.textures,re=E.isWebGLCubeRenderTarget===!0,ue=Y.length>1;if(ue||(H.__webglTexture===void 0&&(H.__webglTexture=i.createTexture()),H.__version=d.version,a.memory.textures++),re){O.__webglFramebuffer=[];for(let B=0;B<6;B++)if(d.mipmaps&&d.mipmaps.length>0){O.__webglFramebuffer[B]=[];for(let W=0;W<d.mipmaps.length;W++)O.__webglFramebuffer[B][W]=i.createFramebuffer()}else O.__webglFramebuffer[B]=i.createFramebuffer()}else{if(d.mipmaps&&d.mipmaps.length>0){O.__webglFramebuffer=[];for(let B=0;B<d.mipmaps.length;B++)O.__webglFramebuffer[B]=i.createFramebuffer()}else O.__webglFramebuffer=i.createFramebuffer();if(ue)for(let B=0,W=Y.length;B<W;B++){const ce=n.get(Y[B]);ce.__webglTexture===void 0&&(ce.__webglTexture=i.createTexture(),a.memory.textures++)}if(E.samples>0&&D(E)===!1){O.__webglMultisampledFramebuffer=i.createFramebuffer(),O.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let B=0;B<Y.length;B++){const W=Y[B];O.__webglColorRenderbuffer[B]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,O.__webglColorRenderbuffer[B]);const ce=s.convert(W.format,W.colorSpace),xe=s.convert(W.type),he=x(W.internalFormat,ce,xe,W.normalized,W.colorSpace,E.isXRRenderTarget===!0),ae=it(E);i.renderbufferStorageMultisample(i.RENDERBUFFER,ae,he,E.width,E.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+B,i.RENDERBUFFER,O.__webglColorRenderbuffer[B])}i.bindRenderbuffer(i.RENDERBUFFER,null),E.depthBuffer&&(O.__webglDepthRenderbuffer=i.createRenderbuffer(),at(O.__webglDepthRenderbuffer,E,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(re){t.bindTexture(i.TEXTURE_CUBE_MAP,H.__webglTexture),Be(i.TEXTURE_CUBE_MAP,d);for(let B=0;B<6;B++)if(d.mipmaps&&d.mipmaps.length>0)for(let W=0;W<d.mipmaps.length;W++)Re(O.__webglFramebuffer[B][W],E,d,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+B,W);else Re(O.__webglFramebuffer[B],E,d,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+B,0);u(d)&&A(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ue){for(let B=0,W=Y.length;B<W;B++){const ce=Y[B],xe=n.get(ce);let he=i.TEXTURE_2D;(E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(he=E.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(he,xe.__webglTexture),Be(he,ce),Re(O.__webglFramebuffer,E,ce,i.COLOR_ATTACHMENT0+B,he,0),u(ce)&&A(he)}t.unbindTexture()}else{let B=i.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(B=E.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(B,H.__webglTexture),Be(B,d),d.mipmaps&&d.mipmaps.length>0)for(let W=0;W<d.mipmaps.length;W++)Re(O.__webglFramebuffer[W],E,d,i.COLOR_ATTACHMENT0,B,W);else Re(O.__webglFramebuffer,E,d,i.COLOR_ATTACHMENT0,B,0);u(d)&&A(B),t.unbindTexture()}E.depthBuffer&&Ge(E)}function st(E){const d=E.textures;for(let O=0,H=d.length;O<H;O++){const Y=d[O];if(u(Y)){const re=C(E),ue=n.get(Y).__webglTexture;t.bindTexture(re,ue),A(re),t.unbindTexture()}}}const ft=[],mt=[];function ct(E){if(E.samples>0){if(D(E)===!1){const d=E.textures,O=E.width,H=E.height;let Y=i.COLOR_BUFFER_BIT;const re=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ue=n.get(E),B=d.length>1;if(B)for(let ce=0;ce<d.length;ce++)t.bindFramebuffer(i.FRAMEBUFFER,ue.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ce,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,ue.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ce,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,ue.__webglMultisampledFramebuffer);const W=E.texture.mipmaps;W&&W.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ue.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ue.__webglFramebuffer);for(let ce=0;ce<d.length;ce++){if(E.resolveDepthBuffer&&(E.depthBuffer&&(Y|=i.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&(Y|=i.STENCIL_BUFFER_BIT)),B){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ue.__webglColorRenderbuffer[ce]);const xe=n.get(d[ce]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,xe,0)}i.blitFramebuffer(0,0,O,H,0,0,O,H,Y,i.NEAREST),l===!0&&(ft.length=0,mt.length=0,ft.push(i.COLOR_ATTACHMENT0+ce),E.depthBuffer&&E.resolveDepthBuffer===!1&&(ft.push(re),mt.push(re),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,mt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,ft))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),B)for(let ce=0;ce<d.length;ce++){t.bindFramebuffer(i.FRAMEBUFFER,ue.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ce,i.RENDERBUFFER,ue.__webglColorRenderbuffer[ce]);const xe=n.get(d[ce]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,ue.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ce,i.TEXTURE_2D,xe,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ue.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.resolveDepthBuffer===!1&&l){const d=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[d])}}}function it(E){return Math.min(r.maxSamples,E.samples)}function D(E){const d=n.get(E);return E.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&d.__useRenderToTexture!==!1}function T(E){const d=a.render.frame;p.get(E)!==d&&(p.set(E,d),E.update())}function fe(E,d){const O=E.colorSpace,H=E.format,Y=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||O!==Hr&&O!==kn&&(tt.getTransfer(O)===lt?(H!==Ut||Y!==Wt)&&ze("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):nt("WebGLTextures: Unsupported texture color space:",O)),d}function de(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(c.width=E.naturalWidth||E.width,c.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(c.width=E.displayWidth,c.height=E.displayHeight):(c.width=E.width,c.height=E.height),c}this.allocateTextureUnit=F,this.resetTextureUnits=k,this.getTextureUnits=V,this.setTextureUnits=I,this.setTexture2D=q,this.setTexture2DArray=Q,this.setTexture3D=se,this.setTextureCube=te,this.rebindTextures=Ye,this.setupRenderTarget=Xe,this.updateRenderTargetMipmap=st,this.updateMultisampleRenderTarget=ct,this.setupDepthRenderbuffer=Ge,this.setupFrameBufferTexture=Re,this.useMultisampledRTT=D,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Cm(i,e){function t(n,r=kn){let s;const a=tt.getTransfer(r);if(n===Wt)return i.UNSIGNED_BYTE;if(n===Aa)return i.UNSIGNED_SHORT_4_4_4_4;if(n===wa)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Ml)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Sl)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===xl)return i.BYTE;if(n===vl)return i.SHORT;if(n===ji)return i.UNSIGNED_SHORT;if(n===Ta)return i.INT;if(n===dn)return i.UNSIGNED_INT;if(n===tn)return i.FLOAT;if(n===Rn)return i.HALF_FLOAT;if(n===yl)return i.ALPHA;if(n===El)return i.RGB;if(n===Ut)return i.RGBA;if(n===Cn)return i.DEPTH_COMPONENT;if(n===ti)return i.DEPTH_STENCIL;if(n===Ra)return i.RED;if(n===Ca)return i.RED_INTEGER;if(n===ii)return i.RG;if(n===Pa)return i.RG_INTEGER;if(n===La)return i.RGBA_INTEGER;if(n===Ir||n===Ur||n===Nr||n===Fr)if(a===lt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Ir)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Ur)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Nr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Fr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Ir)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Ur)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Nr)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Fr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Vs||n===Ws||n===Xs||n===qs)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Vs)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Ws)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Xs)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===qs)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Ys||n===$s||n===Ks||n===Zs||n===Js||n===Br||n===Qs)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Ys||n===$s)return a===lt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Ks)return a===lt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===Zs)return s.COMPRESSED_R11_EAC;if(n===Js)return s.COMPRESSED_SIGNED_R11_EAC;if(n===Br)return s.COMPRESSED_RG11_EAC;if(n===Qs)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===js||n===ea||n===ta||n===na||n===ia||n===ra||n===sa||n===aa||n===oa||n===la||n===ca||n===ua||n===fa||n===ha)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===js)return a===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===ea)return a===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ta)return a===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===na)return a===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ia)return a===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===ra)return a===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===sa)return a===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===aa)return a===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===oa)return a===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===la)return a===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===ca)return a===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===ua)return a===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===fa)return a===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===ha)return a===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===da||n===pa||n===ma)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===da)return a===lt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===pa)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===ma)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===ga||n===_a||n===zr||n===xa)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===ga)return s.COMPRESSED_RED_RGTC1_EXT;if(n===_a)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===zr)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===xa)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===er?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const Pm=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
...
}`;class Dm{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new Ll(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new pn({vertexShader:Pm,fragmentShader:Lm,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Xt(new Ui(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Im extends ri{constructor(e,t){super();const n=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,p=null,f=null,h=null,_=null,v=null;const w=typeof XRWebGLBinding<"u",m=new Dm,u={},A=t.getContextAttributes();let C=null,x=null;const b=[],y=[],R=new Ze;let g=null;const M=new Zt;M.viewport=new vt;const L=new Zt;L.viewport=new vt;const P=[M,L],N=new Gu;let k=null,V=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(j){let le=b[j];return le===void 0&&(le=new as,b[j]=le),le.getTargetRaySpace()},this.getControllerGrip=function(j){let le=b[j];return le===void 0&&(le=new as,b[j]=le),le.getGripSpace()},this.getHand=function(j){let le=b[j];return le===void 0&&(le=new as,b[j]=le),le.getHandSpace()};function I(j){const le=y.indexOf(j.inputSource);if(le===-1)return;const oe=b[le];oe!==void 0&&(oe.update(j.inputSource,j.frame,c||a),oe.dispatchEvent({type:j.type,data:j.inputSource}))}function F(){r.removeEventListener("select",I),r.removeEventListener("selectstart",I),r.removeEventListener("selectend",I),r.removeEventListener("squeeze",I),r.removeEventListener("squeezestart",I),r.removeEventListener("squeezeend",I),r.removeEventListener("end",F),r.removeEventListener("inputsourceschange",U);for(let j=0;j<b.length;j++){const le=y[j];le!==null&&(y[j]=null,b[j].disconnect(le))}k=null,V=null,m.reset();for(const j in u)delete u[j];e.setRenderTarget(C),_=null,h=null,f=null,r=null,x=null,Be.stop(),n.isPresenting=!1,e.setPixelRatio(g),e.setSize(R.width,R.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(j){s=j,n.isPresenting===!0&&ze("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(j){o=j,n.isPresenting===!0&&ze("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(j){c=j},this.getBaseLayer=function(){return h!==null?h:_},this.getBinding=function(){return f===null&&w&&(f=new XRWebGLBinding(r,t)),f},this.getFrame=function(){return v},this.getSession=function(){return r},this.setSession=async function(j){if(r=j,r!==null){if(C=e.getRenderTarget(),r.addEventListener("select",I),r.addEventListener("selectstart",I),r.addEventListener("selectend",I),r.addEventListener("squeeze",I),r.addEventListener("squeezestart",I),r.addEventListener("squeezeend",I),r.addEventListener("end",F),r.addEventListener("inputsourceschange",U),A.xrCompatible!==!0&&await t.makeXRCompatible(),g=e.getPixelRatio(),e.getSize(R),w&&"createProjectionLayer"in XRWebGLBinding.prototype){let oe=null,De=null,Ue=null;A.depth&&(Ue=A.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,oe=A.stencil?ti:Cn,De=A.stencil?er:dn);const Re={colorFormat:t.RGBA8,depthFormat:Ue,scaleFactor:s};f=this.getBinding(),h=f.createProjectionLayer(Re),r.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),x=new hn(h.textureWidth,h.textureHeight,{format:Ut,type:Wt,depthTexture:new Ii(h.textureWidth,h.textureHeight,De,void 0,void 0,void 0,void 0,void 0,void 0,oe),stencilBuffer:A.stencil,colorSpace:e.outputColorSpace,samples:A.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{const oe={antialias:A.antialias,alpha:!0,depth:A.depth,stencil:A.stencil,framebufferScaleFactor:s};_=new XRWebGLLayer(r,t,oe),r.updateRenderState({baseLayer:_}),e.setPixelRatio(1),e.setSize(_.framebufferWidth,_.framebufferHeight,!1),x=new hn(_.framebufferWidth,_.framebufferHeight,{format:Ut,type:Wt,colorSpace:e.outputColorSpace,stencilBuffer:A.stencil,resolveDepthBuffer:_.ignoreDepthValues===!1,resolveStencilBuffer:_.ignoreDepthValues===!1})}x.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),Be.setContext(r),Be.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function U(j){for(let le=0;le<j.removed.length;le++){const oe=j.removed[le],De=y.indexOf(oe);De>=0&&(y[De]=null,b[De].disconnect(oe))}for(let le=0;le<j.added.length;le++){const oe=j.added[le];let De=y.indexOf(oe);if(De===-1){for(let Re=0;Re<b.length;Re++)if(Re>=y.length){y.push(oe),De=Re;break}else if(y[Re]===null){y[Re]=oe,De=Re;break}if(De===-1)break}const Ue=b[De];Ue&&Ue.connect(oe)}}const q=new $,Q=new $;function se(j,le,oe){q.setFromMatrixPosition(le.matrixWorld),Q.setFromMatrixPosition(oe.matrixWorld);const De=q.distanceTo(Q),Ue=le.projectionMatrix.elements,Re=oe.projectionMatrix.elements,at=Ue[14]/(Ue[10]-1),Ve=Ue[14]/(Ue[10]+1),Ge=(Ue[9]+1)/Ue[5],Ye=(Ue[9]-1)/Ue[5],Xe=(Ue[8]-1)/Ue[0],st=(Re[8]+1)/Re[0],ft=at*Xe,mt=at*st,ct=De/(-Xe+st),it=ct*-Xe;if(le.matrixWorld.decompose(j.position,j.quaternion,j.scale),j.translateX(it),j.translateZ(ct),j.matrixWorld.compose(j.position,j.quaternion,j.scale),j.matrixWorldInverse.copy(j.matrixWorld).invert(),Ue[10]===-1)j.projectionMatrix.copy(le.projectionMatrix),j.projectionMatrixInverse.copy(le.projectionMatrixInverse);else{const D=at+ct,T=Ve+ct,fe=ft-it,de=mt+(De-it),E=Ge*Ve/T*D,d=Ye*Ve/T*D;j.projectionMatrix.makePerspective(fe,de,E,d,D,T),j.projectionMatrixInverse.copy(j.projectionMatrix).invert()}}function te(j,le){le===null?j.matrixWorld.copy(j.matrix):j.matrixWorld.multiplyMatrices(le.matrixWorld,j.matrix),j.matrixWorldInverse.copy(j.matrixWorld).invert()}this.updateCamera=function(j){if(r===null)return;let le=j.near,oe=j.far;m.texture!==null&&(m.depthNear>0&&(le=m.depthNear),m.depthFar>0&&(oe=m.depthFar)),N.near=L.near=M.near=le,N.far=L.far=M.far=oe,(k!==N.near||V!==N.far)&&(r.updateRenderState({depthNear:N.near,depthFar:N.far}),k=N.near,V=N.far),N.layers.mask=j.layers.mask|6,M.layers.mask=N.layers.mask&-5,L.layers.mask=N.layers.mask&-3;const De=j.parent,Ue=N.cameras;te(N,De);for(let Re=0;Re<Ue.length;Re++)te(Ue[Re],De);Ue.length===2?se(N,M,L):N.projectionMatrix.copy(M.projectionMatrix),pe(j,N,De)};function pe(j,le,oe){oe===null?j.matrix.copy(le.matrixWorld):(j.matrix.copy(oe.matrixWorld),j.matrix.invert(),j.matrix.multiply(le.matrixWorld)),j.matrix.decompose(j.position,j.quaternion,j.scale),j.updateMatrixWorld(!0),j.projectionMatrix.copy(le.projectionMatrix),j.projectionMatrixInverse.copy(le.projectionMatrixInverse),j.isPerspectiveCamera&&(j.fov=ir*2*Math.atan(1/j.projectionMatrix.elements[5]),j.zoom=1)}this.getCamera=function(){return N},this.getFoveation=function(){if(!(h===null&&_===null))return l},this.setFoveation=function(j){l=j,h!==null&&(h.fixedFoveation=j),_!==null&&_.fixedFoveation!==void 0&&(_.fixedFoveation=j)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(N)},this.getCameraTexture=function(j){return u[j]};let Oe=null;function Je(j,le){if(p=le.getViewerPose(c||a),v=le,p!==null){const oe=p.views;_!==null&&(e.setRenderTargetFramebuffer(x,_.framebuffer),e.setRenderTarget(x));let De=!1;oe.length!==N.cameras.length&&(N.cameras.length=0,De=!0);for(let Ve=0;Ve<oe.length;Ve++){const Ge=oe[Ve];let Ye=null;if(_!==null)Ye=_.getViewport(Ge);else{const st=f.getViewSubImage(h,Ge);Ye=st.viewport,Ve===0&&(e.setRenderTargetTextures(x,st.colorTexture,st.depthStencilTexture),e.setRenderTarget(x))}let Xe=P[Ve];Xe===void 0&&(Xe=new Zt,Xe.layers.enable(Ve),Xe.viewport=new vt,P[Ve]=Xe),Xe.matrix.fromArray(Ge.transform.matrix),Xe.matrix.decompose(Xe.position,Xe.quaternion,Xe.scale),Xe.projectionMatrix.fromArray(Ge.projectionMatrix),Xe.projectionMatrixInverse.copy(Xe.projectionMatrix).invert(),Xe.viewport.set(Ye.x,Ye.y,Ye.width,Ye.height),Ve===0&&(N.matrix.copy(Xe.matrix),N.matrix.decompose(N.position,N.quaternion,N.scale)),De===!0&&N.cameras.push(Xe)}const Ue=r.enabledFeatures;if(Ue&&Ue.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&w){f=n.getBinding();const Ve=f.getDepthInformation(oe[0]);Ve&&Ve.isValid&&Ve.texture&&m.init(Ve,r.renderState)}if(Ue&&Ue.includes("camera-access")&&w){e.state.unbindTexture(),f=n.getBinding();for(let Ve=0;Ve<oe.length;Ve++){const Ge=oe[Ve].camera;if(Ge){let Ye=u[Ge];Ye||(Ye=new Ll,u[Ge]=Ye);const Xe=f.getCameraImage(Ge);Ye.sourceTexture=Xe}}}}for(let oe=0;oe<b.length;oe++){const De=y[oe],Ue=b[oe];De!==null&&Ue!==void 0&&Ue.update(De,le,c||a)}Oe&&Oe(j,le),le.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:le}),v=null}const Be=new Fl;Be.setAnimationLoop(Je),this.setAnimationLoop=function(j){Oe=j},this.dispose=function(){}}}const Um=new pt,Vl=new We;Vl.set(-1,0,0,0,1,0,0,0,1);function Nm(i,e){function t(m,u){m.matrixAutoUpdate===!0&&m.updateMatrix(),u.value.copy(m.matrix)}function n(m,u){u.color.getRGB(m.fogColor.value,Dl(i)),u.isFog?(m.fogNear.value=u.near,m.fogFar.value=u.far):u.isFogExp2&&(m.fogDensity.value=u.density)}function r(m,u,A,C,x){u.isNodeMaterial?u.uniformsNeedUpdate=!1:u.isMeshBasicMaterial?s(m,u):u.isMeshLambertMaterial?(s(m,u),u.envMap&&(m.envMapIntensity.value=u.envMapIntensity)):u.isMeshToonMaterial?(s(m,u),f(m,u)):u.isMeshPhongMaterial?(s(m,u),p(m,u),u.envMap&&(m.envMapIntensity.value=u.envMapIntensity)):u.isMeshStandardMaterial?(s(m,u),h(m,u),u.isMeshPhysicalMaterial&&_(m,u,x)):u.isMeshMatcapMaterial?(s(m,u),v(m,u)):u.isMeshDepthMaterial?s(m,u):u.isMeshDistanceMaterial?(s(m,u),w(m,u)):u.isMeshNormalMaterial?s(m,u):u.isLineBasicMaterial?(a(m,u),u.isLineDashedMaterial&&o(m,u)):u.isPointsMaterial?l(m,u,A,C):u.isSpriteMaterial?c(m,u):u.isShadowMaterial?(m.color.value.copy(u.color),m.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function s(m,u){m.opacity.value=u.opacity,u.color&&m.diffuse.value.copy(u.color),u.emissive&&m.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(m.map.value=u.map,t(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,t(u.alphaMap,m.alphaMapTransform)),u.bumpMap&&(m.bumpMap.value=u.bumpMap,t(u.bumpMap,m.bumpMapTransform),m.bumpScale.value=u.bumpScale,u.side===Bt&&(m.bumpScale.value*=-1)),u.normalMap&&(m.normalMap.value=u.normalMap,t(u.normalMap,m.normalMapTransform),m.normalScale.value.copy(u.normalScale),u.side===Bt&&m.normalScale.value.negate()),u.displacementMap&&(m.displacementMap.value=u.displacementMap,t(u.displacementMap,m.displacementMapTransform),m.displacementScale.value=u.displacementScale,m.displacementBias.value=u.displacementBias),u.emissiveMap&&(m.emissiveMap.value=u.emissiveMap,t(u.emissiveMap,m.emissiveMapTransform)),u.specularMap&&(m.specularMap.value=u.specularMap,t(u.specularMap,m.specularMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest);const A=e.get(u),C=A.envMap,x=A.envMapRotation;C&&(m.envMap.value=C,m.envMapRotation.value.setFromMatrix4(Um.makeRotationFromEuler(x)).transpose(),C.isCubeTexture&&C.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(Vl),m.reflectivity.value=u.reflectivity,m.ior.value=u.ior,m.refractionRatio.value=u.refractionRatio),u.lightMap&&(m.lightMap.value=u.lightMap,m.lightMapIntensity.value=u.lightMapIntensity,t(u.lightMap,m.lightMapTransform)),u.aoMap&&(m.aoMap.value=u.aoMap,m.aoMapIntensity.value=u.aoMapIntensity,t(u.aoMap,m.aoMapTransform))}function a(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,u.map&&(m.map.value=u.map,t(u.map,m.mapTransform))}function o(m,u){m.dashSize.value=u.dashSize,m.totalSize.value=u.dashSize+u.gapSize,m.scale.value=u.scale}function l(m,u,A,C){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.size.value=u.size*A,m.scale.value=C*.5,u.map&&(m.map.value=u.map,t(u.map,m.uvTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,t(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function c(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.rotation.value=u.rotation,u.map&&(m.map.value=u.map,t(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,t(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function p(m,u){m.specular.value.copy(u.specular),m.shininess.value=Math.max(u.shininess,1e-4)}function f(m,u){u.gradientMap&&(m.gradientMap.value=u.gradientMap)}function h(m,u){m.metalness.value=u.metalness,u.metalnessMap&&(m.metalnessMap.value=u.metalnessMap,t(u.metalnessMap,m.metalnessMapTransform)),m.roughness.value=u.roughness,u.roughnessMap&&(m.roughnessMap.value=u.roughnessMap,t(u.roughnessMap,m.roughnessMapTransform)),u.envMap&&(m.envMapIntensity.value=u.envMapIntensity)}function _(m,u,A){m.ior.value=u.ior,u.sheen>0&&(m.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),m.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(m.sheenColorMap.value=u.sheenColorMap,t(u.sheenColorMap,m.sheenColorMapTransform)),u.sheenRoughnessMap&&(m.sheenRoughnessMap.value=u.sheenRoughnessMap,t(u.sheenRoughnessMap,m.sheenRoughnessMapTransform))),u.clearcoat>0&&(m.clearcoat.value=u.clearcoat,m.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(m.clearcoatMap.value=u.clearcoatMap,t(u.clearcoatMap,m.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,t(u.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(m.clearcoatNormalMap.value=u.clearcoatNormalMap,t(u.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===Bt&&m.clearcoatNormalScale.value.negate())),u.dispersion>0&&(m.dispersion.value=u.dispersion),u.iridescence>0&&(m.iridescence.value=u.iridescence,m.iridescenceIOR.value=u.iridescenceIOR,m.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(m.iridescenceMap.value=u.iridescenceMap,t(u.iridescenceMap,m.iridescenceMapTransform)),u.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=u.iridescenceThicknessMap,t(u.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),u.transmission>0&&(m.transmission.value=u.transmission,m.transmissionSamplerMap.value=A.texture,m.transmissionSamplerSize.value.set(A.width,A.height),u.transmissionMap&&(m.transmissionMap.value=u.transmissionMap,t(u.transmissionMap,m.transmissionMapTransform)),m.thickness.value=u.thickness,u.thicknessMap&&(m.thicknessMap.value=u.thicknessMap,t(u.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=u.attenuationDistance,m.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(m.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(m.anisotropyMap.value=u.anisotropyMap,t(u.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=u.specularIntensity,m.specularColor.value.copy(u.specularColor),u.specularColorMap&&(m.specularColorMap.value=u.specularColorMap,t(u.specularColorMap,m.specularColorMapTransform)),u.specularIntensityMap&&(m.specularIntensityMap.value=u.specularIntensityMap,t(u.specularIntensityMap,m.specularIntensityMapTransform))}function v(m,u){u.matcap&&(m.matcap.value=u.matcap)}function w(m,u){const A=e.get(u).light;m.referencePosition.value.setFromMatrixPosition(A.matrixWorld),m.nearDistance.value=A.shadow.camera.near,m.farDistance.value=A.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function Fm(i,e,t,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(x,b){const y=b.program;n.uniformBlockBinding(x,y)}function c(x,b){let y=r[x.id];y===void 0&&(m(x),y=p(x),r[x.id]=y,x.addEventListener("dispose",A));const R=b.program;n.updateUBOMapping(x,R);const g=e.render.frame;s[x.id]!==g&&(h(x),s[x.id]=g)}function p(x){const b=f();x.__bindingPointIndex=b;const y=i.createBuffer(),R=x.__size,g=x.usage;return i.bindBuffer(i.UNIFORM_BUFFER,y),i.bufferData(i.UNIFORM_BUFFER,R,g),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,b,y),y}function f(){for(let x=0;x<o;x++)if(a.indexOf(x)===-1)return a.push(x),x;return nt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(x){const b=r[x.id],y=x.uniforms,R=x.__cache;i.bindBuffer(i.UNIFORM_BUFFER,b);for(let g=0,M=y.length;g<M;g++){const L=y[g];if(Array.isArray(L))for(let P=0,N=L.length;P<N;P++)_(L[P],g,P,R);else _(L,g,0,R)}i.bindBuffer(i.UNIFORM_BUFFER,null)}function _(x,b,y,R){if(w(x,b,y,R)===!0){const g=x.__offset,M=x.value;if(Array.isArray(M)){let L=0;for(let P=0;P<M.length;P++){const N=M[P],k=u(N);v(N,x.__data,L),typeof N!="number"&&typeof N!="boolean"&&!N.isMatrix3&&!ArrayBuffer.isView(N)&&(L+=k.storage/Float32Array.BYTES_PER_ELEMENT)}}else v(M,x.__data,0);i.bufferSubData(i.UNIFORM_BUFFER,g,x.__data)}}function v(x,b,y){typeof x=="number"||typeof x=="boolean"?b[0]=x:x.isMatrix3?(b[0]=x.elements[0],b[1]=x.elements[1],b[2]=x.elements[2],b[3]=0,b[4]=x.elements[3],b[5]=x.elements[4],b[6]=x.elements[5],b[7]=0,b[8]=x.elements[6],b[9]=x.elements[7],b[10]=x.elements[8],b[11]=0):ArrayBuffer.isView(x)?b.set(new x.constructor(x.buffer,x.byteOffset,b.length)):x.toArray(b,y)}function w(x,b,y,R){const g=x.value,M=b+"_"+y;if(R[M]===void 0)return typeof g=="number"||typeof g=="boolean"?R[M]=g:ArrayBuffer.isView(g)?R[M]=g.slice():R[M]=g.clone(),!0;{const L=R[M];if(typeof g=="number"||typeof g=="boolean"){if(L!==g)return R[M]=g,!0}else{if(ArrayBuffer.isView(g))return!0;if(L.equals(g)===!1)return L.copy(g),!0}}return!1}function m(x){const b=x.uniforms;let y=0;const R=16;for(let M=0,L=b.length;M<L;M++){const P=Array.isArray(b[M])?b[M]:[b[M]];for(let N=0,k=P.length;N<k;N++){const V=P[N],I=Array.isArray(V.value)?V.value:[V.value];for(let F=0,U=I.length;F<U;F++){const q=I[F],Q=u(q),se=y%R,te=se%Q.boundary,pe=se+te;y+=te,pe!==0&&R-pe<Q.storage&&(y+=R-pe),V.__data=new Float32Array(Q.storage/Float32Array.BYTES_PER_ELEMENT),V.__offset=y,y+=Q.storage}}}const g=y%R;return g>0&&(y+=R-g),x.__size=y,x.__cache={},this}function u(x){const b={boundary:0,storage:0};return typeof x=="number"||typeof x=="boolean"?(b.boundary=4,b.storage=4):x.isVector2?(b.boundary=8,b.storage=8):x.isVector3||x.isColor?(b.boundary=16,b.storage=12):x.isVector4?(b.boundary=16,b.storage=16):x.isMatrix3?(b.boundary=48,b.storage=48):x.isMatrix4?(b.boundary=64,b.storage=64):x.isTexture?ze("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(x)?(b.boundary=16,b.storage=x.byteLength):ze("WebGLRenderer: Unsupported uniform value type.",x),b}function A(x){const b=x.target;b.removeEventListener("dispose",A);const y=a.indexOf(b.__bindingPointIndex);a.splice(y,1),i.deleteBuffer(r[b.id]),delete r[b.id],delete s[b.id]}function C(){for(const x in r)i.deleteBuffer(r[x]);a=[],r={},s={}}return{bind:l,update:c,dispose:C}}const Om=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let an=null;function Bm(){return an===null&&(an=new jn(Om,16,16,ii,Rn),an.name="DFG_LUT",an.minFilter=Ct,an.magFilter=Ct,an.wrapS=En,an.wrapT=En,an.generateMipmaps=!1,an.needsUpdate=!0),an}class zm{constructor(e={}){const{canvas:t=Oc(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:p="default",failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:h=!1,outputBufferType:_=Wt}=e;this.isWebGLRenderer=!0;let v;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");v=n.getContextAttributes().alpha}else v=a;const w=_,m=new Set([La,Pa,Ca]),u=new Set([Wt,dn,ji,er,Aa,wa]),A=new Uint32Array(4),C=new Int32Array(4),x=new $;let b=null,y=null;const R=[],g=[];let M=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=fn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const L=this;let P=!1,N=null,k=null,V=null,I=null;this._outputColorSpace=Ot;let F=0,U=0,q=null,Q=-1,se=null;const te=new vt,pe=new vt;let Oe=null;const Je=new Qe(0);let Be=0,j=t.width,le=t.height,oe=1,De=null,Ue=null;const Re=new vt(0,0,j,le),at=new vt(0,0,j,le);let Ve=!1;const Ge=new Ba;let Ye=!1,Xe=!1;const st=new pt,ft=new $,mt=new vt,ct={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let it=!1;function D(){return q===null?oe:1}let T=n;function fe(S,G){return t.getContext(S,G)}try{const S={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:p,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Ea}`),t.addEventListener("webglcontextlost",_t,!1),t.addEventListener("webglcontextrestored",ot,!1),t.addEventListener("webglcontextcreationerror",Ht,!1),T===null){const G="webgl2";if(T=fe(G,S),T===null)throw fe(G)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(S){throw nt("WebGLRenderer: "+S.message),S}let de,E,d,O,H,Y,re,ue,B,W,ce,xe,he,ae,ie,_e,Ne,z,ge,ee,me,ve,ne;function we(){de=new Bd(T),de.init(),me=new Cm(T,de),E=new Pd(T,de,e,me),d=new wm(T,de),E.reversedDepthBuffer&&h&&d.buffers.depth.setReversed(!0),k=T.createFramebuffer(),V=T.createFramebuffer(),I=T.createFramebuffer(),O=new kd(T),H=new dm,Y=new Rm(T,de,d,H,E,me,O),re=new Od(L),ue=new Wu(T),ve=new Rd(T,ue),B=new zd(T,ue,O,ve),W=new Vd(T,B,ue,ve,O),z=new Gd(T,E,Y),ie=new Ld(H),ce=new hm(L,re,de,E,ve,ie),xe=new Nm(L,H),he=new mm,ae=new Sm(de),Ne=new wd(L,re,d,W,v,l),_e=new Am(L,W,E),ne=new Fm(T,O,E,d),ge=new Cd(T,de,O),ee=new Hd(T,de,O),O.programs=ce.programs,L.capabilities=E,L.extensions=de,L.properties=H,L.renderLists=he,L.shadowMap=_e,L.state=d,L.info=O}we(),w!==Wt&&(M=new Xd(w,t.width,t.height,o,r,s));const Ae=new Im(L,T);this.xr=Ae,this.getContext=function(){return T},this.getContextAttributes=function(){return T.getContextAttributes()},this.forceContextLoss=function(){const S=de.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=de.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return oe},this.setPixelRatio=function(S){S!==void 0&&(oe=S,this.setSize(j,le,!1))},this.getSize=function(S){return S.set(j,le)},this.setSize=function(S,G,J=!0){if(Ae.isPresenting){ze("WebGLRenderer: Can't change size while VR device is presenting.");return}j=S,le=G,t.width=Math.floor(S*oe),t.height=Math.floor(G*oe),J===!0&&(t.style.width=S+"px",t.style.height=G+"px"),M!==null&&M.setSize(t.width,t.height),this.setViewport(0,0,S,G)},this.getDrawingBufferSize=function(S){return S.set(j*oe,le*oe).floor()},this.setDrawingBufferSize=function(S,G,J){j=S,le=G,oe=J,t.width=Math.floor(S*J),t.height=Math.floor(G*J),this.setViewport(0,0,S,G)},this.setEffects=function(S){if(w===Wt){nt("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(S){for(let G=0;G<S.length;G++)if(S[G].isOutputPass===!0){ze("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}M.setEffects(S||[])},this.getCurrentViewport=function(S){return S.copy(te)},this.getViewport=function(S){return S.copy(Re)},this.setViewport=function(S,G,J,K){S.isVector4?Re.set(S.x,S.y,S.z,S.w):Re.set(S,G,J,K),d.viewport(te.copy(Re).multiplyScalar(oe).round())},this.getScissor=function(S){return S.copy(at)},this.setScissor=function(S,G,J,K){S.isVector4?at.set(S.x,S.y,S.z,S.w):at.set(S,G,J,K),d.scissor(pe.copy(at).multiplyScalar(oe).round())},this.getScissorTest=function(){return Ve},this.setScissorTest=function(S){d.setScissorTest(Ve=S)},this.setOpaqueSort=function(S){De=S},this.setTransparentSort=function(S){Ue=S},this.getClearColor=function(S){return S.copy(Ne.getClearColor())},this.setClearColor=function(){Ne.setClearColor(...arguments)},this.getClearAlpha=function(){return Ne.getClearAlpha()},this.setClearAlpha=function(){Ne.setClearAlpha(...arguments)},this.clear=function(S=!0,G=!0,J=!0){let K=0;if(S){let Z=!1;if(q!==null){const ye=q.texture.format;Z=m.has(ye)}if(Z){const ye=q.texture.type,Te=u.has(ye),Se=Ne.getClearColor(),Ce=Ne.getClearAlpha(),Le=Se.r,qe=Se.g,Ke=Se.b;Te?(A[0]=Le,A[1]=qe,A[2]=Ke,A[3]=Ce,T.clearBufferuiv(T.COLOR,0,A)):(C[0]=Le,C[1]=qe,C[2]=Ke,C[3]=Ce,T.clearBufferiv(T.COLOR,0,C))}else K|=T.COLOR_BUFFER_BIT}G&&(K|=T.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),J&&(K|=T.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),K!==0&&T.clear(K)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(S){S.setRenderer(this),N=S},this.dispose=function(){t.removeEventListener("webglcontextlost",_t,!1),t.removeEventListener("webglcontextrestored",ot,!1),t.removeEventListener("webglcontextcreationerror",Ht,!1),Ne.dispose(),he.dispose(),ae.dispose(),H.dispose(),re.dispose(),W.dispose(),ve.dispose(),ne.dispose(),ce.dispose(),Ae.dispose(),Ae.removeEventListener("sessionstart",Xn),Ae.removeEventListener("sessionend",Pn),nn.stop()};function _t(S){S.preventDefault(),ao("WebGLRenderer: Context Lost."),P=!0}function ot(){ao("WebGLRenderer: Context Restored."),P=!1;const S=O.autoReset,G=_e.enabled,J=_e.autoUpdate,K=_e.needsUpdate,Z=_e.type;we(),O.autoReset=S,_e.enabled=G,_e.autoUpdate=J,_e.needsUpdate=K,_e.type=Z}function Ht(S){nt("WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function qt(S){const G=S.target;G.removeEventListener("dispose",qt),Yr(G)}function Yr(S){$r(S),H.remove(S)}function $r(S){const G=H.get(S).programs;G!==void 0&&(G.forEach(function(J){ce.releaseProgram(J)}),S.isShaderMaterial&&ce.releaseShaderCache(S))}this.renderBufferDirect=function(S,G,J,K,Z,ye){G===null&&(G=ct);const Te=Z.isMesh&&Z.matrixWorld.determinantAffine()<0,Se=Xl(S,G,J,K,Z);d.setMaterial(K,Te);let Ce=J.index,Le=1;if(K.wireframe===!0){if(Ce=B.getWireframeAttribute(J),Ce===void 0)return;Le=2}const qe=J.drawRange,Ke=J.attributes.position;let Ie=qe.start*Le,ut=(qe.start+qe.count)*Le;ye!==null&&(Ie=Math.max(Ie,ye.start*Le),ut=Math.min(ut,(ye.start+ye.count)*Le)),Ce!==null?(Ie=Math.max(Ie,0),ut=Math.min(ut,Ce.count)):Ke!=null&&(Ie=Math.max(Ie,0),ut=Math.min(ut,Ke.count));const St=ut-Ie;if(St<0||St===1/0)return;ve.setup(Z,K,Se,J,Ce);let Mt,ht=ge;if(Ce!==null&&(Mt=ue.get(Ce),ht=ee,ht.setIndex(Mt)),Z.isMesh)K.wireframe===!0?(d.setLineWidth(K.wireframeLinewidth*D()),ht.setMode(T.LINES)):ht.setMode(T.TRIANGLES);else if(Z.isLine){let Lt=K.linewidth;Lt===void 0&&(Lt=1),d.setLineWidth(Lt*D()),Z.isLineSegments?ht.setMode(T.LINES):Z.isLineLoop?ht.setMode(T.LINE_LOOP):ht.setMode(T.LINE_STRIP)}else Z.isPoints?ht.setMode(T.POINTS):Z.isSprite&&ht.setMode(T.TRIANGLES);if(Z.isBatchedMesh)if(de.get("WEBGL_multi_draw"))ht.renderMultiDraw(Z._multiDrawStarts,Z._multiDrawCounts,Z._multiDrawCount);else{const Lt=Z._multiDrawStarts,be=Z._multiDrawCounts,kt=Z._multiDrawCount,rt=Ce?ue.get(Ce).bytesPerElement:1,Yt=H.get(K).currentProgram.getUniforms();for(let rn=0;rn<kt;rn++)Yt.setValue(T,"_gl_DrawID",rn),ht.render(Lt[rn]/rt,be[rn])}else if(Z.isInstancedMesh)ht.renderInstances(Ie,St,Z.count);else if(J.isInstancedBufferGeometry){const Lt=J._maxInstanceCount!==void 0?J._maxInstanceCount:1/0,be=Math.min(J.instanceCount,Lt);ht.renderInstances(Ie,St,be)}else ht.render(Ie,St)};function oi(S,G,J){S.transparent===!0&&S.side===ln&&S.forceSinglePass===!1?(S.side=Bt,S.needsUpdate=!0,gn(S,G,J),S.side=wn,S.needsUpdate=!0,gn(S,G,J),S.side=ln):gn(S,G,J)}this.compile=function(S,G,J=null){J===null&&(J=S),y=ae.get(J),y.init(G),g.push(y),J.traverseVisible(function(Z){Z.isLight&&Z.layers.test(G.layers)&&(y.pushLight(Z),Z.castShadow&&y.pushShadow(Z))}),S!==J&&S.traverseVisible(function(Z){Z.isLight&&Z.layers.test(G.layers)&&(y.pushLight(Z),Z.castShadow&&y.pushShadow(Z))}),y.setupLights();const K=new Set;return S.traverse(function(Z){if(!(Z.isMesh||Z.isPoints||Z.isLine||Z.isSprite))return;const ye=Z.material;if(ye)if(Array.isArray(ye))for(let Te=0;Te<ye.length;Te++){const Se=ye[Te];oi(Se,J,Z),K.add(Se)}else oi(ye,J,Z),K.add(ye)}),y=g.pop(),K},this.compileAsync=function(S,G,J=null){const K=this.compile(S,G,J);return new Promise(Z=>{function ye(){if(K.forEach(function(Te){H.get(Te).currentProgram.isReady()&&K.delete(Te)}),K.size===0){Z(S);return}setTimeout(ye,10)}de.get("KHR_parallel_shader_compile")!==null?ye():setTimeout(ye,10)})};let Wn=null;function li(S){Wn&&Wn(S)}function Xn(){nn.stop()}function Pn(){nn.start()}const nn=new Fl;nn.setAnimationLoop(li),typeof self<"u"&&nn.setContext(self),this.setAnimationLoop=function(S){Wn=S,Ae.setAnimationLoop(S),S===null?nn.stop():nn.start()},Ae.addEventListener("sessionstart",Xn),Ae.addEventListener("sessionend",Pn),this.render=function(S,G){if(G!==void 0&&G.isCamera!==!0){nt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(P===!0)return;N!==null&&N.renderStart(S,G);const J=Ae.enabled===!0&&Ae.isPresenting===!0,K=M!==null&&(q===null||J)&&M.begin(L,q);if(S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),G.parent===null&&G.matrixWorldAutoUpdate===!0&&G.updateMatrixWorld(),Ae.enabled===!0&&Ae.isPresenting===!0&&(M===null||M.isCompositing()===!1)&&(Ae.cameraAutoUpdate===!0&&Ae.updateCamera(G),G=Ae.getCamera()),S.isScene===!0&&S.onBeforeRender(L,S,G,q),y=ae.get(S,g.length),y.init(G),y.state.textureUnits=Y.getTextureUnits(),g.push(y),st.multiplyMatrices(G.projectionMatrix,G.matrixWorldInverse),Ge.setFromProjectionMatrix(st,un,G.reversedDepth),Xe=this.localClippingEnabled,Ye=ie.init(this.clippingPlanes,Xe),b=he.get(S,R.length),b.init(),R.push(b),Ae.enabled===!0&&Ae.isPresenting===!0){const Te=L.xr.getDepthSensingMesh();Te!==null&&X(Te,G,-1/0,L.sortObjects)}X(S,G,0,L.sortObjects),b.finish(),L.sortObjects===!0&&b.sort(De,Ue,G.reversedDepth),it=Ae.enabled===!1||Ae.isPresenting===!1||Ae.hasDepthSensing()===!1,it&&Ne.addToRenderList(b,S),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Ye===!0&&ie.beginShadows();const Z=y.state.shadowsArray;if(_e.render(Z,S,G),Ye===!0&&ie.endShadows(),(K&&M.hasRenderPass())===!1){const Te=b.opaque,Se=b.transmissive;if(y.setupLights(),G.isArrayCamera){const Ce=G.cameras;if(Se.length>0)for(let Le=0,qe=Ce.length;Le<qe;Le++){const Ke=Ce[Le];He(Te,Se,S,Ke)}it&&Ne.render(S);for(let Le=0,qe=Ce.length;Le<qe;Le++){const Ke=Ce[Le];Ee(b,S,Ke,Ke.viewport)}}else Se.length>0&&He(Te,Se,S,G),it&&Ne.render(S),Ee(b,S,G)}q!==null&&U===0&&(Y.updateMultisampleRenderTarget(q),Y.updateRenderTargetMipmap(q)),K&&M.end(L),S.isScene===!0&&S.onAfterRender(L,S,G),ve.resetDefaultState(),Q=-1,se=null,g.pop(),g.length>0?(y=g[g.length-1],Y.setTextureUnits(y.state.textureUnits),Ye===!0&&ie.setGlobalState(L.clippingPlanes,y.state.camera)):y=null,R.pop(),R.length>0?b=R[R.length-1]:b=null,N!==null&&N.renderEnd()};function X(S,G,J,K){if(S.visible===!1)return;if(S.layers.test(G.layers)){if(S.isGroup)J=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(G);else if(S.isLightProbeGrid)y.pushLightProbeGrid(S);else if(S.isLight)y.pushLight(S),S.castShadow&&y.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||Ge.intersectsSprite(S)){K&&mt.setFromMatrixPosition(S.matrixWorld).applyMatrix4(st);const Te=W.update(S),Se=S.material;Se.visible&&b.push(S,Te,Se,J,mt.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||Ge.intersectsObject(S))){const Te=W.update(S),Se=S.material;if(K&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),mt.copy(S.boundingSphere.center)):(Te.boundingSphere===null&&Te.computeBoundingSphere(),mt.copy(Te.boundingSphere.center)),mt.applyMatrix4(S.matrixWorld).applyMatrix4(st)),Array.isArray(Se)){const Ce=Te.groups;for(let Le=0,qe=Ce.length;Le<qe;Le++){const Ke=Ce[Le],Ie=Se[Ke.materialIndex];Ie&&Ie.visible&&b.push(S,Te,Ie,J,mt.z,Ke)}}else Se.visible&&b.push(S,Te,Se,J,mt.z,null)}}const ye=S.children;for(let Te=0,Se=ye.length;Te<Se;Te++)X(ye[Te],G,J,K)}function Ee(S,G,J,K){const{opaque:Z,transmissive:ye,transparent:Te}=S;y.setupLightsView(J),Ye===!0&&ie.setGlobalState(L.clippingPlanes,J),K&&d.viewport(te.copy(K)),Z.length>0&&Pe(Z,G,J),ye.length>0&&Pe(ye,G,J),Te.length>0&&Pe(Te,G,J),d.buffers.depth.setTest(!0),d.buffers.depth.setMask(!0),d.buffers.color.setMask(!0),d.setPolygonOffset(!1)}function He(S,G,J,K){if((J.isScene===!0?J.overrideMaterial:null)!==null)return;if(y.state.transmissionRenderTarget[K.id]===void 0){const Ie=de.has("EXT_color_buffer_half_float")||de.has("EXT_color_buffer_float");y.state.transmissionRenderTarget[K.id]=new hn(1,1,{generateMipmaps:!0,type:Ie?Rn:Wt,minFilter:cn,samples:Math.max(4,E.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:tt.workingColorSpace})}const ye=y.state.transmissionRenderTarget[K.id],Te=K.viewport||te;ye.setSize(Te.z*L.transmissionResolutionScale,Te.w*L.transmissionResolutionScale);const Se=L.getRenderTarget(),Ce=L.getActiveCubeFace(),Le=L.getActiveMipmapLevel();L.setRenderTarget(ye),L.getClearColor(Je),Be=L.getClearAlpha(),Be<1&&L.setClearColor(16777215,.5),L.clear(),it&&Ne.render(J);const qe=L.toneMapping;L.toneMapping=fn;const Ke=K.viewport;if(K.viewport!==void 0&&(K.viewport=void 0),y.setupLightsView(K),Ye===!0&&ie.setGlobalState(L.clippingPlanes,K),Pe(S,J,K),Y.updateMultisampleRenderTarget(ye),Y.updateRenderTargetMipmap(ye),de.has("WEBGL_multisampled_render_to_texture")===!1){let Ie=!1;for(let ut=0,St=G.length;ut<St;ut++){const Mt=G[ut],{object:ht,geometry:Lt,material:be,group:kt}=Mt;if(be.side===ln&&ht.layers.test(K.layers)){const rt=be.side;be.side=Bt,be.needsUpdate=!0,je(ht,J,K,Lt,be,kt),be.side=rt,be.needsUpdate=!0,Ie=!0}}Ie===!0&&(Y.updateMultisampleRenderTarget(ye),Y.updateRenderTargetMipmap(ye))}L.setRenderTarget(Se,Ce,Le),L.setClearColor(Je,Be),Ke!==void 0&&(K.viewport=Ke),L.toneMapping=qe}function Pe(S,G,J){const K=G.isScene===!0?G.overrideMaterial:null;for(let Z=0,ye=S.length;Z<ye;Z++){const Te=S[Z],{object:Se,geometry:Ce,group:Le}=Te;let qe=Te.material;qe.allowOverride===!0&&K!==null&&(qe=K),Se.layers.test(J.layers)&&je(Se,G,J,Ce,qe,Le)}}function je(S,G,J,K,Z,ye){S.onBeforeRender(L,G,J,K,Z,ye),S.modelViewMatrix.multiplyMatrices(J.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),Z.onBeforeRender(L,G,J,K,S,ye),Z.transparent===!0&&Z.side===ln&&Z.forceSinglePass===!1?(Z.side=Bt,Z.needsUpdate=!0,L.renderBufferDirect(J,G,K,Z,S,ye),Z.side=wn,Z.needsUpdate=!0,L.renderBufferDirect(J,G,K,Z,S,ye),Z.side=ln):L.renderBufferDirect(J,G,K,Z,S,ye),S.onAfterRender(L,G,J,K,Z,ye)}function gn(S,G,J){G.isScene!==!0&&(G=ct);const K=H.get(S),Z=y.state.lights,ye=y.state.shadowsArray,Te=Z.state.version,Se=ce.getParameters(S,Z.state,ye,G,J,y.state.lightProbeGridArray),Ce=ce.getProgramCacheKey(Se);let Le=K.programs;K.environment=S.isMeshStandardMaterial||S.isMeshLambertMaterial||S.isMeshPhongMaterial?G.environment:null,K.fog=G.fog;const qe=S.isMeshStandardMaterial||S.isMeshLambertMaterial&&!S.envMap||S.isMeshPhongMaterial&&!S.envMap;K.envMap=re.get(S.envMap||K.environment,qe),K.envMapRotation=K.environment!==null&&S.envMap===null?G.environmentRotation:S.envMapRotation,Le===void 0&&(S.addEventListener("dispose",qt),Le=new Map,K.programs=Le);let Ke=Le.get(Ce);if(Ke!==void 0){if(K.currentProgram===Ke&&K.lightsStateVersion===Te)return qa(S,Se),Ke}else Se.uniforms=ce.getUniforms(S),N!==null&&S.isNodeMaterial&&N.build(S,J,Se),S.onBeforeCompile(Se,L),Ke=ce.acquireProgram(Se,Ce),Le.set(Ce,Ke),K.uniforms=Se.uniforms;const Ie=K.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(Ie.clippingPlanes=ie.uniform),qa(S,Se),K.needsLights=Yl(S),K.lightsStateVersion=Te,K.needsLights&&(Ie.ambientLightColor.value=Z.state.ambient,Ie.lightProbe.value=Z.state.probe,Ie.directionalLights.value=Z.state.directional,Ie.directionalLightShadows.value=Z.state.directionalShadow,Ie.spotLights.value=Z.state.spot,Ie.spotLightShadows.value=Z.state.spotShadow,Ie.rectAreaLights.value=Z.state.rectArea,Ie.ltc_1.value=Z.state.rectAreaLTC1,Ie.ltc_2.value=Z.state.rectAreaLTC2,Ie.pointLights.value=Z.state.point,Ie.pointLightShadows.value=Z.state.pointShadow,Ie.hemisphereLights.value=Z.state.hemi,Ie.directionalShadowMatrix.value=Z.state.directionalShadowMatrix,Ie.spotLightMatrix.value=Z.state.spotLightMatrix,Ie.spotLightMap.value=Z.state.spotLightMap,Ie.pointShadowMatrix.value=Z.state.pointShadowMatrix),K.lightProbeGrid=y.state.lightProbeGridArray.length>0,K.currentProgram=Ke,K.uniformsList=null,Ke}function _n(S){if(S.uniformsList===null){const G=S.currentProgram.getUniforms();S.uniformsList=Or.seqWithValue(G.seq,S.uniforms)}return S.uniformsList}function qa(S,G){const J=H.get(S);J.outputColorSpace=G.outputColorSpace,J.batching=G.batching,J.batchingColor=G.batchingColor,J.instancing=G.instancing,J.instancingColor=G.instancingColor,J.instancingMorph=G.instancingMorph,J.skinning=G.skinning,J.morphTargets=G.morphTargets,J.morphNormals=G.morphNormals,J.morphColors=G.morphColors,J.morphTargetsCount=G.morphTargetsCount,J.numClippingPlanes=G.numClippingPlanes,J.numIntersection=G.numClipIntersection,J.vertexAlphas=G.vertexAlphas,J.vertexTangents=G.vertexTangents,J.toneMapping=G.toneMapping}function Wl(S,G){if(S.length===0)return null;if(S.length===1)return S[0].texture!==null?S[0]:null;x.setFromMatrixPosition(G.matrixWorld);for(let J=0,K=S.length;J<K;J++){const Z=S[J];if(Z.texture!==null&&Z.boundingBox.containsPoint(x))return Z}return null}function Xl(S,G,J,K,Z){G.isScene!==!0&&(G=ct),Y.resetTextureUnits();const ye=G.fog,Te=K.isMeshStandardMaterial||K.isMeshLambertMaterial||K.isMeshPhongMaterial?G.environment:null,Se=q===null?L.outputColorSpace:q.isXRRenderTarget===!0?q.texture.colorSpace:tt.workingColorSpace,Ce=K.isMeshStandardMaterial||K.isMeshLambertMaterial&&!K.envMap||K.isMeshPhongMaterial&&!K.envMap,Le=re.get(K.envMap||Te,Ce),qe=K.vertexColors===!0&&!!J.attributes.color&&J.attributes.color.itemSize===4,Ke=!!J.attributes.tangent&&(!!K.normalMap||K.anisotropy>0),Ie=!!J.morphAttributes.position,ut=!!J.morphAttributes.normal,St=!!J.morphAttributes.color;let Mt=fn;K.toneMapped&&(q===null||q.isXRRenderTarget===!0)&&(Mt=L.toneMapping);const ht=J.morphAttributes.position||J.morphAttributes.normal||J.morphAttributes.color,Lt=ht!==void 0?ht.length:0,be=H.get(K),kt=y.state.lights;if(Ye===!0&&(Xe===!0||S!==se)){const gt=S===se&&K.id===Q;ie.setState(K,S,gt)}let rt=!1;K.version===be.__version?(be.needsLights&&be.lightsStateVersion!==kt.state.version||be.outputColorSpace!==Se||Z.isBatchedMesh&&be.batching===!1||!Z.isBatchedMesh&&be.batching===!0||Z.isBatchedMesh&&be.batchingColor===!0&&Z.colorTexture===null||Z.isBatchedMesh&&be.batchingColor===!1&&Z.colorTexture!==null||Z.isInstancedMesh&&be.instancing===!1||!Z.isInstancedMesh&&be.instancing===!0||Z.isSkinnedMesh&&be.skinning===!1||!Z.isSkinnedMesh&&be.skinning===!0||Z.isInstancedMesh&&be.instancingColor===!0&&Z.instanceColor===null||Z.isInstancedMesh&&be.instancingColor===!1&&Z.instanceColor!==null||Z.isInstancedMesh&&be.instancingMorph===!0&&Z.morphTexture===null||Z.isInstancedMesh&&be.instancingMorph===!1&&Z.morphTexture!==null||be.envMap!==Le||K.fog===!0&&be.fog!==ye||be.numClippingPlanes!==void 0&&(be.numClippingPlanes!==ie.numPlanes||be.numIntersection!==ie.numIntersection)||be.vertexAlphas!==qe||be.vertexTangents!==Ke||be.morphTargets!==Ie||be.morphNormals!==ut||be.morphColors!==St||be.toneMapping!==Mt||be.morphTargetsCount!==Lt||!!be.lightProbeGrid!=y.state.lightProbeGridArray.length>0)&&(rt=!0):(rt=!0,be.__version=K.version);let Yt=be.currentProgram;rt===!0&&(Yt=gn(K,G,Z),N&&K.isNodeMaterial&&N.onUpdateProgram(K,Yt,be));let rn=!1,Ln=!1,ci=!1;const dt=Yt.getUniforms(),yt=be.uniforms;if(d.useProgram(Yt.program)&&(rn=!0,Ln=!0,ci=!0),K.id!==Q&&(Q=K.id,Ln=!0),be.needsLights){const gt=Wl(y.state.lightProbeGridArray,Z);be.lightProbeGrid!==gt&&(be.lightProbeGrid=gt,Ln=!0)}if(rn||se!==S){d.buffers.depth.getReversed()&&S.reversedDepth!==!0&&(S._reversedDepth=!0,S.updateProjectionMatrix()),dt.setValue(T,"projectionMatrix",S.projectionMatrix),dt.setValue(T,"viewMatrix",S.matrixWorldInverse);const In=dt.map.cameraPosition;In!==void 0&&In.setValue(T,ft.setFromMatrixPosition(S.matrixWorld)),E.logarithmicDepthBuffer&&dt.setValue(T,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(K.isMeshPhongMaterial||K.isMeshToonMaterial||K.isMeshLambertMaterial||K.isMeshBasicMaterial||K.isMeshStandardMaterial||K.isShaderMaterial)&&dt.setValue(T,"isOrthographic",S.isOrthographicCamera===!0),se!==S&&(se=S,Ln=!0,ci=!0)}if(be.needsLights&&(kt.state.directionalShadowMap.length>0&&dt.setValue(T,"directionalShadowMap",kt.state.directionalShadowMap,Y),kt.state.spotShadowMap.length>0&&dt.setValue(T,"spotShadowMap",kt.state.spotShadowMap,Y),kt.state.pointShadowMap.length>0&&dt.setValue(T,"pointShadowMap",kt.state.pointShadowMap,Y)),Z.isSkinnedMesh){dt.setOptional(T,Z,"bindMatrix"),dt.setOptional(T,Z,"bindMatrixInverse");const gt=Z.skeleton;gt&&(gt.boneTexture===null&&gt.computeBoneTexture(),dt.setValue(T,"boneTexture",gt.boneTexture,Y))}Z.isBatchedMesh&&(dt.setOptional(T,Z,"batchingTexture"),dt.setValue(T,"batchingTexture",Z._matricesTexture,Y),dt.setOptional(T,Z,"batchingIdTexture"),dt.setValue(T,"batchingIdTexture",Z._indirectTexture,Y),dt.setOptional(T,Z,"batchingColorTexture"),Z._colorsTexture!==null&&dt.setValue(T,"batchingColorTexture",Z._colorsTexture,Y));const Dn=J.morphAttributes;if((Dn.position!==void 0||Dn.normal!==void 0||Dn.color!==void 0)&&z.update(Z,J,Yt),(Ln||be.receiveShadow!==Z.receiveShadow)&&(be.receiveShadow=Z.receiveShadow,dt.setValue(T,"receiveShadow",Z.receiveShadow)),(K.isMeshStandardMaterial||K.isMeshLambertMaterial||K.isMeshPhongMaterial)&&K.envMap===null&&G.environment!==null&&(yt.envMapIntensity.value=G.environmentIntensity),yt.dfgLUT!==void 0&&(yt.dfgLUT.value=Bm()),Ln){if(dt.setValue(T,"toneMappingExposure",L.toneMappingExposure),be.needsLights&&ql(yt,ci),ye&&K.fog===!0&&xe.refreshFogUniforms(yt,ye),xe.refreshMaterialUniforms(yt,K,oe,le,y.state.transmissionRenderTarget[S.id]),be.needsLights&&be.lightProbeGrid){const gt=be.lightProbeGrid;yt.probesSH.value=gt.texture,yt.probesMin.value.copy(gt.boundingBox.min),yt.probesMax.value.copy(gt.boundingBox.max),yt.probesResolution.value.copy(gt.resolution)}Or.upload(T,_n(be),yt,Y)}if(K.isShaderMaterial&&K.uniformsNeedUpdate===!0&&(Or.upload(T,_n(be),yt,Y),K.uniformsNeedUpdate=!1),K.isSpriteMaterial&&dt.setValue(T,"center",Z.center),dt.setValue(T,"modelViewMatrix",Z.modelViewMatrix),dt.setValue(T,"normalMatrix",Z.normalMatrix),dt.setValue(T,"modelMatrix",Z.matrixWorld),K.uniformsGroups!==void 0){const gt=K.uniformsGroups;for(let In=0,ui=gt.length;In<ui;In++){const Ya=gt[In];ne.update(Ya,Yt),ne.bind(Ya,Yt)}}return Yt}function ql(S,G){S.ambientLightColor.needsUpdate=G,S.lightProbe.needsUpdate=G,S.directionalLights.needsUpdate=G,S.directionalLightShadows.needsUpdate=G,S.pointLights.needsUpdate=G,S.pointLightShadows.needsUpdate=G,S.spotLights.needsUpdate=G,S.spotLightShadows.needsUpdate=G,S.rectAreaLights.needsUpdate=G,S.hemisphereLights.needsUpdate=G}function Yl(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return F},this.getActiveMipmapLevel=function(){return U},this.getRenderTarget=function(){return q},this.setRenderTargetTextures=function(S,G,J){const K=H.get(S);K.__autoAllocateDepthBuffer=S.resolveDepthBuffer===!1,K.__autoAllocateDepthBuffer===!1&&(K.__useRenderToTexture=!1),H.get(S.texture).__webglTexture=G,H.get(S.depthTexture).__webglTexture=K.__autoAllocateDepthBuffer?void 0:J,K.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(S,G){const J=H.get(S);J.__webglFramebuffer=G,J.__useDefaultFramebuffer=G===void 0},this.setRenderTarget=function(S,G=0,J=0){q=S,F=G,U=J;let K=null,Z=!1,ye=!1;if(S){const Se=H.get(S);if(Se.__useDefaultFramebuffer!==void 0){d.bindFramebuffer(T.FRAMEBUFFER,Se.__webglFramebuffer),te.copy(S.viewport),pe.copy(S.scissor),Oe=S.scissorTest,d.viewport(te),d.scissor(pe),d.setScissorTest(Oe),Q=-1;return}else if(Se.__webglFramebuffer===void 0)Y.setupRenderTarget(S);else if(Se.__hasExternalTextures)Y.rebindTextures(S,H.get(S.texture).__webglTexture,H.get(S.depthTexture).__webglTexture);else if(S.depthBuffer){const qe=S.depthTexture;if(Se.__boundDepthTexture!==qe){if(qe!==null&&H.has(qe)&&(S.width!==qe.image.width||S.height!==qe.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");Y.setupDepthRenderbuffer(S)}}const Ce=S.texture;(Ce.isData3DTexture||Ce.isDataArrayTexture||Ce.isCompressedArrayTexture)&&(ye=!0);const Le=H.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(Le[G])?K=Le[G][J]:K=Le[G],Z=!0):S.samples>0&&Y.useMultisampledRTT(S)===!1?K=H.get(S).__webglMultisampledFramebuffer:Array.isArray(Le)?K=Le[J]:K=Le,te.copy(S.viewport),pe.copy(S.scissor),Oe=S.scissorTest}else te.copy(Re).multiplyScalar(oe).floor(),pe.copy(at).multiplyScalar(oe).floor(),Oe=Ve;if(J!==0&&(K=k),d.bindFramebuffer(T.FRAMEBUFFER,K)&&d.drawBuffers(S,K),d.viewport(te),d.scissor(pe),d.setScissorTest(Oe),Z){const Se=H.get(S.texture);T.framebufferTexture2D(T.FRAMEBUFFER,T.COLOR_ATTACHMENT0,T.TEXTURE_CUBE_MAP_POSITIVE_X+G,Se.__webglTexture,J)}else if(ye){const Se=G;for(let Ce=0;Ce<S.textures.length;Ce++){const Le=H.get(S.textures[Ce]);T.framebufferTextureLayer(T.FRAMEBUFFER,T.COLOR_ATTACHMENT0+Ce,Le.__webglTexture,J,Se)}}else if(S!==null&&J!==0){const Se=H.get(S.texture);T.framebufferTexture2D(T.FRAMEBUFFER,T.COLOR_ATTACHMENT0,T.TEXTURE_2D,Se.__webglTexture,J)}Q=-1},this.readRenderTargetPixels=function(S,G,J,K,Z,ye,Te,Se=0){if(!(S&&S.isWebGLRenderTarget)){nt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ce=H.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Te!==void 0&&(Ce=Ce[Te]),Ce){d.bindFramebuffer(T.FRAMEBUFFER,Ce);try{const Le=S.textures[Se],qe=Le.format,Ke=Le.type;if(S.textures.length>1&&T.readBuffer(T.COLOR_ATTACHMENT0+Se),!E.textureFormatReadable(qe)){nt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!E.textureTypeReadable(Ke)){nt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}G>=0&&G<=S.width-K&&J>=0&&J<=S.height-Z&&T.readPixels(G,J,K,Z,me.convert(qe),me.convert(Ke),ye)}finally{const Le=q!==null?H.get(q).__webglFramebuffer:null;d.bindFramebuffer(T.FRAMEBUFFER,Le)}}},this.readRenderTargetPixelsAsync=async function(S,G,J,K,Z,ye,Te,Se=0){if(!(S&&S.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ce=H.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&Te!==void 0&&(Ce=Ce[Te]),Ce)if(G>=0&&G<=S.width-K&&J>=0&&J<=S.height-Z){d.bindFramebuffer(T.FRAMEBUFFER,Ce);const Le=S.textures[Se],qe=Le.format,Ke=Le.type;if(S.textures.length>1&&T.readBuffer(T.COLOR_ATTACHMENT0+Se),!E.textureFormatReadable(qe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!E.textureTypeReadable(Ke))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Ie=T.createBuffer();T.bindBuffer(T.PIXEL_PACK_BUFFER,Ie),T.bufferData(T.PIXEL_PACK_BUFFER,ye.byteLength,T.STREAM_READ),T.readPixels(G,J,K,Z,me.convert(qe),me.convert(Ke),0);const ut=q!==null?H.get(q).__webglFramebuffer:null;d.bindFramebuffer(T.FRAMEBUFFER,ut);const St=T.fenceSync(T.SYNC_GPU_COMMANDS_COMPLETE,0);return T.flush(),await Bc(T,St,4),T.bindBuffer(T.PIXEL_PACK_BUFFER,Ie),T.getBufferSubData(T.PIXEL_PACK_BUFFER,0,ye),T.deleteBuffer(Ie),T.deleteSync(St),ye}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(S,G=null,J=0){const K=Math.pow(2,-J),Z=Math.floor(S.image.width*K),ye=Math.floor(S.image.height*K),Te=G!==null?G.x:0,Se=G!==null?G.y:0;Y.setTexture2D(S,0),T.copyTexSubImage2D(T.TEXTURE_2D,J,0,0,Te,Se,Z,ye),d.unbindTexture()},this.copyTextureToTexture=function(S,G,J=null,K=null,Z=0,ye=0){let Te,Se,Ce,Le,qe,Ke,Ie,ut,St;const Mt=S.isCompressedTexture?S.mipmaps[ye]:S.image;if(J!==null)Te=J.max.x-J.min.x,Se=J.max.y-J.min.y,Ce=J.isBox3?J.max.z-J.min.z:1,Le=J.min.x,qe=J.min.y,Ke=J.isBox3?J.min.z:0;else{const yt=Math.pow(2,-Z);Te=Math.floor(Mt.width*yt),Se=Math.floor(Mt.height*yt),S.isDataArrayTexture?Ce=Mt.depth:S.isData3DTexture?Ce=Math.floor(Mt.depth*yt):Ce=1,Le=0,qe=0,Ke=0}K!==null?(Ie=K.x,ut=K.y,St=K.z):(Ie=0,ut=0,St=0);const ht=me.convert(G.format),Lt=me.convert(G.type);let be;G.isData3DTexture?(Y.setTexture3D(G,0),be=T.TEXTURE_3D):G.isDataArrayTexture||G.isCompressedArrayTexture?(Y.setTexture2DArray(G,0),be=T.TEXTURE_2D_ARRAY):(Y.setTexture2D(G,0),be=T.TEXTURE_2D),d.activeTexture(T.TEXTURE0),d.pixelStorei(T.UNPACK_FLIP_Y_WEBGL,G.flipY),d.pixelStorei(T.UNPACK_PREMULTIPLY_ALPHA_WEBGL,G.premultiplyAlpha),d.pixelStorei(T.UNPACK_ALIGNMENT,G.unpackAlignment);const kt=d.getParameter(T.UNPACK_ROW_LENGTH),rt=d.getParameter(T.UNPACK_IMAGE_HEIGHT),Yt=d.getParameter(T.UNPACK_SKIP_PIXELS),rn=d.getParameter(T.UNPACK_SKIP_ROWS),Ln=d.getParameter(T.UNPACK_SKIP_IMAGES);d.pixelStorei(T.UNPACK_ROW_LENGTH,Mt.width),d.pixelStorei(T.UNPACK_IMAGE_HEIGHT,Mt.height),d.pixelStorei(T.UNPACK_SKIP_PIXELS,Le),d.pixelStorei(T.UNPACK_SKIP_ROWS,qe),d.pixelStorei(T.UNPACK_SKIP_IMAGES,Ke);const ci=S.isDataArrayTexture||S.isData3DTexture,dt=G.isDataArrayTexture||G.isData3DTexture;if(S.isDepthTexture){const yt=H.get(S),Dn=H.get(G),gt=H.get(yt.__renderTarget),In=H.get(Dn.__renderTarget);d.bindFramebuffer(T.READ_FRAMEBUFFER,gt.__webglFramebuffer),d.bindFramebuffer(T.DRAW_FRAMEBUFFER,In.__webglFramebuffer);for(let ui=0;ui<Ce;ui++)ci&&(T.framebufferTextureLayer(T.READ_FRAMEBUFFER,T.COLOR_ATTACHMENT0,H.get(S).__webglTexture,Z,Ke+ui),T.framebufferTextureLayer(T.DRAW_FRAMEBUFFER,T.COLOR_ATTACHMENT0,H.get(G).__webglTexture,ye,St+ui)),T.blitFramebuffer(Le,qe,Te,Se,Ie,ut,Te,Se,T.DEPTH_BUFFER_BIT,T.NEAREST);d.bindFramebuffer(T.READ_FRAMEBUFFER,null),d.bindFramebuffer(T.DRAW_FRAMEBUFFER,null)}else if(Z!==0||S.isRenderTargetTexture||H.has(S)){const yt=H.get(S),Dn=H.get(G);d.bindFramebuffer(T.READ_FRAMEBUFFER,V),d.bindFramebuffer(T.DRAW_FRAMEBUFFER,I);for(let gt=0;gt<Ce;gt++)ci?T.framebufferTextureLayer(T.READ_FRAMEBUFFER,T.COLOR_ATTACHMENT0,yt.__webglTexture,Z,Ke+gt):T.framebufferTexture2D(T.READ_FRAMEBUFFER,T.COLOR_ATTACHMENT0,T.TEXTURE_2D,yt.__webglTexture,Z),dt?T.framebufferTextureLayer(T.DRAW_FRAMEBUFFER,T.COLOR_ATTACHMENT0,Dn.__webglTexture,ye,St+gt):T.framebufferTexture2D(T.DRAW_FRAMEBUFFER,T.COLOR_ATTACHMENT0,T.TEXTURE_2D,Dn.__webglTexture,ye),Z!==0?T.blitFramebuffer(Le,qe,Te,Se,Ie,ut,Te,Se,T.COLOR_BUFFER_BIT,T.NEAREST):dt?T.copyTexSubImage3D(be,ye,Ie,ut,St+gt,Le,qe,Te,Se):T.copyTexSubImage2D(be,ye,Ie,ut,Le,qe,Te,Se);d.bindFramebuffer(T.READ_FRAMEBUFFER,null),d.bindFramebuffer(T.DRAW_FRAMEBUFFER,null)}else dt?S.isDataTexture||S.isData3DTexture?T.texSubImage3D(be,ye,Ie,ut,St,Te,Se,Ce,ht,Lt,Mt.data):G.isCompressedArrayTexture?T.compressedTexSubImage3D(be,ye,Ie,ut,St,Te,Se,Ce,ht,Mt.data):T.texSubImage3D(be,ye,Ie,ut,St,Te,Se,Ce,ht,Lt,Mt):S.isDataTexture?T.texSubImage2D(T.TEXTURE_2D,ye,Ie,ut,Te,Se,ht,Lt,Mt.data):S.isCompressedTexture?T.compressedTexSubImage2D(T.TEXTURE_2D,ye,Ie,ut,Mt.width,Mt.height,ht,Mt.data):T.texSubImage2D(T.TEXTURE_2D,ye,Ie,ut,Te,Se,ht,Lt,Mt);d.pixelStorei(T.UNPACK_ROW_LENGTH,kt),d.pixelStorei(T.UNPACK_IMAGE_HEIGHT,rt),d.pixelStorei(T.UNPACK_SKIP_PIXELS,Yt),d.pixelStorei(T.UNPACK_SKIP_ROWS,rn),d.pixelStorei(T.UNPACK_SKIP_IMAGES,Ln),ye===0&&G.generateMipmaps&&T.generateMipmap(be),d.unbindTexture()},this.initRenderTarget=function(S){H.get(S).__webglFramebuffer===void 0&&Y.setupRenderTarget(S)},this.initTexture=function(S){S.isCubeTexture?Y.setTextureCube(S,0):S.isData3DTexture?Y.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?Y.setTexture2DArray(S,0):Y.setTexture2D(S,0),d.unbindTexture()},this.resetState=function(){F=0,U=0,q=null,d.reset(),ve.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return un}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=tt._getDrawingBufferColorSpace(e),t.unpackColorSpace=tt._getUnpackColorSpace()}}const Hn=1024,Zn=512,Hm=90;class km{constructor(e,t,n,r,s){xt(this,"renderer");xt(this,"camera");xt(this,"scene");xt(this,"terrain");xt(this,"texture");xt(this,"W");xt(this,"H");xt(this,"maxElev",0);xt(this,"minElev",0);xt(this,"cam");xt(this,"fitDist");xt(this,"needsRender",!0);xt(this,"onCameraChange",null);xt(this,"world");xt(this,"hlUniforms",{hoverId:{value:new Ze(-10,-10)},selId:{value:new Ze(-10,-10)}});xt(this,"modeUniforms",{provDark:{value:.1},hierK:{value:1},washFlat:{value:0}});xt(this,"paperUniforms",{paperLand:{value:new Tt},paperSea:{value:new Tt},paperKL:{value:0},paperKS:{value:0}});xt(this,"washData");xt(this,"washTex");xt(this,"idW",0);xt(this,"idH",0);xt(this,"vertElev");this.world=e;const{W:a,H:o}=e;this.W=a,this.H=o;const l=Hn+1,c=Zn+1;this.vertElev=new Float32Array(l*c);{const{height:M,seaBase:L,land:P}=e,N=Math.max(1,Math.round(a/Hn/2)),k=Math.max(1,Math.round(o/Zn/2));for(let V=0;V<c;V++){const I=Math.round(V/Zn*(o-1));for(let F=0;F<l;F++){const U=Math.round(F/Hn*(a-1));let q=0,Q=0,se=0,te=0;for(let Oe=-k;Oe<=k;Oe++){const Je=Math.min(o-1,Math.max(0,I+Oe));for(let Be=-N;Be<=N;Be++){const j=Math.min(a-1,Math.max(0,U+Be)),le=Je*a+j;q+=M[le],Q++,P[le]&&(se+=M[le],te++)}}let pe=Math.max(0,q/Q-L);if(te>0){const Oe=Math.max(0,se/te-L);pe=Math.max(pe,Oe*Math.min(1,te/Q*2.4))}this.vertElev[V*l+F]=Math.pow(pe,.92)*Hm}}}this.renderer=new zm({antialias:!0,preserveDrawingBuffer:!0}),this.renderer.setPixelRatio(Math.min(2,window.devicePixelRatio||1)),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.domElement.id="gl",n.prepend(this.renderer.domElement),this.scene=new mu;const p=new Qe("#878f83");this.scene.background=p,this.camera=new Zt(50,window.innerWidth/window.innerHeight,2,16e3),this.texture=new wo(t),this.texture.colorSpace=Ot,this.texture.anisotropy=Math.min(8,this.renderer.capabilities.getMaxAnisotropy()),this.texture.generateMipmaps=!0,this.texture.minFilter=cn,this.texture.magFilter=Ct;const f=new Ui(a,o,Hn,Zn),h=f.attributes.position;let _=0;for(let M=0;M<h.count;M++){const L=this.vertElev[M];L>_&&(_=L),h.setZ(M,L)}this.maxElev=_,f.rotateX(-Math.PI/2),f.computeVertexNormals();const v=(()=>{const P=document.createElement("canvas");P.width=256,P.height=256;const N=P.getContext("2d"),k=N.createImageData(256,256),V=[];for(let U=0;U<1024;U++){let q=U*374761393+668265263|0;q=Math.imul(q^q>>>13,1274126177),V.push(((q^q>>>16)>>>0)/4294967295)}const I=U=>U*U*(3-2*U);for(let U=0;U<256;U++)for(let q=0;q<256;q++){const Q=q/256*32,se=U/256*32,te=Q|0,pe=se|0,Oe=I(Q-te),Je=I(se-pe),Be=(te+1)%32,j=(pe+1)%32,le=V[pe*32+te],oe=V[pe*32+Be],De=V[j*32+te],Ue=V[j*32+Be];let Re=le+(oe-le)*Oe+(De-le)*Je+(le-oe-De+Ue)*Oe*Je;const at=q/256*32*4,Ve=U/256*32*4,Ge=at|0,Ye=Ve|0,Xe=I(at-Ge),st=I(Ve-Ye),ft=(Ge+1)%128,mt=(Ye+1)%128,ct=(d,O)=>V[d%32*32+O%32],it=ct(Ye,Ge),D=ct(Ye,ft),T=ct(mt,Ge),fe=ct(mt,ft);Re=Re*.65+(it+(D-it)*Xe+(T-it)*st+(it-D-T+fe)*Xe*st)*.35;const de=(U*256+q)*4,E=Re*255|0;k.data[de]=E,k.data[de+1]=E,k.data[de+2]=E,k.data[de+3]=255}N.putImageData(k,0,0);const F=new wo(P);return F.wrapS=F.wrapT=Qi,F.minFilter=cn,F.anisotropy=Math.min(4,this.renderer.capabilities.getMaxAnisotropy()),F})();let w;if(r&&this.renderer.capabilities.maxTextureSize>=r.width)w=new Tt(r),this.idW=r.width,this.idH=r.height;else{const M=new Uint8Array(a*o*4);for(let L=0;L<o;L++)for(let P=0;P<a;P++){const N=e.rawGrid[L*a+P],k=((o-1-L)*a+P)*4;M[k]=N&255,M[k+1]=N>>8&255,M[k+3]=255}w=new jn(M,a,o,Ut),this.idW=a,this.idH=o}w.minFilter=Et,w.magFilter=Et,w.generateMipmaps=!1,w.needsUpdate=!0,this.washData=new Uint8Array(256*256*4),this.washTex=new jn(this.washData,256,256,Ut),this.washTex.minFilter=this.washTex.magFilter=Et;const m=new Uint8Array(256*256*4),u=new Uint8Array(256*256*4);{const{rawCounty:M,rawLand:L,cDuchy:P,dKing:N,kEmp:k}=e;for(let V=0;V<65536;V++){const I=M[V],F=I>=0?P[I]:-1,U=F>=0?N[F]:-1,q=U>=0?k[U]:-1,Q=I>=0?I:65535,se=F>=0?F:65535,te=V*4;m[te]=Q&255,m[te+1]=Q>>8,m[te+2]=se&255,m[te+3]=se>>8,u[te]=U>=0?U:255,u[te+1]=q>=0?q:255,u[te+2]=L[V]?255:0,u[te+3]=255}}const A=new jn(m,256,256,Ut),C=new jn(u,256,256,Ut);for(const M of[A,C])M.minFilter=M.magFilter=Et,M.needsUpdate=!0;const x=new Uint8Array(a*o*4);{const{shade:M,land:L,coastD:P}=e;for(let N=0;N<o;N++)for(let k=0;k<a;k++){const V=N*a+k,I=((o-1-N)*a+k)*4;x[I]=Math.max(0,Math.min(255,(M[V]-.42)/.88*255))|0,x[I+1]=s?s[V]:0,x[I+2]=L[V]?24+Math.min(12,P[V])*18:0,x[I+3]=255}}const b=new jn(x,a,o,Ut);b.minFilter=b.magFilter=Ct,b.generateMipmaps=!1,b.needsUpdate=!0;const y=new Gr({map:this.texture});y.onBeforeCompile=M=>{M.uniforms.detailMap={value:v},M.uniforms.provMap={value:w},M.uniforms.washMap={value:this.washTex},M.uniforms.tierMapA={value:A},M.uniforms.tierMapB={value:C},M.uniforms.shadeMap={value:b},M.uniforms.provTexel={value:new Ze(1/this.idW,1/this.idH)},M.uniforms.provDark=this.modeUniforms.provDark,M.uniforms.hierK=this.modeUniforms.hierK,M.uniforms.washFlat=this.modeUniforms.washFlat,M.uniforms.hoverId=this.hlUniforms.hoverId,M.uniforms.selId=this.hlUniforms.selId,M.uniforms.paperLand=this.paperUniforms.paperLand,M.uniforms.paperSea=this.paperUniforms.paperSea,M.uniforms.paperKL=this.paperUniforms.paperKL,M.uniforms.paperKS=this.paperUniforms.paperKS,M.fragmentShader=M.fragmentShader.replace("void main() {",`
      ...
      diffuseColor.rgb = mix( diffuseColor.rgb, ps * 1.10, seaF * 0.15 );`)},this.terrain=new Xt(f,y),this.scene.add(this.terrain);const R=new Xt(new Ui(a*8,o*8),new Gr({color:new Qe("#42504f")}));R.geometry.rotateX(-Math.PI/2),R.position.y=-1.2,this.scene.add(R);const g=o*1.15/(2*Math.tan(this.camera.fov*Math.PI/180/2));this.fitDist=Math.max(g,a/(2*Math.tan(this.camera.fov*Math.PI/180/2)*this.camera.aspect)*1.06),this.scene.fog=new Oa(p,this.fitDist*.75,this.fitDist*2.1),this.cam={tx:e.landCX-a/2,tz:e.landCY-o/2,dist:this.fitDist*.72,pitch:es.degToRad(52),yaw:0},this.applyCamera(),window.addEventListener("resize",()=>{this.renderer.setSize(window.innerWidth,window.innerHeight),this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.invalidate()})}elevAtGrid(e,t){const{W:n,H:r}=this.world,s=Hn+1;let a=e/(n-1)*Hn,o=t/(r-1)*Zn;a<0&&(a=0),o<0&&(o=0),a>Hn-.001&&(a=Hn-.001),o>Zn-.001&&(o=Zn-.001);const l=a|0,c=o|0,p=a-l,f=o-c,h=c*s+l,_=this.vertElev[h],v=this.vertElev[h+1],w=this.vertElev[h+s],m=this.vertElev[h+s+1];return _+(v-_)*p+(w-_)*f+(_-v-w+m)*p*f}elevAtWorld(e,t){return this.elevAtGrid(e+this.W/2,t+this.H/2)}applyCamera(){const e=this.cam,t=this.elevAtWorld(e.tx,e.tz)*.5,n=Math.cos(e.pitch),r=Math.sin(e.pitch);this.camera.position.set(e.tx+Math.sin(e.yaw)*n*e.dist,t+r*e.dist,e.tz+Math.cos(e.yaw)*n*e.dist),this.camera.lookAt(e.tx,t,e.tz),this.invalidate(),this.onCameraChange&&this.onCameraChange()}clampCamera(){const e=this.cam;e.dist=Math.max(70,Math.min(this.fitDist*1.25,e.dist)),e.pitch=Math.max(es.degToRad(28),Math.min(es.degToRad(80),e.pitch)),e.yaw=Math.max(-1,Math.min(1,e.yaw));const t=this.W*.62,n=this.H*.72;e.tx=Math.max(-t,Math.min(t,e.tx)),e.tz=Math.max(-n,Math.min(n,e.tz))}invalidate(){this.needsRender=!0}setPaperTextures(e,t){const n=new Il,r=[[e,this.paperUniforms.paperLand,this.paperUniforms.paperKL],[t,this.paperUniforms.paperSea,this.paperUniforms.paperKS]];for(const[s,a,o]of r)n.load(s,l=>{l.wrapS=l.wrapT=Qi,l.minFilter=cn,l.anisotropy=Math.min(4,this.renderer.capabilities.getMaxAnisotropy()),a.value=l,o.value=1,this.invalidate()})}setHover(e){const t=this.hlUniforms.hoverId.value;e<0?t.set(-10,-10):t.set(e&255,e>>8&255),this.invalidate()}setSelected(e){const t=this.hlUniforms.selId.value;e<0?t.set(-10,-10):t.set(e&255,e>>8&255),this.invalidate()}setWash(e,t,n,r=!1){this.washData.set(e),this.washTex.needsUpdate=!0,this.modeUniforms.provDark.value=t,this.modeUniforms.hierK.value=n?1:0,this.modeUniforms.washFlat.value=r?1:0,this.invalidate()}render(){this.needsRender&&(this.needsRender=!1,this.renderer.render(this.scene,this.camera))}ndc(e,t){return new Ze(e/window.innerWidth*2-1,-(t/window.innerHeight)*2+1)}pickPlane(e,t){const n=new No;n.setFromCamera(this.ndc(e,t),this.camera);const r=-n.ray.origin.y/n.ray.direction.y;return!isFinite(r)||r<=0?null:n.ray.origin.clone().addScaledVector(n.ray.direction,r)}pickGround(e,t){const n=new No;n.setFromCamera(this.ndc(e,t),this.camera);const r=n.ray.origin,s=n.ray.direction;if(s.y>=-1e-5)return null;const a=Math.max(0,(r.y-(this.maxElev+2))/-s.y),o=r.y/-s.y,l=320;let c=a,p=-1;for(let u=0;u<=l;u++){const A=a+(o+4-a)*u/l,C=r.x+s.x*A,x=r.y+s.y*A,b=r.z+s.z*A;if(x<=this.elevAtWorld(C,b)){p=A;break}c=A}if(p<0)return null;let f=c,h=p;for(let u=0;u<18;u++){const A=(f+h)/2,C=r.x+s.x*A,x=r.y+s.y*A,b=r.z+s.z*A;x<=this.elevAtWorld(C,b)?h=A:f=A}const _=r.x+s.x*h,v=r.z+s.z*h,w=_+this.W/2,m=v+this.H/2;return w<0||m<0||w>=this.W||m>=this.H?null:{gx:w,gy:m}}projectGrid(e,t,n=3){const r=new $(e-this.W/2,this.elevAtGrid(e,t)+n,t-this.H/2);return r.clone().sub(this.camera.position).dot(this.camera.getWorldDirection(new $))<=0?null:(r.project(this.camera),[(r.x*.5+.5)*window.innerWidth,(1-(r.y*.5+.5))*window.innerHeight])}}function Lr(i){const e=atob(i),t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n);return t}function Gm(i,e,t){let n=2.6,r=5;return i.startsWith("rock")?(n=1.4,r=3.8):/^b\d+_/.test(i)&&(i.endsWith("castle")?(n=4.4,r=4):i.endsWith("temple")?(n=3.9,r=4.4):(n=3.2,r=5)),Math.min(n/Math.max(.001,e),r/Math.max(.001,t))}function ll(i){let e=0;for(const t of i.parts)e=Math.max(e,t.hi[0]-t.lo[0],t.hi[2]-t.lo[2]);return e}async function Vm(i,e){const t=await fetch(i+"map/objects/models.json");if(!t.ok)throw new Error("models.json HTTP "+t.status);const n=await t.json(),r=new $i,s=e.W,a=e.H,o=new Il,l=new Map,c=y=>{let R=l.get(y);return R||(R=o.load(i+"map/objects/"+y,()=>e.invalidate()),R.colorSpace=Ot,R.anisotropy=4,l.set(y,R)),R},p=new Ou(16773853,9076848,1.9),f=new Hu(16772812,2.1);f.position.set(-.55,1,-.7),r.add(p,f);const h=new Map,_=y=>{let R=h.get(y);if(R)return R;R=[];for(const g of n.models[y].parts){const M=new Uint16Array(Lr(g.v).buffer.slice(0)),L=new Uint16Array(Lr(g.u).buffer.slice(0)),P=Lr(g.x).buffer.slice(0),N=M.length/3,k=new Float32Array(M.length);for(let F=0;F<3;F++){const U=g.lo[F],q=g.hi[F]-g.lo[F];for(let Q=0;Q<N;Q++)k[Q*3+F]=U+M[Q*3+F]/65535*q}const V=new Float32Array(L.length);for(let F=0;F<L.length;F++)V[F]=L[F]/65535;const I=new mn;I.setAttribute("position",new zt(k,3)),I.setAttribute("uv",new zt(V,2)),I.setIndex(new zt(g.x32?new Uint32Array(P):new Uint16Array(P),1)),I.computeVertexNormals(),R.push(I)}return h.set(y,R),R},v=new Map,w=(y,R)=>{const g=y+(R?"|f":"");let M=v.get(g);return M||(M=new Lu({map:c(y),alphaTest:R?.45:.6,side:R?ln:wn}),v.set(g,M)),M},m=new pt,u=new si,A=new $(0,1,0),C=new $,x=new $;for(const[y,R]of Object.entries(n.inst)){const g=n.models[y];if(!g)continue;const M=Lr(R.d),L=R.n,P=!/^b\d+_/.test(y)&&!y.startsWith("rock"),N=Gm(y,g.hgt,ll(g)),V=_(y).map((I,F)=>{const U=new Ao(I,w(g.parts[F].tex,P),L);return U.frustumCulled=!1,U});for(let I=0;I<L;I++){const F=I*6,U=M[F]|M[F+1]<<8,q=M[F+2]|M[F+3]<<8,Q=M[F+4]/255*Math.PI*2,se=(.25+M[F+5]/255*2.75)*N,te=e.elevAtGrid(U,q);u.setFromAxisAngle(A,Q),m.compose(C.set(U-s/2,te,q-a/2),u,x.set(se,se,se));for(const pe of V)pe.setMatrixAt(I,m)}for(const I of V)I.instanceMatrix.needsUpdate=!0,r.add(I)}const b=new Map;for(const y of n.spec)n.models[y.k]&&(b.get(y.k)??b.set(y.k,[]).get(y.k)).push(y);for(const[y,R]of b){const g=n.models[y],M=_(y),L=ll(g),P=4/Math.max(.001,g.hgt),N=Math.min(17/Math.max(.001,g.hgt),22/Math.max(.001,L)),k=M.map((V,I)=>{const F=new Ao(V,w(g.parts[I].tex,!1),R.length);return F.frustumCulled=!1,F});R.forEach((V,I)=>{const F=Math.max(e.elevAtGrid(V.x,V.y),.15),U=Math.min(Math.max(V.s*.5*1.6,P),Math.max(P,N));u.setFromAxisAngle(A,V.r),m.compose(C.set(V.x-s/2,F,V.y-a/2),u,x.set(U,U,U));for(const q of k)q.setMatrixAt(I,m)});for(const V of k)V.instanceMatrix.needsUpdate=!0,r.add(V)}return e.scene.add(r),e.invalidate(),r}function Wm(i){const{np:e,pArea:t,pCX:n,pCY:r,W:s,H:a}=i;function o(u,A,C){const x=new Float64Array(u),b=new Float64Array(u),y=new Float64Array(u),R=new Float64Array(u),g=new Float64Array(u),M=new Float64Array(u);for(let P=0;P<e;P++){const N=A[P];if(N<0)continue;const k=t[P],V=n[P],I=r[P];x[N]+=V*k,b[N]+=I*k,y[N]+=k,R[N]+=V*V*k,g[N]+=I*I*k,M[N]+=V*I*k}const L=[];for(let P=0;P<u;P++){if(y[P]<1)continue;const N=x[P]/y[P],k=b[P]/y[P],V=R[P]/y[P]-N*N,I=g[P]/y[P]-k*k,F=M[P]/y[P]-N*k,U=.5*Math.atan2(2*F,V-I),q=V+I,Q=V*I-F*F,se=Math.sqrt(Math.max(0,q*q/4-Q));L.push({x:N,y:k,angle:U,ext:Math.sqrt(Math.max(1,q/2+se)),name:C[P],area:y[P],idx:P})}return L}const l=o(i.nKing,i.kingOf,i.kingName),c=o(i.nEmp,i.empOf,i.empName),p=new Float64Array(i.nCounty),f=new Float64Array(i.nCounty),h=new Float64Array(i.nCounty);for(let u=0;u<e;u++){const A=i.countyOf[u];A<0||(p[A]+=n[u]*t[u],f[A]+=r[u]*t[u],h[A]+=t[u])}const _=(u,A)=>{for(const C of u){const x=A[C.idx];x>=0&&h[x]>0&&(C.capX=p[x]/h[x],C.capY=f[x]/h[x])}};_(l,i.kCapital),_(c,i.eCapital);const v=i.seaLabels.map(u=>({x:u.x,y:u.y,name:u.n,area:u.a,ext:Math.sqrt(u.a)*.9})),w=[],m=Math.max(40,s*a/e*.25);for(let u=0;u<e;u++)t[u]<m||w.push({x:n[u],y:r[u],name:i.provName[u],ext:Math.hypot(i.pMaxX[u]-i.pMinX[u],i.pMaxY[u]-i.pMinY[u])/2,area:t[u]});return{king:l,emp:c,prov:w,sea:v,straits:i.straits}}const Ls='"Iowan Old Style",Palatino,Georgia,serif',Ds=new Map;function Xm(i,e){let t=Ds.get(i);if(t!==void 0)return t&&t.complete&&t.naturalWidth?t:null;const n=new Image;return n.onload=()=>{e&&e()},n.onerror=()=>Ds.set(i,null),n.src=i,Ds.set(i,n),null}function qm(i,e,t,n,r){const s=window.innerWidth,a=window.innerHeight;i.clearRect(0,0,s,a),i.textAlign="center",i.textBaseline="middle";const o=t.cam.dist,l=o>t.fitDist*.55,c=o<680,p=[],f=[];document.querySelectorAll(".panel").forEach(u=>{if(u.classList.contains("hidden"))return;const A=getComputedStyle(u);if(A.display==="none"||A.visibility==="hidden")return;const C=u.getBoundingClientRect();C.width&&C.height&&f.push(C)});const h=44;function _(u,A,C,x){if(u-C<h||u+C>s-h||A-x<h||A+x>a-h)return!0;for(const b of f)if(u+C>b.left-6&&u-C<b.right+6&&A+x>b.top-6&&A-x<b.bottom+6)return!0;return!1}function v(u,A,C,x){if(_(u,A,C,x))return!1;for(const b of p)if(Math.abs(u-b.x)<C+b.hw&&Math.abs(A-b.y)<x+b.hh)return!1;return!0}function w(u){const A=t.projectGrid(u.x,u.y);if(!A)return null;const C=Math.cos(u.angle)*u.ext,x=Math.sin(u.angle)*u.ext,b=t.projectGrid(u.x-C,u.y-x),y=t.projectGrid(u.x+C,u.y+x);if(!b||!y)return null;let R=Math.atan2(y[1]-b[1],y[0]-b[0]);return R>Math.PI/2&&(R-=Math.PI),R<-Math.PI/2&&(R+=Math.PI),{sx:A[0],sy:A[1],screenExt:Math.hypot(y[0]-b[0],y[1]-b[1]),rot:R}}function m(u,A,C,x,b,y,R){const g=w(u);if(!g||g.sx<-320||g.sx>s+320||g.sy<-200||g.sy>a+200)return;i.font=`600 ${A}px ${Ls}`;const M=u.name.toUpperCase();let L=0;const P=[];for(const U of M){const q=i.measureText(U).width;P.push(q),L+=q}let N=M.length>1?(b-L)/(M.length-1):0;N=Math.max(A*.08,Math.min(N,A*.9));const k=L+N*(M.length-1),V=k*.5*.8+8,I=A*.62+5;if(!v(g.sx,g.sy,V,I))return;p.push({x:g.sx,y:g.sy,hw:V,hh:I}),i.save(),i.translate(g.sx,g.sy),i.rotate(g.rot),i.globalAlpha=y,i.lineJoin="round";let F=-k/2;for(let U=0;U<M.length;U++){const q=M[U],Q=P[U],se=F+Q/2;i.lineWidth=A*.2,i.strokeStyle=x,i.strokeText(q,se,0),i.fillStyle=C,i.fillText(q,se,0),F+=Q+N}if(i.restore(),R&&n){const U=Xm(`${n}${R}_${u.idx}.png`,r??null);if(U){const q=Math.max(20,Math.min(A*1.25,46));let Q=g.sx,se=g.sy-I-q-4;if(u.capX!==void 0&&u.capY!==void 0){const te=t.projectGrid(u.capX,u.capY,4);te&&(Q=te[0],se=te[1]-q)}i.save(),i.globalAlpha=y,i.shadowColor="rgba(0,0,0,0.55)",i.shadowBlur=6,i.shadowOffsetY=2,i.drawImage(U,Q-q/2,se,q,q),i.restore()}}}{i.save(),i.setLineDash([7,5]),i.lineWidth=1.6,i.strokeStyle="rgba(146, 44, 30, 0.75)";for(const u of e.straits){const A=t.projectGrid(u[0],u[1],1.5),C=t.projectGrid(u[2],u[3],1.5);if(!A||!C)continue;const x=Math.hypot(C[0]-A[0],C[1]-A[1]);x<7||x>620||Math.max(A[0],C[0])<0||Math.min(A[0],C[0])>s||Math.max(A[1],C[1])<0||Math.min(A[1],C[1])>a||(i.beginPath(),i.moveTo(A[0],A[1]),i.lineTo(C[0],C[1]),i.stroke())}i.restore()}if(l)for(const u of[...e.emp].sort((A,C)=>C.area-A.area)){const A=w(u);if(!A)continue;const C=Math.max(22,Math.min(A.screenExt*2*.15,56));m(u,C,"rgba(26,20,12,0.86)","rgba(238,228,198,0.4)",Math.min(A.screenExt*2*.9,s*.62),.9,"e")}{const u=l?.85:1;for(const A of[...e.king].sort((C,x)=>x.area-C.area)){const C=w(A);if(!C)continue;const x=C.screenExt*2;if(x<62)continue;let b=Math.max(13,Math.min(x*.18,40));b*.62>x*.95/Math.max(3,A.name.length)&&(b=Math.max(12,x*.95/(A.name.length*.62))),m(A,b,"rgba(26,20,12,0.94)","rgba(238,226,192,0.5)",Math.min(x*.86,s*.5),u,l?void 0:"k")}}{i.save(),i.textAlign="center",i.textBaseline="middle";for(const u of e.sea){const A=t.projectGrid(u.x,u.y,1);if(!A)continue;const[C,x]=A;if(C<-60||C>s+60||x<-40||x>a+40)continue;const b=t.projectGrid(u.x+u.ext,u.y,1),y=b?Math.abs(b[0]-C):0,R=Math.max(10,Math.min(y*.3,26));if(R<10)continue;i.font=`italic 600 ${R}px ${Ls}`;const g=i.measureText(u.name).width*.5+6,M=R*.6+3;v(C,x,g,M)&&(p.push({x:C,y:x,hw:g,hh:M}),i.globalAlpha=.78,i.lineWidth=R*.18,i.strokeStyle="rgba(26,34,34,0.5)",i.strokeText(u.name,C,x),i.fillStyle="rgba(205,221,218,0.92)",i.fillText(u.name,C,x))}i.globalAlpha=1,i.restore()}if(c){const u=Math.min(1,(680-o)/220);for(const A of[...e.prov].sort((C,x)=>x.area-C.area)){const C=t.projectGrid(A.x,A.y);if(!C)continue;const[x,b]=C;if(x<0||x>s||b<0||b>a)continue;const y=t.projectGrid(A.x+A.ext,A.y),R=y?Math.abs(y[0]-x):0,g=Math.max(9,Math.min(R*.32,16));if(g<9)continue;i.font=`600 ${g}px ${Ls}`;const M=i.measureText(A.name).width*.5+4,L=g*.6+3;v(x,b,M,L)&&(p.push({x,y:b,hw:M,hh:L}),i.globalAlpha=u,i.lineWidth=g*.28,i.strokeStyle="rgba(242,232,202,0.78)",i.strokeText(A.name,x,b),i.fillStyle="rgba(26,20,10,0.96)",i.fillText(A.name,x,b))}}i.globalAlpha=1}const Kt="/ck3/world/",Fe=i=>document.getElementById(i),cl=()=>new Promise(i=>requestAnimationFrame(()=>i())),Ym=[["political","Political"],["province","Provinces"],["terrain","Terrain"],["elevation","Elevation"],["culture","Culture"],["faith","Faith"],["development","Development"]];async function $m(){const i=Fe("loading"),e=async D=>{i.style.display="flex",i.textContent=D,await cl(),await cl()},t=new Promise(D=>{const T=new Image;T.onload=()=>D(T),T.onerror=()=>D(null),T.src=Kt+"map/prov8.png"});await e("Loading the map…");const n=await ec(1420,Kt);Fe("date").textContent=`${n.date} · Anno Aldermarki`,await e("Shading the relief…"),tc(n),await e("Baking the map…");const r=nc(n);n.cloud=null;const s=document.createElement("canvas");s.width=n.W,s.height=n.H;const a=s.getContext("2d",{willReadFrequently:!0}),o=a.createImageData(n.W,n.H);let l="political",c=!1;Ja(n,r,l,o),a.putImageData(o,0,0),await e("Raising the terrain…");const p=await t,f=new km(n,s,document.body,p,r.snow),h=f.renderer.domElement;f.setPaperTextures(Kt+"map/ui/paper_land.png",Kt+"map/ui/paper_sea.png");{const D=document.createElement("img");D.src=Kt+"map/ui/vignette.png",D.id="vig",D.alt="",document.body.appendChild(D)}const _=new Uint8Array(65536).fill(40);for(let D=0;D<n.np;D++)_[n.rawOf[D]]=n.devOf[D];const v=new Uint8Array(256*256*4);function w(D){v.fill(0);const{rawCounty:T,rawCult:fe,rawFaith:de,rawLand:E,cDuchy:d,dKing:O,kEmp:H,kColor:Y,cultCol:re,faithCol:ue}=n,B=D==="province"?0:.16,W=(ae,ie,_e)=>{const Ne=ie[0]*.3+ie[1]*.59+ie[2]*.11,z=ae*4;v[z]=ie[0]+(Ne-ie[0])*B,v[z+1]=ie[1]+(Ne-ie[1])*B,v[z+2]=ie[2]+(Ne-ie[2])*B,v[z+3]=_e*255|0};if(D!=="terrain"&&D!=="elevation"){for(let ae=0;ae<65536;ae++)if(E[ae])if(D==="political"){const ie=T[ae],_e=ie>=0?d[ie]:-1,Ne=_e>=0?O[_e]:-1;Ne>=0&&W(ae,Y[Ne],.52)}else if(D==="province"){const ie=ae*2654435761>>>0;W(ae,[80+(ie&175),80+(ie>>8&175),80+(ie>>16&175)],.97)}else if(D==="culture"){const ie=fe[ae];ie>=0&&W(ae,re[ie],.5)}else if(D==="faith"){const ie=de[ae];ie>=0&&W(ae,ue[ie],.5)}else D==="development"&&W(ae,ic(_[ae]),.56)}const ce=D==="terrain"||D==="elevation";f.setWash(v,ce?0:D==="province"?.42:.1,D==="political"||D==="culture"||D==="faith"||D==="development",D==="province");const xe=document.getElementById("vig");xe&&(xe.style.display=D==="province"?"none":"");const he=D==="elevation";he!==c&&(c=he,Ja(n,r,D,o),a.putImageData(o,0,0),f.texture.needsUpdate=!0),f.invalidate()}w(l);let m=null;Vm(Kt,f).then(D=>{m=D;const T=Fe("objs");T&&(T.className="on")}).catch(D=>console.warn("map objects unavailable:",D));const u=Fe("labels"),A=u.getContext("2d"),C=Wm(n);let x=!0;const b=Math.min(2,window.devicePixelRatio||1),y=()=>{u.width=window.innerWidth*b,u.height=window.innerHeight*b,u.style.width=window.innerWidth+"px",u.style.height=window.innerHeight+"px",A.setTransform(b,0,0,b,0,0),x=!0};y(),window.addEventListener("resize",y),f.onCameraChange=()=>{x=!0};const R=["No Holding","Castle","City","Temple","Tribe"],g=(D,...T)=>{const fe=D.map(de=>de+".png");for(const de of T){const E=n.artPools[de];E&&fe.push(...E)}return fe},M={castle:g(["holding_1","art_fortress"],"castle"),city:g(["art_city1","art_city2"],"city"),port:g(["art_port"],"port"),temple:g(["holding_3"],"temple"),tribal:g(["art_tribal"],"tribal"),terr:{[ke.BEACH]:g(["terr_beach","art_coast"],"coast","port"),[ke.PLAINS]:g(["terr_plains"],"plains"),[ke.FARM]:g(["terr_farm","art_farm"],"farm"),[ke.FOREST]:g(["terr_forest"],"forest","jungle"),[ke.HILLS]:g(["terr_hills"],"mountain"),[ke.DRY]:g(["terr_desert","art_desert","art_ruin","art_river"],"desert","ruin","river"),[ke.WET]:g(["terr_wet","art_swamp","art_lakes"],"swamp"),[ke.MTN]:g(["terr_mtn"],"mountain"),[ke.SNOW]:g(["terr_mtn"],"snow","mountain")}};function L(D){const T=n.holdingOf[D],fe=n.pTerr[D],de=n.countyOf[D],E=O=>O[D%O.length];if(de>=0){if(T===1)return E(M.castle);if(T===2)return fe===ke.BEACH?E(M.port):E(M.city);if(T===3)return E(M.temple);if(T===4)return E(M.tribal)}const d=M.terr[fe];return d?E(d):"holding_0.png"}const P=D=>`<span class="swatch" style="background:rgb(${D[0]},${D[1]},${D[2]})"></span>`;let N=-1;function k(D){N=D,f.setSelected(D<0?-1:n.rawOf[D]);const T=Fe("sel");if(D<0){T.style.display="none";return}Fe("faith").classList.remove("open");const fe=n.countyOf[D],de=n.duchyOf[D],E=n.kingOf[D],d=n.empOf[D],O=n.cultureOf[D],H=n.faithOf[D],Y=n.holdingOf[D];Fe("selName").textContent=n.provName[D];let re=fe>=0?`${R[Y]} in the County of ${n.countyName[fe]}`:"Uncolonised wasteland";fe>=0&&d>=0&&n.eCapital[d]===fe?re+=" · Imperial Capital":fe>=0&&E>=0&&n.kCapital[E]===fe&&(re+=" · Royal Capital"),Fe("selSub").textContent=re;const ue=[],B=(ie,_e)=>`<img class="coa" src="${Kt}map/ui/coa/${ie}_${_e}.png" alt="" onerror="this.remove()">`;de>=0&&ue.push(`<span class="chip" style="--cc:#8a7f66">${n.duchyName[de]}</span>`),E>=0&&ue.push(`<span class="chip flagged rlink" data-realm="k:${E}" title="About this realm">${B("k",E)}${n.kingName[E]}</span>`),d>=0&&ue.push(`<span class="chip flagged rlink" data-realm="e:${d}" title="About this realm">${B("e",d)}${n.empName[d]}</span>`),Fe("selChips").innerHTML=ue.join(""),Fe("selChips").querySelectorAll(".rlink").forEach(ie=>{ie.onclick=()=>{const[_e,Ne]=ie.dataset.realm.split(":");te(_e,+Ne)}});const W=ie=>!ie||/^wasteland/i.test(ie),ce=H>=0&&n.faithHasIcon[H]?`<img class="fic" src="${Kt}map/ui/faith_${H}.png" alt="">`:H>=0?P(n.faithCol[H]):"";Fe("selBody").innerHTML=`<div class="k">Terrain</div><div>${or[n.pTerr[D]]}</div>`+(O>=0&&!W(n.cultName[O])?`<div class="k">Culture</div><div>${P(n.cultCol[O])}<a class="flink" data-culture="${O}" title="About this culture">${n.cultName[O]}</a></div>`:"")+(H>=0&&!W(n.faithName[H])?`<div class="k">Faith</div><div>${ce}<a class="flink" data-faith="${H}" title="About this faith">${n.faithName[H]}</a></div>`:"")+`<div class="k">Development</div><div>${n.devOf[D]}</div>`,Fe("selBody").querySelectorAll("a.flink").forEach(ie=>{ie.onclick=_e=>{_e.preventDefault(),ie.dataset.faith?q(+ie.dataset.faith):ie.dataset.culture&&Q(+ie.dataset.culture)}});const xe=(ie,_e)=>ie&&_e?`<a class="flink" data-char="${ie}" title="About this ruler">${_e}</a>`:_e??"",he=[];if(fe>=0){const ie=n.countyHolder[fe];he.push(`<div><span class="k">County Holder:</span> <b>${W(ie)?"uncolonised":xe(n.countyHolderKey[fe],ie)}</b></div>`)}if(E>=0&&n.kingHolder[E]&&he.push(`<div><span class="k">${n.kingName[E]}:</span> <b>${xe(n.kingHolderKey[E],n.kingHolder[E])}</b></div>`),d>=0&&n.empHolder[d]&&he.push(`<div><span class="k">${n.empName[d]}:</span> <b>${xe(n.empHolderKey[d],n.empHolder[d])}</b></div>`),Fe("selHolders").innerHTML=he.join(""),Fe("selHolders").style.display=he.length?"block":"none",Fe("selHolders").querySelectorAll("a[data-char]").forEach(ie=>{ie.onclick=_e=>{_e.preventDefault(),se(ie.dataset.char)}}),fe>=0){const ie=[];for(let _e=0;_e<n.np&&ie.length<40;_e++)n.countyOf[_e]===fe&&ie.push(_e===D?`<b>${n.provName[_e]}</b>`:`${n.provName[_e]}${n.holdingOf[_e]?` (${R[n.holdingOf[_e]].toLowerCase()})`:""}`);Fe("selBars").innerHTML='<span class="k">Baronies:</span> '+ie.join(" · "),Fe("selBars").style.display="block"}else Fe("selBars").style.display="none";const ae=Fe("selIllu");ae.src=`${Kt}map/ui/${L(D)}`,ae.style.display="block",ae.onerror=()=>{ae.style.display="none"},T.style.display="block"}let V=null;function I(D){let T=-1,fe=0;for(let de=0;de<n.np;de++)n.countyOf[de]===D&&n.pArea[de]>fe&&(fe=n.pArea[de],T=de);T<0||(f.cam.tx=n.pCX[T]-n.W/2,f.cam.tz=n.pCY[T]-n.H/2,f.cam.dist=Math.min(f.cam.dist,320),f.clampCamera(),f.applyCamera(),k(T))}function F(D,T,fe,de){Fe("sel").style.display="none",V=de,Fe("faithName").innerHTML=D,Fe("faithSub").textContent=T,Fe("faithBody").innerHTML=fe,Fe("faithMode").style.display=de?"":"none",Fe("faith").classList.add("open"),Fe("faithBody").querySelectorAll("a[data-county]").forEach(E=>{E.onclick=d=>{d.preventDefault(),I(+E.dataset.county)}}),Fe("faithBody").querySelectorAll("a[data-char]").forEach(E=>{E.onclick=d=>{d.preventDefault(),se(E.dataset.char)}}),Fe("faithBody").querySelectorAll("a[data-culture]").forEach(E=>{E.onclick=d=>{d.preventDefault(),Q(+E.dataset.culture)}}),Fe("faithBody").querySelectorAll("a[data-realm]").forEach(E=>{E.onclick=d=>{d.preventDefault();const[O,H]=E.dataset.realm.split(":");te(O,+H)}})}const U=(D,T)=>D&&T?`<a class="hsite" data-char="${D}">${T}</a>`:T??"vacant";function q(D){const T=n.faithHasIcon[D]?`<img class="fic" src="${Kt}map/ui/faith_${D}.png" alt="">`:P(n.faithCol[D]);let fe=0;for(let d=0;d<n.np;d++)n.faithOf[d]===D&&fe++;const de=[n.faithRelig[D],n.faithAdh[D]?`followers: ${n.faithAdh[D]}s`:null,`${fe} provinces`].filter(Boolean);let E="";n.faithDesc[D]&&(E+=`<div class="desc">${n.faithDesc[D]}</div>`),n.faithTenets[D].length&&(E+=`<div class="sect"><span class="k">Tenets:</span> <b>${n.faithTenets[D].join("</b> · <b>")}</b></div>`),n.faithSites[D].length&&(E+='<div class="sect"><span class="k">Holy sites:</span> '+n.faithSites[D].map(d=>`<a class="hsite" data-county="${d.c}">${d.n}</a>`).join(" · ")+"</div>"),F(`${T}${n.faithName[D]}`,de.join(" · "),E,"faith")}function Q(D){let T=0;for(let E=0;E<n.np;E++)n.cultureOf[E]===D&&T++;const fe=[n.cultHeritage[D]?`${n.cultHeritage[D]} heritage`:null,n.cultLang[D]?`speaks ${n.cultLang[D]}`:null,`${T} provinces`].filter(Boolean);let de='<div class="grid" style="display:grid;grid-template-columns:auto 1fr;gap:4px 12px;font-size:13px">';n.cultEthos[D]&&(de+=`<div class="k">Ethos</div><div><b>${n.cultEthos[D]}</b></div>`),n.cultMartial[D]&&(de+=`<div class="k">Warriors</div><div>${n.cultMartial[D]}</div>`),de+="</div>",n.cultTrad[D].length&&(de+=`<div class="sect"><span class="k">Traditions:</span> <b>${n.cultTrad[D].join("</b> · <b>")}</b></div>`),F(`${P(n.cultCol[D])}${n.cultName[D]}`,fe.join(" · "),de,"culture")}function se(D){const T=n.chars[D];if(!T)return;const fe=["Diplomacy","Martial","Stewardship","Intrigue","Learning"],de=T.b?`born ${T.b}${T.dd?`, died ${T.dd}`:""} · year is ${n.date}`:"";let E="";T.mo&&(E+=`<div class="desc" style="font-style:italic">“${T.mo}”</div>`);const d=T.sk.map((H,Y)=>H==null?null:`<div class="k">${fe[Y]}</div><div><b>${H}</b></div>`).filter(Boolean).join("");if(d&&(E+=`<div class="grid" style="display:grid;grid-template-columns:auto 1fr;gap:3px 12px;font-size:13px;margin-top:6px">${d}</div>`),T.tr.length){const H=T.tr.map((Y,re)=>{var W;const ue=((W=T.ti)==null?void 0:W[re])??-1;return`<span class="trchip">${ue>=0?`<img class="tric" src="map/ui/tr_${ue}.png" alt="">`:""}<b>${Y}</b></span>`}).join(" ");E+=`<div class="sect"><span class="k">Traits:</span> ${H}</div>`}const O=T.dy?`${T.n} of House ${T.dy}`:T.n;F(O,de,E,null)}function te(D,T){const fe=`<img class="fic" src="${Kt}map/ui/coa/${D}_${T}.png" alt="" onerror="this.remove()">`;let de=0;const E=D==="k"?n.kingOf:n.empOf;for(let O=0;O<n.np;O++)E[O]===T&&de++;let d="";if(D==="k"){const O=n.kEmp[T],H=[O>=0?`part of ${n.empName[O]}`:"independent",`${de} provinces`];d+=`<div class="sect" style="padding-top:0"><span class="k">Ruler:</span> <b>${U(n.kingHolderKey[T],n.kingHolder[T])}</b></div>`,n.kCapital[T]>=0&&(d+=`<div class="sect"><span class="k">Capital:</span> <a class="hsite" data-county="${n.kCapital[T]}">${n.countyName[n.kCapital[T]]}</a></div>`);const Y=[];for(let re=0;re<n.nDuchy;re++)n.dKing[re]===T&&Y.push(re);Y.length&&(d+='<div class="sect"><span class="k">De jure duchies:</span> '+Y.map(re=>`<b>${n.duchyName[re]}</b>`).join(" · ")+"</div>"),F(`${fe}${n.kingName[T]}`,H.join(" · "),d,"political")}else{const O=[`${de} provinces`];d+=`<div class="sect" style="padding-top:0"><span class="k">Ruler:</span> <b>${U(n.empHolderKey[T],n.empHolder[T])}</b></div>`,n.eCapital[T]>=0&&(d+=`<div class="sect"><span class="k">Capital:</span> <a class="hsite" data-county="${n.eCapital[T]}">${n.countyName[n.eCapital[T]]}</a></div>`);const H=[];for(let Y=0;Y<n.nKing;Y++)n.kEmp[Y]===T&&H.push(Y);H.length&&(d+='<div class="sect"><span class="k">De jure kingdoms:</span> '+H.map(Y=>`<a class="hsite" data-realm="k:${Y}">${n.kingName[Y]}</a>`).join(" · ")+"</div>"),F(`${fe}${n.empName[T]}`,O.join(" · "),d,"political")}}Fe("faithClose").onclick=()=>{Fe("faith").classList.remove("open"),N>=0&&(Fe("sel").style.display="block")},Fe("faithMode").onclick=()=>{V&&(l=V,[...Fe("modes").children].forEach(D=>{D.className=D.dataset.mode===V?"on":""}),w(V))};const pe=(D,T)=>{const fe=f.pickGround(D,T);return fe?n.prov[(fe.gy|0)*n.W+(fe.gx|0)]:-1};let Oe=!1,Je=!1,Be=!1,j=-1,le=null,oe=[0,0],De=[0,0];const Ue=Fe("tip"),Re=D=>{D!==j&&(j=D,f.setHover(D<0?-1:n.rawOf[D]))};h.addEventListener("contextmenu",D=>D.preventDefault()),h.addEventListener("pointerdown",D=>{if(Be=!1,De=[D.clientX,D.clientY],oe=[D.clientX,D.clientY],D.button===2||D.button===1)Je=!0;else{Oe=!0;const T=f.pickPlane(D.clientX,D.clientY);le=T?{x:T.x,z:T.z}:null}h.classList.add("drag"),h.setPointerCapture(D.pointerId)}),h.addEventListener("pointermove",D=>{if(Math.abs(D.clientX-De[0])+Math.abs(D.clientY-De[1])>4&&(Be=!0),Oe&&le){const T=f.pickPlane(D.clientX,D.clientY);T&&(f.cam.tx+=le.x-T.x,f.cam.tz+=le.z-T.z,f.clampCamera(),f.applyCamera())}else if(Je)f.cam.yaw-=(D.clientX-oe[0])*.004,f.cam.pitch+=(D.clientY-oe[1])*.003,f.clampCamera(),f.applyCamera();else{const T=pe(D.clientX,D.clientY);if(Re(T),T>=0){const fe=n.countyOf[T],de=n.kingOf[T],E=n.empOf[T],d=n.holdingOf[T],O=d?`<b>${n.provName[T]}</b> · ${R[d]}`:`<b>${n.provName[T]}</b>`,H=fe>=0?`${or[n.pTerr[T]]} · County of ${n.countyName[fe]}`:or[n.pTerr[T]],Y=fe>=0&&n.countyHolder[fe]?`<br><span style="color:#b6a988">Holder:</span> ${n.countyHolder[fe]}`:"",re=de>=0?`${n.kingName[de]} · <span style="color:#b6a988">${E>=0?n.empName[E]:""}</span>`:'<span style="color:#b6a988">Wasteland</span>';Ue.innerHTML=`${O}<br>${H}${Y}<br>${re}`,Ue.style.display="block";let ue=D.clientX+16,B=D.clientY+16;const W=Ue.getBoundingClientRect();ue+W.width>window.innerWidth-8&&(ue=D.clientX-W.width-16),B+W.height>window.innerHeight-8&&(B=D.clientY-W.height-16),Ue.style.left=ue+"px",Ue.style.top=B+"px"}else Ue.style.display="none"}oe=[D.clientX,D.clientY]});const at=D=>{const T=(Oe||Je)&&!Be&&D.button!==2&&D.button!==1;Oe=!1,Je=!1,le=null,h.classList.remove("drag"),T&&k(pe(D.clientX,D.clientY))};h.addEventListener("pointerup",at),h.addEventListener("pointerleave",()=>{Ue.style.display="none",Re(-1)}),h.addEventListener("wheel",D=>{D.preventDefault();const T=f.pickPlane(D.clientX,D.clientY),fe=f.cam.dist;if(f.cam.dist*=Math.exp(D.deltaY*.0011),f.clampCamera(),T){const de=1-f.cam.dist/fe;f.cam.tx+=(T.x-f.cam.tx)*de,f.cam.tz+=(T.z-f.cam.tz)*de,f.clampCamera()}f.applyCamera()},{passive:!1});{const D=Fe("search"),T=Fe("results"),fe=B=>B.normalize("NFD").replace(/[̀-ͯ]/g,"").toLowerCase(),de=[],E=(B,W,ce=320)=>{f.cam.tx=B-n.W/2,f.cam.tz=W-n.H/2,f.cam.dist=Math.min(f.cam.dist,ce),f.clampCamera(),f.applyCamera()},d=(B,W)=>{let ce=-1,xe=0;for(let he=0;he<n.np;he++)B[he]===W&&n.pArea[he]>xe&&(xe=n.pArea[he],ce=he);return ce},O=(B,W,ce)=>{let xe=0,he=0,ae=0;for(let ie=0;ie<n.np;ie++)B[ie]===W&&(xe+=n.pCX[ie]*n.pArea[ie],he+=n.pCY[ie]*n.pArea[ie],ae+=n.pArea[ie]);ae&&E(xe/ae,he/ae,ce)};for(let B=0;B<n.np;B++)de.push({key:fe(n.provName[B]),name:n.provName[B],type:"Province",go:()=>{E(n.pCX[B],n.pCY[B],260),k(B)}});n.countyName.forEach((B,W)=>de.push({key:fe(B),name:B,type:"County",go:()=>{const ce=d(n.countyOf,W);ce>=0&&(E(n.pCX[ce],n.pCY[ce],300),k(ce))}})),n.duchyName.forEach((B,W)=>de.push({key:fe(B),name:B,type:"Duchy",go:()=>O(n.duchyOf,W,420)})),n.kingName.forEach((B,W)=>de.push({key:fe(B),name:B,type:"Kingdom",go:()=>{O(n.kingOf,W,700),te("k",W)}})),n.empName.forEach((B,W)=>de.push({key:fe(B),name:B,type:"Empire",go:()=>{O(n.empOf,W,1100),te("e",W)}})),n.cultName.forEach((B,W)=>{/^wasteland/i.test(B)||de.push({key:fe(B),name:B,type:"Culture",go:()=>Q(W)})}),n.faithName.forEach((B,W)=>{/^wasteland/i.test(B)||de.push({key:fe(B),name:B,type:"Faith",go:()=>q(W)})}),n.seaLabels.forEach(B=>de.push({key:fe(B.n),name:B.n,type:"Sea",go:()=>E(B.x,B.y,900)}));let H=[],Y=-1;const re=()=>{T.innerHTML=H.map((B,W)=>`<div class="res${W===Y?" hot":""}" data-i="${W}"><span>${B.name}</span><span class="t">${B.type}</span></div>`).join(""),T.style.display=H.length?"block":"none",T.querySelectorAll(".res").forEach(B=>{B.onmousedown=W=>{W.preventDefault(),ue(+B.dataset.i)}})},ue=B=>{const W=H[B];W&&(D.value=W.name,H=[],Y=-1,re(),D.blur(),W.go())};D.oninput=()=>{const B=fe(D.value.trim());if(Y=-1,B.length<2){H=[],re();return}const W=[],ce=[];for(const xe of de)if(xe.key.startsWith(B)?W.push(xe):xe.key.includes(B)&&ce.push(xe),W.length>=12)break;H=[...W,...ce].slice(0,12),re()},D.onkeydown=B=>{B.key==="ArrowDown"?(Y=Math.min(H.length-1,Y+1),re(),B.preventDefault()):B.key==="ArrowUp"?(Y=Math.max(0,Y-1),re(),B.preventDefault()):B.key==="Enter"?(ue(Y>=0?Y:0),B.preventDefault()):B.key==="Escape"&&(H=[],re(),D.blur()),B.stopPropagation()},D.onblur=()=>setTimeout(()=>{H=[],re()},150)}const Ve=()=>document.activeElement instanceof HTMLInputElement&&document.activeElement.type==="text",Ge={};window.addEventListener("keydown",D=>{Ve()||(Ge[D.key.toLowerCase()]=!0)}),window.addEventListener("keyup",D=>{Ge[D.key.toLowerCase()]=!1}),setInterval(()=>{const D=f.cam.dist*.02;let T=!1;(Ge.w||Ge.arrowup)&&(f.cam.tz-=D,T=!0),(Ge.s||Ge.arrowdown)&&(f.cam.tz+=D,T=!0),(Ge.a||Ge.arrowleft)&&(f.cam.tx-=D,T=!0),(Ge.d||Ge.arrowright)&&(f.cam.tx+=D,T=!0),T&&(f.clampCamera(),f.applyCamera())},16);const Ye=Fe("modes");for(const[D,T]of Ym){const fe=document.createElement("button");fe.textContent=T,fe.dataset.mode=D,D===l&&(fe.className="on"),fe.onclick=()=>{l=D,[...Ye.children].forEach(de=>{de.className=de.dataset.mode===D?"on":""}),w(D)},Ye.appendChild(fe)}const Xe=Fe("tilt");Xe.oninput=()=>{Fe("tiltv").textContent=Xe.value,f.cam.pitch=(24+ +Xe.value/100*56)*Math.PI/180,f.clampCamera(),f.applyCamera()},Fe("reset").onclick=()=>{f.cam.tx=n.landCX-n.W/2,f.cam.tz=n.landCY-n.H/2,f.cam.dist=f.fitDist*.72,f.cam.yaw=0,f.clampCamera(),f.applyCamera()},Fe("zin").onclick=()=>{f.cam.dist/=1.3,f.clampCamera(),f.applyCamera()},Fe("zout").onclick=()=>{f.cam.dist*=1.3,f.clampCamera(),f.applyCamera()},Fe("clearSel").onclick=()=>k(-1),Fe("center").onclick=()=>{N<0||(f.cam.tx=n.pCX[N]-n.W/2,f.cam.tz=n.pCY[N]-n.H/2,f.cam.dist=Math.min(f.cam.dist,420),f.clampCamera(),f.applyCamera())};let st=!0;Fe("objs").onclick=()=>{m&&(st=!st,Fe("objs").className=st?"on":"",f.invalidate())},Fe("hideui").onclick=()=>{document.querySelectorAll(".panel").forEach(T=>{T.id!=="hideui"&&T.classList.toggle("hidden")});const D=Fe("hideui");D.textContent=D.textContent==="Hide UI"?"Show UI":"Hide UI",x=!0},Fe("dl").onclick=()=>{f.render();const D=document.createElement("canvas");D.width=h.width,D.height=h.height;const T=D.getContext("2d");T.drawImage(h,0,0),T.drawImage(u,0,0,D.width,D.height),Fe("dl").href=D.toDataURL("image/png")},Fe("dljson").onclick=()=>{const D=[];for(let fe=0;fe<n.np;fe++){const de=n.countyOf[fe],E=n.duchyOf[fe],d=n.kingOf[fe],O=n.empOf[fe],H=n.cultureOf[fe],Y=n.faithOf[fe];D.push({id:fe,name:n.provName[fe],terrain:or[n.pTerr[fe]],county:de>=0?n.countyName[de]:null,duchy:E>=0?n.duchyName[E]:null,kingdom:d>=0?n.kingName[d]:null,empire:O>=0?n.empName[O]:null,culture:H>=0?n.cultName[H]:null,faith:Y>=0?n.faithName[Y]:null,holding:R[n.holdingOf[fe]],holder:de>=0?n.countyHolder[de]:null,development:n.devOf[fe],neighbours:[...n.padj[fe]]})}const T={provinces:n.np,counties:n.nCounty,duchies:n.nDuchy,kingdoms:n.nKing,empires:n.nEmp,realms:D};Fe("dljson").href=URL.createObjectURL(new Blob([JSON.stringify(T)],{type:"application/json"}))};const ft=()=>{if(m){const D=st&&f.cam.dist<f.fitDist*.55;m.visible!==D&&(m.visible=D,f.invalidate())}f.render(),x&&(x=!1,qm(A,C,f,Kt+"map/ui/coa/",()=>{x=!0})),requestAnimationFrame(ft)};requestAnimationFrame(ft),i.style.display="none";const mt=f.terrain.geometry.attributes.position;let ct=1e9,it=-1e9;for(let D=0;D<mt.count;D++){const T=mt.getY(D);T<ct&&(ct=T),T>it&&(it=T)}window.__APP={scene:f,world:n,selectProvince:k,showFaith:q,showCulture:Q,showChar:se,showRealm:te,info:{webgl2:f.renderer.getContext()instanceof WebGL2RenderingContext,rendererType:"WebGLRenderer",isPerspectiveCamera:f.camera.isPerspectiveCamera===!0,geometryType:f.terrain.geometry.type,terrainMinY:ct,terrainMaxY:it,provinces:n.np,kingdoms:n.nKing,empires:n.nEmp}},console.log("3D map ready:",JSON.stringify(window.__APP.info))}$m().catch(i=>{console.error("boot failed",i);const e=document.getElementById("loading");e&&(e.textContent="Load error — see console")});
