...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Fn,depthTest:!1,depthWrite:!1})}function Bh(i,e,t){const n=new Float32Array(ui),r=new Y(0,1,0);return new Cn({name:"SphericalGaussianBlur",defines:{n:ui,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:jr(),fragmentShader:`
...
`)}const Vp={[gl]:"Linear",[_l]:"Reinhard",[xl]:"Cineon",[vl]:"ACESFilmic",[Sl]:"AgX",[yl]:"Neutral",[Ml]:"Custom"};function Wp(i,e){const t=Vp[e];return t===void 0?(Ye("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Fr=new Y;function Xp(){ft.getLuminanceCoefficients(Fr);const i=Fr.x.toFixed(4),e=Fr.y.toFixed(4),t=Fr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+d);const C=b+p+a,x=b+d+o,E=nl(r,r.VERTEX_SHADER,C),M=nl(r,r.FRAGMENT_SHADER,x);r.attachShader(T,E),r.attachShader(T,M),t.index0AttributeName!==void 0?r.bindAttribLocation(T,0,t.index0AttributeName):t.hasPositionAttribute===!0&&r.bindAttribLocation(T,0,"position"),r.linkProgram(T);function w(R){if(i.debug.checkShaderErrors){const U=r.getProgramInfoLog(T)||"",z=r.getShaderInfoLog(E)||"",H=r.getShaderInfoLog(M)||"",I=U.trim(),k=z.trim(),D=H.trim();let W=!0,te=!0;if(r.getProgramParameter(T,r.LINK_STATUS)===!1)if(W=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,T,E,M);else{const oe=rl(r,E,"vertex"),re=rl(r,M,"fragment");ht("WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(T,r.VALIDATE_STATUS)+`
...
Program Info Log: `+I+`
`+oe+`
`+re)}else I!==""?Ye("WebGLProgram: Program Info Log:",I):(k===""||D==="")&&(te=!1);te&&(R.diagnostics={runnable:W,programLog:I,vertexShader:{log:k,prefix:p},fragmentShader:{log:D,prefix:d}})}r.deleteShader(E),r.deleteShader(M),m=new Vr(r,T),S=$p(r,T)}let m;this.getUniforms=function(){return m===void 0&&w(this),m};let S;this.getAttributes=function(){return S===void 0&&w(this),S};let L=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return L===!1&&(L=r.getProgramParameter(T,Bp)),L},this.destroy=function(){n.releaseStatesOfProgram(this),r.deleteProgram(T),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=zp++,this.cacheKey=e,this.usedTimes=1,this.program=T,this.vertexShader=E,this.fragmentShader=M,this}let um=0;class fm{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e,t,n){const r=this._getShaderCacheForMaterial(e);return r.has(t)===!1&&(r.add(t),t.usedTimes++),r.has(n)===!1&&(r.add(n),n.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderStage(e){return this._getShaderStage(e.vertexShader)}getFragmentShaderStage(e){return this._getShaderStage(e.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new dm(e),t.set(e,n)),n}}class dm{constructor(e){this.id=um++,this.code=e,this.usedTimes=0}}function hm(i){return i===hi||i===qr||i===Yr}function pm(i,e,t,n,r,s){const a=new Va,o=new fm,l=new Set,c=[],h=new Map,u=n.logarithmicDepthBuffer;let f=n.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function v(m){return l.add(m),m===0?"uv":`uv${m}`}function T(m,S,L,R,U,z){const H=R.fog,I=U.geometry,k=m.isMeshStandardMaterial||m.isMeshLambertMaterial||m.isMeshPhongMaterial?R.environment:null,D=m.isMeshStandardMaterial||m.isMeshLambertMaterial&&!m.envMap||m.isMeshPhongMaterial&&!m.envMap,W=e.get(m.envMap||k,D),te=W&&W.mapping===Qr?W.image.height:null,oe=g[m.type];m.precision!==null&&(f=n.getMaxPrecision(m.precision),f!==m.precision&&Ye("WebGLProgram.getParameters:",m.precision,"not supported, using",f,"instead."));const re=I.morphAttributes.position||I.morphAttributes.normal||I.morphAttributes.color,he=re!==void 0?re.length:0;let We=0;I.morphAttributes.position!==void 0&&(We=1),I.morphAttributes.normal!==void 0&&(We=2),I.morphAttributes.color!==void 0&&(We=3);let dt,Ge,ee,ce;if(oe){const we=Sn[oe];dt=we.vertexShader,Ge=we.fragmentShader}else{dt=m.vertexShader,Ge=m.fragmentShader;const we=o.getVertexShaderStage(m),Et=o.getFragmentShaderStage(m);o.update(m,we,Et),ee=we.id,ce=Et.id}const J=i.getRenderTarget(),Fe=i.state.buffers.depth.getReversed(),Ve=U.isInstancedMesh===!0,De=U.isBatchedMesh===!0,pt=!!m.map,Xe=!!m.matcap,je=!!W,Je=!!m.aoMap,et=!!m.lightMap,Tt=!!m.bumpMap&&m.wireframe===!1,yt=!!m.normalMap,Lt=!!m.displacementMap,xt=!!m.emissiveMap,ct=!!m.metalnessMap,vt=!!m.roughnessMap,F=m.anisotropy>0,Nt=m.clearcoat>0,it=m.dispersion>0,P=m.iridescence>0,_=m.sheen>0,V=m.transmission>0,X=F&&!!m.anisotropyMap,Q=Nt&&!!m.clearcoatMap,ue=Nt&&!!m.clearcoatNormalMap,ge=Nt&&!!m.clearcoatRoughnessMap,j=P&&!!m.iridescenceMap,ne=P&&!!m.iridescenceThicknessMap,pe=_&&!!m.sheenColorMap,Pe=_&&!!m.sheenRoughnessMap,ve=!!m.specularMap,_e=!!m.specularColorMap,Ie=!!m.specularIntensityMap,Oe=V&&!!m.transmissionMap,qe=V&&!!m.thicknessMap,N=!!m.gradientMap,me=!!m.alphaMap,ie=m.alphaTest>0,xe=!!m.alphaHash,fe=!!m.extensions;let se=Tn;m.toneMapped&&(J===null||J.isXRRenderTarget===!0)&&(se=i.toneMapping);const Te={shaderID:oe,shaderType:m.type,shaderName:m.name,vertexShader:dt,fragmentShader:Ge,defines:m.defines,customVertexShaderID:ee,customFragmentShaderID:ce,isRawShaderMaterial:m.isRawShaderMaterial===!0,glslVersion:m.glslVersion,precision:f,batching:De,batchingColor:De&&U._colorsTexture!==null,instancing:Ve,instancingColor:Ve&&U.instanceColor!==null,instancingMorph:Ve&&U.morphTexture!==null,outputColorSpace:J===null?i.outputColorSpace:J.isXRRenderTarget===!0?J.texture.colorSpace:ft.workingColorSpace,alphaToCoverage:!!m.alphaToCoverage,map:pt,matcap:Xe,envMap:je,envMapMode:je&&W.mapping,envMapCubeUVHeight:te,aoMap:Je,lightMap:et,bumpMap:Tt,normalMap:yt,displacementMap:Lt,emissiveMap:xt,normalMapObjectSpace:yt&&m.normalMapType===Lc,normalMapTangentSpace:yt&&m.normalMapType===Aa,packedNormalMap:yt&&m.normalMapType===Aa&&hm(m.normalMap.format),metalnessMap:ct,roughnessMap:vt,anisotropy:F,anisotropyMap:X,clearcoat:Nt,clearcoatMap:Q,clearcoatNormalMap:ue,clearcoatRoughnessMap:ge,dispersion:it,iridescence:P,iridescenceMap:j,iridescenceThicknessMap:ne,sheen:_,sheenColorMap:pe,sheenRoughnessMap:Pe,specularMap:ve,specularColorMap:_e,specularIntensityMap:Ie,transmission:V,transmissionMap:Oe,thicknessMap:qe,gradientMap:N,opaque:m.transparent===!1&&m.blending===Oi&&m.alphaToCoverage===!1,alphaMap:me,alphaTest:ie,alphaHash:xe,combine:m.combine,mapUv:pt&&v(m.map.channel),aoMapUv:Je&&v(m.aoMap.channel),lightMapUv:et&&v(m.lightMap.channel),bumpMapUv:Tt&&v(m.bumpMap.channel),normalMapUv:yt&&v(m.normalMap.channel),displacementMapUv:Lt&&v(m.displacementMap.channel),emissiveMapUv:xt&&v(m.emissiveMap.channel),metalnessMapUv:ct&&v(m.metalnessMap.channel),roughnessMapUv:vt&&v(m.roughnessMap.channel),anisotropyMapUv:X&&v(m.anisotropyMap.channel),clearcoatMapUv:Q&&v(m.clearcoatMap.channel),clearcoatNormalMapUv:ue&&v(m.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ge&&v(m.clearcoatRoughnessMap.channel),iridescenceMapUv:j&&v(m.iridescenceMap.channel),iridescenceThicknessMapUv:ne&&v(m.iridescenceThicknessMap.channel),sheenColorMapUv:pe&&v(m.sheenColorMap.channel),sheenRoughnessMapUv:Pe&&v(m.sheenRoughnessMap.channel),specularMapUv:ve&&v(m.specularMap.channel),specularColorMapUv:_e&&v(m.specularColorMap.channel),specularIntensityMapUv:Ie&&v(m.specularIntensityMap.channel),transmissionMapUv:Oe&&v(m.transmissionMap.channel),thicknessMapUv:qe&&v(m.thicknessMap.channel),alphaMapUv:me&&v(m.alphaMap.channel),vertexTangents:!!I.attributes.tangent&&(yt||F),vertexNormals:!!I.attributes.normal,vertexColors:m.vertexColors,vertexAlphas:m.vertexColors===!0&&!!I.attributes.color&&I.attributes.color.itemSize===4,pointsUvs:U.isPoints===!0&&!!I.attributes.uv&&(pt||me),fog:!!H,useFog:m.fog===!0,fogExp2:!!H&&H.isFogExp2,flatShading:m.wireframe===!1&&(m.flatShading===!0||I.attributes.normal===void 0&&yt===!1&&(m.isMeshLambertMaterial||m.isMeshPhongMaterial||m.isMeshStandardMaterial||m.isMeshPhysicalMaterial)),sizeAttenuation:m.sizeAttenuation===!0,logarithmicDepthBuffer:u,reversedDepthBuffer:Fe,skinning:U.isSkinnedMesh===!0,hasPositionAttribute:I.attributes.position!==void 0,morphTargets:I.morphAttributes.position!==void 0,morphNormals:I.morphAttributes.normal!==void 0,morphColors:I.morphAttributes.color!==void 0,morphTargetsCount:he,morphTextureStride:We,numDirLights:S.directional.length,numPointLights:S.point.length,numSpotLights:S.spot.length,numSpotLightMaps:S.spotLightMap.length,numRectAreaLights:S.rectArea.length,numHemiLights:S.hemi.length,numDirLightShadows:S.directionalShadowMap.length,numPointLightShadows:S.pointShadowMap.length,numSpotLightShadows:S.spotShadowMap.length,numSpotLightShadowsWithMaps:S.numSpotLightShadowsWithMaps,numLightProbes:S.numLightProbes,numLightProbeGrids:z.length,numClippingPlanes:s.numPlanes,numClipIntersection:s.numIntersection,dithering:m.dithering,shadowMapEnabled:i.shadowMap.enabled&&L.length>0,shadowMapType:i.shadowMap.type,toneMapping:se,decodeVideoTexture:pt&&m.map.isVideoTexture===!0&&ft.getTransfer(m.map.colorSpace)===St,decodeVideoTextureEmissive:xt&&m.emissiveMap.isVideoTexture===!0&&ft.getTransfer(m.emissiveMap.colorSpace)===St,premultipliedAlpha:m.premultipliedAlpha,doubleSided:m.side===yn,flipSided:m.side===nn,useDepthPacking:m.depthPacking>=0,depthPacking:m.depthPacking||0,index0AttributeName:m.index0AttributeName,extensionClipCullDistance:fe&&m.extensions.clipCullDistance===!0&&t.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(fe&&m.extensions.multiDraw===!0||De)&&t.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:t.has("KHR_parallel_shader_compile"),customProgramCacheKey:m.customProgramCacheKey()};return Te.vertexUv1s=l.has(1),Te.vertexUv2s=l.has(2),Te.vertexUv3s=l.has(3),l.clear(),Te}function p(m){const S=[];if(m.shaderID?S.push(m.shaderID):(S.push(m.customVertexShaderID),S.push(m.customFragmentShaderID)),m.defines!==void 0)for(const L in m.defines)S.push(L),S.push(m.defines[L]);return m.isRawShaderMaterial===!1&&(d(S,m),b(S,m),S.push(i.outputColorSpace)),S.push(m.customProgramCacheKey),S.join()}function d(m,S){m.push(S.precision),m.push(S.outputColorSpace),m.push(S.envMapMode),m.push(S.envMapCubeUVHeight),m.push(S.mapUv),m.push(S.alphaMapUv),m.push(S.lightMapUv),m.push(S.aoMapUv),m.push(S.bumpMapUv),m.push(S.normalMapUv),m.push(S.displacementMapUv),m.push(S.emissiveMapUv),m.push(S.metalnessMapUv),m.push(S.roughnessMapUv),m.push(S.anisotropyMapUv),m.push(S.clearcoatMapUv),m.push(S.clearcoatNormalMapUv),m.push(S.clearcoatRoughnessMapUv),m.push(S.iridescenceMapUv),m.push(S.iridescenceThicknessMapUv),m.push(S.sheenColorMapUv),m.push(S.sheenRoughnessMapUv),m.push(S.specularMapUv),m.push(S.specularColorMapUv),m.push(S.specularIntensityMapUv),m.push(S.transmissionMapUv),m.push(S.thicknessMapUv),m.push(S.combine),m.push(S.fogExp2),m.push(S.sizeAttenuation),m.push(S.morphTargetsCount),m.push(S.morphAttributeCount),m.push(S.numDirLights),m.push(S.numPointLights),m.push(S.numSpotLights),m.push(S.numSpotLightMaps),m.push(S.numHemiLights),m.push(S.numRectAreaLights),m.push(S.numDirLightShadows),m.push(S.numPointLightShadows),m.push(S.numSpotLightShadows),m.push(S.numSpotLightShadowsWithMaps),m.push(S.numLightProbes),m.push(S.shadowMapType),m.push(S.toneMapping),m.push(S.numClippingPlanes),m.push(S.numClipIntersection),m.push(S.depthPacking)}function b(m,S){a.disableAll(),S.instancing&&a.enable(0),S.instancingColor&&a.enable(1),S.instancingMorph&&a.enable(2),S.matcap&&a.enable(3),S.envMap&&a.enable(4),S.normalMapObjectSpace&&a.enable(5),S.normalMapTangentSpace&&a.enable(6),S.clearcoat&&a.enable(7),S.iridescence&&a.enable(8),S.alphaTest&&a.enable(9),S.vertexColors&&a.enable(10),S.vertexAlphas&&a.enable(11),S.vertexUv1s&&a.enable(12),S.vertexUv2s&&a.enable(13),S.vertexUv3s&&a.enable(14),S.vertexTangents&&a.enable(15),S.anisotropy&&a.enable(16),S.alphaHash&&a.enable(17),S.batching&&a.enable(18),S.dispersion&&a.enable(19),S.batchingColor&&a.enable(20),S.gradientMap&&a.enable(21),S.packedNormalMap&&a.enable(22),S.vertexNormals&&a.enable(23),m.push(a.mask),a.disableAll(),S.fog&&a.enable(0),S.useFog&&a.enable(1),S.flatShading&&a.enable(2),S.logarithmicDepthBuffer&&a.enable(3),S.reversedDepthBuffer&&a.enable(4),S.skinning&&a.enable(5),S.morphTargets&&a.enable(6),S.morphNormals&&a.enable(7),S.morphColors&&a.enable(8),S.premultipliedAlpha&&a.enable(9),S.shadowMapEnabled&&a.enable(10),S.doubleSided&&a.enable(11),S.flipSided&&a.enable(12),S.useDepthPacking&&a.enable(13),S.dithering&&a.enable(14),S.transmission&&a.enable(15),S.sheen&&a.enable(16),S.opaque&&a.enable(17),S.pointsUvs&&a.enable(18),S.decodeVideoTexture&&a.enable(19),S.decodeVideoTextureEmissive&&a.enable(20),S.alphaToCoverage&&a.enable(21),S.numLightProbeGrids>0&&a.enable(22),S.hasPositionAttribute&&a.enable(23),m.push(a.mask)}function C(m){const S=g[m.type];let L;if(S){const R=Sn[S];L=Ru.clone(R.uniforms)}else L=m.uniforms;return L}function x(m,S){let L=h.get(S);return L!==void 0?++L.usedTimes:(L=new cm(i,S,m,r),c.push(L),h.set(S,L)),L}function E(m){if(--m.usedTimes===0){const S=c.indexOf(m);c[S]=c[c.length-1],c.pop(),h.delete(m.cacheKey),m.destroy()}}function M(m){o.remove(m)}function w(){o.dispose()}return{getParameters:T,getProgramCacheKey:p,getUniforms:C,acquireProgram:x,releaseProgram:E,releaseShaderCache:M,programs:c,dispose:w}}function mm(){let i=new WeakMap;function e(a){return i.has(a)}function t(a){let o=i.get(a);return o===void 0&&(o={},i.set(a,o)),o}function n(a){i.delete(a)}function r(a,o,l){i.get(a)[o]=l}function s(){i=new WeakMap}return{has:e,get:t,remove:n,update:r,dispose:s}}function gm(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.materialVariant!==e.materialVariant?i.materialVariant-e.materialVariant:i.z!==e.z?i.z-e.z:i.id-e.id}function cl(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function ul(){const i=[];let e=0;const t=[],n=[],r=[];function s(){e=0,t.length=0,n.length=0,r.length=0}function a(f){let g=0;return f.isInstancedMesh&&(g+=2),f.isSkinnedMesh&&(g+=1),g}function o(f,g,v,T,p,d){let b=i[e];return b===void 0?(b={id:f.id,object:f,geometry:g,material:v,materialVariant:a(f),groupOrder:T,renderOrder:f.renderOrder,z:p,group:d},i[e]=b):(b.id=f.id,b.object=f,b.geometry=g,b.material=v,b.materialVariant=a(f),b.groupOrder=T,b.renderOrder=f.renderOrder,b.z=p,b.group=d),e++,b}function l(f,g,v,T,p,d){const b=o(f,g,v,T,p,d);v.transmission>0?n.push(b):v.transparent===!0?r.push(b):t.push(b)}function c(f,g,v,T,p,d){const b=o(f,g,v,T,p,d);v.transmission>0?n.unshift(b):v.transparent===!0?r.unshift(b):t.unshift(b)}function h(f,g,v){t.length>1&&t.sort(f||gm),n.length>1&&n.sort(g||cl),r.length>1&&r.sort(g||cl),v&&(t.reverse(),n.reverse(),r.reverse())}function u(){for(let f=e,g=i.length;f<g;f++){const v=i[f];if(v.id===null)break;v.id=null,v.object=null,v.geometry=null,v.material=null,v.group=null}}return{opaque:t,transmissive:n,transparent:r,init:s,push:l,unshift:c,finish:u,sort:h}}function _m(){let i=new WeakMap;function e(n,r){const s=i.get(n);let a;return s===void 0?(a=new ul,i.set(n,[a])):r>=s.length?(a=new ul,s.push(a)):a=s[r],a}function t(){i=new WeakMap}return{get:e,dispose:t}}function xm(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new Y,color:new at};break;case"SpotLight":t={position:new Y,direction:new Y,color:new at,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new Y,color:new at,distance:0,decay:0};break;case"HemisphereLight":t={direction:new Y,skyColor:new at,groundColor:new at};break;case"RectAreaLight":t={color:new at,position:new Y,halfWidth:new Y,halfHeight:new Y};break}return i[e.id]=t,t}}}function vm(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new st};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new st};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new st,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let Mm=0;function Sm(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function ym(i){const e=new xm,t=vm(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new Y);const r=new Y,s=new Ct,a=new Ct;function o(c){let h=0,u=0,f=0;for(let S=0;S<9;S++)n.probe[S].set(0,0,0);let g=0,v=0,T=0,p=0,d=0,b=0,C=0,x=0,E=0,M=0,w=0;c.sort(Sm);for(let S=0,L=c.length;S<L;S++){const R=c[S],U=R.color,z=R.intensity,H=R.distance;let I=null;if(R.shadow&&R.shadow.map&&(R.shadow.map.texture.format===hi?I=R.shadow.map.texture:I=R.shadow.map.depthTexture||R.shadow.map.texture),R.isAmbientLight)h+=U.r*z,u+=U.g*z,f+=U.b*z;else if(R.isLightProbe){for(let k=0;k<9;k++)n.probe[k].addScaledVector(R.sh.coefficients[k],z);w++}else if(R.isDirectionalLight){const k=e.get(R);if(k.color.copy(R.color).multiplyScalar(R.intensity),R.castShadow){const D=R.shadow,W=t.get(R);W.shadowIntensity=D.intensity,W.shadowBias=D.bias,W.shadowNormalBias=D.normalBias,W.shadowRadius=D.radius,W.shadowMapSize=D.mapSize,n.directionalShadow[g]=W,n.directionalShadowMap[g]=I,n.directionalShadowMatrix[g]=R.shadow.matrix,b++}n.directional[g]=k,g++}else if(R.isSpotLight){const k=e.get(R);k.position.setFromMatrixPosition(R.matrixWorld),k.color.copy(U).multiplyScalar(z),k.distance=H,k.coneCos=Math.cos(R.angle),k.penumbraCos=Math.cos(R.angle*(1-R.penumbra)),k.decay=R.decay,n.spot[T]=k;const D=R.shadow;if(R.map&&(n.spotLightMap[E]=R.map,E++,D.updateMatrices(R),R.castShadow&&M++),n.spotLightMatrix[T]=D.matrix,R.castShadow){const W=t.get(R);W.shadowIntensity=D.intensity,W.shadowBias=D.bias,W.shadowNormalBias=D.normalBias,W.shadowRadius=D.radius,W.shadowMapSize=D.mapSize,n.spotShadow[T]=W,n.spotShadowMap[T]=I,x++}T++}else if(R.isRectAreaLight){const k=e.get(R);k.color.copy(U).multiplyScalar(z),k.halfWidth.set(R.width*.5,0,0),k.halfHeight.set(0,R.height*.5,0),n.rectArea[p]=k,p++}else if(R.isPointLight){const k=e.get(R);if(k.color.copy(R.color).multiplyScalar(R.intensity),k.distance=R.distance,k.decay=R.decay,R.castShadow){const D=R.shadow,W=t.get(R);W.shadowIntensity=D.intensity,W.shadowBias=D.bias,W.shadowNormalBias=D.normalBias,W.shadowRadius=D.radius,W.shadowMapSize=D.mapSize,W.shadowCameraNear=D.camera.near,W.shadowCameraFar=D.camera.far,n.pointShadow[v]=W,n.pointShadowMap[v]=I,n.pointShadowMatrix[v]=R.shadow.matrix,C++}n.point[v]=k,v++}else if(R.isHemisphereLight){const k=e.get(R);k.skyColor.copy(R.color).multiplyScalar(z),k.groundColor.copy(R.groundColor).multiplyScalar(z),n.hemi[d]=k,d++}}p>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=Ee.LTC_FLOAT_1,n.rectAreaLTC2=Ee.LTC_FLOAT_2):(n.rectAreaLTC1=Ee.LTC_HALF_1,n.rectAreaLTC2=Ee.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=u,n.ambient[2]=f;const m=n.hash;(m.directionalLength!==g||m.pointLength!==v||m.spotLength!==T||m.rectAreaLength!==p||m.hemiLength!==d||m.numDirectionalShadows!==b||m.numPointShadows!==C||m.numSpotShadows!==x||m.numSpotMaps!==E||m.numLightProbes!==w)&&(n.directional.length=g,n.spot.length=T,n.rectArea.length=p,n.point.length=v,n.hemi.length=d,n.directionalShadow.length=b,n.directionalShadowMap.length=b,n.pointShadow.length=C,n.pointShadowMap.length=C,n.spotShadow.length=x,n.spotShadowMap.length=x,n.directionalShadowMatrix.length=b,n.pointShadowMatrix.length=C,n.spotLightMatrix.length=x+E-M,n.spotLightMap.length=E,n.numSpotLightShadowsWithMaps=M,n.numLightProbes=w,m.directionalLength=g,m.pointLength=v,m.spotLength=T,m.rectAreaLength=p,m.hemiLength=d,m.numDirectionalShadows=b,m.numPointShadows=C,m.numSpotShadows=x,m.numSpotMaps=E,m.numLightProbes=w,n.version=Mm++)}function l(c,h){let u=0,f=0,g=0,v=0,T=0;const p=h.matrixWorldInverse;for(let d=0,b=c.length;d<b;d++){const C=c[d];if(C.isDirectionalLight){const x=n.directional[u];x.direction.setFromMatrixPosition(C.matrixWorld),r.setFromMatrixPosition(C.target.matrixWorld),x.direction.sub(r),x.direction.transformDirection(p),u++}else if(C.isSpotLight){const x=n.spot[g];x.position.setFromMatrixPosition(C.matrixWorld),x.position.applyMatrix4(p),x.direction.setFromMatrixPosition(C.matrixWorld),r.setFromMatrixPosition(C.target.matrixWorld),x.direction.sub(r),x.direction.transformDirection(p),g++}else if(C.isRectAreaLight){const x=n.rectArea[v];x.position.setFromMatrixPosition(C.matrixWorld),x.position.applyMatrix4(p),a.identity(),s.copy(C.matrixWorld),s.premultiply(p),a.extractRotation(s),x.halfWidth.set(C.width*.5,0,0),x.halfHeight.set(0,C.height*.5,0),x.halfWidth.applyMatrix4(a),x.halfHeight.applyMatrix4(a),v++}else if(C.isPointLight){const x=n.point[f];x.position.setFromMatrixPosition(C.matrixWorld),x.position.applyMatrix4(p),f++}else if(C.isHemisphereLight){const x=n.hemi[T];x.direction.setFromMatrixPosition(C.matrixWorld),x.direction.transformDirection(p),T++}}}return{setup:o,setupView:l,state:n}}function fl(i){const e=new ym(i),t=[],n=[],r=[];function s(f){u.camera=f,t.length=0,n.length=0,r.length=0}function a(f){t.push(f)}function o(f){n.push(f)}function l(f){r.push(f)}function c(){e.setup(t)}function h(f){e.setupView(t,f)}const u={lightsArray:t,shadowsArray:n,lightProbeGridArray:r,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:s,state:u,setupLights:c,setupLightsView:h,pushLight:a,pushShadow:o,pushLightProbeGrid:l}}function Em(i){let e=new WeakMap;function t(r,s=0){const a=e.get(r);let o;return a===void 0?(o=new fl(i),e.set(r,[o])):s>=a.length?(o=new fl(i),a.push(o)):o=a[s],o}function n(){e=new WeakMap}return{get:t,dispose:n}}const bm=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,Am=[new Y(1,0,0),new Y(-1,0,0),new Y(0,1,0),new Y(0,-1,0),new Y(0,0,1),new Y(0,0,-1)],wm=[new Y(0,-1,0),new Y(0,-1,0),new Y(0,0,1),new Y(0,0,-1),new Y(0,-1,0),new Y(0,-1,0)],dl=new Ct,er=new Y,Os=new Y;function Cm(i,e,t){let n=new Xa;const r=new st,s=new st,a=new It,o=new Uu,l=new Nu,c={},h=t.maxTextureSize,u={[zn]:nn,[nn]:zn,[yn]:yn},f=new Cn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new st},radius:{value:4}},vertexShader:bm,fragmentShader:Tm}),g=f.clone();g.defines.HORIZONTAL_PASS=1;const v=new Rn;v.setAttribute("position",new rn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const T=new cn(v,f),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Br;let d=this.type;this.render=function(M,w,m){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||M.length===0)return;this.type===lc&&(Ye("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Br);const S=i.getRenderTarget(),L=i.getActiveCubeFace(),R=i.getActiveMipmapLevel(),U=i.state;U.setBlending(Fn),U.buffers.depth.getReversed()===!0?U.buffers.color.setClear(0,0,0,0):U.buffers.color.setClear(1,1,1,1),U.buffers.depth.setTest(!0),U.setScissorTest(!1);const z=d!==this.type;z&&w.traverse(function(H){H.material&&(Array.isArray(H.material)?H.material.forEach(I=>I.needsUpdate=!0):H.material.needsUpdate=!0)});for(let H=0,I=M.length;H<I;H++){const k=M[H],D=k.shadow;if(D===void 0){Ye("WebGLShadowMap:",k,"has no shadow.");continue}if(D.autoUpdate===!1&&D.needsUpdate===!1)continue;r.copy(D.mapSize);const W=D.getFrameExtents();r.multiply(W),s.copy(D.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/W.x),r.x=s.x*W.x,D.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/W.y),r.y=s.y*W.y,D.mapSize.y=s.y));const te=i.state.buffers.depth.getReversed();if(D.camera._reversedDepth=te,D.map===null||z===!0){if(D.map!==null&&(D.map.depthTexture!==null&&(D.map.depthTexture.dispose(),D.map.depthTexture=null),D.map.dispose()),this.type===tr){if(k.isPointLight){Ye("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}D.map=new An(r.x,r.y,{format:hi,type:Hn,minFilter:Wt,magFilter:Wt,generateMipmaps:!1}),D.map.texture.name=k.name+".shadowMap",D.map.depthTexture=new Gi(r.x,r.y,_n),D.map.depthTexture.name=k.name+".shadowMapDepth",D.map.depthTexture.format=kn,D.map.depthTexture.compareFunction=null,D.map.depthTexture.minFilter=Bt,D.map.depthTexture.magFilter=Bt}else k.isPointLight?(D.map=new Wl(r.x),D.map.depthTexture=new wu(r.x,wn)):(D.map=new An(r.x,r.y),D.map.depthTexture=new Gi(r.x,r.y,wn)),D.map.depthTexture.name=k.name+".shadowMap",D.map.depthTexture.format=kn,this.type===Br?(D.map.depthTexture.compareFunction=te?Ha:za,D.map.depthTexture.minFilter=Wt,D.map.depthTexture.magFilter=Wt):(D.map.depthTexture.compareFunction=null,D.map.depthTexture.minFilter=Bt,D.map.depthTexture.magFilter=Bt);D.camera.updateProjectionMatrix()}const oe=D.map.isWebGLCubeRenderTarget?6:1;for(let re=0;re<oe;re++){if(D.map.isWebGLCubeRenderTarget)i.setRenderTarget(D.map,re),i.clear();else{re===0&&(i.setRenderTarget(D.map),i.clear());const he=D.getViewport(re);a.set(s.x*he.x,s.y*he.y,s.x*he.z,s.y*he.w),U.viewport(a)}if(k.isPointLight){const he=D.camera,We=D.matrix,dt=k.distance||he.far;dt!==he.far&&(he.far=dt,he.updateProjectionMatrix()),er.setFromMatrixPosition(k.matrixWorld),he.position.copy(er),Os.copy(he.position),Os.add(Am[re]),he.up.copy(wm[re]),he.lookAt(Os),he.updateMatrixWorld(),We.makeTranslation(-er.x,-er.y,-er.z),dl.multiplyMatrices(he.projectionMatrix,he.matrixWorldInverse),D._frustum.setFromProjectionMatrix(dl,he.coordinateSystem,he.reversedDepth)}else D.updateMatrices(k);n=D.getFrustum(),x(w,m,D.camera,k,this.type)}D.isPointLightShadow!==!0&&this.type===tr&&b(D,m),D.needsUpdate=!1}d=this.type,p.needsUpdate=!1,i.setRenderTarget(S,L,R)};function b(M,w){const m=e.update(T);f.defines.VSM_SAMPLES!==M.blurSamples&&(f.defines.VSM_SAMPLES=M.blurSamples,g.defines.VSM_SAMPLES=M.blurSamples,f.needsUpdate=!0,g.needsUpdate=!0),M.mapPass===null&&(M.mapPass=new An(r.x,r.y,{format:hi,type:Hn})),f.uniforms.shadow_pass.value=M.map.depthTexture,f.uniforms.resolution.value=M.mapSize,f.uniforms.radius.value=M.radius,i.setRenderTarget(M.mapPass),i.clear(),i.renderBufferDirect(w,null,m,f,T,null),g.uniforms.shadow_pass.value=M.mapPass.texture,g.uniforms.resolution.value=M.mapSize,g.uniforms.radius.value=M.radius,i.setRenderTarget(M.map),i.clear(),i.renderBufferDirect(w,null,m,g,T,null)}function C(M,w,m,S){let L=null;const R=m.isPointLight===!0?M.customDistanceMaterial:M.customDepthMaterial;if(R!==void 0)L=R;else if(L=m.isPointLight===!0?l:o,i.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){const U=L.uuid,z=w.uuid;let H=c[U];H===void 0&&(H={},c[U]=H);let I=H[z];I===void 0&&(I=L.clone(),H[z]=I,w.addEventListener("dispose",E)),L=I}if(L.visible=w.visible,L.wireframe=w.wireframe,S===tr?L.side=w.shadowSide!==null?w.shadowSide:w.side:L.side=w.shadowSide!==null?w.shadowSide:u[w.side],L.alphaMap=w.alphaMap,L.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,L.map=w.map,L.clipShadows=w.clipShadows,L.clippingPlanes=w.clippingPlanes,L.clipIntersection=w.clipIntersection,L.displacementMap=w.displacementMap,L.displacementScale=w.displacementScale,L.displacementBias=w.displacementBias,L.wireframeLinewidth=w.wireframeLinewidth,L.linewidth=w.linewidth,m.isPointLight===!0&&L.isMeshDistanceMaterial===!0){const U=i.properties.get(L);U.light=m}return L}function x(M,w,m,S,L){if(M.visible===!1)return;if(M.layers.test(w.layers)&&(M.isMesh||M.isLine||M.isPoints)&&(M.castShadow||M.receiveShadow&&L===tr)&&(!M.frustumCulled||n.intersectsObject(M))){M.modelViewMatrix.multiplyMatrices(m.matrixWorldInverse,M.matrixWorld);const z=e.update(M),H=M.material;if(Array.isArray(H)){const I=z.groups;for(let k=0,D=I.length;k<D;k++){const W=I[k],te=H[W.materialIndex];if(te&&te.visible){const oe=C(M,te,S,L);M.onBeforeShadow(i,M,w,m,z,oe,W),i.renderBufferDirect(m,null,z,oe,M,W),M.onAfterShadow(i,M,w,m,z,oe,W)}}}else if(H.visible){const I=C(M,H,S,L);M.onBeforeShadow(i,M,w,m,z,I,null),i.renderBufferDirect(m,null,z,I,M,null),M.onAfterShadow(i,M,w,m,z,I,null)}}const U=M.children;for(let z=0,H=U.length;z<H;z++)x(U[z],w,m,S,L)}function E(M){M.target.removeEventListener("dispose",E);for(const m in c){const S=c[m],L=M.target.uuid;L in S&&(S[L].dispose(),delete S[L])}}}function Rm(i,e){function t(){let N=!1;const me=new It;let ie=null;const xe=new It(0,0,0,0);return{setMask:function(fe){ie!==fe&&!N&&(i.colorMask(fe,fe,fe,fe),ie=fe)},setLocked:function(fe){N=fe},setClear:function(fe,se,Te,we,Et){Et===!0&&(fe*=we,se*=we,Te*=we),me.set(fe,se,Te,we),xe.equals(me)===!1&&(i.clearColor(fe,se,Te,we),xe.copy(me))},reset:function(){N=!1,ie=null,xe.set(-1,0,0,0)}}}function n(){let N=!1,me=!1,ie=null,xe=null,fe=null;return{setReversed:function(se){if(me!==se){const Te=e.get("EXT_clip_control");se?Te.clipControlEXT(Te.LOWER_LEFT_EXT,Te.ZERO_TO_ONE_EXT):Te.clipControlEXT(Te.LOWER_LEFT_EXT,Te.NEGATIVE_ONE_TO_ONE_EXT),me=se;const we=fe;fe=null,this.setClear(we)}},getReversed:function(){return me},setTest:function(se){se?J(i.DEPTH_TEST):Fe(i.DEPTH_TEST)},setMask:function(se){ie!==se&&!N&&(i.depthMask(se),ie=se)},setFunc:function(se){if(me&&(se=kc[se]),xe!==se){switch(se){case Vs:i.depthFunc(i.NEVER);break;case Ws:i.depthFunc(i.ALWAYS);break;case Xs:i.depthFunc(i.LESS);break;case Hi:i.depthFunc(i.LEQUAL);break;case qs:i.depthFunc(i.EQUAL);break;case Ys:i.depthFunc(i.GEQUAL);break;case $s:i.depthFunc(i.GREATER);break;case Ks:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}xe=se}},setLocked:function(se){N=se},setClear:function(se){fe!==se&&(fe=se,me&&(se=1-se),i.clearDepth(se))},reset:function(){N=!1,ie=null,xe=null,fe=null,me=!1}}}function r(){let N=!1,me=null,ie=null,xe=null,fe=null,se=null,Te=null,we=null,Et=null;return{setTest:function(_t){N||(_t?J(i.STENCIL_TEST):Fe(i.STENCIL_TEST))},setMask:function(_t){me!==_t&&!N&&(i.stencilMask(_t),me=_t)},setFunc:function(_t,Xt,qt){(ie!==_t||xe!==Xt||fe!==qt)&&(i.stencilFunc(_t,Xt,qt),ie=_t,xe=Xt,fe=qt)},setOp:function(_t,Xt,qt){(se!==_t||Te!==Xt||we!==qt)&&(i.stencilOp(_t,Xt,qt),se=_t,Te=Xt,we=qt)},setLocked:function(_t){N=_t},setClear:function(_t){Et!==_t&&(i.clearStencil(_t),Et=_t)},reset:function(){N=!1,me=null,ie=null,xe=null,fe=null,se=null,Te=null,we=null,Et=null}}}const s=new t,a=new n,o=new r,l=new WeakMap,c=new WeakMap;let h={},u={},f={},g=new WeakMap,v=[],T=null,p=!1,d=null,b=null,C=null,x=null,E=null,M=null,w=null,m=new at(0,0,0),S=0,L=!1,R=null,U=null,z=null,H=null,I=null;const k=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let D=!1,W=0;const te=i.getParameter(i.VERSION);te.indexOf("WebGL")!==-1?(W=parseFloat(/^WebGL (\d)/.exec(te)[1]),D=W>=1):te.indexOf("OpenGL ES")!==-1&&(W=parseFloat(/^OpenGL ES (\d)/.exec(te)[1]),D=W>=2);let oe=null,re={};const he=i.getParameter(i.SCISSOR_BOX),We=i.getParameter(i.VIEWPORT),dt=new It().fromArray(he),Ge=new It().fromArray(We);function ee(N,me,ie,xe){const fe=new Uint8Array(4),se=i.createTexture();i.bindTexture(N,se),i.texParameteri(N,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(N,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Te=0;Te<ie;Te++)N===i.TEXTURE_3D||N===i.TEXTURE_2D_ARRAY?i.texImage3D(me,0,i.RGBA,1,1,xe,0,i.RGBA,i.UNSIGNED_BYTE,fe):i.texImage2D(me+Te,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,fe);return se}const ce={};ce[i.TEXTURE_2D]=ee(i.TEXTURE_2D,i.TEXTURE_2D,1),ce[i.TEXTURE_CUBE_MAP]=ee(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),ce[i.TEXTURE_2D_ARRAY]=ee(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),ce[i.TEXTURE_3D]=ee(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),J(i.DEPTH_TEST),a.setFunc(Hi),Tt(!1),yt(io),J(i.CULL_FACE),Je(Fn);function J(N){h[N]!==!0&&(i.enable(N),h[N]=!0)}function Fe(N){h[N]!==!1&&(i.disable(N),h[N]=!1)}function Ve(N,me){return f[N]!==me?(i.bindFramebuffer(N,me),f[N]=me,N===i.DRAW_FRAMEBUFFER&&(f[i.FRAMEBUFFER]=me),N===i.FRAMEBUFFER&&(f[i.DRAW_FRAMEBUFFER]=me),!0):!1}function De(N,me){let ie=v,xe=!1;if(N){ie=g.get(me),ie===void 0&&(ie=[],g.set(me,ie));const fe=N.textures;if(ie.length!==fe.length||ie[0]!==i.COLOR_ATTACHMENT0){for(let se=0,Te=fe.length;se<Te;se++)ie[se]=i.COLOR_ATTACHMENT0+se;ie.length=fe.length,xe=!0}}else ie[0]!==i.BACK&&(ie[0]=i.BACK,xe=!0);xe&&i.drawBuffers(ie)}function pt(N){return T!==N?(i.useProgram(N),T=N,!0):!1}const Xe={[li]:i.FUNC_ADD,[uc]:i.FUNC_SUBTRACT,[fc]:i.FUNC_REVERSE_SUBTRACT};Xe[dc]=i.MIN,Xe[hc]=i.MAX;const je={[pc]:i.ZERO,[mc]:i.ONE,[gc]:i.SRC_COLOR,[ks]:i.SRC_ALPHA,[yc]:i.SRC_ALPHA_SATURATE,[Mc]:i.DST_COLOR,[xc]:i.DST_ALPHA,[_c]:i.ONE_MINUS_SRC_COLOR,[Gs]:i.ONE_MINUS_SRC_ALPHA,[Sc]:i.ONE_MINUS_DST_COLOR,[vc]:i.ONE_MINUS_DST_ALPHA,[Ec]:i.CONSTANT_COLOR,[bc]:i.ONE_MINUS_CONSTANT_COLOR,[Tc]:i.CONSTANT_ALPHA,[Ac]:i.ONE_MINUS_CONSTANT_ALPHA};function Je(N,me,ie,xe,fe,se,Te,we,Et,_t){if(N===Fn){p===!0&&(Fe(i.BLEND),p=!1);return}if(p===!1&&(J(i.BLEND),p=!0),N!==cc){if(N!==d||_t!==L){if((b!==li||E!==li)&&(i.blendEquation(i.FUNC_ADD),b=li,E=li),_t)switch(N){case Oi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ro:i.blendFunc(i.ONE,i.ONE);break;case so:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ao:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:ht("WebGLState: Invalid blending: ",N);break}else switch(N){case Oi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ro:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case so:ht("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case ao:ht("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:ht("WebGLState: Invalid blending: ",N);break}C=null,x=null,M=null,w=null,m.set(0,0,0),S=0,d=N,L=_t}return}fe=fe||me,se=se||ie,Te=Te||xe,(me!==b||fe!==E)&&(i.blendEquationSeparate(Xe[me],Xe[fe]),b=me,E=fe),(ie!==C||xe!==x||se!==M||Te!==w)&&(i.blendFuncSeparate(je[ie],je[xe],je[se],je[Te]),C=ie,x=xe,M=se,w=Te),(we.equals(m)===!1||Et!==S)&&(i.blendColor(we.r,we.g,we.b,Et),m.copy(we),S=Et),d=N,L=!1}function et(N,me){N.side===yn?Fe(i.CULL_FACE):J(i.CULL_FACE);let ie=N.side===nn;me&&(ie=!ie),Tt(ie),N.blending===Oi&&N.transparent===!1?Je(Fn):Je(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),a.setFunc(N.depthFunc),a.setTest(N.depthTest),a.setMask(N.depthWrite),s.setMask(N.colorWrite);const xe=N.stencilWrite;o.setTest(xe),xe&&(o.setMask(N.stencilWriteMask),o.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),o.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),xt(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?J(i.SAMPLE_ALPHA_TO_COVERAGE):Fe(i.SAMPLE_ALPHA_TO_COVERAGE)}function Tt(N){R!==N&&(N?i.frontFace(i.CW):i.frontFace(i.CCW),R=N)}function yt(N){N!==ac?(J(i.CULL_FACE),N!==U&&(N===io?i.cullFace(i.BACK):N===oc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Fe(i.CULL_FACE),U=N}function Lt(N){N!==z&&(D&&i.lineWidth(N),z=N)}function xt(N,me,ie){N?(J(i.POLYGON_OFFSET_FILL),(H!==me||I!==ie)&&(H=me,I=ie,a.getReversed()&&(me=-me),i.polygonOffset(me,ie))):Fe(i.POLYGON_OFFSET_FILL)}function ct(N){N?J(i.SCISSOR_TEST):Fe(i.SCISSOR_TEST)}function vt(N){N===void 0&&(N=i.TEXTURE0+k-1),oe!==N&&(i.activeTexture(N),oe=N)}function F(N,me,ie){ie===void 0&&(oe===null?ie=i.TEXTURE0+k-1:ie=oe);let xe=re[ie];xe===void 0&&(xe={type:void 0,texture:void 0},re[ie]=xe),(xe.type!==N||xe.texture!==me)&&(oe!==ie&&(i.activeTexture(ie),oe=ie),i.bindTexture(N,me||ce[N]),xe.type=N,xe.texture=me)}function Nt(){const N=re[oe];N!==void 0&&N.type!==void 0&&(i.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function it(){try{i.compressedTexImage2D(...arguments)}catch(N){ht("WebGLState:",N)}}function P(){try{i.compressedTexImage3D(...arguments)}catch(N){ht("WebGLState:",N)}}function _(){try{i.texSubImage2D(...arguments)}catch(N){ht("WebGLState:",N)}}function V(){try{i.texSubImage3D(...arguments)}catch(N){ht("WebGLState:",N)}}function X(){try{i.compressedTexSubImage2D(...arguments)}catch(N){ht("WebGLState:",N)}}function Q(){try{i.compressedTexSubImage3D(...arguments)}catch(N){ht("WebGLState:",N)}}function ue(){try{i.texStorage2D(...arguments)}catch(N){ht("WebGLState:",N)}}function ge(){try{i.texStorage3D(...arguments)}catch(N){ht("WebGLState:",N)}}function j(){try{i.texImage2D(...arguments)}catch(N){ht("WebGLState:",N)}}function ne(){try{i.texImage3D(...arguments)}catch(N){ht("WebGLState:",N)}}function pe(N){return u[N]!==void 0?u[N]:i.getParameter(N)}function Pe(N,me){u[N]!==me&&(i.pixelStorei(N,me),u[N]=me)}function ve(N){dt.equals(N)===!1&&(i.scissor(N.x,N.y,N.z,N.w),dt.copy(N))}function _e(N){Ge.equals(N)===!1&&(i.viewport(N.x,N.y,N.z,N.w),Ge.copy(N))}function Ie(N,me){let ie=c.get(me);ie===void 0&&(ie=new WeakMap,c.set(me,ie));let xe=ie.get(N);xe===void 0&&(xe=i.getUniformBlockIndex(me,N.name),ie.set(N,xe))}function Oe(N,me){const xe=c.get(me).get(N);l.get(me)!==xe&&(i.uniformBlockBinding(me,xe,N.__bindingPointIndex),l.set(me,xe))}function qe(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),h={},u={},oe=null,re={},f={},g=new WeakMap,v=[],T=null,p=!1,d=null,b=null,C=null,x=null,E=null,M=null,w=null,m=new at(0,0,0),S=0,L=!1,R=null,U=null,z=null,H=null,I=null,dt.set(0,0,i.canvas.width,i.canvas.height),Ge.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:J,disable:Fe,bindFramebuffer:Ve,drawBuffers:De,useProgram:pt,setBlending:Je,setMaterial:et,setFlipSided:Tt,setCullFace:yt,setLineWidth:Lt,setPolygonOffset:xt,setScissorTest:ct,activeTexture:vt,bindTexture:F,unbindTexture:Nt,compressedTexImage2D:it,compressedTexImage3D:P,texImage2D:j,texImage3D:ne,pixelStorei:Pe,getParameter:pe,updateUBOMapping:Ie,uniformBlockBinding:Oe,texStorage2D:ue,texStorage3D:ge,texSubImage2D:_,texSubImage3D:V,compressedTexSubImage2D:X,compressedTexSubImage3D:Q,scissor:ve,viewport:_e,reset:qe}}function Pm(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new st,h=new WeakMap,u=new Set;let f;const g=new WeakMap;let v=!1;try{v=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function T(P,_){return v?new OffscreenCanvas(P,_):cr("canvas")}function p(P,_,V){let X=1;const Q=it(P);if((Q.width>V||Q.height>V)&&(X=V/Math.max(Q.width,Q.height)),X<1)if(typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&P instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&P instanceof ImageBitmap||typeof VideoFrame<"u"&&P instanceof VideoFrame){const ue=Math.floor(X*Q.width),ge=Math.floor(X*Q.height);f===void 0&&(f=T(ue,ge));const j=_?T(ue,ge):f;return j.width=ue,j.height=ge,j.getContext("2d").drawImage(P,0,0,ue,ge),Ye("WebGLRenderer: Texture has been resized from ("+Q.width+"x"+Q.height+") to ("+ue+"x"+ge+")."),j}else return"data"in P&&Ye("WebGLRenderer: Image in DataTexture is too big ("+Q.width+"x"+Q.height+")."),P;return P}function d(P){return P.generateMipmaps}function b(P){i.generateMipmap(P)}function C(P){return P.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:P.isWebGL3DRenderTarget?i.TEXTURE_3D:P.isWebGLArrayRenderTarget||P.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function x(P,_,V,X,Q,ue=!1){if(P!==null){if(i[P]!==void 0)return i[P];Ye("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+P+"'")}let ge;X&&(ge=e.get("EXT_texture_norm16"),ge||Ye("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let j=_;if(_===i.RED&&(V===i.FLOAT&&(j=i.R32F),V===i.HALF_FLOAT&&(j=i.R16F),V===i.UNSIGNED_BYTE&&(j=i.R8),V===i.UNSIGNED_SHORT&&ge&&(j=ge.R16_EXT),V===i.SHORT&&ge&&(j=ge.R16_SNORM_EXT)),_===i.RED_INTEGER&&(V===i.UNSIGNED_BYTE&&(j=i.R8UI),V===i.UNSIGNED_SHORT&&(j=i.R16UI),V===i.UNSIGNED_INT&&(j=i.R32UI),V===i.BYTE&&(j=i.R8I),V===i.SHORT&&(j=i.R16I),V===i.INT&&(j=i.R32I)),_===i.RG&&(V===i.FLOAT&&(j=i.RG32F),V===i.HALF_FLOAT&&(j=i.RG16F),V===i.UNSIGNED_BYTE&&(j=i.RG8),V===i.UNSIGNED_SHORT&&ge&&(j=ge.RG16_EXT),V===i.SHORT&&ge&&(j=ge.RG16_SNORM_EXT)),_===i.RG_INTEGER&&(V===i.UNSIGNED_BYTE&&(j=i.RG8UI),V===i.UNSIGNED_SHORT&&(j=i.RG16UI),V===i.UNSIGNED_INT&&(j=i.RG32UI),V===i.BYTE&&(j=i.RG8I),V===i.SHORT&&(j=i.RG16I),V===i.INT&&(j=i.RG32I)),_===i.RGB_INTEGER&&(V===i.UNSIGNED_BYTE&&(j=i.RGB8UI),V===i.UNSIGNED_SHORT&&(j=i.RGB16UI),V===i.UNSIGNED_INT&&(j=i.RGB32UI),V===i.BYTE&&(j=i.RGB8I),V===i.SHORT&&(j=i.RGB16I),V===i.INT&&(j=i.RGB32I)),_===i.RGBA_INTEGER&&(V===i.UNSIGNED_BYTE&&(j=i.RGBA8UI),V===i.UNSIGNED_SHORT&&(j=i.RGBA16UI),V===i.UNSIGNED_INT&&(j=i.RGBA32UI),V===i.BYTE&&(j=i.RGBA8I),V===i.SHORT&&(j=i.RGBA16I),V===i.INT&&(j=i.RGBA32I)),_===i.RGB&&(V===i.UNSIGNED_SHORT&&ge&&(j=ge.RGB16_EXT),V===i.SHORT&&ge&&(j=ge.RGB16_SNORM_EXT),V===i.UNSIGNED_INT_5_9_9_9_REV&&(j=i.RGB9_E5),V===i.UNSIGNED_INT_10F_11F_11F_REV&&(j=i.R11F_G11F_B10F)),_===i.RGBA){const ne=ue?Kr:ft.getTransfer(Q);V===i.FLOAT&&(j=i.RGBA32F),V===i.HALF_FLOAT&&(j=i.RGBA16F),V===i.UNSIGNED_BYTE&&(j=ne===St?i.SRGB8_ALPHA8:i.RGBA8),V===i.UNSIGNED_SHORT&&ge&&(j=ge.RGBA16_EXT),V===i.SHORT&&ge&&(j=ge.RGBA16_SNORM_EXT),V===i.UNSIGNED_SHORT_4_4_4_4&&(j=i.RGBA4),V===i.UNSIGNED_SHORT_5_5_5_1&&(j=i.RGB5_A1)}return(j===i.R16F||j===i.R32F||j===i.RG16F||j===i.RG32F||j===i.RGBA16F||j===i.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function E(P,_){let V;return P?_===null||_===wn||_===or?V=i.DEPTH24_STENCIL8:_===_n?V=i.DEPTH32F_STENCIL8:_===ar&&(V=i.DEPTH24_STENCIL8,Ye("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===wn||_===or?V=i.DEPTH_COMPONENT24:_===_n?V=i.DEPTH_COMPONENT32F:_===ar&&(V=i.DEPTH_COMPONENT16),V}function M(P,_){return d(P)===!0||P.isFramebufferTexture&&P.minFilter!==Bt&&P.minFilter!==Wt?Math.log2(Math.max(_.width,_.height))+1:P.mipmaps!==void 0&&P.mipmaps.length>0?P.mipmaps.length:P.isCompressedTexture&&Array.isArray(P.image)?_.mipmaps.length:1}function w(P){const _=P.target;_.removeEventListener("dispose",w),S(_),_.isVideoTexture&&h.delete(_),_.isHTMLTexture&&u.delete(_)}function m(P){const _=P.target;_.removeEventListener("dispose",m),R(_)}function S(P){const _=n.get(P);if(_.__webglInit===void 0)return;const V=P.source,X=g.get(V);if(X){const Q=X[_.__cacheKey];Q.usedTimes--,Q.usedTimes===0&&L(P),Object.keys(X).length===0&&g.delete(V)}n.remove(P)}function L(P){const _=n.get(P);i.deleteTexture(_.__webglTexture);const V=P.source,X=g.get(V);delete X[_.__cacheKey],a.memory.textures--}function R(P){const _=n.get(P);if(P.depthTexture&&(P.depthTexture.dispose(),n.remove(P.depthTexture)),P.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(_.__webglFramebuffer[X]))for(let Q=0;Q<_.__webglFramebuffer[X].length;Q++)i.deleteFramebuffer(_.__webglFramebuffer[X][Q]);else i.deleteFramebuffer(_.__webglFramebuffer[X]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[X])}else{if(Array.isArray(_.__webglFramebuffer))for(let X=0;X<_.__webglFramebuffer.length;X++)i.deleteFramebuffer(_.__webglFramebuffer[X]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let X=0;X<_.__webglColorRenderbuffer.length;X++)_.__webglColorRenderbuffer[X]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[X]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const V=P.textures;for(let X=0,Q=V.length;X<Q;X++){const ue=n.get(V[X]);ue.__webglTexture&&(i.deleteTexture(ue.__webglTexture),a.memory.textures--),n.remove(V[X])}n.remove(P)}let U=0;function z(){U=0}function H(){return U}function I(P){U=P}function k(){const P=U;return P>=r.maxTextures&&Ye("WebGLTextures: Trying to use "+P+" texture units while this GPU supports only "+r.maxTextures),U+=1,P}function D(P){const _=[];return _.push(P.wrapS),_.push(P.wrapT),_.push(P.wrapR||0),_.push(P.magFilter),_.push(P.minFilter),_.push(P.anisotropy),_.push(P.internalFormat),_.push(P.format),_.push(P.type),_.push(P.generateMipmaps),_.push(P.premultiplyAlpha),_.push(P.flipY),_.push(P.unpackAlignment),_.push(P.colorSpace),_.join()}function W(P,_){const V=n.get(P);if(P.isVideoTexture&&F(P),P.isRenderTargetTexture===!1&&P.isExternalTexture!==!0&&P.version>0&&V.__version!==P.version){const X=P.image;if(X===null)Ye("WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)Ye("WebGLRenderer: Texture marked for update but image is incomplete");else{Fe(V,P,_);return}}else P.isExternalTexture&&(V.__webglTexture=P.sourceTexture?P.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,V.__webglTexture,i.TEXTURE0+_)}function te(P,_){const V=n.get(P);if(P.isRenderTargetTexture===!1&&P.version>0&&V.__version!==P.version){Fe(V,P,_);return}else P.isExternalTexture&&(V.__webglTexture=P.sourceTexture?P.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,V.__webglTexture,i.TEXTURE0+_)}function oe(P,_){const V=n.get(P);if(P.isRenderTargetTexture===!1&&P.version>0&&V.__version!==P.version){Fe(V,P,_);return}t.bindTexture(i.TEXTURE_3D,V.__webglTexture,i.TEXTURE0+_)}function re(P,_){const V=n.get(P);if(P.isCubeDepthTexture!==!0&&P.version>0&&V.__version!==P.version){Ve(V,P,_);return}t.bindTexture(i.TEXTURE_CUBE_MAP,V.__webglTexture,i.TEXTURE0+_)}const he={[Wr]:i.REPEAT,[Nn]:i.CLAMP_TO_EDGE,[Xr]:i.MIRRORED_REPEAT},We={[Bt]:i.NEAREST,[Rc]:i.NEAREST_MIPMAP_NEAREST,[pr]:i.NEAREST_MIPMAP_LINEAR,[Wt]:i.LINEAR,[as]:i.LINEAR_MIPMAP_NEAREST,[En]:i.LINEAR_MIPMAP_LINEAR},dt={[Dc]:i.NEVER,[Oc]:i.ALWAYS,[Ic]:i.LESS,[za]:i.LEQUAL,[Uc]:i.EQUAL,[Ha]:i.GEQUAL,[Nc]:i.GREATER,[Fc]:i.NOTEQUAL};function Ge(P,_){if(_.type===_n&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===Wt||_.magFilter===as||_.magFilter===pr||_.magFilter===En||_.minFilter===Wt||_.minFilter===as||_.minFilter===pr||_.minFilter===En)&&Ye("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(P,i.TEXTURE_WRAP_S,he[_.wrapS]),i.texParameteri(P,i.TEXTURE_WRAP_T,he[_.wrapT]),(P===i.TEXTURE_3D||P===i.TEXTURE_2D_ARRAY)&&i.texParameteri(P,i.TEXTURE_WRAP_R,he[_.wrapR]),i.texParameteri(P,i.TEXTURE_MAG_FILTER,We[_.magFilter]),i.texParameteri(P,i.TEXTURE_MIN_FILTER,We[_.minFilter]),_.compareFunction&&(i.texParameteri(P,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(P,i.TEXTURE_COMPARE_FUNC,dt[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Bt||_.minFilter!==pr&&_.minFilter!==En||_.type===_n&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const V=e.get("EXT_texture_filter_anisotropic");i.texParameterf(P,V.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,r.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function ee(P,_){let V=!1;P.__webglInit===void 0&&(P.__webglInit=!0,_.addEventListener("dispose",w));const X=_.source;let Q=g.get(X);Q===void 0&&(Q={},g.set(X,Q));const ue=D(_);if(ue!==P.__cacheKey){Q[ue]===void 0&&(Q[ue]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,V=!0),Q[ue].usedTimes++;const ge=Q[P.__cacheKey];ge!==void 0&&(Q[P.__cacheKey].usedTimes--,ge.usedTimes===0&&L(_)),P.__cacheKey=ue,P.__webglTexture=Q[ue].texture}return V}function ce(P,_,V){return Math.floor(Math.floor(P/V)/_)}function J(P,_,V,X){const ue=P.updateRanges;if(ue.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,V,X,_.data);else{ue.sort((Pe,ve)=>Pe.start-ve.start);let ge=0;for(let Pe=1;Pe<ue.length;Pe++){const ve=ue[ge],_e=ue[Pe],Ie=ve.start+ve.count,Oe=ce(_e.start,_.width,4),qe=ce(ve.start,_.width,4);_e.start<=Ie+1&&Oe===qe&&ce(_e.start+_e.count-1,_.width,4)===Oe?ve.count=Math.max(ve.count,_e.start+_e.count-ve.start):(++ge,ue[ge]=_e)}ue.length=ge+1;const j=t.getParameter(i.UNPACK_ROW_LENGTH),ne=t.getParameter(i.UNPACK_SKIP_PIXELS),pe=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let Pe=0,ve=ue.length;Pe<ve;Pe++){const _e=ue[Pe],Ie=Math.floor(_e.start/4),Oe=Math.ceil(_e.count/4),qe=Ie%_.width,N=Math.floor(Ie/_.width),me=Oe,ie=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,qe),t.pixelStorei(i.UNPACK_SKIP_ROWS,N),t.texSubImage2D(i.TEXTURE_2D,0,qe,N,me,ie,V,X,_.data)}P.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,j),t.pixelStorei(i.UNPACK_SKIP_PIXELS,ne),t.pixelStorei(i.UNPACK_SKIP_ROWS,pe)}}function Fe(P,_,V){let X=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(X=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(X=i.TEXTURE_3D);const Q=ee(P,_),ue=_.source;t.bindTexture(X,P.__webglTexture,i.TEXTURE0+V);const ge=n.get(ue);if(ue.version!==ge.__version||Q===!0){if(t.activeTexture(i.TEXTURE0+V),(typeof ImageBitmap<"u"&&_.image instanceof ImageBitmap)===!1){const ie=ft.getPrimaries(ft.workingColorSpace),xe=_.colorSpace===Qn?null:ft.getPrimaries(_.colorSpace),fe=_.colorSpace===Qn||ie===xe?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,fe)}t.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment);let ne=p(_.image,!1,r.maxTextureSize);ne=Nt(_,ne);const pe=s.convert(_.format,_.colorSpace),Pe=s.convert(_.type);let ve=x(_.internalFormat,pe,Pe,_.normalized,_.colorSpace,_.isVideoTexture);Ge(X,_);let _e;const Ie=_.mipmaps,Oe=_.isVideoTexture!==!0,qe=ge.__version===void 0||Q===!0,N=ue.dataReady,me=M(_,ne);if(_.isDepthTexture)ve=E(_.format===fi,_.type),qe&&(Oe?t.texStorage2D(i.TEXTURE_2D,1,ve,ne.width,ne.height):t.texImage2D(i.TEXTURE_2D,0,ve,ne.width,ne.height,0,pe,Pe,null));else if(_.isDataTexture)if(Ie.length>0){Oe&&qe&&t.texStorage2D(i.TEXTURE_2D,me,ve,Ie[0].width,Ie[0].height);for(let ie=0,xe=Ie.length;ie<xe;ie++)_e=Ie[ie],Oe?N&&t.texSubImage2D(i.TEXTURE_2D,ie,0,0,_e.width,_e.height,pe,Pe,_e.data):t.texImage2D(i.TEXTURE_2D,ie,ve,_e.width,_e.height,0,pe,Pe,_e.data);_.generateMipmaps=!1}else Oe?(qe&&t.texStorage2D(i.TEXTURE_2D,me,ve,ne.width,ne.height),N&&J(_,ne,pe,Pe)):t.texImage2D(i.TEXTURE_2D,0,ve,ne.width,ne.height,0,pe,Pe,ne.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){Oe&&qe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,me,ve,Ie[0].width,Ie[0].height,ne.depth);for(let ie=0,xe=Ie.length;ie<xe;ie++)if(_e=Ie[ie],_.format!==Qt)if(pe!==null)if(Oe){if(N)if(_.layerUpdates.size>0){const fe=Vo(_e.width,_e.height,_.format,_.type);for(const se of _.layerUpdates){const Te=_e.data.subarray(se*fe/_e.data.BYTES_PER_ELEMENT,(se+1)*fe/_e.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ie,0,0,se,_e.width,_e.height,1,pe,Te)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ie,0,0,0,_e.width,_e.height,ne.depth,pe,_e.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,ie,ve,_e.width,_e.height,ne.depth,0,_e.data,0,0);else Ye("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Oe?N&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,ie,0,0,0,_e.width,_e.height,ne.depth,pe,Pe,_e.data):t.texImage3D(i.TEXTURE_2D_ARRAY,ie,ve,_e.width,_e.height,ne.depth,0,pe,Pe,_e.data)}else{Oe&&qe&&t.texStorage2D(i.TEXTURE_2D,me,ve,Ie[0].width,Ie[0].height);for(let ie=0,xe=Ie.length;ie<xe;ie++)_e=Ie[ie],_.format!==Qt?pe!==null?Oe?N&&t.compressedTexSubImage2D(i.TEXTURE_2D,ie,0,0,_e.width,_e.height,pe,_e.data):t.compressedTexImage2D(i.TEXTURE_2D,ie,ve,_e.width,_e.height,0,_e.data):Ye("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Oe?N&&t.texSubImage2D(i.TEXTURE_2D,ie,0,0,_e.width,_e.height,pe,Pe,_e.data):t.texImage2D(i.TEXTURE_2D,ie,ve,_e.width,_e.height,0,pe,Pe,_e.data)}else if(_.isDataArrayTexture)if(Oe){if(qe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,me,ve,ne.width,ne.height,ne.depth),N)if(_.layerUpdates.size>0){const ie=Vo(ne.width,ne.height,_.format,_.type);for(const xe of _.layerUpdates){const fe=ne.data.subarray(xe*ie/ne.data.BYTES_PER_ELEMENT,(xe+1)*ie/ne.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,xe,ne.width,ne.height,1,pe,Pe,fe)}_.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,ne.width,ne.height,ne.depth,pe,Pe,ne.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,ve,ne.width,ne.height,ne.depth,0,pe,Pe,ne.data);else if(_.isData3DTexture)Oe?(qe&&t.texStorage3D(i.TEXTURE_3D,me,ve,ne.width,ne.height,ne.depth),N&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,ne.width,ne.height,ne.depth,pe,Pe,ne.data)):t.texImage3D(i.TEXTURE_3D,0,ve,ne.width,ne.height,ne.depth,0,pe,Pe,ne.data);else if(_.isFramebufferTexture){if(qe)if(Oe)t.texStorage2D(i.TEXTURE_2D,me,ve,ne.width,ne.height);else{let ie=ne.width,xe=ne.height;for(let fe=0;fe<me;fe++)t.texImage2D(i.TEXTURE_2D,fe,ve,ie,xe,0,pe,Pe,null),ie>>=1,xe>>=1}}else if(_.isHTMLTexture){if("texElementImage2D"in i){const ie=i.canvas;if(ie.hasAttribute("layoutsubtree")||ie.setAttribute("layoutsubtree","true"),ne.parentNode!==ie){ie.appendChild(ne),u.add(_),ie.onpaint=xe=>{const fe=xe.changedElements;for(const se of u)fe.includes(se.image)&&(se.needsUpdate=!0)},ie.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,ne);else{const fe=i.RGBA,se=i.RGBA,Te=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,fe,se,Te,ne)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Ie.length>0){if(Oe&&qe){const ie=it(Ie[0]);t.texStorage2D(i.TEXTURE_2D,me,ve,ie.width,ie.height)}for(let ie=0,xe=Ie.length;ie<xe;ie++)_e=Ie[ie],Oe?N&&t.texSubImage2D(i.TEXTURE_2D,ie,0,0,pe,Pe,_e):t.texImage2D(i.TEXTURE_2D,ie,ve,pe,Pe,_e);_.generateMipmaps=!1}else if(Oe){if(qe){const ie=it(ne);t.texStorage2D(i.TEXTURE_2D,me,ve,ie.width,ie.height)}N&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,pe,Pe,ne)}else t.texImage2D(i.TEXTURE_2D,0,ve,pe,Pe,ne);d(_)&&b(X),ge.__version=ue.version,_.onUpdate&&_.onUpdate(_)}P.__version=_.version}function Ve(P,_,V){if(_.image.length!==6)return;const X=ee(P,_),Q=_.source;t.bindTexture(i.TEXTURE_CUBE_MAP,P.__webglTexture,i.TEXTURE0+V);const ue=n.get(Q);if(Q.version!==ue.__version||X===!0){t.activeTexture(i.TEXTURE0+V);const ge=ft.getPrimaries(ft.workingColorSpace),j=_.colorSpace===Qn?null:ft.getPrimaries(_.colorSpace),ne=_.colorSpace===Qn||ge===j?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ne);const pe=_.isCompressedTexture||_.image[0].isCompressedTexture,Pe=_.image[0]&&_.image[0].isDataTexture,ve=[];for(let se=0;se<6;se++)!pe&&!Pe?ve[se]=p(_.image[se],!0,r.maxCubemapSize):ve[se]=Pe?_.image[se].image:_.image[se],ve[se]=Nt(_,ve[se]);const _e=ve[0],Ie=s.convert(_.format,_.colorSpace),Oe=s.convert(_.type),qe=x(_.internalFormat,Ie,Oe,_.normalized,_.colorSpace),N=_.isVideoTexture!==!0,me=ue.__version===void 0||X===!0,ie=Q.dataReady;let xe=M(_,_e);Ge(i.TEXTURE_CUBE_MAP,_);let fe;if(pe){N&&me&&t.texStorage2D(i.TEXTURE_CUBE_MAP,xe,qe,_e.width,_e.height);for(let se=0;se<6;se++){fe=ve[se].mipmaps;for(let Te=0;Te<fe.length;Te++){const we=fe[Te];_.format!==Qt?Ie!==null?N?ie&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,Te,0,0,we.width,we.height,Ie,we.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,Te,qe,we.width,we.height,0,we.data):Ye("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,Te,0,0,we.width,we.height,Ie,Oe,we.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,Te,qe,we.width,we.height,0,Ie,Oe,we.data)}}}else{if(fe=_.mipmaps,N&&me){fe.length>0&&xe++;const se=it(ve[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,xe,qe,se.width,se.height)}for(let se=0;se<6;se++)if(Pe){N?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,0,0,ve[se].width,ve[se].height,Ie,Oe,ve[se].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,qe,ve[se].width,ve[se].height,0,Ie,Oe,ve[se].data);for(let Te=0;Te<fe.length;Te++){const Et=fe[Te].image[se].image;N?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,Te+1,0,0,Et.width,Et.height,Ie,Oe,Et.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,Te+1,qe,Et.width,Et.height,0,Ie,Oe,Et.data)}}else{N?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,0,0,Ie,Oe,ve[se]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,qe,Ie,Oe,ve[se]);for(let Te=0;Te<fe.length;Te++){const we=fe[Te];N?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,Te+1,0,0,Ie,Oe,we.image[se]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,Te+1,qe,Ie,Oe,we.image[se])}}}d(_)&&b(i.TEXTURE_CUBE_MAP),ue.__version=Q.version,_.onUpdate&&_.onUpdate(_)}P.__version=_.version}function De(P,_,V,X,Q,ue){const ge=s.convert(V.format,V.colorSpace),j=s.convert(V.type),ne=x(V.internalFormat,ge,j,V.normalized,V.colorSpace),pe=n.get(_),Pe=n.get(V);if(Pe.__renderTarget=_,!pe.__hasExternalTextures){const ve=Math.max(1,_.width>>ue),_e=Math.max(1,_.height>>ue);Q===i.TEXTURE_3D||Q===i.TEXTURE_2D_ARRAY?t.texImage3D(Q,ue,ne,ve,_e,_.depth,0,ge,j,null):t.texImage2D(Q,ue,ne,ve,_e,0,ge,j,null)}t.bindFramebuffer(i.FRAMEBUFFER,P),vt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,X,Q,Pe.__webglTexture,0,ct(_)):(Q===i.TEXTURE_2D||Q>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Q<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,X,Q,Pe.__webglTexture,ue),t.bindFramebuffer(i.FRAMEBUFFER,null)}function pt(P,_,V){if(i.bindRenderbuffer(i.RENDERBUFFER,P),_.depthBuffer){const X=_.depthTexture,Q=X&&X.isDepthTexture?X.type:null,ue=E(_.stencilBuffer,Q),ge=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;vt(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ct(_),ue,_.width,_.height):V?i.renderbufferStorageMultisample(i.RENDERBUFFER,ct(_),ue,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,ue,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,ge,i.RENDERBUFFER,P)}else{const X=_.textures;for(let Q=0;Q<X.length;Q++){const ue=X[Q],ge=s.convert(ue.format,ue.colorSpace),j=s.convert(ue.type),ne=x(ue.internalFormat,ge,j,ue.normalized,ue.colorSpace);vt(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ct(_),ne,_.width,_.height):V?i.renderbufferStorageMultisample(i.RENDERBUFFER,ct(_),ne,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,ne,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Xe(P,_,V){const X=_.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,P),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const Q=n.get(_.depthTexture);if(Q.__renderTarget=_,(!Q.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),X){if(Q.__webglInit===void 0&&(Q.__webglInit=!0,_.depthTexture.addEventListener("dispose",w)),Q.__webglTexture===void 0){Q.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,Q.__webglTexture),Ge(i.TEXTURE_CUBE_MAP,_.depthTexture);const pe=s.convert(_.depthTexture.format),Pe=s.convert(_.depthTexture.type);let ve;_.depthTexture.format===kn?ve=i.DEPTH_COMPONENT24:_.depthTexture.format===fi&&(ve=i.DEPTH24_STENCIL8);for(let _e=0;_e<6;_e++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_e,0,ve,_.width,_.height,0,pe,Pe,null)}}else W(_.depthTexture,0);const ue=Q.__webglTexture,ge=ct(_),j=X?i.TEXTURE_CUBE_MAP_POSITIVE_X+V:i.TEXTURE_2D,ne=_.depthTexture.format===fi?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(_.depthTexture.format===kn)vt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ne,j,ue,0,ge):i.framebufferTexture2D(i.FRAMEBUFFER,ne,j,ue,0);else if(_.depthTexture.format===fi)vt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ne,j,ue,0,ge):i.framebufferTexture2D(i.FRAMEBUFFER,ne,j,ue,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function je(P){const _=n.get(P),V=P.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==P.depthTexture){const X=P.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),X){const Q=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,X.removeEventListener("dispose",Q)};X.addEventListener("dispose",Q),_.__depthDisposeCallback=Q}_.__boundDepthTexture=X}if(P.depthTexture&&!_.__autoAllocateDepthBuffer)if(V)for(let X=0;X<6;X++)Xe(_.__webglFramebuffer[X],P,X);else{const X=P.texture.mipmaps;X&&X.length>0?Xe(_.__webglFramebuffer[0],P,0):Xe(_.__webglFramebuffer,P,0)}else if(V){_.__webglDepthbuffer=[];for(let X=0;X<6;X++)if(t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[X]),_.__webglDepthbuffer[X]===void 0)_.__webglDepthbuffer[X]=i.createRenderbuffer(),pt(_.__webglDepthbuffer[X],P,!1);else{const Q=P.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ue=_.__webglDepthbuffer[X];i.bindRenderbuffer(i.RENDERBUFFER,ue),i.framebufferRenderbuffer(i.FRAMEBUFFER,Q,i.RENDERBUFFER,ue)}}else{const X=P.texture.mipmaps;if(X&&X.length>0?t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),pt(_.__webglDepthbuffer,P,!1);else{const Q=P.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ue=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ue),i.framebufferRenderbuffer(i.FRAMEBUFFER,Q,i.RENDERBUFFER,ue)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Je(P,_,V){const X=n.get(P);_!==void 0&&De(X.__webglFramebuffer,P,P.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),V!==void 0&&je(P)}function et(P){const _=P.texture,V=n.get(P),X=n.get(_);P.addEventListener("dispose",m);const Q=P.textures,ue=P.isWebGLCubeRenderTarget===!0,ge=Q.length>1;if(ge||(X.__webglTexture===void 0&&(X.__webglTexture=i.createTexture()),X.__version=_.version,a.memory.textures++),ue){V.__webglFramebuffer=[];for(let j=0;j<6;j++)if(_.mipmaps&&_.mipmaps.length>0){V.__webglFramebuffer[j]=[];for(let ne=0;ne<_.mipmaps.length;ne++)V.__webglFramebuffer[j][ne]=i.createFramebuffer()}else V.__webglFramebuffer[j]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){V.__webglFramebuffer=[];for(let j=0;j<_.mipmaps.length;j++)V.__webglFramebuffer[j]=i.createFramebuffer()}else V.__webglFramebuffer=i.createFramebuffer();if(ge)for(let j=0,ne=Q.length;j<ne;j++){const pe=n.get(Q[j]);pe.__webglTexture===void 0&&(pe.__webglTexture=i.createTexture(),a.memory.textures++)}if(P.samples>0&&vt(P)===!1){V.__webglMultisampledFramebuffer=i.createFramebuffer(),V.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,V.__webglMultisampledFramebuffer);for(let j=0;j<Q.length;j++){const ne=Q[j];V.__webglColorRenderbuffer[j]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,V.__webglColorRenderbuffer[j]);const pe=s.convert(ne.format,ne.colorSpace),Pe=s.convert(ne.type),ve=x(ne.internalFormat,pe,Pe,ne.normalized,ne.colorSpace,P.isXRRenderTarget===!0),_e=ct(P);i.renderbufferStorageMultisample(i.RENDERBUFFER,_e,ve,P.width,P.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+j,i.RENDERBUFFER,V.__webglColorRenderbuffer[j])}i.bindRenderbuffer(i.RENDERBUFFER,null),P.depthBuffer&&(V.__webglDepthRenderbuffer=i.createRenderbuffer(),pt(V.__webglDepthRenderbuffer,P,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ue){t.bindTexture(i.TEXTURE_CUBE_MAP,X.__webglTexture),Ge(i.TEXTURE_CUBE_MAP,_);for(let j=0;j<6;j++)if(_.mipmaps&&_.mipmaps.length>0)for(let ne=0;ne<_.mipmaps.length;ne++)De(V.__webglFramebuffer[j][ne],P,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+j,ne);else De(V.__webglFramebuffer[j],P,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0);d(_)&&b(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ge){for(let j=0,ne=Q.length;j<ne;j++){const pe=Q[j],Pe=n.get(pe);let ve=i.TEXTURE_2D;(P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(ve=P.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ve,Pe.__webglTexture),Ge(ve,pe),De(V.__webglFramebuffer,P,pe,i.COLOR_ATTACHMENT0+j,ve,0),d(pe)&&b(ve)}t.unbindTexture()}else{let j=i.TEXTURE_2D;if((P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(j=P.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(j,X.__webglTexture),Ge(j,_),_.mipmaps&&_.mipmaps.length>0)for(let ne=0;ne<_.mipmaps.length;ne++)De(V.__webglFramebuffer[ne],P,_,i.COLOR_ATTACHMENT0,j,ne);else De(V.__webglFramebuffer,P,_,i.COLOR_ATTACHMENT0,j,0);d(_)&&b(j),t.unbindTexture()}P.depthBuffer&&je(P)}function Tt(P){const _=P.textures;for(let V=0,X=_.length;V<X;V++){const Q=_[V];if(d(Q)){const ue=C(P),ge=n.get(Q).__webglTexture;t.bindTexture(ue,ge),b(ue),t.unbindTexture()}}}const yt=[],Lt=[];function xt(P){if(P.samples>0){if(vt(P)===!1){const _=P.textures,V=P.width,X=P.height;let Q=i.COLOR_BUFFER_BIT;const ue=P.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ge=n.get(P),j=_.length>1;if(j)for(let pe=0;pe<_.length;pe++)t.bindFramebuffer(i.FRAMEBUFFER,ge.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+pe,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,ge.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+pe,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,ge.__webglMultisampledFramebuffer);const ne=P.texture.mipmaps;ne&&ne.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ge.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ge.__webglFramebuffer);for(let pe=0;pe<_.length;pe++){if(P.resolveDepthBuffer&&(P.depthBuffer&&(Q|=i.DEPTH_BUFFER_BIT),P.stencilBuffer&&P.resolveStencilBuffer&&(Q|=i.STENCIL_BUFFER_BIT)),j){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ge.__webglColorRenderbuffer[pe]);const Pe=n.get(_[pe]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Pe,0)}i.blitFramebuffer(0,0,V,X,0,0,V,X,Q,i.NEAREST),l===!0&&(yt.length=0,Lt.length=0,yt.push(i.COLOR_ATTACHMENT0+pe),P.depthBuffer&&P.resolveDepthBuffer===!1&&(yt.push(ue),Lt.push(ue),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Lt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,yt))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),j)for(let pe=0;pe<_.length;pe++){t.bindFramebuffer(i.FRAMEBUFFER,ge.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+pe,i.RENDERBUFFER,ge.__webglColorRenderbuffer[pe]);const Pe=n.get(_[pe]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,ge.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+pe,i.TEXTURE_2D,Pe,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ge.__webglMultisampledFramebuffer)}else if(P.depthBuffer&&P.resolveDepthBuffer===!1&&l){const _=P.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function ct(P){return Math.min(r.maxSamples,P.samples)}function vt(P){const _=n.get(P);return P.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function F(P){const _=a.render.frame;h.get(P)!==_&&(h.set(P,_),P.update())}function Nt(P,_){const V=P.colorSpace,X=P.format,Q=P.type;return P.isCompressedTexture===!0||P.isVideoTexture===!0||V!==$r&&V!==Qn&&(ft.getTransfer(V)===St?(X!==Qt||Q!==ln)&&Ye("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):ht("WebGLTextures: Unsupported texture color space:",V)),_}function it(P){return typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement?(c.width=P.naturalWidth||P.width,c.height=P.naturalHeight||P.height):typeof VideoFrame<"u"&&P instanceof VideoFrame?(c.width=P.displayWidth,c.height=P.displayHeight):(c.width=P.width,c.height=P.height),c}this.allocateTextureUnit=k,this.resetTextureUnits=z,this.getTextureUnits=H,this.setTextureUnits=I,this.setTexture2D=W,this.setTexture2DArray=te,this.setTexture3D=oe,this.setTextureCube=re,this.rebindTextures=Je,this.setupRenderTarget=et,this.updateRenderTargetMipmap=Tt,this.updateMultisampleRenderTarget=xt,this.setupDepthRenderbuffer=je,this.setupFrameBufferTexture=De,this.useMultisampledRTT=vt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Lm(i,e){function t(n,r=Qn){let s;const a=ft.getTransfer(r);if(n===ln)return i.UNSIGNED_BYTE;if(n===Ia)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Ua)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Al)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===wl)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===bl)return i.BYTE;if(n===Tl)return i.SHORT;if(n===ar)return i.UNSIGNED_SHORT;if(n===Da)return i.INT;if(n===wn)return i.UNSIGNED_INT;if(n===_n)return i.FLOAT;if(n===Hn)return i.HALF_FLOAT;if(n===Cl)return i.ALPHA;if(n===Rl)return i.RGB;if(n===Qt)return i.RGBA;if(n===kn)return i.DEPTH_COMPONENT;if(n===fi)return i.DEPTH_STENCIL;if(n===Na)return i.RED;if(n===Fa)return i.RED_INTEGER;if(n===hi)return i.RG;if(n===Oa)return i.RG_INTEGER;if(n===Ba)return i.RGBA_INTEGER;if(n===zr||n===Hr||n===kr||n===Gr)if(a===St)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===zr)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Hr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===kr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Gr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===zr)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Hr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===kr)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Gr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Zs||n===Js||n===Qs||n===js)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Zs)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Js)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Qs)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===js)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ea||n===ta||n===na||n===ia||n===ra||n===qr||n===sa)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===ea||n===ta)return a===St?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===na)return a===St?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===ia)return s.COMPRESSED_R11_EAC;if(n===ra)return s.COMPRESSED_SIGNED_R11_EAC;if(n===qr)return s.COMPRESSED_RG11_EAC;if(n===sa)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===aa||n===oa||n===la||n===ca||n===ua||n===fa||n===da||n===ha||n===pa||n===ma||n===ga||n===_a||n===xa||n===va)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===aa)return a===St?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===oa)return a===St?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===la)return a===St?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===ca)return a===St?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ua)return a===St?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===fa)return a===St?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===da)return a===St?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===ha)return a===St?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===pa)return a===St?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===ma)return a===St?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===ga)return a===St?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===_a)return a===St?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===xa)return a===St?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===va)return a===St?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ma||n===Sa||n===ya)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===Ma)return a===St?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Sa)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===ya)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Ea||n===ba||n===Yr||n===Ta)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===Ea)return s.COMPRESSED_RED_RGTC1_EXT;if(n===ba)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Yr)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Ta)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===or?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const Dm=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
...
}`;class Um{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new Ol(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new Cn({vertexShader:Dm,fragmentShader:Im,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new cn(new Vi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Nm extends pi{constructor(e,t){super();const n=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,h=null,u=null,f=null,g=null,v=null;const T=typeof XRWebGLBinding<"u",p=new Um,d={},b=t.getContextAttributes();let C=null,x=null;const E=[],M=[],w=new st;let m=null;const S=new dn;S.viewport=new It;const L=new dn;L.viewport=new It;const R=[S,L],U=new Wu;let z=null,H=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(ee){let ce=E[ee];return ce===void 0&&(ce=new hs,E[ee]=ce),ce.getTargetRaySpace()},this.getControllerGrip=function(ee){let ce=E[ee];return ce===void 0&&(ce=new hs,E[ee]=ce),ce.getGripSpace()},this.getHand=function(ee){let ce=E[ee];return ce===void 0&&(ce=new hs,E[ee]=ce),ce.getHandSpace()};function I(ee){const ce=M.indexOf(ee.inputSource);if(ce===-1)return;const J=E[ce];J!==void 0&&(J.update(ee.inputSource,ee.frame,c||a),J.dispatchEvent({type:ee.type,data:ee.inputSource}))}function k(){r.removeEventListener("select",I),r.removeEventListener("selectstart",I),r.removeEventListener("selectend",I),r.removeEventListener("squeeze",I),r.removeEventListener("squeezestart",I),r.removeEventListener("squeezeend",I),r.removeEventListener("end",k),r.removeEventListener("inputsourceschange",D);for(let ee=0;ee<E.length;ee++){const ce=M[ee];ce!==null&&(M[ee]=null,E[ee].disconnect(ce))}z=null,H=null,p.reset();for(const ee in d)delete d[ee];e.setRenderTarget(C),g=null,f=null,u=null,r=null,x=null,Ge.stop(),n.isPresenting=!1,e.setPixelRatio(m),e.setSize(w.width,w.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(ee){s=ee,n.isPresenting===!0&&Ye("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(ee){o=ee,n.isPresenting===!0&&Ye("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(ee){c=ee},this.getBaseLayer=function(){return f!==null?f:g},this.getBinding=function(){return u===null&&T&&(u=new XRWebGLBinding(r,t)),u},this.getFrame=function(){return v},this.getSession=function(){return r},this.setSession=async function(ee){if(r=ee,r!==null){if(C=e.getRenderTarget(),r.addEventListener("select",I),r.addEventListener("selectstart",I),r.addEventListener("selectend",I),r.addEventListener("squeeze",I),r.addEventListener("squeezestart",I),r.addEventListener("squeezeend",I),r.addEventListener("end",k),r.addEventListener("inputsourceschange",D),b.xrCompatible!==!0&&await t.makeXRCompatible(),m=e.getPixelRatio(),e.getSize(w),T&&"createProjectionLayer"in XRWebGLBinding.prototype){let J=null,Fe=null,Ve=null;b.depth&&(Ve=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,J=b.stencil?fi:kn,Fe=b.stencil?or:wn);const De={colorFormat:t.RGBA8,depthFormat:Ve,scaleFactor:s};u=this.getBinding(),f=u.createProjectionLayer(De),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),x=new An(f.textureWidth,f.textureHeight,{format:Qt,type:ln,depthTexture:new Gi(f.textureWidth,f.textureHeight,Fe,void 0,void 0,void 0,void 0,void 0,void 0,J),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{const J={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:s};g=new XRWebGLLayer(r,t,J),r.updateRenderState({baseLayer:g}),e.setPixelRatio(1),e.setSize(g.framebufferWidth,g.framebufferHeight,!1),x=new An(g.framebufferWidth,g.framebufferHeight,{format:Qt,type:ln,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:g.ignoreDepthValues===!1,resolveStencilBuffer:g.ignoreDepthValues===!1})}x.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),Ge.setContext(r),Ge.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return p.getDepthTexture()};function D(ee){for(let ce=0;ce<ee.removed.length;ce++){const J=ee.removed[ce],Fe=M.indexOf(J);Fe>=0&&(M[Fe]=null,E[Fe].disconnect(J))}for(let ce=0;ce<ee.added.length;ce++){const J=ee.added[ce];let Fe=M.indexOf(J);if(Fe===-1){for(let De=0;De<E.length;De++)if(De>=M.length){M.push(J),Fe=De;break}else if(M[De]===null){M[De]=J,Fe=De;break}if(Fe===-1)break}const Ve=E[Fe];Ve&&Ve.connect(J)}}const W=new Y,te=new Y;function oe(ee,ce,J){W.setFromMatrixPosition(ce.matrixWorld),te.setFromMatrixPosition(J.matrixWorld);const Fe=W.distanceTo(te),Ve=ce.projectionMatrix.elements,De=J.projectionMatrix.elements,pt=Ve[14]/(Ve[10]-1),Xe=Ve[14]/(Ve[10]+1),je=(Ve[9]+1)/Ve[5],Je=(Ve[9]-1)/Ve[5],et=(Ve[8]-1)/Ve[0],Tt=(De[8]+1)/De[0],yt=pt*et,Lt=pt*Tt,xt=Fe/(-et+Tt),ct=xt*-et;if(ce.matrixWorld.decompose(ee.position,ee.quaternion,ee.scale),ee.translateX(ct),ee.translateZ(xt),ee.matrixWorld.compose(ee.position,ee.quaternion,ee.scale),ee.matrixWorldInverse.copy(ee.matrixWorld).invert(),Ve[10]===-1)ee.projectionMatrix.copy(ce.projectionMatrix),ee.projectionMatrixInverse.copy(ce.projectionMatrixInverse);else{const vt=pt+xt,F=Xe+xt,Nt=yt-ct,it=Lt+(Fe-ct),P=je*Xe/F*vt,_=Je*Xe/F*vt;ee.projectionMatrix.makePerspective(Nt,it,P,_,vt,F),ee.projectionMatrixInverse.copy(ee.projectionMatrix).invert()}}function re(ee,ce){ce===null?ee.matrixWorld.copy(ee.matrix):ee.matrixWorld.multiplyMatrices(ce.matrixWorld,ee.matrix),ee.matrixWorldInverse.copy(ee.matrixWorld).invert()}this.updateCamera=function(ee){if(r===null)return;let ce=ee.near,J=ee.far;p.texture!==null&&(p.depthNear>0&&(ce=p.depthNear),p.depthFar>0&&(J=p.depthFar)),U.near=L.near=S.near=ce,U.far=L.far=S.far=J,(z!==U.near||H!==U.far)&&(r.updateRenderState({depthNear:U.near,depthFar:U.far}),z=U.near,H=U.far),U.layers.mask=ee.layers.mask|6,S.layers.mask=U.layers.mask&-5,L.layers.mask=U.layers.mask&-3;const Fe=ee.parent,Ve=U.cameras;re(U,Fe);for(let De=0;De<Ve.length;De++)re(Ve[De],Fe);Ve.length===2?oe(U,S,L):U.projectionMatrix.copy(S.projectionMatrix),he(ee,U,Fe)};function he(ee,ce,J){J===null?ee.matrix.copy(ce.matrixWorld):(ee.matrix.copy(J.matrixWorld),ee.matrix.invert(),ee.matrix.multiply(ce.matrixWorld)),ee.matrix.decompose(ee.position,ee.quaternion,ee.scale),ee.updateMatrixWorld(!0),ee.projectionMatrix.copy(ce.projectionMatrix),ee.projectionMatrixInverse.copy(ce.projectionMatrixInverse),ee.isPerspectiveCamera&&(ee.fov=ur*2*Math.atan(1/ee.projectionMatrix.elements[5]),ee.zoom=1)}this.getCamera=function(){return U},this.getFoveation=function(){if(!(f===null&&g===null))return l},this.setFoveation=function(ee){l=ee,f!==null&&(f.fixedFoveation=ee),g!==null&&g.fixedFoveation!==void 0&&(g.fixedFoveation=ee)},this.hasDepthSensing=function(){return p.texture!==null},this.getDepthSensingMesh=function(){return p.getMesh(U)},this.getCameraTexture=function(ee){return d[ee]};let We=null;function dt(ee,ce){if(h=ce.getViewerPose(c||a),v=ce,h!==null){const J=h.views;g!==null&&(e.setRenderTargetFramebuffer(x,g.framebuffer),e.setRenderTarget(x));let Fe=!1;J.length!==U.cameras.length&&(U.cameras.length=0,Fe=!0);for(let Xe=0;Xe<J.length;Xe++){const je=J[Xe];let Je=null;if(g!==null)Je=g.getViewport(je);else{const Tt=u.getViewSubImage(f,je);Je=Tt.viewport,Xe===0&&(e.setRenderTargetTextures(x,Tt.colorTexture,Tt.depthStencilTexture),e.setRenderTarget(x))}let et=R[Xe];et===void 0&&(et=new dn,et.layers.enable(Xe),et.viewport=new It,R[Xe]=et),et.matrix.fromArray(je.transform.matrix),et.matrix.decompose(et.position,et.quaternion,et.scale),et.projectionMatrix.fromArray(je.projectionMatrix),et.projectionMatrixInverse.copy(et.projectionMatrix).invert(),et.viewport.set(Je.x,Je.y,Je.width,Je.height),Xe===0&&(U.matrix.copy(et.matrix),U.matrix.decompose(U.position,U.quaternion,U.scale)),Fe===!0&&U.cameras.push(et)}const Ve=r.enabledFeatures;if(Ve&&Ve.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&T){u=n.getBinding();const Xe=u.getDepthInformation(J[0]);Xe&&Xe.isValid&&Xe.texture&&p.init(Xe,r.renderState)}if(Ve&&Ve.includes("camera-access")&&T){e.state.unbindTexture(),u=n.getBinding();for(let Xe=0;Xe<J.length;Xe++){const je=J[Xe].camera;if(je){let Je=d[je];Je||(Je=new Ol,d[je]=Je);const et=u.getCameraImage(je);Je.sourceTexture=et}}}}for(let J=0;J<E.length;J++){const Fe=M[J],Ve=E[J];Fe!==null&&Ve!==void 0&&Ve.update(Fe,ce,c||a)}We&&We(ee,ce),ce.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:ce}),v=null}const Ge=new Gl;Ge.setAnimationLoop(dt),this.setAnimationLoop=function(ee){We=ee},this.dispose=function(){}}}const Fm=new Ct,Kl=new Ze;Kl.set(-1,0,0,0,1,0,0,0,1);function Om(i,e){function t(p,d){p.matrixAutoUpdate===!0&&p.updateMatrix(),d.value.copy(p.matrix)}function n(p,d){d.color.getRGB(p.fogColor.value,Bl(i)),d.isFog?(p.fogNear.value=d.near,p.fogFar.value=d.far):d.isFogExp2&&(p.fogDensity.value=d.density)}function r(p,d,b,C,x){d.isNodeMaterial?d.uniformsNeedUpdate=!1:d.isMeshBasicMaterial?s(p,d):d.isMeshLambertMaterial?(s(p,d),d.envMap&&(p.envMapIntensity.value=d.envMapIntensity)):d.isMeshToonMaterial?(s(p,d),u(p,d)):d.isMeshPhongMaterial?(s(p,d),h(p,d),d.envMap&&(p.envMapIntensity.value=d.envMapIntensity)):d.isMeshStandardMaterial?(s(p,d),f(p,d),d.isMeshPhysicalMaterial&&g(p,d,x)):d.isMeshMatcapMaterial?(s(p,d),v(p,d)):d.isMeshDepthMaterial?s(p,d):d.isMeshDistanceMaterial?(s(p,d),T(p,d)):d.isMeshNormalMaterial?s(p,d):d.isLineBasicMaterial?(a(p,d),d.isLineDashedMaterial&&o(p,d)):d.isPointsMaterial?l(p,d,b,C):d.isSpriteMaterial?c(p,d):d.isShadowMaterial?(p.color.value.copy(d.color),p.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(p,d){p.opacity.value=d.opacity,d.color&&p.diffuse.value.copy(d.color),d.emissive&&p.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(p.map.value=d.map,t(d.map,p.mapTransform)),d.alphaMap&&(p.alphaMap.value=d.alphaMap,t(d.alphaMap,p.alphaMapTransform)),d.bumpMap&&(p.bumpMap.value=d.bumpMap,t(d.bumpMap,p.bumpMapTransform),p.bumpScale.value=d.bumpScale,d.side===nn&&(p.bumpScale.value*=-1)),d.normalMap&&(p.normalMap.value=d.normalMap,t(d.normalMap,p.normalMapTransform),p.normalScale.value.copy(d.normalScale),d.side===nn&&p.normalScale.value.negate()),d.displacementMap&&(p.displacementMap.value=d.displacementMap,t(d.displacementMap,p.displacementMapTransform),p.displacementScale.value=d.displacementScale,p.displacementBias.value=d.displacementBias),d.emissiveMap&&(p.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,p.emissiveMapTransform)),d.specularMap&&(p.specularMap.value=d.specularMap,t(d.specularMap,p.specularMapTransform)),d.alphaTest>0&&(p.alphaTest.value=d.alphaTest);const b=e.get(d),C=b.envMap,x=b.envMapRotation;C&&(p.envMap.value=C,p.envMapRotation.value.setFromMatrix4(Fm.makeRotationFromEuler(x)).transpose(),C.isCubeTexture&&C.isRenderTargetTexture===!1&&p.envMapRotation.value.premultiply(Kl),p.reflectivity.value=d.reflectivity,p.ior.value=d.ior,p.refractionRatio.value=d.refractionRatio),d.lightMap&&(p.lightMap.value=d.lightMap,p.lightMapIntensity.value=d.lightMapIntensity,t(d.lightMap,p.lightMapTransform)),d.aoMap&&(p.aoMap.value=d.aoMap,p.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,p.aoMapTransform))}function a(p,d){p.diffuse.value.copy(d.color),p.opacity.value=d.opacity,d.map&&(p.map.value=d.map,t(d.map,p.mapTransform))}function o(p,d){p.dashSize.value=d.dashSize,p.totalSize.value=d.dashSize+d.gapSize,p.scale.value=d.scale}function l(p,d,b,C){p.diffuse.value.copy(d.color),p.opacity.value=d.opacity,p.size.value=d.size*b,p.scale.value=C*.5,d.map&&(p.map.value=d.map,t(d.map,p.uvTransform)),d.alphaMap&&(p.alphaMap.value=d.alphaMap,t(d.alphaMap,p.alphaMapTransform)),d.alphaTest>0&&(p.alphaTest.value=d.alphaTest)}function c(p,d){p.diffuse.value.copy(d.color),p.opacity.value=d.opacity,p.rotation.value=d.rotation,d.map&&(p.map.value=d.map,t(d.map,p.mapTransform)),d.alphaMap&&(p.alphaMap.value=d.alphaMap,t(d.alphaMap,p.alphaMapTransform)),d.alphaTest>0&&(p.alphaTest.value=d.alphaTest)}function h(p,d){p.specular.value.copy(d.specular),p.shininess.value=Math.max(d.shininess,1e-4)}function u(p,d){d.gradientMap&&(p.gradientMap.value=d.gradientMap)}function f(p,d){p.metalness.value=d.metalness,d.metalnessMap&&(p.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,p.metalnessMapTransform)),p.roughness.value=d.roughness,d.roughnessMap&&(p.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,p.roughnessMapTransform)),d.envMap&&(p.envMapIntensity.value=d.envMapIntensity)}function g(p,d,b){p.ior.value=d.ior,d.sheen>0&&(p.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),p.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(p.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,p.sheenColorMapTransform)),d.sheenRoughnessMap&&(p.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,p.sheenRoughnessMapTransform))),d.clearcoat>0&&(p.clearcoat.value=d.clearcoat,p.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(p.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,p.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(p.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===nn&&p.clearcoatNormalScale.value.negate())),d.dispersion>0&&(p.dispersion.value=d.dispersion),d.iridescence>0&&(p.iridescence.value=d.iridescence,p.iridescenceIOR.value=d.iridescenceIOR,p.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(p.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,p.iridescenceMapTransform)),d.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),d.transmission>0&&(p.transmission.value=d.transmission,p.transmissionSamplerMap.value=b.texture,p.transmissionSamplerSize.value.set(b.width,b.height),d.transmissionMap&&(p.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,p.transmissionMapTransform)),p.thickness.value=d.thickness,d.thicknessMap&&(p.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=d.attenuationDistance,p.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(p.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(p.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=d.specularIntensity,p.specularColor.value.copy(d.specularColor),d.specularColorMap&&(p.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,p.specularColorMapTransform)),d.specularIntensityMap&&(p.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,p.specularIntensityMapTransform))}function v(p,d){d.matcap&&(p.matcap.value=d.matcap)}function T(p,d){const b=e.get(d).light;p.referencePosition.value.setFromMatrixPosition(b.matrixWorld),p.nearDistance.value=b.shadow.camera.near,p.farDistance.value=b.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function Bm(i,e,t,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(x,E){const M=E.program;n.uniformBlockBinding(x,M)}function c(x,E){let M=r[x.id];M===void 0&&(p(x),M=h(x),r[x.id]=M,x.addEventListener("dispose",b));const w=E.program;n.updateUBOMapping(x,w);const m=e.render.frame;s[x.id]!==m&&(f(x),s[x.id]=m)}function h(x){const E=u();x.__bindingPointIndex=E;const M=i.createBuffer(),w=x.__size,m=x.usage;return i.bindBuffer(i.UNIFORM_BUFFER,M),i.bufferData(i.UNIFORM_BUFFER,w,m),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,E,M),M}function u(){for(let x=0;x<o;x++)if(a.indexOf(x)===-1)return a.push(x),x;return ht("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(x){const E=r[x.id],M=x.uniforms,w=x.__cache;i.bindBuffer(i.UNIFORM_BUFFER,E);for(let m=0,S=M.length;m<S;m++){const L=M[m];if(Array.isArray(L))for(let R=0,U=L.length;R<U;R++)g(L[R],m,R,w);else g(L,m,0,w)}i.bindBuffer(i.UNIFORM_BUFFER,null)}function g(x,E,M,w){if(T(x,E,M,w)===!0){const m=x.__offset,S=x.value;if(Array.isArray(S)){let L=0;for(let R=0;R<S.length;R++){const U=S[R],z=d(U);v(U,x.__data,L),typeof U!="number"&&typeof U!="boolean"&&!U.isMatrix3&&!ArrayBuffer.isView(U)&&(L+=z.storage/Float32Array.BYTES_PER_ELEMENT)}}else v(S,x.__data,0);i.bufferSubData(i.UNIFORM_BUFFER,m,x.__data)}}function v(x,E,M){typeof x=="number"||typeof x=="boolean"?E[0]=x:x.isMatrix3?(E[0]=x.elements[0],E[1]=x.elements[1],E[2]=x.elements[2],E[3]=0,E[4]=x.elements[3],E[5]=x.elements[4],E[6]=x.elements[5],E[7]=0,E[8]=x.elements[6],E[9]=x.elements[7],E[10]=x.elements[8],E[11]=0):ArrayBuffer.isView(x)?E.set(new x.constructor(x.buffer,x.byteOffset,E.length)):x.toArray(E,M)}function T(x,E,M,w){const m=x.value,S=E+"_"+M;if(w[S]===void 0)return typeof m=="number"||typeof m=="boolean"?w[S]=m:ArrayBuffer.isView(m)?w[S]=m.slice():w[S]=m.clone(),!0;{const L=w[S];if(typeof m=="number"||typeof m=="boolean"){if(L!==m)return w[S]=m,!0}else{if(ArrayBuffer.isView(m))return!0;if(L.equals(m)===!1)return L.copy(m),!0}}return!1}function p(x){const E=x.uniforms;let M=0;const w=16;for(let S=0,L=E.length;S<L;S++){const R=Array.isArray(E[S])?E[S]:[E[S]];for(let U=0,z=R.length;U<z;U++){const H=R[U],I=Array.isArray(H.value)?H.value:[H.value];for(let k=0,D=I.length;k<D;k++){const W=I[k],te=d(W),oe=M%w,re=oe%te.boundary,he=oe+re;M+=re,he!==0&&w-he<te.storage&&(M+=w-he),H.__data=new Float32Array(te.storage/Float32Array.BYTES_PER_ELEMENT),H.__offset=M,M+=te.storage}}}const m=M%w;return m>0&&(M+=w-m),x.__size=M,x.__cache={},this}function d(x){const E={boundary:0,storage:0};return typeof x=="number"||typeof x=="boolean"?(E.boundary=4,E.storage=4):x.isVector2?(E.boundary=8,E.storage=8):x.isVector3||x.isColor?(E.boundary=16,E.storage=12):x.isVector4?(E.boundary=16,E.storage=16):x.isMatrix3?(E.boundary=48,E.storage=48):x.isMatrix4?(E.boundary=64,E.storage=64):x.isTexture?Ye("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(x)?(E.boundary=16,E.storage=x.byteLength):Ye("WebGLRenderer: Unsupported uniform value type.",x),E}function b(x){const E=x.target;E.removeEventListener("dispose",b);const M=a.indexOf(E.__bindingPointIndex);a.splice(M,1),i.deleteBuffer(r[E.id]),delete r[E.id],delete s[E.id]}function C(){for(const x in r)i.deleteBuffer(r[x]);a=[],r={},s={}}return{bind:l,update:c,dispose:C}}const zm=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Mn=null;function Hm(){return Mn===null&&(Mn=new ci(zm,16,16,hi,Hn),Mn.name="DFG_LUT",Mn.minFilter=Wt,Mn.magFilter=Wt,Mn.wrapS=Nn,Mn.wrapT=Nn,Mn.generateMipmaps=!1,Mn.needsUpdate=!0),Mn}class km{constructor(e={}){const{canvas:t=zc(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1,reversedDepthBuffer:f=!1,outputBufferType:g=ln}=e;this.isWebGLRenderer=!0;let v;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");v=n.getContextAttributes().alpha}else v=a;const T=g,p=new Set([Ba,Oa,Fa]),d=new Set([ln,wn,ar,or,Ia,Ua]),b=new Uint32Array(4),C=new Int32Array(4),x=new Y;let E=null,M=null;const w=[],m=[];let S=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Tn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const L=this;let R=!1,U=null,z=null,H=null,I=null;this._outputColorSpace=tn;let k=0,D=0,W=null,te=-1,oe=null;const re=new It,he=new It;let We=null;const dt=new at(0);let Ge=0,ee=t.width,ce=t.height,J=1,Fe=null,Ve=null;const De=new It(0,0,ee,ce),pt=new It(0,0,ee,ce);let Xe=!1;const je=new Xa;let Je=!1,et=!1;const Tt=new Ct,yt=new Y,Lt=new It,xt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let ct=!1;function vt(){return W===null?J:1}let F=n;function Nt(y,G){return t.getContext(y,G)}try{const y={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Pa}`),t.addEventListener("webglcontextlost",Et,!1),t.addEventListener("webglcontextrestored",_t,!1),t.addEventListener("webglcontextcreationerror",Xt,!1),F===null){const G="webgl2";if(F=Nt(G,y),F===null)throw Nt(G)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(y){throw ht("WebGLRenderer: "+y.message),y}let it,P,_,V,X,Q,ue,ge,j,ne,pe,Pe,ve,_e,Ie,Oe,qe,N,me,ie,xe,fe,se;function Te(){it=new Hh(F),it.init(),xe=new Lm(F,it),P=new Dh(F,it,e,xe),_=new Rm(F,it),P.reversedDepthBuffer&&f&&_.buffers.depth.setReversed(!0),z=F.createFramebuffer(),H=F.createFramebuffer(),I=F.createFramebuffer(),V=new Vh(F),X=new mm,Q=new Pm(F,it,_,X,P,xe,V),ue=new zh(L),ge=new qu(F),fe=new Ph(F,ge),j=new kh(F,ge,V,fe),ne=new Xh(F,j,ge,fe,V),N=new Wh(F,P,Q),Ie=new Ih(X),pe=new pm(L,ue,it,P,fe,Ie),Pe=new Om(L,X),ve=new _m,_e=new Em(it),qe=new Rh(L,ue,_,ne,v,l),Oe=new Cm(L,ne,P),se=new Bm(F,V,P,_),me=new Lh(F,it,V),ie=new Gh(F,it,V),V.programs=pe.programs,L.capabilities=P,L.extensions=it,L.properties=X,L.renderLists=ve,L.shadowMap=Oe,L.state=_,L.info=V}Te(),T!==ln&&(S=new Yh(T,t.width,t.height,o,r,s));const we=new Nm(L,F);this.xr=we,this.getContext=function(){return F},this.getContextAttributes=function(){return F.getContextAttributes()},this.forceContextLoss=function(){const y=it.get("WEBGL_lose_context");y&&y.loseContext()},this.forceContextRestore=function(){const y=it.get("WEBGL_lose_context");y&&y.restoreContext()},this.getPixelRatio=function(){return J},this.setPixelRatio=function(y){y!==void 0&&(J=y,this.setSize(ee,ce,!1))},this.getSize=function(y){return y.set(ee,ce)},this.setSize=function(y,G,Z=!0){if(we.isPresenting){Ye("WebGLRenderer: Can't change size while VR device is presenting.");return}ee=y,ce=G,t.width=Math.floor(y*J),t.height=Math.floor(G*J),Z===!0&&(t.style.width=y+"px",t.style.height=G+"px"),S!==null&&S.setSize(t.width,t.height),this.setViewport(0,0,y,G)},this.getDrawingBufferSize=function(y){return y.set(ee*J,ce*J).floor()},this.setDrawingBufferSize=function(y,G,Z){ee=y,ce=G,J=Z,t.width=Math.floor(y*Z),t.height=Math.floor(G*Z),this.setViewport(0,0,y,G)},this.setEffects=function(y){if(T===ln){ht("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(y){for(let G=0;G<y.length;G++)if(y[G].isOutputPass===!0){Ye("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}S.setEffects(y||[])},this.getCurrentViewport=function(y){return y.copy(re)},this.getViewport=function(y){return y.copy(De)},this.setViewport=function(y,G,Z,$){y.isVector4?De.set(y.x,y.y,y.z,y.w):De.set(y,G,Z,$),_.viewport(re.copy(De).multiplyScalar(J).round())},this.getScissor=function(y){return y.copy(pt)},this.setScissor=function(y,G,Z,$){y.isVector4?pt.set(y.x,y.y,y.z,y.w):pt.set(y,G,Z,$),_.scissor(he.copy(pt).multiplyScalar(J).round())},this.getScissorTest=function(){return Xe},this.setScissorTest=function(y){_.setScissorTest(Xe=y)},this.setOpaqueSort=function(y){Fe=y},this.setTransparentSort=function(y){Ve=y},this.getClearColor=function(y){return y.copy(qe.getClearColor())},this.setClearColor=function(){qe.setClearColor(...arguments)},this.getClearAlpha=function(){return qe.getClearAlpha()},this.setClearAlpha=function(){qe.setClearAlpha(...arguments)},this.clear=function(y=!0,G=!0,Z=!0){let $=0;if(y){let K=!1;if(W!==null){const Ae=W.texture.format;K=p.has(Ae)}if(K){const Ae=W.texture.type,Re=d.has(Ae),be=qe.getClearColor(),Ne=qe.getClearAlpha(),Be=be.r,Qe=be.g,nt=be.b;Re?(b[0]=Be,b[1]=Qe,b[2]=nt,b[3]=Ne,F.clearBufferuiv(F.COLOR,0,b)):(C[0]=Be,C[1]=Qe,C[2]=nt,C[3]=Ne,F.clearBufferiv(F.COLOR,0,C))}else $|=F.COLOR_BUFFER_BIT}G&&($|=F.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),Z&&($|=F.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),$!==0&&F.clear($)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(y){y.setRenderer(this),U=y},this.dispose=function(){t.removeEventListener("webglcontextlost",Et,!1),t.removeEventListener("webglcontextrestored",_t,!1),t.removeEventListener("webglcontextcreationerror",Xt,!1),qe.dispose(),ve.dispose(),_e.dispose(),X.dispose(),ue.dispose(),ne.dispose(),fe.dispose(),se.dispose(),pe.dispose(),we.dispose(),we.removeEventListener("sessionstart",Le),we.removeEventListener("sessionend",$e),ze.stop()};function Et(y){y.preventDefault(),fo("WebGLRenderer: Context Lost."),R=!0}function _t(){fo("WebGLRenderer: Context Restored."),R=!1;const y=V.autoReset,G=Oe.enabled,Z=Oe.autoUpdate,$=Oe.needsUpdate,K=Oe.type;Te(),V.autoReset=y,Oe.enabled=G,Oe.autoUpdate=Z,Oe.needsUpdate=$,Oe.type=K}function Xt(y){ht("WebGLRenderer: A WebGL context could not be created. Reason: ",y.statusMessage)}function qt(y){const G=y.target;G.removeEventListener("dispose",qt),A(G)}function A(y){O(y),X.remove(y)}function O(y){const G=X.get(y).programs;G!==void 0&&(G.forEach(function(Z){pe.releaseProgram(Z)}),y.isShaderMaterial&&pe.releaseShaderCache(y))}this.renderBufferDirect=function(y,G,Z,$,K,Ae){G===null&&(G=xt);const Re=K.isMesh&&K.matrixWorld.determinantAffine()<0,be=ot(y,G,Z,$,K);_.setMaterial($,Re);let Ne=Z.index,Be=1;if($.wireframe===!0){if(Ne=j.getWireframeAttribute(Z),Ne===void 0)return;Be=2}const Qe=Z.drawRange,nt=Z.attributes.position;let He=Qe.start*Be,bt=(Qe.start+Qe.count)*Be;Ae!==null&&(He=Math.max(He,Ae.start*Be),bt=Math.min(bt,(Ae.start+Ae.count)*Be)),Ne!==null?(He=Math.max(He,0),bt=Math.min(bt,Ne.count)):nt!=null&&(He=Math.max(He,0),bt=Math.min(bt,nt.count));const Ft=bt-He;if(Ft<0||Ft===1/0)return;fe.setup(K,$,be,Z,Ne);let Ut,At=me;if(Ne!==null&&(Ut=ge.get(Ne),At=ie,At.setIndex(Ut)),K.isMesh)$.wireframe===!0?(_.setLineWidth($.wireframeLinewidth*vt()),At.setMode(F.LINES)):At.setMode(F.TRIANGLES);else if(K.isLine){let $t=$.linewidth;$t===void 0&&($t=1),_.setLineWidth($t*vt()),K.isLineSegments?At.setMode(F.LINES):K.isLineLoop?At.setMode(F.LINE_LOOP):At.setMode(F.LINE_STRIP)}else K.isPoints?At.setMode(F.POINTS):K.isSprite&&At.setMode(F.TRIANGLES);if(K.isBatchedMesh)if(it.get("WEBGL_multi_draw"))At.renderMultiDraw(K._multiDrawStarts,K._multiDrawCounts,K._multiDrawCount);else{const $t=K._multiDrawStarts,Ce=K._multiDrawCounts,sn=K._multiDrawCount,gt=Ne?ge.get(Ne).bytesPerElement:1,un=X.get($).currentProgram.getUniforms();for(let xn=0;xn<sn;xn++)un.setValue(F,"_gl_DrawID",xn),At.render($t[xn]/gt,Ce[xn])}else if(K.isInstancedMesh)At.renderInstances(He,Ft,K.count);else if(Z.isInstancedBufferGeometry){const $t=Z._maxInstanceCount!==void 0?Z._maxInstanceCount:1/0,Ce=Math.min(Z.instanceCount,$t);At.renderInstances(He,Ft,Ce)}else At.render(He,Ft)};function le(y,G,Z){y.transparent===!0&&y.side===yn&&y.forceSinglePass===!1?(y.side=nn,y.needsUpdate=!0,Me(y,G,Z),y.side=zn,y.needsUpdate=!0,Me(y,G,Z),y.side=yn):Me(y,G,Z)}this.compile=function(y,G,Z=null){Z===null&&(Z=y),M=_e.get(Z),M.init(G),m.push(M),Z.traverseVisible(function(K){K.isLight&&K.layers.test(G.layers)&&(M.pushLight(K),K.castShadow&&M.pushShadow(K))}),y!==Z&&y.traverseVisible(function(K){K.isLight&&K.layers.test(G.layers)&&(M.pushLight(K),K.castShadow&&M.pushShadow(K))}),M.setupLights();const $=new Set;return y.traverse(function(K){if(!(K.isMesh||K.isPoints||K.isLine||K.isSprite))return;const Ae=K.material;if(Ae)if(Array.isArray(Ae))for(let Re=0;Re<Ae.length;Re++){const be=Ae[Re];le(be,Z,K),$.add(be)}else le(Ae,Z,K),$.add(Ae)}),M=m.pop(),$},this.compileAsync=function(y,G,Z=null){const $=this.compile(y,G,Z);return new Promise(K=>{function Ae(){if($.forEach(function(Re){X.get(Re).currentProgram.isReady()&&$.delete(Re)}),$.size===0){K(y);return}setTimeout(Ae,10)}it.get("KHR_parallel_shader_compile")!==null?Ae():setTimeout(Ae,10)})};let de=null;function ye(y){de&&de(y)}function Le(){ze.stop()}function $e(){ze.start()}const ze=new Gl;ze.setAnimationLoop(ye),typeof self<"u"&&ze.setContext(self),this.setAnimationLoop=function(y){de=y,we.setAnimationLoop(y),y===null?ze.stop():ze.start()},we.addEventListener("sessionstart",Le),we.addEventListener("sessionend",$e),this.render=function(y,G){if(G!==void 0&&G.isCamera!==!0){ht("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(R===!0)return;U!==null&&U.renderStart(y,G);const Z=we.enabled===!0&&we.isPresenting===!0,$=S!==null&&(W===null||Z)&&S.begin(L,W);if(y.matrixWorldAutoUpdate===!0&&y.updateMatrixWorld(),G.parent===null&&G.matrixWorldAutoUpdate===!0&&G.updateMatrixWorld(),we.enabled===!0&&we.isPresenting===!0&&(S===null||S.isCompositing()===!1)&&(we.cameraAutoUpdate===!0&&we.updateCamera(G),G=we.getCamera()),y.isScene===!0&&y.onBeforeRender(L,y,G,W),M=_e.get(y,m.length),M.init(G),M.state.textureUnits=Q.getTextureUnits(),m.push(M),Tt.multiplyMatrices(G.projectionMatrix,G.matrixWorldInverse),je.setFromProjectionMatrix(Tt,bn,G.reversedDepth),et=this.localClippingEnabled,Je=Ie.init(this.clippingPlanes,et),E=ve.get(y,w.length),E.init(),w.push(E),we.enabled===!0&&we.isPresenting===!0){const Re=L.xr.getDepthSensingMesh();Re!==null&&Ke(Re,G,-1/0,L.sortObjects)}Ke(y,G,0,L.sortObjects),E.finish(),L.sortObjects===!0&&E.sort(Fe,Ve,G.reversedDepth),ct=we.enabled===!1||we.isPresenting===!1||we.hasDepthSensing()===!1,ct&&qe.addToRenderList(E,y),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Je===!0&&Ie.beginShadows();const K=M.state.shadowsArray;if(Oe.render(K,y,G),Je===!0&&Ie.endShadows(),($&&S.hasRenderPass())===!1){const Re=E.opaque,be=E.transmissive;if(M.setupLights(),G.isArrayCamera){const Ne=G.cameras;if(be.length>0)for(let Be=0,Qe=Ne.length;Be<Qe;Be++){const nt=Ne[Be];B(Re,be,y,nt)}ct&&qe.render(y);for(let Be=0,Qe=Ne.length;Be<Qe;Be++){const nt=Ne[Be];rt(E,y,nt,nt.viewport)}}else be.length>0&&B(Re,be,y,G),ct&&qe.render(y),rt(E,y,G)}W!==null&&D===0&&(Q.updateMultisampleRenderTarget(W),Q.updateRenderTargetMipmap(W)),$&&S.end(L),y.isScene===!0&&y.onAfterRender(L,y,G),fe.resetDefaultState(),te=-1,oe=null,m.pop(),m.length>0?(M=m[m.length-1],Q.setTextureUnits(M.state.textureUnits),Je===!0&&Ie.setGlobalState(L.clippingPlanes,M.state.camera)):M=null,w.pop(),w.length>0?E=w[w.length-1]:E=null,U!==null&&U.renderEnd()};function Ke(y,G,Z,$){if(y.visible===!1)return;if(y.layers.test(G.layers)){if(y.isGroup)Z=y.renderOrder;else if(y.isLOD)y.autoUpdate===!0&&y.update(G);else if(y.isLightProbeGrid)M.pushLightProbeGrid(y);else if(y.isLight)M.pushLight(y),y.castShadow&&M.pushShadow(y);else if(y.isSprite){if(!y.frustumCulled||je.intersectsSprite(y)){$&&Lt.setFromMatrixPosition(y.matrixWorld).applyMatrix4(Tt);const Re=ne.update(y),be=y.material;be.visible&&E.push(y,Re,be,Z,Lt.z,null)}}else if((y.isMesh||y.isLine||y.isPoints)&&(!y.frustumCulled||je.intersectsObject(y))){const Re=ne.update(y),be=y.material;if($&&(y.boundingSphere!==void 0?(y.boundingSphere===null&&y.computeBoundingSphere(),Lt.copy(y.boundingSphere.center)):(Re.boundingSphere===null&&Re.computeBoundingSphere(),Lt.copy(Re.boundingSphere.center)),Lt.applyMatrix4(y.matrixWorld).applyMatrix4(Tt)),Array.isArray(be)){const Ne=Re.groups;for(let Be=0,Qe=Ne.length;Be<Qe;Be++){const nt=Ne[Be],He=be[nt.materialIndex];He&&He.visible&&E.push(y,Re,He,Z,Lt.z,nt)}}else be.visible&&E.push(y,Re,be,Z,Lt.z,null)}}const Ae=y.children;for(let Re=0,be=Ae.length;Re<be;Re++)Ke(Ae[Re],G,Z,$)}function rt(y,G,Z,$){const{opaque:K,transmissive:Ae,transparent:Re}=y;M.setupLightsView(Z),Je===!0&&Ie.setGlobalState(L.clippingPlanes,Z),$&&_.viewport(re.copy($)),K.length>0&&q(K,G,Z),Ae.length>0&&q(Ae,G,Z),Re.length>0&&q(Re,G,Z),_.buffers.depth.setTest(!0),_.buffers.depth.setMask(!0),_.buffers.color.setMask(!0),_.setPolygonOffset(!1)}function B(y,G,Z,$){if((Z.isScene===!0?Z.overrideMaterial:null)!==null)return;if(M.state.transmissionRenderTarget[$.id]===void 0){const He=it.has("EXT_color_buffer_half_float")||it.has("EXT_color_buffer_float");M.state.transmissionRenderTarget[$.id]=new An(1,1,{generateMipmaps:!0,type:He?Hn:ln,minFilter:En,samples:Math.max(4,P.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ft.workingColorSpace})}const Ae=M.state.transmissionRenderTarget[$.id],Re=$.viewport||re;Ae.setSize(Re.z*L.transmissionResolutionScale,Re.w*L.transmissionResolutionScale);const be=L.getRenderTarget(),Ne=L.getActiveCubeFace(),Be=L.getActiveMipmapLevel();L.setRenderTarget(Ae),L.getClearColor(dt),Ge=L.getClearAlpha(),Ge<1&&L.setClearColor(16777215,.5),L.clear(),ct&&qe.render(Z);const Qe=L.toneMapping;L.toneMapping=Tn;const nt=$.viewport;if($.viewport!==void 0&&($.viewport=void 0),M.setupLightsView($),Je===!0&&Ie.setGlobalState(L.clippingPlanes,$),q(y,Z,$),Q.updateMultisampleRenderTarget(Ae),Q.updateRenderTargetMipmap(Ae),it.has("WEBGL_multisampled_render_to_texture")===!1){let He=!1;for(let bt=0,Ft=G.length;bt<Ft;bt++){const Ut=G[bt],{object:At,geometry:$t,material:Ce,group:sn}=Ut;if(Ce.side===yn&&At.layers.test($.layers)){const gt=Ce.side;Ce.side=nn,Ce.needsUpdate=!0,ae(At,Z,$,$t,Ce,sn),Ce.side=gt,Ce.needsUpdate=!0,He=!0}}He===!0&&(Q.updateMultisampleRenderTarget(Ae),Q.updateRenderTargetMipmap(Ae))}L.setRenderTarget(be,Ne,Be),L.setClearColor(dt,Ge),nt!==void 0&&($.viewport=nt),L.toneMapping=Qe}function q(y,G,Z){const $=G.isScene===!0?G.overrideMaterial:null;for(let K=0,Ae=y.length;K<Ae;K++){const Re=y[K],{object:be,geometry:Ne,group:Be}=Re;let Qe=Re.material;Qe.allowOverride===!0&&$!==null&&(Qe=$),be.layers.test(Z.layers)&&ae(be,G,Z,Ne,Qe,Be)}}function ae(y,G,Z,$,K,Ae){y.onBeforeRender(L,G,Z,$,K,Ae),y.modelViewMatrix.multiplyMatrices(Z.matrixWorldInverse,y.matrixWorld),y.normalMatrix.getNormalMatrix(y.modelViewMatrix),K.onBeforeRender(L,G,Z,$,y,Ae),K.transparent===!0&&K.side===yn&&K.forceSinglePass===!1?(K.side=nn,K.needsUpdate=!0,L.renderBufferDirect(Z,G,$,K,y,Ae),K.side=zn,K.needsUpdate=!0,L.renderBufferDirect(Z,G,$,K,y,Ae),K.side=yn):L.renderBufferDirect(Z,G,$,K,y,Ae),y.onAfterRender(L,G,Z,$,K,Ae)}function Me(y,G,Z){G.isScene!==!0&&(G=xt);const $=X.get(y),K=M.state.lights,Ae=M.state.shadowsArray,Re=K.state.version,be=pe.getParameters(y,K.state,Ae,G,Z,M.state.lightProbeGridArray),Ne=pe.getProgramCacheKey(be);let Be=$.programs;$.environment=y.isMeshStandardMaterial||y.isMeshLambertMaterial||y.isMeshPhongMaterial?G.environment:null,$.fog=G.fog;const Qe=y.isMeshStandardMaterial||y.isMeshLambertMaterial&&!y.envMap||y.isMeshPhongMaterial&&!y.envMap;$.envMap=ue.get(y.envMap||$.environment,Qe),$.envMapRotation=$.environment!==null&&y.envMap===null?G.environmentRotation:y.envMapRotation,Be===void 0&&(y.addEventListener("dispose",qt),Be=new Map,$.programs=Be);let nt=Be.get(Ne);if(nt!==void 0){if($.currentProgram===nt&&$.lightsStateVersion===Re)return Rt(y,be),nt}else be.uniforms=pe.getUniforms(y),U!==null&&y.isNodeMaterial&&U.build(y,Z,be),y.onBeforeCompile(be,L),nt=pe.acquireProgram(be,Ne),Be.set(Ne,nt),$.uniforms=be.uniforms;const He=$.uniforms;return(!y.isShaderMaterial&&!y.isRawShaderMaterial||y.clipping===!0)&&(He.clippingPlanes=Ie.uniform),Rt(y,be),$.needsLights=Mt(y),$.lightsStateVersion=Re,$.needsLights&&(He.ambientLightColor.value=K.state.ambient,He.lightProbe.value=K.state.probe,He.directionalLights.value=K.state.directional,He.directionalLightShadows.value=K.state.directionalShadow,He.spotLights.value=K.state.spot,He.spotLightShadows.value=K.state.spotShadow,He.rectAreaLights.value=K.state.rectArea,He.ltc_1.value=K.state.rectAreaLTC1,He.ltc_2.value=K.state.rectAreaLTC2,He.pointLights.value=K.state.point,He.pointLightShadows.value=K.state.pointShadow,He.hemisphereLights.value=K.state.hemi,He.directionalShadowMatrix.value=K.state.directionalShadowMatrix,He.spotLightMatrix.value=K.state.spotLightMatrix,He.spotLightMap.value=K.state.spotLightMap,He.pointShadowMatrix.value=K.state.pointShadowMatrix),$.lightProbeGrid=M.state.lightProbeGridArray.length>0,$.currentProgram=nt,$.uniformsList=null,nt}function Ue(y){if(y.uniformsList===null){const G=y.currentProgram.getUniforms();y.uniformsList=Vr.seqWithValue(G.seq,y.uniforms)}return y.uniformsList}function Rt(y,G){const Z=X.get(y);Z.outputColorSpace=G.outputColorSpace,Z.batching=G.batching,Z.batchingColor=G.batchingColor,Z.instancing=G.instancing,Z.instancingColor=G.instancingColor,Z.instancingMorph=G.instancingMorph,Z.skinning=G.skinning,Z.morphTargets=G.morphTargets,Z.morphNormals=G.morphNormals,Z.morphColors=G.morphColors,Z.morphTargetsCount=G.morphTargetsCount,Z.numClippingPlanes=G.numClippingPlanes,Z.numIntersection=G.numClipIntersection,Z.vertexAlphas=G.vertexAlphas,Z.vertexTangents=G.vertexTangents,Z.toneMapping=G.toneMapping}function ut(y,G){if(y.length===0)return null;if(y.length===1)return y[0].texture!==null?y[0]:null;x.setFromMatrixPosition(G.matrixWorld);for(let Z=0,$=y.length;Z<$;Z++){const K=y[Z];if(K.texture!==null&&K.boundingBox.containsPoint(x))return K}return null}function ot(y,G,Z,$,K){G.isScene!==!0&&(G=xt),Q.resetTextureUnits();const Ae=G.fog,Re=$.isMeshStandardMaterial||$.isMeshLambertMaterial||$.isMeshPhongMaterial?G.environment:null,be=W===null?L.outputColorSpace:W.isXRRenderTarget===!0?W.texture.colorSpace:ft.workingColorSpace,Ne=$.isMeshStandardMaterial||$.isMeshLambertMaterial&&!$.envMap||$.isMeshPhongMaterial&&!$.envMap,Be=ue.get($.envMap||Re,Ne),Qe=$.vertexColors===!0&&!!Z.attributes.color&&Z.attributes.color.itemSize===4,nt=!!Z.attributes.tangent&&(!!$.normalMap||$.anisotropy>0),He=!!Z.morphAttributes.position,bt=!!Z.morphAttributes.normal,Ft=!!Z.morphAttributes.color;let Ut=Tn;$.toneMapped&&(W===null||W.isXRRenderTarget===!0)&&(Ut=L.toneMapping);const At=Z.morphAttributes.position||Z.morphAttributes.normal||Z.morphAttributes.color,$t=At!==void 0?At.length:0,Ce=X.get($),sn=M.state.lights;if(Je===!0&&(et===!0||y!==oe)){const Pt=y===oe&&$.id===te;Ie.setState($,y,Pt)}let gt=!1;$.version===Ce.__version?(Ce.needsLights&&Ce.lightsStateVersion!==sn.state.version||Ce.outputColorSpace!==be||K.isBatchedMesh&&Ce.batching===!1||!K.isBatchedMesh&&Ce.batching===!0||K.isBatchedMesh&&Ce.batchingColor===!0&&K.colorTexture===null||K.isBatchedMesh&&Ce.batchingColor===!1&&K.colorTexture!==null||K.isInstancedMesh&&Ce.instancing===!1||!K.isInstancedMesh&&Ce.instancing===!0||K.isSkinnedMesh&&Ce.skinning===!1||!K.isSkinnedMesh&&Ce.skinning===!0||K.isInstancedMesh&&Ce.instancingColor===!0&&K.instanceColor===null||K.isInstancedMesh&&Ce.instancingColor===!1&&K.instanceColor!==null||K.isInstancedMesh&&Ce.instancingMorph===!0&&K.morphTexture===null||K.isInstancedMesh&&Ce.instancingMorph===!1&&K.morphTexture!==null||Ce.envMap!==Be||$.fog===!0&&Ce.fog!==Ae||Ce.numClippingPlanes!==void 0&&(Ce.numClippingPlanes!==Ie.numPlanes||Ce.numIntersection!==Ie.numIntersection)||Ce.vertexAlphas!==Qe||Ce.vertexTangents!==nt||Ce.morphTargets!==He||Ce.morphNormals!==bt||Ce.morphColors!==Ft||Ce.toneMapping!==Ut||Ce.morphTargetsCount!==$t||!!Ce.lightProbeGrid!=M.state.lightProbeGridArray.length>0)&&(gt=!0):(gt=!0,Ce.__version=$.version);let un=Ce.currentProgram;gt===!0&&(un=Me($,G,K),U&&$.isNodeMaterial&&U.onUpdateProgram($,un,Ce));let xn=!1,Gn=!1,_i=!1;const wt=un.getUniforms(),Ot=Ce.uniforms;if(_.useProgram(un.program)&&(xn=!0,Gn=!0,_i=!0),$.id!==te&&(te=$.id,Gn=!0),Ce.needsLights){const Pt=ut(M.state.lightProbeGridArray,K);Ce.lightProbeGrid!==Pt&&(Ce.lightProbeGrid=Pt,Gn=!0)}if(xn||oe!==y){_.buffers.depth.getReversed()&&y.reversedDepth!==!0&&(y._reversedDepth=!0,y.updateProjectionMatrix()),wt.setValue(F,"projectionMatrix",y.projectionMatrix),wt.setValue(F,"viewMatrix",y.matrixWorldInverse);const Wn=wt.map.cameraPosition;Wn!==void 0&&Wn.setValue(F,yt.setFromMatrixPosition(y.matrixWorld)),P.logarithmicDepthBuffer&&wt.setValue(F,"logDepthBufFC",2/(Math.log(y.far+1)/Math.LN2)),($.isMeshPhongMaterial||$.isMeshToonMaterial||$.isMeshLambertMaterial||$.isMeshBasicMaterial||$.isMeshStandardMaterial||$.isShaderMaterial)&&wt.setValue(F,"isOrthographic",y.isOrthographicCamera===!0),oe!==y&&(oe=y,Gn=!0,_i=!0)}if(Ce.needsLights&&(sn.state.directionalShadowMap.length>0&&wt.setValue(F,"directionalShadowMap",sn.state.directionalShadowMap,Q),sn.state.spotShadowMap.length>0&&wt.setValue(F,"spotShadowMap",sn.state.spotShadowMap,Q),sn.state.pointShadowMap.length>0&&wt.setValue(F,"pointShadowMap",sn.state.pointShadowMap,Q)),K.isSkinnedMesh){wt.setOptional(F,K,"bindMatrix"),wt.setOptional(F,K,"bindMatrixInverse");const Pt=K.skeleton;Pt&&(Pt.boneTexture===null&&Pt.computeBoneTexture(),wt.setValue(F,"boneTexture",Pt.boneTexture,Q))}K.isBatchedMesh&&(wt.setOptional(F,K,"batchingTexture"),wt.setValue(F,"batchingTexture",K._matricesTexture,Q),wt.setOptional(F,K,"batchingIdTexture"),wt.setValue(F,"batchingIdTexture",K._indirectTexture,Q),wt.setOptional(F,K,"batchingColorTexture"),K._colorsTexture!==null&&wt.setValue(F,"batchingColorTexture",K._colorsTexture,Q));const Vn=Z.morphAttributes;if((Vn.position!==void 0||Vn.normal!==void 0||Vn.color!==void 0)&&N.update(K,Z,un),(Gn||Ce.receiveShadow!==K.receiveShadow)&&(Ce.receiveShadow=K.receiveShadow,wt.setValue(F,"receiveShadow",K.receiveShadow)),($.isMeshStandardMaterial||$.isMeshLambertMaterial||$.isMeshPhongMaterial)&&$.envMap===null&&G.environment!==null&&(Ot.envMapIntensity.value=G.environmentIntensity),Ot.dfgLUT!==void 0&&(Ot.dfgLUT.value=Hm()),Gn){if(wt.setValue(F,"toneMappingExposure",L.toneMappingExposure),Ce.needsLights&&mt(Ot,_i),Ae&&$.fog===!0&&Pe.refreshFogUniforms(Ot,Ae),Pe.refreshMaterialUniforms(Ot,$,J,ce,M.state.transmissionRenderTarget[y.id]),Ce.needsLights&&Ce.lightProbeGrid){const Pt=Ce.lightProbeGrid;Ot.probesSH.value=Pt.texture,Ot.probesMin.value.copy(Pt.boundingBox.min),Ot.probesMax.value.copy(Pt.boundingBox.max),Ot.probesResolution.value.copy(Pt.resolution)}Vr.upload(F,Ue(Ce),Ot,Q)}if($.isShaderMaterial&&$.uniformsNeedUpdate===!0&&(Vr.upload(F,Ue(Ce),Ot,Q),$.uniformsNeedUpdate=!1),$.isSpriteMaterial&&wt.setValue(F,"center",K.center),wt.setValue(F,"modelViewMatrix",K.modelViewMatrix),wt.setValue(F,"normalMatrix",K.normalMatrix),wt.setValue(F,"modelMatrix",K.matrixWorld),$.uniformsGroups!==void 0){const Pt=$.uniformsGroups;for(let Wn=0,xi=Pt.length;Wn<xi;Wn++){const ja=Pt[Wn];se.update(ja,un),se.bind(ja,un)}}return un}function mt(y,G){y.ambientLightColor.needsUpdate=G,y.lightProbe.needsUpdate=G,y.directionalLights.needsUpdate=G,y.directionalLightShadows.needsUpdate=G,y.pointLights.needsUpdate=G,y.pointLightShadows.needsUpdate=G,y.spotLights.needsUpdate=G,y.spotLightShadows.needsUpdate=G,y.rectAreaLights.needsUpdate=G,y.hemisphereLights.needsUpdate=G}function Mt(y){return y.isMeshLambertMaterial||y.isMeshToonMaterial||y.isMeshPhongMaterial||y.isMeshStandardMaterial||y.isShadowMaterial||y.isShaderMaterial&&y.lights===!0}this.getActiveCubeFace=function(){return k},this.getActiveMipmapLevel=function(){return D},this.getRenderTarget=function(){return W},this.setRenderTargetTextures=function(y,G,Z){const $=X.get(y);$.__autoAllocateDepthBuffer=y.resolveDepthBuffer===!1,$.__autoAllocateDepthBuffer===!1&&($.__useRenderToTexture=!1),X.get(y.texture).__webglTexture=G,X.get(y.depthTexture).__webglTexture=$.__autoAllocateDepthBuffer?void 0:Z,$.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(y,G){const Z=X.get(y);Z.__webglFramebuffer=G,Z.__useDefaultFramebuffer=G===void 0},this.setRenderTarget=function(y,G=0,Z=0){W=y,k=G,D=Z;let $=null,K=!1,Ae=!1;if(y){const be=X.get(y);if(be.__useDefaultFramebuffer!==void 0){_.bindFramebuffer(F.FRAMEBUFFER,be.__webglFramebuffer),re.copy(y.viewport),he.copy(y.scissor),We=y.scissorTest,_.viewport(re),_.scissor(he),_.setScissorTest(We),te=-1;return}else if(be.__webglFramebuffer===void 0)Q.setupRenderTarget(y);else if(be.__hasExternalTextures)Q.rebindTextures(y,X.get(y.texture).__webglTexture,X.get(y.depthTexture).__webglTexture);else if(y.depthBuffer){const Qe=y.depthTexture;if(be.__boundDepthTexture!==Qe){if(Qe!==null&&X.has(Qe)&&(y.width!==Qe.image.width||y.height!==Qe.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");Q.setupDepthRenderbuffer(y)}}const Ne=y.texture;(Ne.isData3DTexture||Ne.isDataArrayTexture||Ne.isCompressedArrayTexture)&&(Ae=!0);const Be=X.get(y).__webglFramebuffer;y.isWebGLCubeRenderTarget?(Array.isArray(Be[G])?$=Be[G][Z]:$=Be[G],K=!0):y.samples>0&&Q.useMultisampledRTT(y)===!1?$=X.get(y).__webglMultisampledFramebuffer:Array.isArray(Be)?$=Be[Z]:$=Be,re.copy(y.viewport),he.copy(y.scissor),We=y.scissorTest}else re.copy(De).multiplyScalar(J).floor(),he.copy(pt).multiplyScalar(J).floor(),We=Xe;if(Z!==0&&($=z),_.bindFramebuffer(F.FRAMEBUFFER,$)&&_.drawBuffers(y,$),_.viewport(re),_.scissor(he),_.setScissorTest(We),K){const be=X.get(y.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_CUBE_MAP_POSITIVE_X+G,be.__webglTexture,Z)}else if(Ae){const be=G;for(let Ne=0;Ne<y.textures.length;Ne++){const Be=X.get(y.textures[Ne]);F.framebufferTextureLayer(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0+Ne,Be.__webglTexture,Z,be)}}else if(y!==null&&Z!==0){const be=X.get(y.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,be.__webglTexture,Z)}te=-1},this.readRenderTargetPixels=function(y,G,Z,$,K,Ae,Re,be=0){if(!(y&&y.isWebGLRenderTarget)){ht("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ne=X.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&Re!==void 0&&(Ne=Ne[Re]),Ne){_.bindFramebuffer(F.FRAMEBUFFER,Ne);try{const Be=y.textures[be],Qe=Be.format,nt=Be.type;if(y.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+be),!P.textureFormatReadable(Qe)){ht("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!P.textureTypeReadable(nt)){ht("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}G>=0&&G<=y.width-$&&Z>=0&&Z<=y.height-K&&F.readPixels(G,Z,$,K,xe.convert(Qe),xe.convert(nt),Ae)}finally{const Be=W!==null?X.get(W).__webglFramebuffer:null;_.bindFramebuffer(F.FRAMEBUFFER,Be)}}},this.readRenderTargetPixelsAsync=async function(y,G,Z,$,K,Ae,Re,be=0){if(!(y&&y.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ne=X.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&Re!==void 0&&(Ne=Ne[Re]),Ne)if(G>=0&&G<=y.width-$&&Z>=0&&Z<=y.height-K){_.bindFramebuffer(F.FRAMEBUFFER,Ne);const Be=y.textures[be],Qe=Be.format,nt=Be.type;if(y.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+be),!P.textureFormatReadable(Qe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!P.textureTypeReadable(nt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const He=F.createBuffer();F.bindBuffer(F.PIXEL_PACK_BUFFER,He),F.bufferData(F.PIXEL_PACK_BUFFER,Ae.byteLength,F.STREAM_READ),F.readPixels(G,Z,$,K,xe.convert(Qe),xe.convert(nt),0);const bt=W!==null?X.get(W).__webglFramebuffer:null;_.bindFramebuffer(F.FRAMEBUFFER,bt);const Ft=F.fenceSync(F.SYNC_GPU_COMMANDS_COMPLETE,0);return F.flush(),await Hc(F,Ft,4),F.bindBuffer(F.PIXEL_PACK_BUFFER,He),F.getBufferSubData(F.PIXEL_PACK_BUFFER,0,Ae),F.deleteBuffer(He),F.deleteSync(Ft),Ae}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(y,G=null,Z=0){const $=Math.pow(2,-Z),K=Math.floor(y.image.width*$),Ae=Math.floor(y.image.height*$),Re=G!==null?G.x:0,be=G!==null?G.y:0;Q.setTexture2D(y,0),F.copyTexSubImage2D(F.TEXTURE_2D,Z,0,0,Re,be,K,Ae),_.unbindTexture()},this.copyTextureToTexture=function(y,G,Z=null,$=null,K=0,Ae=0){let Re,be,Ne,Be,Qe,nt,He,bt,Ft;const Ut=y.isCompressedTexture?y.mipmaps[Ae]:y.image;if(Z!==null)Re=Z.max.x-Z.min.x,be=Z.max.y-Z.min.y,Ne=Z.isBox3?Z.max.z-Z.min.z:1,Be=Z.min.x,Qe=Z.min.y,nt=Z.isBox3?Z.min.z:0;else{const Ot=Math.pow(2,-K);Re=Math.floor(Ut.width*Ot),be=Math.floor(Ut.height*Ot),y.isDataArrayTexture?Ne=Ut.depth:y.isData3DTexture?Ne=Math.floor(Ut.depth*Ot):Ne=1,Be=0,Qe=0,nt=0}$!==null?(He=$.x,bt=$.y,Ft=$.z):(He=0,bt=0,Ft=0);const At=xe.convert(G.format),$t=xe.convert(G.type);let Ce;G.isData3DTexture?(Q.setTexture3D(G,0),Ce=F.TEXTURE_3D):G.isDataArrayTexture||G.isCompressedArrayTexture?(Q.setTexture2DArray(G,0),Ce=F.TEXTURE_2D_ARRAY):(Q.setTexture2D(G,0),Ce=F.TEXTURE_2D),_.activeTexture(F.TEXTURE0),_.pixelStorei(F.UNPACK_FLIP_Y_WEBGL,G.flipY),_.pixelStorei(F.UNPACK_PREMULTIPLY_ALPHA_WEBGL,G.premultiplyAlpha),_.pixelStorei(F.UNPACK_ALIGNMENT,G.unpackAlignment);const sn=_.getParameter(F.UNPACK_ROW_LENGTH),gt=_.getParameter(F.UNPACK_IMAGE_HEIGHT),un=_.getParameter(F.UNPACK_SKIP_PIXELS),xn=_.getParameter(F.UNPACK_SKIP_ROWS),Gn=_.getParameter(F.UNPACK_SKIP_IMAGES);_.pixelStorei(F.UNPACK_ROW_LENGTH,Ut.width),_.pixelStorei(F.UNPACK_IMAGE_HEIGHT,Ut.height),_.pixelStorei(F.UNPACK_SKIP_PIXELS,Be),_.pixelStorei(F.UNPACK_SKIP_ROWS,Qe),_.pixelStorei(F.UNPACK_SKIP_IMAGES,nt);const _i=y.isDataArrayTexture||y.isData3DTexture,wt=G.isDataArrayTexture||G.isData3DTexture;if(y.isDepthTexture){const Ot=X.get(y),Vn=X.get(G),Pt=X.get(Ot.__renderTarget),Wn=X.get(Vn.__renderTarget);_.bindFramebuffer(F.READ_FRAMEBUFFER,Pt.__webglFramebuffer),_.bindFramebuffer(F.DRAW_FRAMEBUFFER,Wn.__webglFramebuffer);for(let xi=0;xi<Ne;xi++)_i&&(F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,X.get(y).__webglTexture,K,nt+xi),F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,X.get(G).__webglTexture,Ae,Ft+xi)),F.blitFramebuffer(Be,Qe,Re,be,He,bt,Re,be,F.DEPTH_BUFFER_BIT,F.NEAREST);_.bindFramebuffer(F.READ_FRAMEBUFFER,null),_.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else if(K!==0||y.isRenderTargetTexture||X.has(y)){const Ot=X.get(y),Vn=X.get(G);_.bindFramebuffer(F.READ_FRAMEBUFFER,H),_.bindFramebuffer(F.DRAW_FRAMEBUFFER,I);for(let Pt=0;Pt<Ne;Pt++)_i?F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,Ot.__webglTexture,K,nt+Pt):F.framebufferTexture2D(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,Ot.__webglTexture,K),wt?F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,Vn.__webglTexture,Ae,Ft+Pt):F.framebufferTexture2D(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,Vn.__webglTexture,Ae),K!==0?F.blitFramebuffer(Be,Qe,Re,be,He,bt,Re,be,F.COLOR_BUFFER_BIT,F.NEAREST):wt?F.copyTexSubImage3D(Ce,Ae,He,bt,Ft+Pt,Be,Qe,Re,be):F.copyTexSubImage2D(Ce,Ae,He,bt,Be,Qe,Re,be);_.bindFramebuffer(F.READ_FRAMEBUFFER,null),_.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else wt?y.isDataTexture||y.isData3DTexture?F.texSubImage3D(Ce,Ae,He,bt,Ft,Re,be,Ne,At,$t,Ut.data):G.isCompressedArrayTexture?F.compressedTexSubImage3D(Ce,Ae,He,bt,Ft,Re,be,Ne,At,Ut.data):F.texSubImage3D(Ce,Ae,He,bt,Ft,Re,be,Ne,At,$t,Ut):y.isDataTexture?F.texSubImage2D(F.TEXTURE_2D,Ae,He,bt,Re,be,At,$t,Ut.data):y.isCompressedTexture?F.compressedTexSubImage2D(F.TEXTURE_2D,Ae,He,bt,Ut.width,Ut.height,At,Ut.data):F.texSubImage2D(F.TEXTURE_2D,Ae,He,bt,Re,be,At,$t,Ut);_.pixelStorei(F.UNPACK_ROW_LENGTH,sn),_.pixelStorei(F.UNPACK_IMAGE_HEIGHT,gt),_.pixelStorei(F.UNPACK_SKIP_PIXELS,un),_.pixelStorei(F.UNPACK_SKIP_ROWS,xn),_.pixelStorei(F.UNPACK_SKIP_IMAGES,Gn),Ae===0&&G.generateMipmaps&&F.generateMipmap(Ce),_.unbindTexture()},this.initRenderTarget=function(y){X.get(y).__webglFramebuffer===void 0&&Q.setupRenderTarget(y)},this.initTexture=function(y){y.isCubeTexture?Q.setTextureCube(y,0):y.isData3DTexture?Q.setTexture3D(y,0):y.isDataArrayTexture||y.isCompressedArrayTexture?Q.setTexture2DArray(y,0):Q.setTexture2D(y,0),_.unbindTexture()},this.resetState=function(){k=0,D=0,W=null,_.reset(),fe.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return bn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=ft._getDrawingBufferColorSpace(e),t.unpackColorSpace=ft._getUnpackColorSpace()}}const Jn=1024,ai=512,Gm=90;class Vm{constructor(e,t,n,r,s){Dt(this,"renderer");Dt(this,"camera");Dt(this,"scene");Dt(this,"terrain");Dt(this,"texture");Dt(this,"W");Dt(this,"H");Dt(this,"maxElev",0);Dt(this,"minElev",0);Dt(this,"cam");Dt(this,"fitDist");Dt(this,"needsRender",!0);Dt(this,"onCameraChange",null);Dt(this,"world");Dt(this,"hlUniforms",{hoverId:{value:new st(-10,-10)},selId:{value:new st(-10,-10)}});Dt(this,"modeUniforms",{provDark:{value:.1},hierK:{value:1},washFlat:{value:0}});Dt(this,"paperUniforms",{paperLand:{value:new Ht},paperSea:{value:new Ht},paperKL:{value:0},paperKS:{value:0}});Dt(this,"washData");Dt(this,"washTex");Dt(this,"idW",0);Dt(this,"idH",0);Dt(this,"vertElev");this.world=e;const{W:a,H:o}=e;this.W=a,this.H=o;const l=Jn+1,c=ai+1;this.vertElev=new Float32Array(l*c);{const{height:S,seaBase:L,land:R}=e,U=Math.max(1,Math.round(a/Jn/2)),z=Math.max(1,Math.round(o/ai/2));for(let H=0;H<c;H++){const I=Math.round(H/ai*(o-1));for(let k=0;k<l;k++){const D=Math.round(k/Jn*(a-1));let W=0,te=0,oe=0,re=0;for(let We=-z;We<=z;We++){const dt=Math.min(o-1,Math.max(0,I+We));for(let Ge=-U;Ge<=U;Ge++){const ee=Math.min(a-1,Math.max(0,D+Ge)),ce=dt*a+ee;W+=S[ce],te++,R[ce]&&(oe+=S[ce],re++)}}let he=Math.max(0,W/te-L);if(re>0){const We=Math.max(0,oe/re-L);he=Math.max(he,We*Math.min(1,re/te*2.4))}this.vertElev[H*l+k]=Math.pow(he,.92)*Gm}}}this.renderer=new km({antialias:!0,preserveDrawingBuffer:!0}),this.renderer.setPixelRatio(Math.min(2,window.devicePixelRatio||1)),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.domElement.id="gl",n.prepend(this.renderer.domElement),this.scene=new _u;const h=new at("#878f83");this.scene.background=h,this.camera=new dn(50,window.innerWidth/window.innerHeight,2,16e3),this.texture=new Do(t),this.texture.colorSpace=tn,this.texture.anisotropy=this.renderer.capabilities.getMaxAnisotropy(),this.texture.generateMipmaps=!0,this.texture.minFilter=En,this.texture.magFilter=Wt;const u=new Vi(a,o,Jn,ai),f=u.attributes.position;let g=0;for(let S=0;S<f.count;S++){const L=this.vertElev[S];L>g&&(g=L),f.setZ(S,L)}this.maxElev=g,u.rotateX(-Math.PI/2),u.computeVertexNormals();const v=(()=>{const R=document.createElement("canvas");R.width=256,R.height=256;const U=R.getContext("2d"),z=U.createImageData(256,256),H=[];for(let D=0;D<1024;D++){let W=D*374761393+668265263|0;W=Math.imul(W^W>>>13,1274126177),H.push(((W^W>>>16)>>>0)/4294967295)}const I=D=>D*D*(3-2*D);for(let D=0;D<256;D++)for(let W=0;W<256;W++){const te=W/256*32,oe=D/256*32,re=te|0,he=oe|0,We=I(te-re),dt=I(oe-he),Ge=(re+1)%32,ee=(he+1)%32,ce=H[he*32+re],J=H[he*32+Ge],Fe=H[ee*32+re],Ve=H[ee*32+Ge];let De=ce+(J-ce)*We+(Fe-ce)*dt+(ce-J-Fe+Ve)*We*dt;const pt=W/256*32*4,Xe=D/256*32*4,je=pt|0,Je=Xe|0,et=I(pt-je),Tt=I(Xe-Je),yt=(je+1)%128,Lt=(Je+1)%128,xt=(_,V)=>H[_%32*32+V%32],ct=xt(Je,je),vt=xt(Je,yt),F=xt(Lt,je),Nt=xt(Lt,yt);De=De*.65+(ct+(vt-ct)*et+(F-ct)*Tt+(ct-vt-F+Nt)*et*Tt)*.35;const it=(D*256+W)*4,P=De*255|0;z.data[it]=P,z.data[it+1]=P,z.data[it+2]=P,z.data[it+3]=255}U.putImageData(z,0,0);const k=new Do(R);return k.wrapS=k.wrapT=Wr,k.minFilter=En,k.anisotropy=Math.min(4,this.renderer.capabilities.getMaxAnisotropy()),k})();let T;if(r&&this.renderer.capabilities.maxTextureSize>=r.width)T=new Ht(r),this.idW=r.width,this.idH=r.height;else{const S=new Uint8Array(a*o*4);for(let L=0;L<o;L++)for(let R=0;R<a;R++){const U=e.rawGrid[L*a+R],z=((o-1-L)*a+R)*4;S[z]=U&255,S[z+1]=U>>8&255,S[z+3]=255}T=new ci(S,a,o,Qt),this.idW=a,this.idH=o}T.minFilter=Bt,T.magFilter=Bt,T.generateMipmaps=!1,T.needsUpdate=!0,this.washData=new Uint8Array(256*256*4),this.washTex=new ci(this.washData,256,256,Qt),this.washTex.minFilter=this.washTex.magFilter=Bt;const p=new Uint8Array(256*256*4),d=new Uint8Array(256*256*4);{const{rawCounty:S,rawLand:L,cDuchy:R,dKing:U,kEmp:z}=e;for(let H=0;H<65536;H++){const I=S[H],k=I>=0?R[I]:-1,D=k>=0?U[k]:-1,W=D>=0?z[D]:-1,te=I>=0?I:65535,oe=k>=0?k:65535,re=H*4;p[re]=te&255,p[re+1]=te>>8,p[re+2]=oe&255,p[re+3]=oe>>8,d[re]=D>=0?D:255,d[re+1]=W>=0?W:255,d[re+2]=L[H]?255:0,d[re+3]=255}}const b=new ci(p,256,256,Qt),C=new ci(d,256,256,Qt);for(const S of[b,C])S.minFilter=S.magFilter=Bt,S.needsUpdate=!0;const x=new Uint8Array(a*o*4);{const{shade:S,land:L,coastD:R}=e;for(let U=0;U<o;U++)for(let z=0;z<a;z++){const H=U*a+z,I=((o-1-U)*a+z)*4;x[I]=Math.max(0,Math.min(255,(S[H]-.42)/.88*255))|0,x[I+1]=s?s[H]:0,x[I+2]=L[H]?24+Math.min(12,R[H])*18:0,x[I+3]=255}}const E=new ci(x,a,o,Qt);E.minFilter=E.magFilter=Wt,E.generateMipmaps=!1,E.needsUpdate=!0;const M=new Zr({map:this.texture});M.onBeforeCompile=S=>{S.uniforms.detailMap={value:v},S.uniforms.provMap={value:T},S.uniforms.washMap={value:this.washTex},S.uniforms.tierMapA={value:b},S.uniforms.tierMapB={value:C},S.uniforms.shadeMap={value:E},S.uniforms.provTexel={value:new st(1/this.idW,1/this.idH)},S.uniforms.provDark=this.modeUniforms.provDark,S.uniforms.hierK=this.modeUniforms.hierK,S.uniforms.washFlat=this.modeUniforms.washFlat,S.uniforms.hoverId=this.hlUniforms.hoverId,S.uniforms.selId=this.hlUniforms.selId,S.uniforms.paperLand=this.paperUniforms.paperLand,S.uniforms.paperSea=this.paperUniforms.paperSea,S.uniforms.paperKL=this.paperUniforms.paperKL,S.uniforms.paperKS=this.paperUniforms.paperKS,S.fragmentShader=S.fragmentShader.replace("void main() {",`
      ...
      diffuseColor.rgb = mix( diffuseColor.rgb, ps * 1.10, seaF * 0.15 );`)},this.terrain=new cn(u,M),this.scene.add(this.terrain);const w=new cn(new Vi(a*8,o*8),new Zr({color:new at("#42504f")}));w.geometry.rotateX(-Math.PI/2),w.position.y=-1.2,this.scene.add(w);const m=o*1.15/(2*Math.tan(this.camera.fov*Math.PI/180/2));this.fitDist=Math.max(m,a/(2*Math.tan(this.camera.fov*Math.PI/180/2)*this.camera.aspect)*1.06),this.scene.fog=new Wa(h,this.fitDist*.75,this.fitDist*2.1),this.cam={tx:e.landCX-a/2,tz:e.landCY-o/2,dist:this.fitDist*.72,pitch:os.degToRad(52),yaw:0},this.applyCamera(),window.addEventListener("resize",()=>{this.renderer.setSize(window.innerWidth,window.innerHeight),this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.invalidate()})}elevAtGrid(e,t){const{W:n,H:r}=this.world,s=Jn+1;let a=e/(n-1)*Jn,o=t/(r-1)*ai;a<0&&(a=0),o<0&&(o=0),a>Jn-.001&&(a=Jn-.001),o>ai-.001&&(o=ai-.001);const l=a|0,c=o|0,h=a-l,u=o-c,f=c*s+l,g=this.vertElev[f],v=this.vertElev[f+1],T=this.vertElev[f+s],p=this.vertElev[f+s+1];return g+(v-g)*h+(T-g)*u+(g-v-T+p)*h*u}elevAtWorld(e,t){return this.elevAtGrid(e+this.W/2,t+this.H/2)}applyCamera(){const e=this.cam,t=this.elevAtWorld(e.tx,e.tz)*.5,n=Math.cos(e.pitch),r=Math.sin(e.pitch);this.camera.position.set(e.tx+Math.sin(e.yaw)*n*e.dist,t+r*e.dist,e.tz+Math.cos(e.yaw)*n*e.dist),this.camera.lookAt(e.tx,t,e.tz),this.invalidate(),this.onCameraChange&&this.onCameraChange()}clampCamera(){const e=this.cam;e.dist=Math.max(70,Math.min(this.fitDist*1.25,e.dist)),e.pitch=Math.max(os.degToRad(28),Math.min(os.degToRad(80),e.pitch)),e.yaw=Math.max(-1,Math.min(1,e.yaw));const t=this.W*.62,n=this.H*.72;e.tx=Math.max(-t,Math.min(t,e.tx)),e.tz=Math.max(-n,Math.min(n,e.tz))}invalidate(){this.needsRender=!0}setPaperTextures(e,t){const n=new zl,r=[[e,this.paperUniforms.paperLand,this.paperUniforms.paperKL],[t,this.paperUniforms.paperSea,this.paperUniforms.paperKS]];for(const[s,a,o]of r)n.load(s,l=>{l.wrapS=l.wrapT=Xr,l.minFilter=En,l.anisotropy=Math.min(4,this.renderer.capabilities.getMaxAnisotropy()),a.value=l,o.value=1,this.invalidate()})}setHover(e){const t=this.hlUniforms.hoverId.value;e<0?t.set(-10,-10):t.set(e&255,e>>8&255),this.invalidate()}setSelected(e){const t=this.hlUniforms.selId.value;e<0?t.set(-10,-10):t.set(e&255,e>>8&255),this.invalidate()}setWash(e,t,n,r=!1){this.washData.set(e),this.washTex.needsUpdate=!0,this.modeUniforms.provDark.value=t,this.modeUniforms.hierK.value=n?1:0,this.modeUniforms.washFlat.value=r?1:0,this.invalidate()}render(){this.needsRender&&(this.needsRender=!1,this.renderer.render(this.scene,this.camera))}ndc(e,t){return new st(e/window.innerWidth*2-1,-(t/window.innerHeight)*2+1)}pickPlane(e,t){const n=new Ho;n.setFromCamera(this.ndc(e,t),this.camera);const r=-n.ray.origin.y/n.ray.direction.y;return!isFinite(r)||r<=0?null:n.ray.origin.clone().addScaledVector(n.ray.direction,r)}pickGround(e,t){const n=new Ho;n.setFromCamera(this.ndc(e,t),this.camera);const r=n.ray.origin,s=n.ray.direction;if(s.y>=-1e-5)return null;const a=Math.max(0,(r.y-(this.maxElev+2))/-s.y),o=r.y/-s.y,l=320;let c=a,h=-1;for(let d=0;d<=l;d++){const b=a+(o+4-a)*d/l,C=r.x+s.x*b,x=r.y+s.y*b,E=r.z+s.z*b;if(x<=this.elevAtWorld(C,E)){h=b;break}c=b}if(h<0)return null;let u=c,f=h;for(let d=0;d<18;d++){const b=(u+f)/2,C=r.x+s.x*b,x=r.y+s.y*b,E=r.z+s.z*b;x<=this.elevAtWorld(C,E)?f=b:u=b}const g=r.x+s.x*f,v=r.z+s.z*f,T=g+this.W/2,p=v+this.H/2;return T<0||p<0||T>=this.W||p>=this.H?null:{gx:T,gy:p}}projectGrid(e,t,n=3){const r=new Y(e-this.W/2,this.elevAtGrid(e,t)+n,t-this.H/2);return r.clone().sub(this.camera.position).dot(this.camera.getWorldDirection(new Y))<=0?null:(r.project(this.camera),[(r.x*.5+.5)*window.innerWidth,(1-(r.y*.5+.5))*window.innerHeight])}}function Or(i){const e=atob(i),t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n);return t}function Wm(i,e,t){let n=2.6,r=5;return i.startsWith("rock")?(n=1.4,r=3.8):/^b\d+_/.test(i)&&(i.endsWith("castle")?(n=4.4,r=4):i.endsWith("temple")?(n=3.9,r=4.4):(n=3.2,r=5)),Math.min(n/Math.max(.001,e),r/Math.max(.001,t))}function hl(i){let e=0;for(const t of i.parts)e=Math.max(e,t.hi[0]-t.lo[0],t.hi[2]-t.lo[2]);return e}async function Xm(i,e){const t=await fetch(i+"map/objects/models.json");if(!t.ok)throw new Error("models.json HTTP "+t.status);const n=await t.json(),r=new nr,s=e.W,a=e.H,o=new zl,l=new Map,c=M=>{let w=l.get(M);return w||(w=o.load(i+"map/objects/"+M,()=>e.invalidate()),w.colorSpace=tn,w.anisotropy=4,l.set(M,w)),w},h=new zu(16773853,9076848,1.9),u=new Gu(16772812,2.1);u.position.set(-.55,1,-.7),r.add(h,u);const f=new Map,g=M=>{let w=f.get(M);if(w)return w;w=[];for(const m of n.models[M].parts){const S=new Uint16Array(Or(m.v).buffer.slice(0)),L=new Uint16Array(Or(m.u).buffer.slice(0)),R=Or(m.x).buffer.slice(0),U=S.length/3,z=new Float32Array(S.length);for(let k=0;k<3;k++){const D=m.lo[k],W=m.hi[k]-m.lo[k];for(let te=0;te<U;te++)z[te*3+k]=D+S[te*3+k]/65535*W}const H=new Float32Array(L.length);for(let k=0;k<L.length;k++)H[k]=L[k]/65535;const I=new Rn;I.setAttribute("position",new rn(z,3)),I.setAttribute("uv",new rn(H,2)),I.setIndex(new rn(m.x32?new Uint32Array(R):new Uint16Array(R),1)),I.computeVertexNormals(),w.push(I)}return f.set(M,w),w},v=new Map,T=(M,w)=>{const m=M+(w?"|f":"");let S=v.get(m);return S||(S=new Iu({map:c(M),alphaTest:w?.45:.6,side:w?yn:zn}),v.set(m,S)),S},p=new Ct,d=new mi,b=new Y(0,1,0),C=new Y,x=new Y;for(const[M,w]of Object.entries(n.inst)){const m=n.models[M];if(!m)continue;const S=Or(w.d),L=w.n,R=!/^b\d+_/.test(M)&&!M.startsWith("rock"),U=Wm(M,m.hgt,hl(m)),H=g(M).map((I,k)=>{const D=new Lo(I,T(m.parts[k].tex,R),L);return D.frustumCulled=!1,D});for(let I=0;I<L;I++){const k=I*6,D=S[k]|S[k+1]<<8,W=S[k+2]|S[k+3]<<8,te=S[k+4]/255*Math.PI*2,oe=(.25+S[k+5]/255*2.75)*U,re=e.elevAtGrid(D,W);d.setFromAxisAngle(b,te),p.compose(C.set(D-s/2,re,W-a/2),d,x.set(oe,oe,oe));for(const he of H)he.setMatrixAt(I,p)}for(const I of H)I.instanceMatrix.needsUpdate=!0,r.add(I)}const E=new Map;for(const M of n.spec)n.models[M.k]&&(E.get(M.k)??E.set(M.k,[]).get(M.k)).push(M);for(const[M,w]of E){const m=n.models[M],S=g(M),L=hl(m),R=4/Math.max(.001,m.hgt),U=Math.min(17/Math.max(.001,m.hgt),22/Math.max(.001,L)),z=S.map((H,I)=>{const k=new Lo(H,T(m.parts[I].tex,!1),w.length);return k.frustumCulled=!1,k});w.forEach((H,I)=>{const k=Math.max(e.elevAtGrid(H.x,H.y),.15),D=Math.min(Math.max(H.s*.5*1.6,R),Math.max(R,U));d.setFromAxisAngle(b,H.r),p.compose(C.set(H.x-s/2,k,H.y-a/2),d,x.set(D,D,D));for(const W of z)W.setMatrixAt(I,p)});for(const H of z)H.instanceMatrix.needsUpdate=!0,r.add(H)}return e.scene.add(r),e.invalidate(),r}function Bs(i){const{np:e,pArea:t,pCX:n,pCY:r,W:s,H:a}=i;function o(d,b,C){const x=new Float64Array(d),E=new Float64Array(d),M=new Float64Array(d),w=new Float64Array(d),m=new Float64Array(d),S=new Float64Array(d);for(let R=0;R<e;R++){const U=b[R];if(U<0)continue;const z=t[R],H=n[R],I=r[R];x[U]+=H*z,E[U]+=I*z,M[U]+=z,w[U]+=H*H*z,m[U]+=I*I*z,S[U]+=H*I*z}const L=[];for(let R=0;R<d;R++){if(M[R]<1)continue;const U=x[R]/M[R],z=E[R]/M[R],H=w[R]/M[R]-U*U,I=m[R]/M[R]-z*z,k=S[R]/M[R]-U*z,D=.5*Math.atan2(2*k,H-I),W=H+I,te=H*I-k*k,oe=Math.sqrt(Math.max(0,W*W/4-te));L.push({x:U,y:z,angle:D,ext:Math.sqrt(Math.max(1,W/2+oe)),name:C[R],area:M[R],idx:R})}return L}const l=o(i.nKing,i.kingOf,i.kingName),c=o(i.nEmp,i.empOf,i.empName),h=new Float64Array(i.nCounty),u=new Float64Array(i.nCounty),f=new Float64Array(i.nCounty);for(let d=0;d<e;d++){const b=i.countyOf[d];b<0||(h[b]+=n[d]*t[d],u[b]+=r[d]*t[d],f[b]+=t[d])}const g=(d,b)=>{for(const C of d){const x=b[C.idx];x>=0&&f[x]>0&&(C.capX=h[x]/f[x],C.capY=u[x]/f[x])}};g(l,i.kCapital),g(c,i.eCapital);const v=i.seaLabels.map(d=>({x:d.x,y:d.y,name:d.n,area:d.a,ext:Math.sqrt(d.a)*.9})),T=[],p=Math.max(40,s*a/e*.25);for(let d=0;d<e;d++)t[d]<p||T.push({x:n[d],y:r[d],name:i.provName[d],ext:Math.hypot(i.pMaxX[d]-i.pMinX[d],i.pMaxY[d]-i.pMinY[d])/2,area:t[d]});return{king:l,emp:c,prov:T,sea:v,straits:i.straits,duchy:o(i.nDuchy,i.duchyOf,i.duchyName),county:o(i.nCounty,i.countyOf,i.countyName)}}const zs='"Iowan Old Style",Palatino,Georgia,serif',Hs=new Map;function qm(i,e){let t=Hs.get(i);if(t!==void 0)return t&&t.complete&&t.naturalWidth?t:null;const n=new Image;return n.onload=()=>{e&&e()},n.onerror=()=>Hs.set(i,null),n.src=i,Hs.set(i,n),null}function Ym(i,e,t,n,r,s){const a=window.innerWidth,o=window.innerHeight;i.clearRect(0,0,a,o),i.textAlign="center",i.textBaseline="middle";const l=t.cam.dist,c=l>t.fitDist*.55,h=l<680,u=[],f=[];document.querySelectorAll(".panel").forEach(b=>{if(b.classList.contains("hidden"))return;const C=getComputedStyle(b);if(C.display==="none"||C.visibility==="hidden")return;const x=b.getBoundingClientRect();x.width&&x.height&&f.push(x)});const g=44;function v(b,C,x,E){if(b-x<g||b+x>a-g||C-E<g||C+E>o-g)return!0;for(const M of f)if(b+x>M.left-6&&b-x<M.right+6&&C+E>M.top-6&&C-E<M.bottom+6)return!0;return!1}function T(b,C,x,E){if(v(b,C,x,E))return!1;for(const M of u)if(Math.abs(b-M.x)<x+M.hw&&Math.abs(C-M.y)<E+M.hh)return!1;return!0}function p(b){const C=t.projectGrid(b.x,b.y);if(!C)return null;const x=Math.cos(b.angle)*b.ext,E=Math.sin(b.angle)*b.ext,M=t.projectGrid(b.x-x,b.y-E),w=t.projectGrid(b.x+x,b.y+E);if(!M||!w)return null;let m=Math.atan2(w[1]-M[1],w[0]-M[0]);return m>Math.PI/2&&(m-=Math.PI),m<-Math.PI/2&&(m+=Math.PI),{sx:C[0],sy:C[1],screenExt:Math.hypot(w[0]-M[0],w[1]-M[1]),rot:m}}function d(b,C,x,E,M,w){const m=p(b);if(!m||m.sx<-320||m.sx>a+320||m.sy<-200||m.sy>o+200)return;i.font=`600 ${C}px ${zs}`;const S=b.name.toUpperCase();let L=0;const R=[];for(const D of S){const W=i.measureText(D).width;R.push(W),L+=W}let U=S.length>1?(M-L)/(S.length-1):0;U=Math.max(C*.08,Math.min(U,C*.9));const z=L+U*(S.length-1),H=z*.5*.8+8,I=C*.62+5;if(!T(m.sx,m.sy,H,I))return;u.push({x:m.sx,y:m.sy,hw:H,hh:I}),i.save(),i.translate(m.sx,m.sy),i.rotate(m.rot),i.globalAlpha=w,i.lineJoin="round";let k=-z/2;for(let D=0;D<S.length;D++){const W=S[D],te=R[D],oe=k+te/2;i.lineWidth=C*.2,i.strokeStyle=E,i.strokeText(W,oe,0),i.fillStyle=x,i.fillText(W,oe,0),k+=te+U}i.restore()}{const b=Math.max(20,Math.min(46,9e3/l)),C=[],x=(E,M,w,m)=>{const S=t.projectGrid(M.capX??M.x,M.capY??M.y,4);if(!S)return;let L=S[0];const R=S[1];if(L<-w||L>a+w||R<-w||R>o+w*2)return;for(let z=0,H=!0;H&&z<8;z++){H=!1;for(const I of C)Math.abs(L-I.x)<(w+I.s)/2&&Math.abs(R-I.y)<(w+I.s)/2&&(L=I.x+(w+I.s)/2+3,H=!0)}const U=qm(`${n}${E}_${M.idx}.png`,r??null);U&&(i.save(),i.shadowColor="rgba(0,0,0,0.55)",i.shadowBlur=6,i.shadowOffsetY=2,i.drawImage(U,L-w/2,R-w,w,w),i.restore(),C.push({x:L,y:R,s:w}),m&&u.push({x:L,y:R-w/2,hw:w/2+3,hh:w/2+3}))};for(const E of e.emp)x("e",E,b,!0);for(const E of e.king)x("k",E,b,!0);if(s!=null&&s.d)for(const E of e.duchy)x("d",E,b*.78,!1);if(s!=null&&s.c)for(const E of e.county)x("c",E,b*.6,!1)}{i.save(),i.setLineDash([7,5]),i.lineWidth=1.6,i.strokeStyle="rgba(146, 44, 30, 0.75)";for(const b of e.straits){const C=t.projectGrid(b[0],b[1],1.5),x=t.projectGrid(b[2],b[3],1.5);if(!C||!x)continue;const E=Math.hypot(x[0]-C[0],x[1]-C[1]);E<7||E>620||Math.max(C[0],x[0])<0||Math.min(C[0],x[0])>a||Math.max(C[1],x[1])<0||Math.min(C[1],x[1])>o||(i.beginPath(),i.moveTo(C[0],C[1]),i.lineTo(x[0],x[1]),i.stroke())}i.restore()}if(c)for(const b of[...e.emp].sort((C,x)=>x.area-C.area)){const C=p(b);if(!C)continue;const x=Math.max(22,Math.min(C.screenExt*2*.15,56));d(b,x,"rgba(26,20,12,0.86)","rgba(238,228,198,0.4)",Math.min(C.screenExt*2*.9,a*.62),.9)}{const b=c?.85:1;for(const C of[...e.king].sort((x,E)=>E.area-x.area)){const x=p(C);if(!x)continue;const E=x.screenExt*2;if(E<62)continue;let M=Math.max(13,Math.min(E*.18,40));M*.62>E*.95/Math.max(3,C.name.length)&&(M=Math.max(12,E*.95/(C.name.length*.62))),d(C,M,"rgba(26,20,12,0.94)","rgba(238,226,192,0.5)",Math.min(E*.86,a*.5),b)}}{i.save(),i.textAlign="center",i.textBaseline="middle";for(const b of e.sea){const C=t.projectGrid(b.x,b.y,1);if(!C)continue;const[x,E]=C;if(x<-60||x>a+60||E<-40||E>o+40)continue;const M=t.projectGrid(b.x+b.ext,b.y,1),w=M?Math.abs(M[0]-x):0,m=Math.max(10,Math.min(w*.3,26));if(m<10)continue;i.font=`italic 600 ${m}px ${zs}`;const S=i.measureText(b.name).width*.5+6,L=m*.6+3;T(x,E,S,L)&&(u.push({x,y:E,hw:S,hh:L}),i.globalAlpha=.78,i.lineWidth=m*.18,i.strokeStyle="rgba(26,34,34,0.5)",i.strokeText(b.name,x,E),i.fillStyle="rgba(205,221,218,0.92)",i.fillText(b.name,x,E))}i.globalAlpha=1,i.restore()}if(h){const b=Math.min(1,(680-l)/220);for(const C of[...e.prov].sort((x,E)=>E.area-x.area)){const x=t.projectGrid(C.x,C.y);if(!x)continue;const[E,M]=x;if(E<0||E>a||M<0||M>o)continue;const w=t.projectGrid(C.x+C.ext,C.y),m=w?Math.abs(w[0]-E):0,S=Math.max(9,Math.min(m*.32,16));if(S<9)continue;i.font=`600 ${S}px ${zs}`;const L=i.measureText(C.name).width*.5+4,R=S*.6+3;T(E,M,L,R)&&(u.push({x:E,y:M,hw:L,hh:R}),i.globalAlpha=b,i.lineWidth=S*.28,i.strokeStyle="rgba(242,232,202,0.78)",i.strokeText(C.name,E,M),i.fillStyle="rgba(26,20,10,0.96)",i.fillText(C.name,E,M))}}i.globalAlpha=1}const Jt="/ck3/world/",Se=i=>document.getElementById(i),pl=()=>new Promise(i=>requestAnimationFrame(()=>i())),$m=[["political","Political"],["province","Provinces"],["terrain","Terrain"],["elevation","Elevation"],["culture","Culture"],["faith","Faith"],["development","Development"]];async function Km(){const i=Se("loading"),e=async A=>{i.style.display="flex",i.textContent=A,await pl(),await pl()},t=new Promise(A=>{const O=new Image;O.onload=()=>A(O),O.onerror=()=>A(null),O.src=Jt+"map/prov8.png"});await e("Loading the map…");const n=await tc(1420,Jt);Se("date").textContent=`${n.date} · Anno Aldermarki`,await e("Shading the relief…"),nc(n),await e("Baking the map…");const r=ic(n);n.cloud=null;const s=document.createElement("canvas");s.width=n.W,s.height=n.H;const a=s.getContext("2d",{willReadFrequently:!0}),o=a.createImageData(n.W,n.H);let l="political",c=!1;is(n,r,l,o),a.putImageData(o,0,0),await e("Raising the terrain…");const h=await t,u=new Vm(n,s,document.body,h,r.snow),f=u.renderer.domElement;u.setPaperTextures(Jt+"map/ui/paper_land.png",Jt+"map/ui/paper_sea.png");{const A=document.createElement("img");A.src=Jt+"map/ui/vignette.png",A.id="vig",A.alt="",document.body.appendChild(A)}const g=new Uint8Array(65536).fill(40);for(let A=0;A<n.np;A++)g[n.rawOf[A]]=n.devOf[A];const v=new Uint8Array(256*256*4);function T(A){v.fill(0);const{rawCounty:O,rawCult:le,rawFaith:de,rawLand:ye,cDuchy:Le,dKing:$e,kEmp:ze,kColor:Ke,cultCol:rt,faithCol:B}=n,q=A==="province"?0:.16,ae=(ut,ot,mt)=>{const Mt=ot[0]*.3+ot[1]*.59+ot[2]*.11,y=ut*4;v[y]=ot[0]+(Mt-ot[0])*q,v[y+1]=ot[1]+(Mt-ot[1])*q,v[y+2]=ot[2]+(Mt-ot[2])*q,v[y+3]=mt*255|0};if(A!=="terrain"&&A!=="elevation"){for(let ut=0;ut<65536;ut++)if(ye[ut])if(A==="political"){const ot=O[ut],mt=ot>=0?Le[ot]:-1,Mt=mt>=0?$e[mt]:-1;Mt>=0&&ae(ut,Ke[Mt],.52)}else if(A==="province"){const ot=ut*2654435761>>>0;ae(ut,[80+(ot&175),80+(ot>>8&175),80+(ot>>16&175)],.97)}else if(A==="culture"){const ot=le[ut];ot>=0&&ae(ut,rt[ot],.5)}else if(A==="faith"){const ot=de[ut];ot>=0&&ae(ut,B[ot],.5)}else A==="development"&&ae(ut,sc(g[ut]),.56)}const Me=A==="terrain"||A==="elevation";u.setWash(v,Me?0:A==="province"?.42:.1,A==="political"||A==="culture"||A==="faith"||A==="development",A==="province");const Ue=document.getElementById("vig");Ue&&(Ue.style.display=A==="province"?"none":"");const Rt=A==="elevation";Rt!==c&&(c=Rt,is(n,r,A,o),a.putImageData(o,0,0),u.texture.needsUpdate=!0),u.invalidate()}T(l);let p=null;Xm(Jt,u).then(A=>{p=A;const O=Se("objs");O&&(O.className="on")}).catch(A=>console.warn("map objects unavailable:",A));const d=Se("labels"),b=d.getContext("2d");let C=Bs(n),x=!0;const E={d:!1,c:!1};for(const A of["d","c"])fetch(`${Jt}map/ui/coa/${A}_0.png`,{method:"HEAD"}).then(O=>{O.ok&&(E[A]=!0,x=!0)}).catch(()=>{});const M=Math.min(2,window.devicePixelRatio||1),w=()=>{d.width=window.innerWidth*M,d.height=window.innerHeight*M,d.style.width=window.innerWidth+"px",d.style.height=window.innerHeight+"px",b.setTransform(M,0,0,M,0,0),x=!0};w(),window.addEventListener("resize",w),u.onCameraChange=()=>{x=!0};const m=["No Holding","Castle","City","Temple","Tribe"],S=(A,...O)=>{const le=A.map(de=>de+".png");for(const de of O){const ye=n.artPools[de];ye&&le.push(...ye)}return le},L={castle:S(["holding_1","art_fortress"],"castle"),city:S(["art_city1","art_city2"],"city"),port:S(["art_port"],"port"),temple:S(["holding_3"],"temple"),tribal:S(["art_tribal"],"tribal"),terr:{[ke.BEACH]:S(["terr_beach","art_coast"],"coast","port"),[ke.PLAINS]:S(["terr_plains"],"plains"),[ke.FARM]:S(["terr_farm","art_farm"],"farm"),[ke.FOREST]:S(["terr_forest"],"forest","jungle"),[ke.HILLS]:S(["terr_hills"],"mountain"),[ke.DRY]:S(["terr_desert","art_desert","art_ruin","art_river"],"desert","ruin","river"),[ke.WET]:S(["terr_wet","art_swamp","art_lakes"],"swamp"),[ke.MTN]:S(["terr_mtn"],"mountain"),[ke.SNOW]:S(["terr_mtn"],"snow","mountain")}},R=new Map;function U(A){return R.get(A)??""}const z=A=>`<span class="swatch" style="background:rgb(${A[0]},${A[1]},${A[2]})"></span>`;let H=-1;function I(A){H=A,u.setSelected(A<0?-1:n.rawOf[A]);const O=Se("sel");if(A<0){O.style.display="none";return}Se("faith").classList.remove("open");const le=n.countyOf[A],de=n.duchyOf[A],ye=n.kingOf[A],Le=n.empOf[A],$e=n.cultureOf[A],ze=n.faithOf[A],Ke=n.holdingOf[A];Se("selName").textContent=n.provName[A];let rt=le>=0?`${m[Ke]} in the County of ${n.countyName[le]}`:"Uncolonised wasteland";le>=0&&Le>=0&&n.eCapital[Le]===le?rt+=" · Imperial Capital":le>=0&&ye>=0&&n.kCapital[ye]===le&&(rt+=" · Royal Capital"),Se("selSub").textContent=rt;const B=[],q=(mt,Mt)=>`<img class="coa" src="${Jt}map/ui/coa/${mt}_${Mt}.png" alt="" onerror="this.remove()">`;de>=0&&B.push(`<span class="chip" style="--cc:#8a7f66">${n.duchyName[de]}</span>`),ye>=0&&B.push(`<span class="chip flagged rlink" data-realm="k:${ye}" title="About this realm">${q("k",ye)}${n.kingName[ye]}</span>`),Le>=0&&B.push(`<span class="chip flagged rlink" data-realm="e:${Le}" title="About this realm">${q("e",Le)}${n.empName[Le]}</span>`),Se("selChips").innerHTML=B.join(""),Se("selChips").querySelectorAll(".rlink").forEach(mt=>{mt.onclick=()=>{const[Mt,y]=mt.dataset.realm.split(":");We(Mt,+y)}});const ae=mt=>!mt||/^wasteland/i.test(mt),Me=ze>=0&&n.faithHasIcon[ze]?`<img class="fic" src="${Jt}map/ui/faith_${ze}.png" alt="">`:ze>=0?z(n.faithCol[ze]):"";Se("selBody").innerHTML=`<div class="k">Terrain</div><div>${ti[n.pTerr[A]]}</div>`+($e>=0&&!ae(n.cultName[$e])?`<div class="k">Culture</div><div>${z(n.cultCol[$e])}<a class="flink" data-culture="${$e}" title="About this culture">${n.cultName[$e]}</a></div>`:"")+(ze>=0&&!ae(n.faithName[ze])?`<div class="k">Faith</div><div>${Me}<a class="flink" data-faith="${ze}" title="About this faith">${n.faithName[ze]}</a></div>`:"")+`<div class="k">Development</div><div>${n.devOf[A]}</div>`,Se("selBody").querySelectorAll("a.flink").forEach(mt=>{mt.onclick=Mt=>{Mt.preventDefault(),mt.dataset.faith?oe(+mt.dataset.faith):mt.dataset.culture&&re(+mt.dataset.culture)}});const Ue=(mt,Mt)=>mt&&Mt?`<a class="flink" data-char="${mt}" title="About this ruler">${Mt}</a>`:Mt??"",Rt=[];if(le>=0){const mt=n.countyHolder[le];Rt.push(`<div><span class="k">County Holder:</span> <b>${ae(mt)?"uncolonised":Ue(n.countyHolderKey[le],mt)}</b></div>`)}if(ye>=0&&n.kingHolder[ye]&&Rt.push(`<div><span class="k">${n.kingName[ye]}:</span> <b>${Ue(n.kingHolderKey[ye],n.kingHolder[ye])}</b></div>`),Le>=0&&n.empHolder[Le]&&Rt.push(`<div><span class="k">${n.empName[Le]}:</span> <b>${Ue(n.empHolderKey[Le],n.empHolder[Le])}</b></div>`),Se("selHolders").innerHTML=Rt.join(""),Se("selHolders").style.display=Rt.length?"block":"none",Se("selHolders").querySelectorAll("a[data-char]").forEach(mt=>{mt.onclick=Mt=>{Mt.preventDefault(),he(mt.dataset.char)}}),le>=0){const mt=[];for(let Mt=0;Mt<n.np&&mt.length<40;Mt++)n.countyOf[Mt]===le&&mt.push(Mt===A?`<b>${n.provName[Mt]}</b>`:`${n.provName[Mt]}${n.holdingOf[Mt]?` (${m[n.holdingOf[Mt]].toLowerCase()})`:""}`);Se("selBars").innerHTML='<span class="k">Baronies:</span> '+mt.join(" · "),Se("selBars").style.display="block"}else Se("selBars").style.display="none";const ut=Se("selIllu"),ot=U(A);ot?(ut.style.display="block",ut.onerror=()=>{ut.style.display="none"},ut.src=`${Jt}map/ui/${ot}`):ut.style.display="none",O.style.display="block"}let k=null;function D(A){let O=-1,le=0;for(let de=0;de<n.np;de++)n.countyOf[de]===A&&n.pArea[de]>le&&(le=n.pArea[de],O=de);O<0||(u.cam.tx=n.pCX[O]-n.W/2,u.cam.tz=n.pCY[O]-n.H/2,u.cam.dist=Math.min(u.cam.dist,320),u.clampCamera(),u.applyCamera(),I(O))}function W(A,O,le,de){Se("sel").style.display="none",k=de,Se("faithName").innerHTML=A,Se("faithSub").textContent=O,Se("faithBody").innerHTML=le,Se("faithMode").style.display=de?"":"none",Se("faith").classList.add("open"),Se("faithBody").querySelectorAll("a[data-county]").forEach(ye=>{ye.onclick=Le=>{Le.preventDefault(),D(+ye.dataset.county)}}),Se("faithBody").querySelectorAll("a[data-char]").forEach(ye=>{ye.onclick=Le=>{Le.preventDefault(),he(ye.dataset.char)}}),Se("faithBody").querySelectorAll("a[data-culture]").forEach(ye=>{ye.onclick=Le=>{Le.preventDefault(),re(+ye.dataset.culture)}}),Se("faithBody").querySelectorAll("a[data-realm]").forEach(ye=>{ye.onclick=Le=>{Le.preventDefault();const[$e,ze]=ye.dataset.realm.split(":");We($e,+ze)}})}const te=(A,O)=>A&&O?`<a class="hsite" data-char="${A}">${O}</a>`:O??"vacant";function oe(A){const O=n.faithHasIcon[A]?`<img class="fic" src="${Jt}map/ui/faith_${A}.png" alt="">`:z(n.faithCol[A]);let le=0;for(let Le=0;Le<n.np;Le++)n.faithOf[Le]===A&&le++;const de=[n.faithRelig[A],n.faithAdh[A]?`followers: ${n.faithAdh[A]}s`:null,`${le} provinces`].filter(Boolean);let ye="";n.faithDesc[A]&&(ye+=`<div class="desc">${n.faithDesc[A]}</div>`),n.faithTenets[A].length&&(ye+=`<div class="sect"><span class="k">Tenets:</span> <b>${n.faithTenets[A].join("</b> · <b>")}</b></div>`),n.faithSites[A].length&&(ye+='<div class="sect"><span class="k">Holy sites:</span> '+n.faithSites[A].map(Le=>`<a class="hsite" data-county="${Le.c}">${Le.n}</a>`).join(" · ")+"</div>"),W(`${O}${n.faithName[A]}`,de.join(" · "),ye,"faith")}function re(A){let O=0;for(let ye=0;ye<n.np;ye++)n.cultureOf[ye]===A&&O++;const le=[n.cultHeritage[A]?`${n.cultHeritage[A]} heritage`:null,n.cultLang[A]?`speaks ${n.cultLang[A]}`:null,`${O} provinces`].filter(Boolean);let de='<div class="grid" style="display:grid;grid-template-columns:auto 1fr;gap:4px 12px;font-size:13px">';n.cultEthos[A]&&(de+=`<div class="k">Ethos</div><div><b>${n.cultEthos[A]}</b></div>`),n.cultMartial[A]&&(de+=`<div class="k">Warriors</div><div>${n.cultMartial[A]}</div>`),de+="</div>",n.cultTrad[A].length&&(de+=`<div class="sect"><span class="k">Traditions:</span> <b>${n.cultTrad[A].join("</b> · <b>")}</b></div>`),W(`${z(n.cultCol[A])}${n.cultName[A]}`,le.join(" · "),de,"culture")}function he(A){const O=n.chars[A];if(!O)return;const le=["Diplomacy","Martial","Stewardship","Intrigue","Learning"],de=O.b?`born ${O.b}${O.dd?`, died ${O.dd}`:""} · year is ${n.date}`:"";let ye="";O.mo&&(ye+=`<div class="desc" style="font-style:italic">“${O.mo}”</div>`);const Le=O.sk.map((ze,Ke)=>ze==null?null:`<div class="k">${le[Ke]}</div><div><b>${ze}</b></div>`).filter(Boolean).join("");if(Le&&(ye+=`<div class="grid" style="display:grid;grid-template-columns:auto 1fr;gap:3px 12px;font-size:13px;margin-top:6px">${Le}</div>`),O.tr.length){const ze=O.tr.map((Ke,rt)=>{var ae;const B=((ae=O.ti)==null?void 0:ae[rt])??-1;return`<span class="trchip">${B>=0?`<img class="tric" src="map/ui/tr_${B}.png" alt="">`:""}<b>${Ke}</b></span>`}).join(" ");ye+=`<div class="sect"><span class="k">Traits:</span> ${ze}</div>`}const $e=O.dy?`${O.n} of House ${O.dy}`:O.n;W($e,de,ye,null)}function We(A,O){const le=`<img class="fic" src="${Jt}map/ui/coa/${A}_${O}.png" alt="" onerror="this.remove()">`;let de=0;const ye=A==="k"?n.kingOf:n.empOf;for(let $e=0;$e<n.np;$e++)ye[$e]===O&&de++;let Le="";if(A==="k"){const $e=n.kEmp[O],ze=[$e>=0?`part of ${n.empName[$e]}`:"independent",`${de} provinces`];Le+=`<div class="sect" style="padding-top:0"><span class="k">Ruler:</span> <b>${te(n.kingHolderKey[O],n.kingHolder[O])}</b></div>`,n.kCapital[O]>=0&&(Le+=`<div class="sect"><span class="k">Capital:</span> <a class="hsite" data-county="${n.kCapital[O]}">${n.countyName[n.kCapital[O]]}</a></div>`);const Ke=[];for(let rt=0;rt<n.nDuchy;rt++)n.dKing[rt]===O&&Ke.push(rt);Ke.length&&(Le+='<div class="sect"><span class="k">De jure duchies:</span> '+Ke.map(rt=>`<b>${n.duchyName[rt]}</b>`).join(" · ")+"</div>"),W(`${le}${n.kingName[O]}`,ze.join(" · "),Le,"political")}else{const $e=[`${de} provinces`];Le+=`<div class="sect" style="padding-top:0"><span class="k">Ruler:</span> <b>${te(n.empHolderKey[O],n.empHolder[O])}</b></div>`,n.eCapital[O]>=0&&(Le+=`<div class="sect"><span class="k">Capital:</span> <a class="hsite" data-county="${n.eCapital[O]}">${n.countyName[n.eCapital[O]]}</a></div>`);const ze=[];for(let Ke=0;Ke<n.nKing;Ke++)n.kEmp[Ke]===O&&ze.push(Ke);ze.length&&(Le+='<div class="sect"><span class="k">De jure kingdoms:</span> '+ze.map(Ke=>`<a class="hsite" data-realm="k:${Ke}">${n.kingName[Ke]}</a>`).join(" · ")+"</div>"),W(`${le}${n.empName[O]}`,$e.join(" · "),Le,"political")}}Se("faithClose").onclick=()=>{Se("faith").classList.remove("open"),H>=0&&(Se("sel").style.display="block")},Se("faithMode").onclick=()=>{k&&(l=k,[...Se("modes").children].forEach(A=>{A.className=A.dataset.mode===k?"on":""}),T(k))};const dt=[ke.BEACH,ke.PLAINS,ke.FARM,ke.FOREST,ke.HILLS,ke.DRY,ke.WET,ke.MTN,ke.SNOW],Ge=new Map,ee=new Map;let ce=!1,J=-1;const Fe=Se("edit"),Ve=Se("edName"),De=Se("edTerr"),pt=Se("edCult"),Xe=Se("edFaith"),je=Se("edHold"),Je=Se("edDev"),et=Se("edArtWrap"),Tt=Se("edArtBtn"),yt=Se("edArtThumb"),Lt=Se("edArtLabel"),xt=Se("edArtList"),ct=Se("edPrev"),vt=Se("dledits"),F=(A,O)=>{const le=document.createElement("option");return le.value=A,le.textContent=O,le};{for(const A of dt)De.appendChild(F(String(A),ti[A]));pt.appendChild(F("-1","(none)")),n.cultName.forEach((A,O)=>pt.appendChild(F(String(O),A))),Xe.appendChild(F("-1","(none)")),n.faithName.forEach((A,O)=>Xe.appendChild(F(String(O),A))),m.forEach((A,O)=>je.appendChild(F(String(O),A)))}const Nt=A=>A.replace(/\.(png|jpg)$/,"").replace(/^(art_|terr_|holding_)/,"").replace(/_/g," ");function it(A){const O=R.get(A)??"";Lt.textContent=O?Nt(O):"(no picture)",O?(yt.style.display="",yt.src=`${Jt}map/ui/${O}`):yt.style.display="none"}function P(A){const O=new Set;for(const[$e,ze]of R)$e!==A&&O.add(ze);const le=R.get(A)??"";let de=`<div class="arow${le===""?" cur":""}" data-f="">(no picture)</div>`;const ye=new Set,Le=($e,ze)=>{let Ke="";for(const rt of ze)ye.has(rt)||O.has(rt)||(ye.add(rt),Ke+=`<div class="arow${rt===le?" cur":""}" data-f="${rt}"><img loading="lazy" src="${Jt}map/ui/${rt}" alt=""><span>${Nt(rt)}</span></div>`);Ke&&(de+=`<div class="ahdr">${$e}</div>`+Ke)};Le("Castles",L.castle),Le("Cities",L.city),Le("Ports",L.port),Le("Temples",L.temple),Le("Tribal",L.tribal);for(const $e of dt)Le(ti[$e],L.terr[$e]??[]);xt.innerHTML=de,xt.querySelectorAll(".arow").forEach($e=>{$e.onclick=()=>_($e.dataset.f??"")}),it(A)}function _(A){if(xt.classList.remove("open"),J<0)return;const O=X(J);A?R.set(J,A):R.delete(J),O.art=A,Q(J),ge(),P(J)}function V(){vt.style.display=Ge.size?"":"none",vt.textContent=`Save edits (${Ge.size})`}function X(A){ee.has(A)||ee.set(A,{name:n.provName[A],terrain:n.pTerr[A],culture:n.cultureOf[A],faith:n.faithOf[A],holding:n.holdingOf[A],dev:n.devOf[A]});let O=Ge.get(A);return O||(O={},Ge.set(A,O)),O}function Q(A){const O=Ge.get(A),le=ee.get(A);!O||!le||(O.name===le.name&&delete O.name,O.terrain===le.terrain&&delete O.terrain,O.culture===le.culture&&delete O.culture,O.faith===le.faith&&delete O.faith,O.holding===le.holding&&delete O.holding,O.dev===le.dev&&delete O.dev,O.art===""&&delete O.art,Object.keys(O).length||Ge.delete(A),V())}function ue(A,O){n.pTerr[A]=O;for(let le=n.pMinY[A];le<=n.pMaxY[A];le++)for(let de=n.pMinX[A];de<=n.pMaxX[A];de++){const ye=le*n.W+de;n.prov[ye]===A&&(n.terr[ye]=O)}rc(n,r,A),is(n,r,l,o),a.putImageData(o,0,0),u.texture.needsUpdate=!0,u.invalidate()}function ge(){if(J<0)return;const A=U(J);if(!A){ct.style.display="none";return}ct.style.display="block",ct.onerror=()=>{ct.style.display="none"},ct.src=`${Jt}map/ui/${A}`}function j(A){if(J=A,u.setSelected(A<0?-1:n.rawOf[A]),A<0){Fe.style.display="none";return}Se("sel").style.display="none",Se("faith").classList.remove("open");const O=n.countyOf[A];Se("edTitle").textContent=n.provName[A],Se("edSub").textContent=(O>=0?`County of ${n.countyName[O]}`:"Uncolonised wasteland")+` · province ${n.rawOf[A]}`,Ve.value=n.provName[A],De.value=String(n.pTerr[A]),pt.value=String(n.cultureOf[A]),Xe.value=String(n.faithOf[A]),je.value=String(n.holdingOf[A]),Je.value=String(n.devOf[A]),P(A),ge(),Fe.style.display="block"}Ve.oninput=()=>{if(J<0)return;const A=Ve.value.trim();if(!A)return;const O=X(J);n.provName[J]=A,Se("edTitle").textContent=A,O.name=A,Q(J)},Ve.onchange=()=>{C=Bs(n),x=!0},De.onchange=()=>{if(J<0)return;const A=+De.value,O=X(J);ue(J,A),O.terrain=A,Q(J)},pt.onchange=()=>{if(J<0)return;const A=+pt.value,O=X(J);n.cultureOf[J]=A,n.rawCult[n.rawOf[J]]=A,O.culture=A,Q(J),T(l)},Xe.onchange=()=>{if(J<0)return;const A=+Xe.value,O=X(J);n.faithOf[J]=A,n.rawFaith[n.rawOf[J]]=A,O.faith=A,Q(J),T(l)},je.onchange=()=>{if(J<0)return;const A=+je.value,O=X(J);n.holdingOf[J]=A,O.holding=A,Q(J)},Je.onchange=()=>{if(J<0)return;const A=Math.max(0,Math.min(100,Math.round(+Je.value||0)));Je.value=String(A);const O=X(J);n.devOf[J]=A,g[n.rawOf[J]]=A,O.dev=A,Q(J),T(l)},Tt.onclick=()=>xt.classList.toggle("open"),document.addEventListener("pointerdown",A=>{et.contains(A.target)||xt.classList.remove("open")}),Se("edRevert").onclick=()=>{const A=J;if(A<0)return;const O=ee.get(A);O&&(n.provName[A]=O.name,n.pTerr[A]!==O.terrain&&ue(A,O.terrain),n.cultureOf[A]=O.culture,n.rawCult[n.rawOf[A]]=O.culture,n.faithOf[A]=O.faith,n.rawFaith[n.rawOf[A]]=O.faith,n.holdingOf[A]=O.holding,n.devOf[A]=O.dev,g[n.rawOf[A]]=O.dev),R.delete(A),Ge.delete(A),V(),C=Bs(n),x=!0,T(l),j(A)},Se("edClose").onclick=()=>{Fe.style.display="none",J=-1,u.setSelected(H>=0?n.rawOf[H]:-1)},Se("editbtn").onclick=()=>{ce=!ce,Se("editbtn").className=ce?"on":"",ce?(Se("sel").style.display="none",Se("faith").classList.remove("open"),H>=0&&j(H)):(Fe.style.display="none",J=-1)},vt.onclick=()=>{const A=[];for(const[le,de]of Ge){const ye={id:n.rawOf[le],province:n.provName[le]};de.name!==void 0&&(ye.name=de.name),de.terrain!==void 0&&(ye.terrain=ti[de.terrain]),de.culture!==void 0&&(ye.culture=de.culture>=0?n.cultName[de.culture]:null),de.faith!==void 0&&(ye.faith=de.faith>=0?n.faithName[de.faith]:null),de.holding!==void 0&&(ye.holding=m[de.holding]),de.dev!==void 0&&(ye.development=de.dev),de.art!==void 0&&(ye.picture=de.art),A.push(ye)}const O={type:"map-edits",generated:new Date().toISOString(),edited:A.length,edits:A};vt.href=URL.createObjectURL(new Blob([JSON.stringify(O,null,2)],{type:"application/json"}))},V();const ne=(A,O)=>{const le=u.pickGround(A,O);return le?n.prov[(le.gy|0)*n.W+(le.gx|0)]:-1};let pe=!1,Pe=!1,ve=!1,_e=-1,Ie=null,Oe=[0,0],qe=[0,0];const N=Se("tip"),me=A=>{A!==_e&&(_e=A,u.setHover(A<0?-1:n.rawOf[A]))};f.addEventListener("contextmenu",A=>A.preventDefault()),f.addEventListener("pointerdown",A=>{if(ve=!1,qe=[A.clientX,A.clientY],Oe=[A.clientX,A.clientY],A.button===2||A.button===1)Pe=!0;else{pe=!0;const O=u.pickPlane(A.clientX,A.clientY);Ie=O?{x:O.x,z:O.z}:null}f.classList.add("drag"),f.setPointerCapture(A.pointerId)}),f.addEventListener("pointermove",A=>{if(Math.abs(A.clientX-qe[0])+Math.abs(A.clientY-qe[1])>4&&(ve=!0),pe&&Ie){const O=u.pickPlane(A.clientX,A.clientY);O&&(u.cam.tx+=Ie.x-O.x,u.cam.tz+=Ie.z-O.z,u.clampCamera(),u.applyCamera())}else if(Pe)u.cam.yaw-=(A.clientX-Oe[0])*.004,u.cam.pitch+=(A.clientY-Oe[1])*.003,u.clampCamera(),u.applyCamera();else{const O=ne(A.clientX,A.clientY);if(me(O),O>=0){const le=n.countyOf[O],de=n.kingOf[O],ye=n.empOf[O],Le=n.holdingOf[O],$e=Le?`<b>${n.provName[O]}</b> · ${m[Le]}`:`<b>${n.provName[O]}</b>`,ze=le>=0?`${ti[n.pTerr[O]]} · County of ${n.countyName[le]}`:ti[n.pTerr[O]],Ke=le>=0&&n.countyHolder[le]?`<br><span style="color:#b6a988">Holder:</span> ${n.countyHolder[le]}`:"",rt=de>=0?`${n.kingName[de]} · <span style="color:#b6a988">${ye>=0?n.empName[ye]:""}</span>`:'<span style="color:#b6a988">Wasteland</span>';N.innerHTML=`${$e}<br>${ze}${Ke}<br>${rt}`,N.style.display="block";let B=A.clientX+16,q=A.clientY+16;const ae=N.getBoundingClientRect();B+ae.width>window.innerWidth-8&&(B=A.clientX-ae.width-16),q+ae.height>window.innerHeight-8&&(q=A.clientY-ae.height-16),N.style.left=B+"px",N.style.top=q+"px"}else N.style.display="none"}Oe=[A.clientX,A.clientY]});const ie=A=>{const O=(pe||Pe)&&!ve&&A.button!==2&&A.button!==1;if(pe=!1,Pe=!1,Ie=null,f.classList.remove("drag"),O){const le=ne(A.clientX,A.clientY);ce?j(le):I(le)}};f.addEventListener("pointerup",ie),f.addEventListener("pointerleave",()=>{N.style.display="none",me(-1)}),f.addEventListener("wheel",A=>{A.preventDefault();const O=u.pickPlane(A.clientX,A.clientY),le=u.cam.dist;if(u.cam.dist*=Math.exp(A.deltaY*.0011),u.clampCamera(),O){const de=1-u.cam.dist/le;u.cam.tx+=(O.x-u.cam.tx)*de,u.cam.tz+=(O.z-u.cam.tz)*de,u.clampCamera()}u.applyCamera()},{passive:!1});{const A=Se("search"),O=Se("results"),le=q=>q.normalize("NFD").replace(/[̀-ͯ]/g,"").toLowerCase(),de=[],ye=(q,ae,Me=320)=>{u.cam.tx=q-n.W/2,u.cam.tz=ae-n.H/2,u.cam.dist=Math.min(u.cam.dist,Me),u.clampCamera(),u.applyCamera()},Le=(q,ae)=>{let Me=-1,Ue=0;for(let Rt=0;Rt<n.np;Rt++)q[Rt]===ae&&n.pArea[Rt]>Ue&&(Ue=n.pArea[Rt],Me=Rt);return Me},$e=(q,ae,Me)=>{let Ue=0,Rt=0,ut=0;for(let ot=0;ot<n.np;ot++)q[ot]===ae&&(Ue+=n.pCX[ot]*n.pArea[ot],Rt+=n.pCY[ot]*n.pArea[ot],ut+=n.pArea[ot]);ut&&ye(Ue/ut,Rt/ut,Me)};for(let q=0;q<n.np;q++)de.push({key:le(n.provName[q]),name:n.provName[q],type:"Province",go:()=>{ye(n.pCX[q],n.pCY[q],260),I(q)}});n.countyName.forEach((q,ae)=>de.push({key:le(q),name:q,type:"County",go:()=>{const Me=Le(n.countyOf,ae);Me>=0&&(ye(n.pCX[Me],n.pCY[Me],300),I(Me))}})),n.duchyName.forEach((q,ae)=>de.push({key:le(q),name:q,type:"Duchy",go:()=>$e(n.duchyOf,ae,420)})),n.kingName.forEach((q,ae)=>de.push({key:le(q),name:q,type:"Kingdom",go:()=>{$e(n.kingOf,ae,700),We("k",ae)}})),n.empName.forEach((q,ae)=>de.push({key:le(q),name:q,type:"Empire",go:()=>{$e(n.empOf,ae,1100),We("e",ae)}})),n.cultName.forEach((q,ae)=>{/^wasteland/i.test(q)||de.push({key:le(q),name:q,type:"Culture",go:()=>re(ae)})}),n.faithName.forEach((q,ae)=>{/^wasteland/i.test(q)||de.push({key:le(q),name:q,type:"Faith",go:()=>oe(ae)})}),n.seaLabels.forEach(q=>de.push({key:le(q.n),name:q.n,type:"Sea",go:()=>ye(q.x,q.y,900)}));let ze=[],Ke=-1;const rt=()=>{O.innerHTML=ze.map((q,ae)=>`<div class="res${ae===Ke?" hot":""}" data-i="${ae}"><span>${q.name}</span><span class="t">${q.type}</span></div>`).join(""),O.style.display=ze.length?"block":"none",O.querySelectorAll(".res").forEach(q=>{q.onmousedown=ae=>{ae.preventDefault(),B(+q.dataset.i)}})},B=q=>{const ae=ze[q];ae&&(A.value=ae.name,ze=[],Ke=-1,rt(),A.blur(),ae.go())};A.oninput=()=>{const q=le(A.value.trim());if(Ke=-1,q.length<2){ze=[],rt();return}const ae=[],Me=[];for(const Ue of de)if(Ue.key.startsWith(q)?ae.push(Ue):Ue.key.includes(q)&&Me.push(Ue),ae.length>=12)break;ze=[...ae,...Me].slice(0,12),rt()},A.onkeydown=q=>{q.key==="ArrowDown"?(Ke=Math.min(ze.length-1,Ke+1),rt(),q.preventDefault()):q.key==="ArrowUp"?(Ke=Math.max(0,Ke-1),rt(),q.preventDefault()):q.key==="Enter"?(B(Ke>=0?Ke:0),q.preventDefault()):q.key==="Escape"&&(ze=[],rt(),A.blur()),q.stopPropagation()},A.onblur=()=>setTimeout(()=>{ze=[],rt()},150)}const xe=()=>document.activeElement instanceof HTMLInputElement||document.activeElement instanceof HTMLSelectElement,fe={};window.addEventListener("keydown",A=>{xe()||(fe[A.key.toLowerCase()]=!0)}),window.addEventListener("keyup",A=>{fe[A.key.toLowerCase()]=!1}),setInterval(()=>{const A=u.cam.dist*.02;let O=!1;(fe.w||fe.arrowup)&&(u.cam.tz-=A,O=!0),(fe.s||fe.arrowdown)&&(u.cam.tz+=A,O=!0),(fe.a||fe.arrowleft)&&(u.cam.tx-=A,O=!0),(fe.d||fe.arrowright)&&(u.cam.tx+=A,O=!0),O&&(u.clampCamera(),u.applyCamera())},16);const se=Se("modes");for(const[A,O]of $m){const le=document.createElement("button");le.textContent=O,le.dataset.mode=A,A===l&&(le.className="on"),le.onclick=()=>{l=A,[...se.children].forEach(de=>{de.className=de.dataset.mode===A?"on":""}),T(A)},se.appendChild(le)}const Te=Se("tilt");Te.oninput=()=>{Se("tiltv").textContent=Te.value,u.cam.pitch=(24+ +Te.value/100*56)*Math.PI/180,u.clampCamera(),u.applyCamera()},Se("reset").onclick=()=>{u.cam.tx=n.landCX-n.W/2,u.cam.tz=n.landCY-n.H/2,u.cam.dist=u.fitDist*.72,u.cam.yaw=0,u.clampCamera(),u.applyCamera()},Se("zin").onclick=()=>{u.cam.dist/=1.3,u.clampCamera(),u.applyCamera()},Se("zout").onclick=()=>{u.cam.dist*=1.3,u.clampCamera(),u.applyCamera()},Se("clearSel").onclick=()=>I(-1),Se("center").onclick=()=>{H<0||(u.cam.tx=n.pCX[H]-n.W/2,u.cam.tz=n.pCY[H]-n.H/2,u.cam.dist=Math.min(u.cam.dist,420),u.clampCamera(),u.applyCamera())};let we=!0;Se("objs").onclick=()=>{p&&(we=!we,Se("objs").className=we?"on":"",u.invalidate())},Se("hideui").onclick=()=>{document.querySelectorAll(".panel").forEach(O=>{O.id!=="hideui"&&O.classList.toggle("hidden")});const A=Se("hideui");A.textContent=A.textContent==="Hide UI"?"Show UI":"Hide UI",x=!0},Se("dl").onclick=()=>{u.render();const A=document.createElement("canvas");A.width=f.width,A.height=f.height;const O=A.getContext("2d");O.drawImage(f,0,0),O.drawImage(d,0,0,A.width,A.height),Se("dl").href=A.toDataURL("image/png")},Se("dljson").onclick=()=>{const A=[];for(let le=0;le<n.np;le++){const de=n.countyOf[le],ye=n.duchyOf[le],Le=n.kingOf[le],$e=n.empOf[le],ze=n.cultureOf[le],Ke=n.faithOf[le];A.push({id:le,name:n.provName[le],terrain:ti[n.pTerr[le]],county:de>=0?n.countyName[de]:null,duchy:ye>=0?n.duchyName[ye]:null,kingdom:Le>=0?n.kingName[Le]:null,empire:$e>=0?n.empName[$e]:null,culture:ze>=0?n.cultName[ze]:null,faith:Ke>=0?n.faithName[Ke]:null,holding:m[n.holdingOf[le]],holder:de>=0?n.countyHolder[de]:null,development:n.devOf[le],neighbours:[...n.padj[le]]})}const O={provinces:n.np,counties:n.nCounty,duchies:n.nDuchy,kingdoms:n.nKing,empires:n.nEmp,realms:A};Se("dljson").href=URL.createObjectURL(new Blob([JSON.stringify(O)],{type:"application/json"}))};const Et=()=>{if(p){const A=we&&u.cam.dist<u.fitDist*.55;p.visible!==A&&(p.visible=A,u.invalidate())}u.render(),x&&(x=!1,Ym(b,C,u,Jt+"map/ui/coa/",()=>{x=!0},E)),requestAnimationFrame(Et)};requestAnimationFrame(Et),i.style.display="none";const _t=u.terrain.geometry.attributes.position;let Xt=1e9,qt=-1e9;for(let A=0;A<_t.count;A++){const O=_t.getY(A);O<Xt&&(Xt=O),O>qt&&(qt=O)}window.__APP={scene:u,world:n,selectProvince:I,showFaith:oe,showCulture:re,showChar:he,showRealm:We,openEditor:j,edits:Ge,info:{webgl2:u.renderer.getContext()instanceof WebGL2RenderingContext,rendererType:"WebGLRenderer",isPerspectiveCamera:u.camera.isPerspectiveCamera===!0,geometryType:u.terrain.geometry.type,terrainMinY:Xt,terrainMaxY:qt,provinces:n.np,kingdoms:n.nKing,empires:n.nEmp}},console.log("3D map ready:",JSON.stringify(window.__APP.info))}Km().catch(i=>{console.error("boot failed",i);const e=document.getElementById("loading");e&&(e.textContent="Load error — see console")});
