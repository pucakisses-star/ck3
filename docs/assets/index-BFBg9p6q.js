...
void main() {
	...
	if ( coord.x >= 1.0 ) {
...
}`;class Dm{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new Ll(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new hn({vertexShader:Pm,fragmentShader:Lm,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Xt(new Ii(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Im extends ni{constructor(e,t){super();const n=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,d=null,f=null,h=null,_=null,v=null;const A=typeof XRWebGLBinding<"u",m=new Dm,u={},T=t.getContextAttributes();let R=null,x=null;const b=[],S=[],w=new Je;let g=null;const y=new Kt;y.viewport=new xt;const L=new Kt;L.viewport=new xt;const P=[y,L],U=new Gu;let z=null,G=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(te){let fe=b[te];return fe===void 0&&(fe=new as,b[te]=fe),fe.getTargetRaySpace()},this.getControllerGrip=function(te){let fe=b[te];return fe===void 0&&(fe=new as,b[te]=fe),fe.getGripSpace()},this.getHand=function(te){let fe=b[te];return fe===void 0&&(fe=new as,b[te]=fe),fe.getHandSpace()};function I(te){const fe=S.indexOf(te.inputSource);if(fe===-1)return;const le=b[fe];le!==void 0&&(le.update(te.inputSource,te.frame,c||a),le.dispatchEvent({type:te.type,data:te.inputSource}))}function O(){r.removeEventListener("select",I),r.removeEventListener("selectstart",I),r.removeEventListener("selectend",I),r.removeEventListener("squeeze",I),r.removeEventListener("squeezestart",I),r.removeEventListener("squeezeend",I),r.removeEventListener("end",O),r.removeEventListener("inputsourceschange",N);for(let te=0;te<b.length;te++){const fe=S[te];fe!==null&&(S[te]=null,b[te].disconnect(fe))}z=null,G=null,m.reset();for(const te in u)delete u[te];e.setRenderTarget(R),_=null,h=null,f=null,r=null,x=null,Be.stop(),n.isPresenting=!1,e.setPixelRatio(g),e.setSize(w.width,w.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(te){s=te,n.isPresenting===!0&&ze("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(te){o=te,n.isPresenting===!0&&ze("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(te){c=te},this.getBaseLayer=function(){return h!==null?h:_},this.getBinding=function(){return f===null&&A&&(f=new XRWebGLBinding(r,t)),f},this.getFrame=function(){return v},this.getSession=function(){return r},this.setSession=async function(te){if(r=te,r!==null){if(R=e.getRenderTarget(),r.addEventListener("select",I),r.addEventListener("selectstart",I),r.addEventListener("selectend",I),r.addEventListener("squeeze",I),r.addEventListener("squeezestart",I),r.addEventListener("squeezeend",I),r.addEventListener("end",O),r.addEventListener("inputsourceschange",N),T.xrCompatible!==!0&&await t.makeXRCompatible(),g=e.getPixelRatio(),e.getSize(w),A&&"createProjectionLayer"in XRWebGLBinding.prototype){let le=null,Ie=null,Ne=null;T.depth&&(Ne=T.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,le=T.stencil?jn:Cn,Ie=T.stencil?ji:fn);const Re={colorFormat:t.RGBA8,depthFormat:Ne,scaleFactor:s};f=this.getBinding(),h=f.createProjectionLayer(Re),r.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),x=new un(h.textureWidth,h.textureHeight,{format:Ut,type:Wt,depthTexture:new Di(h.textureWidth,h.textureHeight,Ie,void 0,void 0,void 0,void 0,void 0,void 0,le),stencilBuffer:T.stencil,colorSpace:e.outputColorSpace,samples:T.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{const le={antialias:T.antialias,alpha:!0,depth:T.depth,stencil:T.stencil,framebufferScaleFactor:s};_=new XRWebGLLayer(r,t,le),r.updateRenderState({baseLayer:_}),e.setPixelRatio(1),e.setSize(_.framebufferWidth,_.framebufferHeight,!1),x=new un(_.framebufferWidth,_.framebufferHeight,{format:Ut,type:Wt,colorSpace:e.outputColorSpace,stencilBuffer:T.stencil,resolveDepthBuffer:_.ignoreDepthValues===!1,resolveStencilBuffer:_.ignoreDepthValues===!1})}x.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),Be.setContext(r),Be.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function N(te){for(let fe=0;fe<te.removed.length;fe++){const le=te.removed[fe],Ie=S.indexOf(le);Ie>=0&&(S[Ie]=null,b[Ie].disconnect(le))}for(let fe=0;fe<te.added.length;fe++){const le=te.added[fe];let Ie=S.indexOf(le);if(Ie===-1){for(let Re=0;Re<b.length;Re++)if(Re>=S.length){S.push(le),Ie=Re;break}else if(S[Re]===null){S[Re]=le,Ie=Re;break}if(Ie===-1)break}const Ne=b[Ie];Ne&&Ne.connect(le)}}const W=new q,ee=new q;function oe(te,fe,le){W.setFromMatrixPosition(fe.matrixWorld),ee.setFromMatrixPosition(le.matrixWorld);const Ie=W.distanceTo(ee),Ne=fe.projectionMatrix.elements,Re=le.projectionMatrix.elements,st=Ne[14]/(Ne[10]-1),Ve=Ne[14]/(Ne[10]+1),ke=(Ne[9]+1)/Ne[5],$e=(Ne[9]-1)/Ne[5],qe=(Ne[8]-1)/Ne[0],lt=(Re[8]+1)/Re[0],ft=st*qe,ht=st*lt,ct=Ie/(-qe+lt),D=ct*-qe;if(fe.matrixWorld.decompose(te.position,te.quaternion,te.scale),te.translateX(D),te.translateZ(ct),te.matrixWorld.compose(te.position,te.quaternion,te.scale),te.matrixWorldInverse.copy(te.matrixWorld).invert(),Ne[10]===-1)te.projectionMatrix.copy(fe.projectionMatrix),te.projectionMatrixInverse.copy(fe.projectionMatrixInverse);else{const J=st+ct,C=Ve+ct,xe=ft-D,ue=ht+(Ie-D),E=ke*Ve/C*J,p=$e*Ve/C*J;te.projectionMatrix.makePerspective(xe,ue,E,p,J,C),te.projectionMatrixInverse.copy(te.projectionMatrix).invert()}}function re(te,fe){fe===null?te.matrixWorld.copy(te.matrix):te.matrixWorld.multiplyMatrices(fe.matrixWorld,te.matrix),te.matrixWorldInverse.copy(te.matrixWorld).invert()}this.updateCamera=function(te){if(r===null)return;let fe=te.near,le=te.far;m.texture!==null&&(m.depthNear>0&&(fe=m.depthNear),m.depthFar>0&&(le=m.depthFar)),U.near=L.near=y.near=fe,U.far=L.far=y.far=le,(z!==U.near||G!==U.far)&&(r.updateRenderState({depthNear:U.near,depthFar:U.far}),z=U.near,G=U.far),U.layers.mask=te.layers.mask|6,y.layers.mask=U.layers.mask&-5,L.layers.mask=U.layers.mask&-3;const Ie=te.parent,Ne=U.cameras;re(U,Ie);for(let Re=0;Re<Ne.length;Re++)re(Ne[Re],Ie);Ne.length===2?oe(U,y,L):U.projectionMatrix.copy(y.projectionMatrix),pe(te,U,Ie)};function pe(te,fe,le){le===null?te.matrix.copy(fe.matrixWorld):(te.matrix.copy(le.matrixWorld),te.matrix.invert(),te.matrix.multiply(fe.matrixWorld)),te.matrix.decompose(te.position,te.quaternion,te.scale),te.updateMatrixWorld(!0),te.projectionMatrix.copy(fe.projectionMatrix),te.projectionMatrixInverse.copy(fe.projectionMatrixInverse),te.isPerspectiveCamera&&(te.fov=nr*2*Math.atan(1/te.projectionMatrix.elements[5]),te.zoom=1)}this.getCamera=function(){return U},this.getFoveation=function(){if(!(h===null&&_===null))return l},this.setFoveation=function(te){l=te,h!==null&&(h.fixedFoveation=te),_!==null&&_.fixedFoveation!==void 0&&(_.fixedFoveation=te)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(U)},this.getCameraTexture=function(te){return u[te]};let Oe=null;function je(te,fe){if(d=fe.getViewerPose(c||a),v=fe,d!==null){const le=d.views;_!==null&&(e.setRenderTargetFramebuffer(x,_.framebuffer),e.setRenderTarget(x));let Ie=!1;le.length!==U.cameras.length&&(U.cameras.length=0,Ie=!0);for(let Ve=0;Ve<le.length;Ve++){const ke=le[Ve];let $e=null;if(_!==null)$e=_.getViewport(ke);else{const lt=f.getViewSubImage(h,ke);$e=lt.viewport,Ve===0&&(e.setRenderTargetTextures(x,lt.colorTexture,lt.depthStencilTexture),e.setRenderTarget(x))}let qe=P[Ve];qe===void 0&&(qe=new Kt,qe.layers.enable(Ve),qe.viewport=new xt,P[Ve]=qe),qe.matrix.fromArray(ke.transform.matrix),qe.matrix.decompose(qe.position,qe.quaternion,qe.scale),qe.projectionMatrix.fromArray(ke.projectionMatrix),qe.projectionMatrixInverse.copy(qe.projectionMatrix).invert(),qe.viewport.set($e.x,$e.y,$e.width,$e.height),Ve===0&&(U.matrix.copy(qe.matrix),U.matrix.decompose(U.position,U.quaternion,U.scale)),Ie===!0&&U.cameras.push(qe)}const Ne=r.enabledFeatures;if(Ne&&Ne.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&A){f=n.getBinding();const Ve=f.getDepthInformation(le[0]);Ve&&Ve.isValid&&Ve.texture&&m.init(Ve,r.renderState)}if(Ne&&Ne.includes("camera-access")&&A){e.state.unbindTexture(),f=n.getBinding();for(let Ve=0;Ve<le.length;Ve++){const ke=le[Ve].camera;if(ke){let $e=u[ke];$e||($e=new Ll,u[ke]=$e);const qe=f.getCameraImage(ke);$e.sourceTexture=qe}}}}for(let le=0;le<b.length;le++){const Ie=S[le],Ne=b[le];Ie!==null&&Ne!==void 0&&Ne.update(Ie,fe,c||a)}Oe&&Oe(te,fe),fe.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:fe}),v=null}const Be=new Nl;Be.setAnimationLoop(je),this.setAnimationLoop=function(te){Oe=te},this.dispose=function(){}}}const Um=new mt,Gl=new Xe;Gl.set(-1,0,0,0,1,0,0,0,1);function Nm(i,e){function t(m,u){m.matrixAutoUpdate===!0&&m.updateMatrix(),u.value.copy(m.matrix)}function n(m,u){u.color.getRGB(m.fogColor.value,Dl(i)),u.isFog?(m.fogNear.value=u.near,m.fogFar.value=u.far):u.isFogExp2&&(m.fogDensity.value=u.density)}function r(m,u,T,R,x){u.isNodeMaterial?u.uniformsNeedUpdate=!1:u.isMeshBasicMaterial?s(m,u):u.isMeshLambertMaterial?(s(m,u),u.envMap&&(m.envMapIntensity.value=u.envMapIntensity)):u.isMeshToonMaterial?(s(m,u),f(m,u)):u.isMeshPhongMaterial?(s(m,u),d(m,u),u.envMap&&(m.envMapIntensity.value=u.envMapIntensity)):u.isMeshStandardMaterial?(s(m,u),h(m,u),u.isMeshPhysicalMaterial&&_(m,u,x)):u.isMeshMatcapMaterial?(s(m,u),v(m,u)):u.isMeshDepthMaterial?s(m,u):u.isMeshDistanceMaterial?(s(m,u),A(m,u)):u.isMeshNormalMaterial?s(m,u):u.isLineBasicMaterial?(a(m,u),u.isLineDashedMaterial&&o(m,u)):u.isPointsMaterial?l(m,u,T,R):u.isSpriteMaterial?c(m,u):u.isShadowMaterial?(m.color.value.copy(u.color),m.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function s(m,u){m.opacity.value=u.opacity,u.color&&m.diffuse.value.copy(u.color),u.emissive&&m.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(m.map.value=u.map,t(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,t(u.alphaMap,m.alphaMapTransform)),u.bumpMap&&(m.bumpMap.value=u.bumpMap,t(u.bumpMap,m.bumpMapTransform),m.bumpScale.value=u.bumpScale,u.side===Bt&&(m.bumpScale.value*=-1)),u.normalMap&&(m.normalMap.value=u.normalMap,t(u.normalMap,m.normalMapTransform),m.normalScale.value.copy(u.normalScale),u.side===Bt&&m.normalScale.value.negate()),u.displacementMap&&(m.displacementMap.value=u.displacementMap,t(u.displacementMap,m.displacementMapTransform),m.displacementScale.value=u.displacementScale,m.displacementBias.value=u.displacementBias),u.emissiveMap&&(m.emissiveMap.value=u.emissiveMap,t(u.emissiveMap,m.emissiveMapTransform)),u.specularMap&&(m.specularMap.value=u.specularMap,t(u.specularMap,m.specularMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest);const T=e.get(u),R=T.envMap,x=T.envMapRotation;R&&(m.envMap.value=R,m.envMapRotation.value.setFromMatrix4(Um.makeRotationFromEuler(x)).transpose(),R.isCubeTexture&&R.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(Gl),m.reflectivity.value=u.reflectivity,m.ior.value=u.ior,m.refractionRatio.value=u.refractionRatio),u.lightMap&&(m.lightMap.value=u.lightMap,m.lightMapIntensity.value=u.lightMapIntensity,t(u.lightMap,m.lightMapTransform)),u.aoMap&&(m.aoMap.value=u.aoMap,m.aoMapIntensity.value=u.aoMapIntensity,t(u.aoMap,m.aoMapTransform))}function a(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,u.map&&(m.map.value=u.map,t(u.map,m.mapTransform))}function o(m,u){m.dashSize.value=u.dashSize,m.totalSize.value=u.dashSize+u.gapSize,m.scale.value=u.scale}function l(m,u,T,R){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.size.value=u.size*T,m.scale.value=R*.5,u.map&&(m.map.value=u.map,t(u.map,m.uvTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,t(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function c(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.rotation.value=u.rotation,u.map&&(m.map.value=u.map,t(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,t(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function d(m,u){m.specular.value.copy(u.specular),m.shininess.value=Math.max(u.shininess,1e-4)}function f(m,u){u.gradientMap&&(m.gradientMap.value=u.gradientMap)}function h(m,u){m.metalness.value=u.metalness,u.metalnessMap&&(m.metalnessMap.value=u.metalnessMap,t(u.metalnessMap,m.metalnessMapTransform)),m.roughness.value=u.roughness,u.roughnessMap&&(m.roughnessMap.value=u.roughnessMap,t(u.roughnessMap,m.roughnessMapTransform)),u.envMap&&(m.envMapIntensity.value=u.envMapIntensity)}function _(m,u,T){m.ior.value=u.ior,u.sheen>0&&(m.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),m.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(m.sheenColorMap.value=u.sheenColorMap,t(u.sheenColorMap,m.sheenColorMapTransform)),u.sheenRoughnessMap&&(m.sheenRoughnessMap.value=u.sheenRoughnessMap,t(u.sheenRoughnessMap,m.sheenRoughnessMapTransform))),u.clearcoat>0&&(m.clearcoat.value=u.clearcoat,m.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(m.clearcoatMap.value=u.clearcoatMap,t(u.clearcoatMap,m.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,t(u.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(m.clearcoatNormalMap.value=u.clearcoatNormalMap,t(u.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===Bt&&m.clearcoatNormalScale.value.negate())),u.dispersion>0&&(m.dispersion.value=u.dispersion),u.iridescence>0&&(m.iridescence.value=u.iridescence,m.iridescenceIOR.value=u.iridescenceIOR,m.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(m.iridescenceMap.value=u.iridescenceMap,t(u.iridescenceMap,m.iridescenceMapTransform)),u.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=u.iridescenceThicknessMap,t(u.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),u.transmission>0&&(m.transmission.value=u.transmission,m.transmissionSamplerMap.value=T.texture,m.transmissionSamplerSize.value.set(T.width,T.height),u.transmissionMap&&(m.transmissionMap.value=u.transmissionMap,t(u.transmissionMap,m.transmissionMapTransform)),m.thickness.value=u.thickness,u.thicknessMap&&(m.thicknessMap.value=u.thicknessMap,t(u.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=u.attenuationDistance,m.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(m.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(m.anisotropyMap.value=u.anisotropyMap,t(u.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=u.specularIntensity,m.specularColor.value.copy(u.specularColor),u.specularColorMap&&(m.specularColorMap.value=u.specularColorMap,t(u.specularColorMap,m.specularColorMapTransform)),u.specularIntensityMap&&(m.specularIntensityMap.value=u.specularIntensityMap,t(u.specularIntensityMap,m.specularIntensityMapTransform))}function v(m,u){u.matcap&&(m.matcap.value=u.matcap)}function A(m,u){const T=e.get(u).light;m.referencePosition.value.setFromMatrixPosition(T.matrixWorld),m.nearDistance.value=T.shadow.camera.near,m.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function Fm(i,e,t,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(x,b){const S=b.program;n.uniformBlockBinding(x,S)}function c(x,b){let S=r[x.id];S===void 0&&(m(x),S=d(x),r[x.id]=S,x.addEventListener("dispose",T));const w=b.program;n.updateUBOMapping(x,w);const g=e.render.frame;s[x.id]!==g&&(h(x),s[x.id]=g)}function d(x){const b=f();x.__bindingPointIndex=b;const S=i.createBuffer(),w=x.__size,g=x.usage;return i.bindBuffer(i.UNIFORM_BUFFER,S),i.bufferData(i.UNIFORM_BUFFER,w,g),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,b,S),S}function f(){for(let x=0;x<o;x++)if(a.indexOf(x)===-1)return a.push(x),x;return it("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(x){const b=r[x.id],S=x.uniforms,w=x.__cache;i.bindBuffer(i.UNIFORM_BUFFER,b);for(let g=0,y=S.length;g<y;g++){const L=S[g];if(Array.isArray(L))for(let P=0,U=L.length;P<U;P++)_(L[P],g,P,w);else _(L,g,0,w)}i.bindBuffer(i.UNIFORM_BUFFER,null)}function _(x,b,S,w){if(A(x,b,S,w)===!0){const g=x.__offset,y=x.value;if(Array.isArray(y)){let L=0;for(let P=0;P<y.length;P++){const U=y[P],z=u(U);v(U,x.__data,L),typeof U!="number"&&typeof U!="boolean"&&!U.isMatrix3&&!ArrayBuffer.isView(U)&&(L+=z.storage/Float32Array.BYTES_PER_ELEMENT)}}else v(y,x.__data,0);i.bufferSubData(i.UNIFORM_BUFFER,g,x.__data)}}function v(x,b,S){typeof x=="number"||typeof x=="boolean"?b[0]=x:x.isMatrix3?(b[0]=x.elements[0],b[1]=x.elements[1],b[2]=x.elements[2],b[3]=0,b[4]=x.elements[3],b[5]=x.elements[4],b[6]=x.elements[5],b[7]=0,b[8]=x.elements[6],b[9]=x.elements[7],b[10]=x.elements[8],b[11]=0):ArrayBuffer.isView(x)?b.set(new x.constructor(x.buffer,x.byteOffset,b.length)):x.toArray(b,S)}function A(x,b,S,w){const g=x.value,y=b+"_"+S;if(w[y]===void 0)return typeof g=="number"||typeof g=="boolean"?w[y]=g:ArrayBuffer.isView(g)?w[y]=g.slice():w[y]=g.clone(),!0;{const L=w[y];if(typeof g=="number"||typeof g=="boolean"){if(L!==g)return w[y]=g,!0}else{if(ArrayBuffer.isView(g))return!0;if(L.equals(g)===!1)return L.copy(g),!0}}return!1}function m(x){const b=x.uniforms;let S=0;const w=16;for(let y=0,L=b.length;y<L;y++){const P=Array.isArray(b[y])?b[y]:[b[y]];for(let U=0,z=P.length;U<z;U++){const G=P[U],I=Array.isArray(G.value)?G.value:[G.value];for(let O=0,N=I.length;O<N;O++){const W=I[O],ee=u(W),oe=S%w,re=oe%ee.boundary,pe=oe+re;S+=re,pe!==0&&w-pe<ee.storage&&(S+=w-pe),G.__data=new Float32Array(ee.storage/Float32Array.BYTES_PER_ELEMENT),G.__offset=S,S+=ee.storage}}}const g=S%w;return g>0&&(S+=w-g),x.__size=S,x.__cache={},this}function u(x){const b={boundary:0,storage:0};return typeof x=="number"||typeof x=="boolean"?(b.boundary=4,b.storage=4):x.isVector2?(b.boundary=8,b.storage=8):x.isVector3||x.isColor?(b.boundary=16,b.storage=12):x.isVector4?(b.boundary=16,b.storage=16):x.isMatrix3?(b.boundary=48,b.storage=48):x.isMatrix4?(b.boundary=64,b.storage=64):x.isTexture?ze("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(x)?(b.boundary=16,b.storage=x.byteLength):ze("WebGLRenderer: Unsupported uniform value type.",x),b}function T(x){const b=x.target;b.removeEventListener("dispose",T);const S=a.indexOf(b.__bindingPointIndex);a.splice(S,1),i.deleteBuffer(r[b.id]),delete r[b.id],delete s[b.id]}function R(){for(const x in r)i.deleteBuffer(r[x]);a=[],r={},s={}}return{bind:l,update:c,dispose:R}}const Om=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let sn=null;function Bm(){return sn===null&&(sn=new Jn(Om,16,16,ti,Rn),sn.name="DFG_LUT",sn.minFilter=Rt,sn.magFilter=Rt,sn.wrapS=yn,sn.wrapT=yn,sn.generateMipmaps=!1,sn.needsUpdate=!0),sn}class zm{constructor(e={}){const{canvas:t=Fc(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:h=!1,outputBufferType:_=Wt}=e;this.isWebGLRenderer=!0;let v;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");v=n.getContextAttributes().alpha}else v=a;const A=_,m=new Set([La,Pa,Ca]),u=new Set([Wt,fn,Qi,ji,Aa,wa]),T=new Uint32Array(4),R=new Int32Array(4),x=new q;let b=null,S=null;const w=[],g=[];let y=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=cn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const L=this;let P=!1,U=null,z=null,G=null,I=null;this._outputColorSpace=Ot;let O=0,N=0,W=null,ee=-1,oe=null;const re=new xt,pe=new xt;let Oe=null;const je=new Qe(0);let Be=0,te=t.width,fe=t.height,le=1,Ie=null,Ne=null;const Re=new xt(0,0,te,fe),st=new xt(0,0,te,fe);let Ve=!1;const ke=new Ba;let $e=!1,qe=!1;const lt=new mt,ft=new q,ht=new xt,ct={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let D=!1;function J(){return W===null?le:1}let C=n;function xe(M,k){return t.getContext(M,k)}try{const M={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:d,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Ea}`),t.addEventListener("webglcontextlost",_t,!1),t.addEventListener("webglcontextrestored",at,!1),t.addEventListener("webglcontextcreationerror",Ht,!1),C===null){const k="webgl2";if(C=xe(k,M),C===null)throw xe(k)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(M){throw it("WebGLRenderer: "+M.message),M}let ue,E,p,F,H,$,ce,Z,V,j,he,de,ae,ie,me,Pe,We,B,_e,ne,ge,ve,se;function we(){ue=new Bd(C),ue.init(),ge=new Cm(C,ue),E=new Pd(C,ue,e,ge),p=new wm(C,ue),E.reversedDepthBuffer&&h&&p.buffers.depth.setReversed(!0),z=C.createFramebuffer(),G=C.createFramebuffer(),I=C.createFramebuffer(),F=new kd(C),H=new dm,$=new Rm(C,ue,p,H,E,ge,F),ce=new Od(L),Z=new Wu(C),ve=new Rd(C,Z),V=new zd(C,Z,F,ve),j=new Vd(C,V,Z,ve,F),B=new Gd(C,E,$),me=new Ld(H),he=new hm(L,ce,ue,E,ve,me),de=new Nm(L,H),ae=new mm,ie=new Sm(ue),We=new wd(L,ce,p,j,v,l),Pe=new Am(L,j,E),se=new Fm(C,F,E,p),_e=new Cd(C,ue,F),ne=new Hd(C,ue,F),F.programs=he.programs,L.capabilities=E,L.extensions=ue,L.properties=H,L.renderLists=ae,L.shadowMap=Pe,L.state=p,L.info=F}we(),A!==Wt&&(y=new Xd(A,t.width,t.height,o,r,s));const Ae=new Im(L,C);this.xr=Ae,this.getContext=function(){return C},this.getContextAttributes=function(){return C.getContextAttributes()},this.forceContextLoss=function(){const M=ue.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){const M=ue.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return le},this.setPixelRatio=function(M){M!==void 0&&(le=M,this.setSize(te,fe,!1))},this.getSize=function(M){return M.set(te,fe)},this.setSize=function(M,k,Q=!0){if(Ae.isPresenting){ze("WebGLRenderer: Can't change size while VR device is presenting.");return}te=M,fe=k,t.width=Math.floor(M*le),t.height=Math.floor(k*le),Q===!0&&(t.style.width=M+"px",t.style.height=k+"px"),y!==null&&y.setSize(t.width,t.height),this.setViewport(0,0,M,k)},this.getDrawingBufferSize=function(M){return M.set(te*le,fe*le).floor()},this.setDrawingBufferSize=function(M,k,Q){te=M,fe=k,le=Q,t.width=Math.floor(M*Q),t.height=Math.floor(k*Q),this.setViewport(0,0,M,k)},this.setEffects=function(M){if(A===Wt){it("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(M){for(let k=0;k<M.length;k++)if(M[k].isOutputPass===!0){ze("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}y.setEffects(M||[])},this.getCurrentViewport=function(M){return M.copy(re)},this.getViewport=function(M){return M.copy(Re)},this.setViewport=function(M,k,Q,Y){M.isVector4?Re.set(M.x,M.y,M.z,M.w):Re.set(M,k,Q,Y),p.viewport(re.copy(Re).multiplyScalar(le).round())},this.getScissor=function(M){return M.copy(st)},this.setScissor=function(M,k,Q,Y){M.isVector4?st.set(M.x,M.y,M.z,M.w):st.set(M,k,Q,Y),p.scissor(pe.copy(st).multiplyScalar(le).round())},this.getScissorTest=function(){return Ve},this.setScissorTest=function(M){p.setScissorTest(Ve=M)},this.setOpaqueSort=function(M){Ie=M},this.setTransparentSort=function(M){Ne=M},this.getClearColor=function(M){return M.copy(We.getClearColor())},this.setClearColor=function(){We.setClearColor(...arguments)},this.getClearAlpha=function(){return We.getClearAlpha()},this.setClearAlpha=function(){We.setClearAlpha(...arguments)},this.clear=function(M=!0,k=!0,Q=!0){let Y=0;if(M){let K=!1;if(W!==null){const ye=W.texture.format;K=m.has(ye)}if(K){const ye=W.texture.type,Te=u.has(ye),Se=We.getClearColor(),Ce=We.getClearAlpha(),De=Se.r,Ye=Se.g,Ze=Se.b;Te?(T[0]=De,T[1]=Ye,T[2]=Ze,T[3]=Ce,C.clearBufferuiv(C.COLOR,0,T)):(R[0]=De,R[1]=Ye,R[2]=Ze,R[3]=Ce,C.clearBufferiv(C.COLOR,0,R))}else Y|=C.COLOR_BUFFER_BIT}k&&(Y|=C.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),Q&&(Y|=C.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),Y!==0&&C.clear(Y)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(M){M.setRenderer(this),U=M},this.dispose=function(){t.removeEventListener("webglcontextlost",_t,!1),t.removeEventListener("webglcontextrestored",at,!1),t.removeEventListener("webglcontextcreationerror",Ht,!1),We.dispose(),ae.dispose(),ie.dispose(),H.dispose(),ce.dispose(),j.dispose(),ve.dispose(),se.dispose(),he.dispose(),Ae.dispose(),Ae.removeEventListener("sessionstart",ai),Ae.removeEventListener("sessionend",oi),tn.stop()};function _t(M){M.preventDefault(),ao("WebGLRenderer: Context Lost."),P=!0}function at(){ao("WebGLRenderer: Context Restored."),P=!1;const M=F.autoReset,k=Pe.enabled,Q=Pe.autoUpdate,Y=Pe.needsUpdate,K=Pe.type;we(),F.autoReset=M,Pe.enabled=k,Pe.autoUpdate=Q,Pe.needsUpdate=Y,Pe.type=K}function Ht(M){it("WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function qt(M){const k=M.target;k.removeEventListener("dispose",qt),Yr(k)}function Yr(M){$r(M),H.remove(M)}function $r(M){const k=H.get(M).programs;k!==void 0&&(k.forEach(function(Q){he.releaseProgram(Q)}),M.isShaderMaterial&&he.releaseShaderCache(M))}this.renderBufferDirect=function(M,k,Q,Y,K,ye){k===null&&(k=ct);const Te=K.isMesh&&K.matrixWorld.determinantAffine()<0,Se=Wl(M,k,Q,Y,K);p.setMaterial(Y,Te);let Ce=Q.index,De=1;if(Y.wireframe===!0){if(Ce=V.getWireframeAttribute(Q),Ce===void 0)return;De=2}const Ye=Q.drawRange,Ze=Q.attributes.position;let Ue=Ye.start*De,ut=(Ye.start+Ye.count)*De;ye!==null&&(Ue=Math.max(Ue,ye.start*De),ut=Math.min(ut,(ye.start+ye.count)*De)),Ce!==null?(Ue=Math.max(Ue,0),ut=Math.min(ut,Ce.count)):Ze!=null&&(Ue=Math.max(Ue,0),ut=Math.min(ut,Ze.count));const St=ut-Ue;if(St<0||St===1/0)return;ve.setup(K,Y,Se,Q,Ce);let vt,dt=_e;if(Ce!==null&&(vt=Z.get(Ce),dt=ne,dt.setIndex(vt)),K.isMesh)Y.wireframe===!0?(p.setLineWidth(Y.wireframeLinewidth*J()),dt.setMode(C.LINES)):dt.setMode(C.TRIANGLES);else if(K.isLine){let Lt=Y.linewidth;Lt===void 0&&(Lt=1),p.setLineWidth(Lt*J()),K.isLineSegments?dt.setMode(C.LINES):K.isLineLoop?dt.setMode(C.LINE_LOOP):dt.setMode(C.LINE_STRIP)}else K.isPoints?dt.setMode(C.POINTS):K.isSprite&&dt.setMode(C.TRIANGLES);if(K.isBatchedMesh)if(ue.get("WEBGL_multi_draw"))dt.renderMultiDraw(K._multiDrawStarts,K._multiDrawCounts,K._multiDrawCount);else{const Lt=K._multiDrawStarts,be=K._multiDrawCounts,kt=K._multiDrawCount,rt=Ce?Z.get(Ce).bytesPerElement:1,Yt=H.get(Y).currentProgram.getUniforms();for(let nn=0;nn<kt;nn++)Yt.setValue(C,"_gl_DrawID",nn),dt.render(Lt[nn]/rt,be[nn])}else if(K.isInstancedMesh)dt.renderInstances(Ue,St,K.count);else if(Q.isInstancedBufferGeometry){const Lt=Q._maxInstanceCount!==void 0?Q._maxInstanceCount:1/0,be=Math.min(Q.instanceCount,Lt);dt.renderInstances(Ue,St,be)}else dt.render(Ue,St)};function si(M,k,Q){M.transparent===!0&&M.side===on&&M.forceSinglePass===!1?(M.side=Bt,M.needsUpdate=!0,pn(M,k,Q),M.side=wn,M.needsUpdate=!0,pn(M,k,Q),M.side=on):pn(M,k,Q)}this.compile=function(M,k,Q=null){Q===null&&(Q=M),S=ie.get(Q),S.init(k),g.push(S),Q.traverseVisible(function(K){K.isLight&&K.layers.test(k.layers)&&(S.pushLight(K),K.castShadow&&S.pushShadow(K))}),M!==Q&&M.traverseVisible(function(K){K.isLight&&K.layers.test(k.layers)&&(S.pushLight(K),K.castShadow&&S.pushShadow(K))}),S.setupLights();const Y=new Set;return M.traverse(function(K){if(!(K.isMesh||K.isPoints||K.isLine||K.isSprite))return;const ye=K.material;if(ye)if(Array.isArray(ye))for(let Te=0;Te<ye.length;Te++){const Se=ye[Te];si(Se,Q,K),Y.add(Se)}else si(ye,Q,K),Y.add(ye)}),S=g.pop(),Y},this.compileAsync=function(M,k,Q=null){const Y=this.compile(M,k,Q);return new Promise(K=>{function ye(){if(Y.forEach(function(Te){H.get(Te).currentProgram.isReady()&&Y.delete(Te)}),Y.size===0){K(M);return}setTimeout(ye,10)}ue.get("KHR_parallel_shader_compile")!==null?ye():setTimeout(ye,10)})};let Vn=null;function Oi(M){Vn&&Vn(M)}function ai(){tn.stop()}function oi(){tn.start()}const tn=new Nl;tn.setAnimationLoop(Oi),typeof self<"u"&&tn.setContext(self),this.setAnimationLoop=function(M){Vn=M,Ae.setAnimationLoop(M),M===null?tn.stop():tn.start()},Ae.addEventListener("sessionstart",ai),Ae.addEventListener("sessionend",oi),this.render=function(M,k){if(k!==void 0&&k.isCamera!==!0){it("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(P===!0)return;U!==null&&U.renderStart(M,k);const Q=Ae.enabled===!0&&Ae.isPresenting===!0,Y=y!==null&&(W===null||Q)&&y.begin(L,W);if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),k.parent===null&&k.matrixWorldAutoUpdate===!0&&k.updateMatrixWorld(),Ae.enabled===!0&&Ae.isPresenting===!0&&(y===null||y.isCompositing()===!1)&&(Ae.cameraAutoUpdate===!0&&Ae.updateCamera(k),k=Ae.getCamera()),M.isScene===!0&&M.onBeforeRender(L,M,k,W),S=ie.get(M,g.length),S.init(k),S.state.textureUnits=$.getTextureUnits(),g.push(S),lt.multiplyMatrices(k.projectionMatrix,k.matrixWorldInverse),ke.setFromProjectionMatrix(lt,ln,k.reversedDepth),qe=this.localClippingEnabled,$e=me.init(this.clippingPlanes,qe),b=ae.get(M,w.length),b.init(),w.push(b),Ae.enabled===!0&&Ae.isPresenting===!0){const Te=L.xr.getDepthSensingMesh();Te!==null&&X(Te,k,-1/0,L.sortObjects)}X(M,k,0,L.sortObjects),b.finish(),L.sortObjects===!0&&b.sort(Ie,Ne,k.reversedDepth),D=Ae.enabled===!1||Ae.isPresenting===!1||Ae.hasDepthSensing()===!1,D&&We.addToRenderList(b,M),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),$e===!0&&me.beginShadows();const K=S.state.shadowsArray;if(Pe.render(K,M,k),$e===!0&&me.endShadows(),(Y&&y.hasRenderPass())===!1){const Te=b.opaque,Se=b.transmissive;if(S.setupLights(),k.isArrayCamera){const Ce=k.cameras;if(Se.length>0)for(let De=0,Ye=Ce.length;De<Ye;De++){const Ze=Ce[De];He(Te,Se,M,Ze)}D&&We.render(M);for(let De=0,Ye=Ce.length;De<Ye;De++){const Ze=Ce[De];Ee(b,M,Ze,Ze.viewport)}}else Se.length>0&&He(Te,Se,M,k),D&&We.render(M),Ee(b,M,k)}W!==null&&N===0&&($.updateMultisampleRenderTarget(W),$.updateRenderTargetMipmap(W)),Y&&y.end(L),M.isScene===!0&&M.onAfterRender(L,M,k),ve.resetDefaultState(),ee=-1,oe=null,g.pop(),g.length>0?(S=g[g.length-1],$.setTextureUnits(S.state.textureUnits),$e===!0&&me.setGlobalState(L.clippingPlanes,S.state.camera)):S=null,w.pop(),w.length>0?b=w[w.length-1]:b=null,U!==null&&U.renderEnd()};function X(M,k,Q,Y){if(M.visible===!1)return;if(M.layers.test(k.layers)){if(M.isGroup)Q=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(k);else if(M.isLightProbeGrid)S.pushLightProbeGrid(M);else if(M.isLight)S.pushLight(M),M.castShadow&&S.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||ke.intersectsSprite(M)){Y&&ht.setFromMatrixPosition(M.matrixWorld).applyMatrix4(lt);const Te=j.update(M),Se=M.material;Se.visible&&b.push(M,Te,Se,Q,ht.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||ke.intersectsObject(M))){const Te=j.update(M),Se=M.material;if(Y&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),ht.copy(M.boundingSphere.center)):(Te.boundingSphere===null&&Te.computeBoundingSphere(),ht.copy(Te.boundingSphere.center)),ht.applyMatrix4(M.matrixWorld).applyMatrix4(lt)),Array.isArray(Se)){const Ce=Te.groups;for(let De=0,Ye=Ce.length;De<Ye;De++){const Ze=Ce[De],Ue=Se[Ze.materialIndex];Ue&&Ue.visible&&b.push(M,Te,Ue,Q,ht.z,Ze)}}else Se.visible&&b.push(M,Te,Se,Q,ht.z,null)}}const ye=M.children;for(let Te=0,Se=ye.length;Te<Se;Te++)X(ye[Te],k,Q,Y)}function Ee(M,k,Q,Y){const{opaque:K,transmissive:ye,transparent:Te}=M;S.setupLightsView(Q),$e===!0&&me.setGlobalState(L.clippingPlanes,Q),Y&&p.viewport(re.copy(Y)),K.length>0&&Le(K,k,Q),ye.length>0&&Le(ye,k,Q),Te.length>0&&Le(Te,k,Q),p.buffers.depth.setTest(!0),p.buffers.depth.setMask(!0),p.buffers.color.setMask(!0),p.setPolygonOffset(!1)}function He(M,k,Q,Y){if((Q.isScene===!0?Q.overrideMaterial:null)!==null)return;if(S.state.transmissionRenderTarget[Y.id]===void 0){const Ue=ue.has("EXT_color_buffer_half_float")||ue.has("EXT_color_buffer_float");S.state.transmissionRenderTarget[Y.id]=new un(1,1,{generateMipmaps:!0,type:Ue?Rn:Wt,minFilter:En,samples:Math.max(4,E.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:nt.workingColorSpace})}const ye=S.state.transmissionRenderTarget[Y.id],Te=Y.viewport||re;ye.setSize(Te.z*L.transmissionResolutionScale,Te.w*L.transmissionResolutionScale);const Se=L.getRenderTarget(),Ce=L.getActiveCubeFace(),De=L.getActiveMipmapLevel();L.setRenderTarget(ye),L.getClearColor(je),Be=L.getClearAlpha(),Be<1&&L.setClearColor(16777215,.5),L.clear(),D&&We.render(Q);const Ye=L.toneMapping;L.toneMapping=cn;const Ze=Y.viewport;if(Y.viewport!==void 0&&(Y.viewport=void 0),S.setupLightsView(Y),$e===!0&&me.setGlobalState(L.clippingPlanes,Y),Le(M,Q,Y),$.updateMultisampleRenderTarget(ye),$.updateRenderTargetMipmap(ye),ue.has("WEBGL_multisampled_render_to_texture")===!1){let Ue=!1;for(let ut=0,St=k.length;ut<St;ut++){const vt=k[ut],{object:dt,geometry:Lt,material:be,group:kt}=vt;if(be.side===on&&dt.layers.test(Y.layers)){const rt=be.side;be.side=Bt,be.needsUpdate=!0,et(dt,Q,Y,Lt,be,kt),be.side=rt,be.needsUpdate=!0,Ue=!0}}Ue===!0&&($.updateMultisampleRenderTarget(ye),$.updateRenderTargetMipmap(ye))}L.setRenderTarget(Se,Ce,De),L.setClearColor(je,Be),Ze!==void 0&&(Y.viewport=Ze),L.toneMapping=Ye}function Le(M,k,Q){const Y=k.isScene===!0?k.overrideMaterial:null;for(let K=0,ye=M.length;K<ye;K++){const Te=M[K],{object:Se,geometry:Ce,group:De}=Te;let Ye=Te.material;Ye.allowOverride===!0&&Y!==null&&(Ye=Y),Se.layers.test(Q.layers)&&et(Se,k,Q,Ce,Ye,De)}}function et(M,k,Q,Y,K,ye){M.onBeforeRender(L,k,Q,Y,K,ye),M.modelViewMatrix.multiplyMatrices(Q.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),K.onBeforeRender(L,k,Q,Y,M,ye),K.transparent===!0&&K.side===on&&K.forceSinglePass===!1?(K.side=Bt,K.needsUpdate=!0,L.renderBufferDirect(Q,k,Y,K,M,ye),K.side=wn,K.needsUpdate=!0,L.renderBufferDirect(Q,k,Y,K,M,ye),K.side=on):L.renderBufferDirect(Q,k,Y,K,M,ye),M.onAfterRender(L,k,Q,Y,K,ye)}function pn(M,k,Q){k.isScene!==!0&&(k=ct);const Y=H.get(M),K=S.state.lights,ye=S.state.shadowsArray,Te=K.state.version,Se=he.getParameters(M,K.state,ye,k,Q,S.state.lightProbeGridArray),Ce=he.getProgramCacheKey(Se);let De=Y.programs;Y.environment=M.isMeshStandardMaterial||M.isMeshLambertMaterial||M.isMeshPhongMaterial?k.environment:null,Y.fog=k.fog;const Ye=M.isMeshStandardMaterial||M.isMeshLambertMaterial&&!M.envMap||M.isMeshPhongMaterial&&!M.envMap;Y.envMap=ce.get(M.envMap||Y.environment,Ye),Y.envMapRotation=Y.environment!==null&&M.envMap===null?k.environmentRotation:M.envMapRotation,De===void 0&&(M.addEventListener("dispose",qt),De=new Map,Y.programs=De);let Ze=De.get(Ce);if(Ze!==void 0){if(Y.currentProgram===Ze&&Y.lightsStateVersion===Te)return qa(M,Se),Ze}else Se.uniforms=he.getUniforms(M),U!==null&&M.isNodeMaterial&&U.build(M,Q,Se),M.onBeforeCompile(Se,L),Ze=he.acquireProgram(Se,Ce),De.set(Ce,Ze),Y.uniforms=Se.uniforms;const Ue=Y.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(Ue.clippingPlanes=me.uniform),qa(M,Se),Y.needsLights=ql(M),Y.lightsStateVersion=Te,Y.needsLights&&(Ue.ambientLightColor.value=K.state.ambient,Ue.lightProbe.value=K.state.probe,Ue.directionalLights.value=K.state.directional,Ue.directionalLightShadows.value=K.state.directionalShadow,Ue.spotLights.value=K.state.spot,Ue.spotLightShadows.value=K.state.spotShadow,Ue.rectAreaLights.value=K.state.rectArea,Ue.ltc_1.value=K.state.rectAreaLTC1,Ue.ltc_2.value=K.state.rectAreaLTC2,Ue.pointLights.value=K.state.point,Ue.pointLightShadows.value=K.state.pointShadow,Ue.hemisphereLights.value=K.state.hemi,Ue.directionalShadowMatrix.value=K.state.directionalShadowMatrix,Ue.spotLightMatrix.value=K.state.spotLightMatrix,Ue.spotLightMap.value=K.state.spotLightMap,Ue.pointShadowMatrix.value=K.state.pointShadowMatrix),Y.lightProbeGrid=S.state.lightProbeGridArray.length>0,Y.currentProgram=Ze,Y.uniformsList=null,Ze}function mn(M){if(M.uniformsList===null){const k=M.currentProgram.getUniforms();M.uniformsList=Fr.seqWithValue(k.seq,M.uniforms)}return M.uniformsList}function qa(M,k){const Q=H.get(M);Q.outputColorSpace=k.outputColorSpace,Q.batching=k.batching,Q.batchingColor=k.batchingColor,Q.instancing=k.instancing,Q.instancingColor=k.instancingColor,Q.instancingMorph=k.instancingMorph,Q.skinning=k.skinning,Q.morphTargets=k.morphTargets,Q.morphNormals=k.morphNormals,Q.morphColors=k.morphColors,Q.morphTargetsCount=k.morphTargetsCount,Q.numClippingPlanes=k.numClippingPlanes,Q.numIntersection=k.numClipIntersection,Q.vertexAlphas=k.vertexAlphas,Q.vertexTangents=k.vertexTangents,Q.toneMapping=k.toneMapping}function Vl(M,k){if(M.length===0)return null;if(M.length===1)return M[0].texture!==null?M[0]:null;x.setFromMatrixPosition(k.matrixWorld);for(let Q=0,Y=M.length;Q<Y;Q++){const K=M[Q];if(K.texture!==null&&K.boundingBox.containsPoint(x))return K}return null}function Wl(M,k,Q,Y,K){k.isScene!==!0&&(k=ct),$.resetTextureUnits();const ye=k.fog,Te=Y.isMeshStandardMaterial||Y.isMeshLambertMaterial||Y.isMeshPhongMaterial?k.environment:null,Se=W===null?L.outputColorSpace:W.isXRRenderTarget===!0?W.texture.colorSpace:nt.workingColorSpace,Ce=Y.isMeshStandardMaterial||Y.isMeshLambertMaterial&&!Y.envMap||Y.isMeshPhongMaterial&&!Y.envMap,De=ce.get(Y.envMap||Te,Ce),Ye=Y.vertexColors===!0&&!!Q.attributes.color&&Q.attributes.color.itemSize===4,Ze=!!Q.attributes.tangent&&(!!Y.normalMap||Y.anisotropy>0),Ue=!!Q.morphAttributes.position,ut=!!Q.morphAttributes.normal,St=!!Q.morphAttributes.color;let vt=cn;Y.toneMapped&&(W===null||W.isXRRenderTarget===!0)&&(vt=L.toneMapping);const dt=Q.morphAttributes.position||Q.morphAttributes.normal||Q.morphAttributes.color,Lt=dt!==void 0?dt.length:0,be=H.get(Y),kt=S.state.lights;if($e===!0&&(qe===!0||M!==oe)){const gt=M===oe&&Y.id===ee;me.setState(Y,M,gt)}let rt=!1;Y.version===be.__version?(be.needsLights&&be.lightsStateVersion!==kt.state.version||be.outputColorSpace!==Se||K.isBatchedMesh&&be.batching===!1||!K.isBatchedMesh&&be.batching===!0||K.isBatchedMesh&&be.batchingColor===!0&&K.colorTexture===null||K.isBatchedMesh&&be.batchingColor===!1&&K.colorTexture!==null||K.isInstancedMesh&&be.instancing===!1||!K.isInstancedMesh&&be.instancing===!0||K.isSkinnedMesh&&be.skinning===!1||!K.isSkinnedMesh&&be.skinning===!0||K.isInstancedMesh&&be.instancingColor===!0&&K.instanceColor===null||K.isInstancedMesh&&be.instancingColor===!1&&K.instanceColor!==null||K.isInstancedMesh&&be.instancingMorph===!0&&K.morphTexture===null||K.isInstancedMesh&&be.instancingMorph===!1&&K.morphTexture!==null||be.envMap!==De||Y.fog===!0&&be.fog!==ye||be.numClippingPlanes!==void 0&&(be.numClippingPlanes!==me.numPlanes||be.numIntersection!==me.numIntersection)||be.vertexAlphas!==Ye||be.vertexTangents!==Ze||be.morphTargets!==Ue||be.morphNormals!==ut||be.morphColors!==St||be.toneMapping!==vt||be.morphTargetsCount!==Lt||!!be.lightProbeGrid!=S.state.lightProbeGridArray.length>0)&&(rt=!0):(rt=!0,be.__version=Y.version);let Yt=be.currentProgram;rt===!0&&(Yt=pn(Y,k,K),U&&Y.isNodeMaterial&&U.onUpdateProgram(Y,Yt,be));let nn=!1,Pn=!1,li=!1;const pt=Yt.getUniforms(),yt=be.uniforms;if(p.useProgram(Yt.program)&&(nn=!0,Pn=!0,li=!0),Y.id!==ee&&(ee=Y.id,Pn=!0),be.needsLights){const gt=Vl(S.state.lightProbeGridArray,K);be.lightProbeGrid!==gt&&(be.lightProbeGrid=gt,Pn=!0)}if(nn||oe!==M){p.buffers.depth.getReversed()&&M.reversedDepth!==!0&&(M._reversedDepth=!0,M.updateProjectionMatrix()),pt.setValue(C,"projectionMatrix",M.projectionMatrix),pt.setValue(C,"viewMatrix",M.matrixWorldInverse);const Dn=pt.map.cameraPosition;Dn!==void 0&&Dn.setValue(C,ft.setFromMatrixPosition(M.matrixWorld)),E.logarithmicDepthBuffer&&pt.setValue(C,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),(Y.isMeshPhongMaterial||Y.isMeshToonMaterial||Y.isMeshLambertMaterial||Y.isMeshBasicMaterial||Y.isMeshStandardMaterial||Y.isShaderMaterial)&&pt.setValue(C,"isOrthographic",M.isOrthographicCamera===!0),oe!==M&&(oe=M,Pn=!0,li=!0)}if(be.needsLights&&(kt.state.directionalShadowMap.length>0&&pt.setValue(C,"directionalShadowMap",kt.state.directionalShadowMap,$),kt.state.spotShadowMap.length>0&&pt.setValue(C,"spotShadowMap",kt.state.spotShadowMap,$),kt.state.pointShadowMap.length>0&&pt.setValue(C,"pointShadowMap",kt.state.pointShadowMap,$)),K.isSkinnedMesh){pt.setOptional(C,K,"bindMatrix"),pt.setOptional(C,K,"bindMatrixInverse");const gt=K.skeleton;gt&&(gt.boneTexture===null&&gt.computeBoneTexture(),pt.setValue(C,"boneTexture",gt.boneTexture,$))}K.isBatchedMesh&&(pt.setOptional(C,K,"batchingTexture"),pt.setValue(C,"batchingTexture",K._matricesTexture,$),pt.setOptional(C,K,"batchingIdTexture"),pt.setValue(C,"batchingIdTexture",K._indirectTexture,$),pt.setOptional(C,K,"batchingColorTexture"),K._colorsTexture!==null&&pt.setValue(C,"batchingColorTexture",K._colorsTexture,$));const Ln=Q.morphAttributes;if((Ln.position!==void 0||Ln.normal!==void 0||Ln.color!==void 0)&&B.update(K,Q,Yt),(Pn||be.receiveShadow!==K.receiveShadow)&&(be.receiveShadow=K.receiveShadow,pt.setValue(C,"receiveShadow",K.receiveShadow)),(Y.isMeshStandardMaterial||Y.isMeshLambertMaterial||Y.isMeshPhongMaterial)&&Y.envMap===null&&k.environment!==null&&(yt.envMapIntensity.value=k.environmentIntensity),yt.dfgLUT!==void 0&&(yt.dfgLUT.value=Bm()),Pn){if(pt.setValue(C,"toneMappingExposure",L.toneMappingExposure),be.needsLights&&Xl(yt,li),ye&&Y.fog===!0&&de.refreshFogUniforms(yt,ye),de.refreshMaterialUniforms(yt,Y,le,fe,S.state.transmissionRenderTarget[M.id]),be.needsLights&&be.lightProbeGrid){const gt=be.lightProbeGrid;yt.probesSH.value=gt.texture,yt.probesMin.value.copy(gt.boundingBox.min),yt.probesMax.value.copy(gt.boundingBox.max),yt.probesResolution.value.copy(gt.resolution)}Fr.upload(C,mn(be),yt,$)}if(Y.isShaderMaterial&&Y.uniformsNeedUpdate===!0&&(Fr.upload(C,mn(be),yt,$),Y.uniformsNeedUpdate=!1),Y.isSpriteMaterial&&pt.setValue(C,"center",K.center),pt.setValue(C,"modelViewMatrix",K.modelViewMatrix),pt.setValue(C,"normalMatrix",K.normalMatrix),pt.setValue(C,"modelMatrix",K.matrixWorld),Y.uniformsGroups!==void 0){const gt=Y.uniformsGroups;for(let Dn=0,ci=gt.length;Dn<ci;Dn++){const Ya=gt[Dn];se.update(Ya,Yt),se.bind(Ya,Yt)}}return Yt}function Xl(M,k){M.ambientLightColor.needsUpdate=k,M.lightProbe.needsUpdate=k,M.directionalLights.needsUpdate=k,M.directionalLightShadows.needsUpdate=k,M.pointLights.needsUpdate=k,M.pointLightShadows.needsUpdate=k,M.spotLights.needsUpdate=k,M.spotLightShadows.needsUpdate=k,M.rectAreaLights.needsUpdate=k,M.hemisphereLights.needsUpdate=k}function ql(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return O},this.getActiveMipmapLevel=function(){return N},this.getRenderTarget=function(){return W},this.setRenderTargetTextures=function(M,k,Q){const Y=H.get(M);Y.__autoAllocateDepthBuffer=M.resolveDepthBuffer===!1,Y.__autoAllocateDepthBuffer===!1&&(Y.__useRenderToTexture=!1),H.get(M.texture).__webglTexture=k,H.get(M.depthTexture).__webglTexture=Y.__autoAllocateDepthBuffer?void 0:Q,Y.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(M,k){const Q=H.get(M);Q.__webglFramebuffer=k,Q.__useDefaultFramebuffer=k===void 0},this.setRenderTarget=function(M,k=0,Q=0){W=M,O=k,N=Q;let Y=null,K=!1,ye=!1;if(M){const Se=H.get(M);if(Se.__useDefaultFramebuffer!==void 0){p.bindFramebuffer(C.FRAMEBUFFER,Se.__webglFramebuffer),re.copy(M.viewport),pe.copy(M.scissor),Oe=M.scissorTest,p.viewport(re),p.scissor(pe),p.setScissorTest(Oe),ee=-1;return}else if(Se.__webglFramebuffer===void 0)$.setupRenderTarget(M);else if(Se.__hasExternalTextures)$.rebindTextures(M,H.get(M.texture).__webglTexture,H.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){const Ye=M.depthTexture;if(Se.__boundDepthTexture!==Ye){if(Ye!==null&&H.has(Ye)&&(M.width!==Ye.image.width||M.height!==Ye.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");$.setupDepthRenderbuffer(M)}}const Ce=M.texture;(Ce.isData3DTexture||Ce.isDataArrayTexture||Ce.isCompressedArrayTexture)&&(ye=!0);const De=H.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(De[k])?Y=De[k][Q]:Y=De[k],K=!0):M.samples>0&&$.useMultisampledRTT(M)===!1?Y=H.get(M).__webglMultisampledFramebuffer:Array.isArray(De)?Y=De[Q]:Y=De,re.copy(M.viewport),pe.copy(M.scissor),Oe=M.scissorTest}else re.copy(Re).multiplyScalar(le).floor(),pe.copy(st).multiplyScalar(le).floor(),Oe=Ve;if(Q!==0&&(Y=z),p.bindFramebuffer(C.FRAMEBUFFER,Y)&&p.drawBuffers(M,Y),p.viewport(re),p.scissor(pe),p.setScissorTest(Oe),K){const Se=H.get(M.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_CUBE_MAP_POSITIVE_X+k,Se.__webglTexture,Q)}else if(ye){const Se=k;for(let Ce=0;Ce<M.textures.length;Ce++){const De=H.get(M.textures[Ce]);C.framebufferTextureLayer(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0+Ce,De.__webglTexture,Q,Se)}}else if(M!==null&&Q!==0){const Se=H.get(M.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,Se.__webglTexture,Q)}ee=-1},this.readRenderTargetPixels=function(M,k,Q,Y,K,ye,Te,Se=0){if(!(M&&M.isWebGLRenderTarget)){it("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ce=H.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&Te!==void 0&&(Ce=Ce[Te]),Ce){p.bindFramebuffer(C.FRAMEBUFFER,Ce);try{const De=M.textures[Se],Ye=De.format,Ze=De.type;if(M.textures.length>1&&C.readBuffer(C.COLOR_ATTACHMENT0+Se),!E.textureFormatReadable(Ye)){it("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!E.textureTypeReadable(Ze)){it("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}k>=0&&k<=M.width-Y&&Q>=0&&Q<=M.height-K&&C.readPixels(k,Q,Y,K,ge.convert(Ye),ge.convert(Ze),ye)}finally{const De=W!==null?H.get(W).__webglFramebuffer:null;p.bindFramebuffer(C.FRAMEBUFFER,De)}}},this.readRenderTargetPixelsAsync=async function(M,k,Q,Y,K,ye,Te,Se=0){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ce=H.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&Te!==void 0&&(Ce=Ce[Te]),Ce)if(k>=0&&k<=M.width-Y&&Q>=0&&Q<=M.height-K){p.bindFramebuffer(C.FRAMEBUFFER,Ce);const De=M.textures[Se],Ye=De.format,Ze=De.type;if(M.textures.length>1&&C.readBuffer(C.COLOR_ATTACHMENT0+Se),!E.textureFormatReadable(Ye))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!E.textureTypeReadable(Ze))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Ue=C.createBuffer();C.bindBuffer(C.PIXEL_PACK_BUFFER,Ue),C.bufferData(C.PIXEL_PACK_BUFFER,ye.byteLength,C.STREAM_READ),C.readPixels(k,Q,Y,K,ge.convert(Ye),ge.convert(Ze),0);const ut=W!==null?H.get(W).__webglFramebuffer:null;p.bindFramebuffer(C.FRAMEBUFFER,ut);const St=C.fenceSync(C.SYNC_GPU_COMMANDS_COMPLETE,0);return C.flush(),await Oc(C,St,4),C.bindBuffer(C.PIXEL_PACK_BUFFER,Ue),C.getBufferSubData(C.PIXEL_PACK_BUFFER,0,ye),C.deleteBuffer(Ue),C.deleteSync(St),ye}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(M,k=null,Q=0){const Y=Math.pow(2,-Q),K=Math.floor(M.image.width*Y),ye=Math.floor(M.image.height*Y),Te=k!==null?k.x:0,Se=k!==null?k.y:0;$.setTexture2D(M,0),C.copyTexSubImage2D(C.TEXTURE_2D,Q,0,0,Te,Se,K,ye),p.unbindTexture()},this.copyTextureToTexture=function(M,k,Q=null,Y=null,K=0,ye=0){let Te,Se,Ce,De,Ye,Ze,Ue,ut,St;const vt=M.isCompressedTexture?M.mipmaps[ye]:M.image;if(Q!==null)Te=Q.max.x-Q.min.x,Se=Q.max.y-Q.min.y,Ce=Q.isBox3?Q.max.z-Q.min.z:1,De=Q.min.x,Ye=Q.min.y,Ze=Q.isBox3?Q.min.z:0;else{const yt=Math.pow(2,-K);Te=Math.floor(vt.width*yt),Se=Math.floor(vt.height*yt),M.isDataArrayTexture?Ce=vt.depth:M.isData3DTexture?Ce=Math.floor(vt.depth*yt):Ce=1,De=0,Ye=0,Ze=0}Y!==null?(Ue=Y.x,ut=Y.y,St=Y.z):(Ue=0,ut=0,St=0);const dt=ge.convert(k.format),Lt=ge.convert(k.type);let be;k.isData3DTexture?($.setTexture3D(k,0),be=C.TEXTURE_3D):k.isDataArrayTexture||k.isCompressedArrayTexture?($.setTexture2DArray(k,0),be=C.TEXTURE_2D_ARRAY):($.setTexture2D(k,0),be=C.TEXTURE_2D),p.activeTexture(C.TEXTURE0),p.pixelStorei(C.UNPACK_FLIP_Y_WEBGL,k.flipY),p.pixelStorei(C.UNPACK_PREMULTIPLY_ALPHA_WEBGL,k.premultiplyAlpha),p.pixelStorei(C.UNPACK_ALIGNMENT,k.unpackAlignment);const kt=p.getParameter(C.UNPACK_ROW_LENGTH),rt=p.getParameter(C.UNPACK_IMAGE_HEIGHT),Yt=p.getParameter(C.UNPACK_SKIP_PIXELS),nn=p.getParameter(C.UNPACK_SKIP_ROWS),Pn=p.getParameter(C.UNPACK_SKIP_IMAGES);p.pixelStorei(C.UNPACK_ROW_LENGTH,vt.width),p.pixelStorei(C.UNPACK_IMAGE_HEIGHT,vt.height),p.pixelStorei(C.UNPACK_SKIP_PIXELS,De),p.pixelStorei(C.UNPACK_SKIP_ROWS,Ye),p.pixelStorei(C.UNPACK_SKIP_IMAGES,Ze);const li=M.isDataArrayTexture||M.isData3DTexture,pt=k.isDataArrayTexture||k.isData3DTexture;if(M.isDepthTexture){const yt=H.get(M),Ln=H.get(k),gt=H.get(yt.__renderTarget),Dn=H.get(Ln.__renderTarget);p.bindFramebuffer(C.READ_FRAMEBUFFER,gt.__webglFramebuffer),p.bindFramebuffer(C.DRAW_FRAMEBUFFER,Dn.__webglFramebuffer);for(let ci=0;ci<Ce;ci++)li&&(C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,H.get(M).__webglTexture,K,Ze+ci),C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,H.get(k).__webglTexture,ye,St+ci)),C.blitFramebuffer(De,Ye,Te,Se,Ue,ut,Te,Se,C.DEPTH_BUFFER_BIT,C.NEAREST);p.bindFramebuffer(C.READ_FRAMEBUFFER,null),p.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else if(K!==0||M.isRenderTargetTexture||H.has(M)){const yt=H.get(M),Ln=H.get(k);p.bindFramebuffer(C.READ_FRAMEBUFFER,G),p.bindFramebuffer(C.DRAW_FRAMEBUFFER,I);for(let gt=0;gt<Ce;gt++)li?C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,yt.__webglTexture,K,Ze+gt):C.framebufferTexture2D(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,yt.__webglTexture,K),pt?C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,Ln.__webglTexture,ye,St+gt):C.framebufferTexture2D(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,Ln.__webglTexture,ye),K!==0?C.blitFramebuffer(De,Ye,Te,Se,Ue,ut,Te,Se,C.COLOR_BUFFER_BIT,C.NEAREST):pt?C.copyTexSubImage3D(be,ye,Ue,ut,St+gt,De,Ye,Te,Se):C.copyTexSubImage2D(be,ye,Ue,ut,De,Ye,Te,Se);p.bindFramebuffer(C.READ_FRAMEBUFFER,null),p.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else pt?M.isDataTexture||M.isData3DTexture?C.texSubImage3D(be,ye,Ue,ut,St,Te,Se,Ce,dt,Lt,vt.data):k.isCompressedArrayTexture?C.compressedTexSubImage3D(be,ye,Ue,ut,St,Te,Se,Ce,dt,vt.data):C.texSubImage3D(be,ye,Ue,ut,St,Te,Se,Ce,dt,Lt,vt):M.isDataTexture?C.texSubImage2D(C.TEXTURE_2D,ye,Ue,ut,Te,Se,dt,Lt,vt.data):M.isCompressedTexture?C.compressedTexSubImage2D(C.TEXTURE_2D,ye,Ue,ut,vt.width,vt.height,dt,vt.data):C.texSubImage2D(C.TEXTURE_2D,ye,Ue,ut,Te,Se,dt,Lt,vt);p.pixelStorei(C.UNPACK_ROW_LENGTH,kt),p.pixelStorei(C.UNPACK_IMAGE_HEIGHT,rt),p.pixelStorei(C.UNPACK_SKIP_PIXELS,Yt),p.pixelStorei(C.UNPACK_SKIP_ROWS,nn),p.pixelStorei(C.UNPACK_SKIP_IMAGES,Pn),ye===0&&k.generateMipmaps&&C.generateMipmap(be),p.unbindTexture()},this.initRenderTarget=function(M){H.get(M).__webglFramebuffer===void 0&&$.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?$.setTextureCube(M,0):M.isData3DTexture?$.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?$.setTexture2DArray(M,0):$.setTexture2D(M,0),p.unbindTexture()},this.resetState=function(){O=0,N=0,W=null,p.reset(),ve.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ln}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=nt._getDrawingBufferColorSpace(e),t.unpackColorSpace=nt._getUnpackColorSpace()}}const zn=1024,$n=512,Hm=90;class km{constructor(e,t,n,r,s){Mt(this,"renderer");Mt(this,"camera");Mt(this,"scene");Mt(this,"terrain");Mt(this,"texture");Mt(this,"W");Mt(this,"H");Mt(this,"maxElev",0);Mt(this,"minElev",0);Mt(this,"cam");Mt(this,"fitDist");Mt(this,"needsRender",!0);Mt(this,"onCameraChange",null);Mt(this,"world");Mt(this,"hlUniforms",{hoverId:{value:new Je(-10,-10)},selId:{value:new Je(-10,-10)}});Mt(this,"modeUniforms",{provDark:{value:.1},hierK:{value:1}});Mt(this,"washData");Mt(this,"washTex");Mt(this,"idW",0);Mt(this,"idH",0);Mt(this,"vertElev");this.world=e;const{W:a,H:o}=e;this.W=a,this.H=o;const l=zn+1,c=$n+1;this.vertElev=new Float32Array(l*c);{const{height:y,seaBase:L,land:P}=e,U=Math.max(1,Math.round(a/zn/2)),z=Math.max(1,Math.round(o/$n/2));for(let G=0;G<c;G++){const I=Math.round(G/$n*(o-1));for(let O=0;O<l;O++){const N=Math.round(O/zn*(a-1));let W=0,ee=0,oe=0,re=0;for(let Oe=-z;Oe<=z;Oe++){const je=Math.min(o-1,Math.max(0,I+Oe));for(let Be=-U;Be<=U;Be++){const te=Math.min(a-1,Math.max(0,N+Be)),fe=je*a+te;W+=y[fe],ee++,P[fe]&&(oe+=y[fe],re++)}}let pe=Math.max(0,W/ee-L);if(re>0){const Oe=Math.max(0,oe/re-L);pe=Math.max(pe,Oe*Math.min(1,re/ee*2.4))}this.vertElev[G*l+O]=Math.pow(pe,.92)*Hm}}}this.renderer=new zm({antialias:!0,preserveDrawingBuffer:!0}),this.renderer.setPixelRatio(Math.min(2,window.devicePixelRatio||1)),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.domElement.id="gl",n.prepend(this.renderer.domElement),this.scene=new pu;const d=new Qe("#878f83");this.scene.background=d,this.camera=new Kt(50,window.innerWidth/window.innerHeight,2,16e3),this.texture=new wo(t),this.texture.colorSpace=Ot,this.texture.anisotropy=Math.min(8,this.renderer.capabilities.getMaxAnisotropy()),this.texture.generateMipmaps=!0,this.texture.minFilter=En,this.texture.magFilter=Rt;const f=new Ii(a,o,zn,$n),h=f.attributes.position;let _=0;for(let y=0;y<h.count;y++){const L=this.vertElev[y];L>_&&(_=L),h.setZ(y,L)}this.maxElev=_,f.rotateX(-Math.PI/2),f.computeVertexNormals();const v=(()=>{const P=document.createElement("canvas");P.width=256,P.height=256;const U=P.getContext("2d"),z=U.createImageData(256,256),G=[];for(let N=0;N<1024;N++){let W=N*374761393+668265263|0;W=Math.imul(W^W>>>13,1274126177),G.push(((W^W>>>16)>>>0)/4294967295)}const I=N=>N*N*(3-2*N);for(let N=0;N<256;N++)for(let W=0;W<256;W++){const ee=W/256*32,oe=N/256*32,re=ee|0,pe=oe|0,Oe=I(ee-re),je=I(oe-pe),Be=(re+1)%32,te=(pe+1)%32,fe=G[pe*32+re],le=G[pe*32+Be],Ie=G[te*32+re],Ne=G[te*32+Be];let Re=fe+(le-fe)*Oe+(Ie-fe)*je+(fe-le-Ie+Ne)*Oe*je;const st=W/256*32*4,Ve=N/256*32*4,ke=st|0,$e=Ve|0,qe=I(st-ke),lt=I(Ve-$e),ft=(ke+1)%128,ht=($e+1)%128,ct=(p,F)=>G[p%32*32+F%32],D=ct($e,ke),J=ct($e,ft),C=ct(ht,ke),xe=ct(ht,ft);Re=Re*.65+(D+(J-D)*qe+(C-D)*lt+(D-J-C+xe)*qe*lt)*.35;const ue=(N*256+W)*4,E=Re*255|0;z.data[ue]=E,z.data[ue+1]=E,z.data[ue+2]=E,z.data[ue+3]=255}U.putImageData(z,0,0);const O=new wo(P);return O.wrapS=O.wrapT=Or,O.minFilter=En,O.anisotropy=Math.min(4,this.renderer.capabilities.getMaxAnisotropy()),O})();let A;if(r&&this.renderer.capabilities.maxTextureSize>=r.width)A=new Ct(r),this.idW=r.width,this.idH=r.height;else{const y=new Uint8Array(a*o*4);for(let L=0;L<o;L++)for(let P=0;P<a;P++){const U=e.rawGrid[L*a+P],z=((o-1-L)*a+P)*4;y[z]=U&255,y[z+1]=U>>8&255,y[z+3]=255}A=new Jn(y,a,o,Ut),this.idW=a,this.idH=o}A.minFilter=Et,A.magFilter=Et,A.generateMipmaps=!1,A.needsUpdate=!0,this.washData=new Uint8Array(256*256*4),this.washTex=new Jn(this.washData,256,256,Ut),this.washTex.minFilter=this.washTex.magFilter=Et;const m=new Uint8Array(256*256*4),u=new Uint8Array(256*256*4);{const{rawCounty:y,rawLand:L,cDuchy:P,dKing:U,kEmp:z}=e;for(let G=0;G<65536;G++){const I=y[G],O=I>=0?P[I]:-1,N=O>=0?U[O]:-1,W=N>=0?z[N]:-1,ee=I>=0?I:65535,oe=O>=0?O:65535,re=G*4;m[re]=ee&255,m[re+1]=ee>>8,m[re+2]=oe&255,m[re+3]=oe>>8,u[re]=N>=0?N:255,u[re+1]=W>=0?W:255,u[re+2]=L[G]?255:0,u[re+3]=255}}const T=new Jn(m,256,256,Ut),R=new Jn(u,256,256,Ut);for(const y of[T,R])y.minFilter=y.magFilter=Et,y.needsUpdate=!0;const x=new Uint8Array(a*o*4);{const{shade:y,land:L,coastD:P}=e;for(let U=0;U<o;U++)for(let z=0;z<a;z++){const G=U*a+z,I=((o-1-U)*a+z)*4;x[I]=Math.max(0,Math.min(255,(y[G]-.42)/.88*255))|0,x[I+1]=s?s[G]:0,x[I+2]=L[G]?24+Math.min(12,P[G])*18:0,x[I+3]=255}}const b=new Jn(x,a,o,Ut);b.minFilter=b.magFilter=Rt,b.generateMipmaps=!1,b.needsUpdate=!0;const S=new Gr({map:this.texture});S.onBeforeCompile=y=>{y.uniforms.detailMap={value:v},y.uniforms.provMap={value:A},y.uniforms.washMap={value:this.washTex},y.uniforms.tierMapA={value:T},y.uniforms.tierMapB={value:R},y.uniforms.shadeMap={value:b},y.uniforms.provTexel={value:new Je(1/this.idW,1/this.idH)},y.uniforms.provDark=this.modeUniforms.provDark,y.uniforms.hierK=this.modeUniforms.hierK,y.uniforms.hoverId=this.hlUniforms.hoverId,y.uniforms.selId=this.hlUniforms.selId,y.fragmentShader=y.fragmentShader.replace("void main() {",`
      ...
      if ( max( abs( mod( pid, 256.0 ) - selId.x ), abs( floor( pid / 256.0 ) - selId.y ) ) < 0.5 )
        diffuseColor.rgb = mix( diffuseColor.rgb, vec3( 1.0, 0.9, 0.58 ), 0.30 * provLand );`)},this.terrain=new Xt(f,S),this.scene.add(this.terrain);const w=new Xt(new Ii(a*8,o*8),new Gr({color:new Qe("#42504f")}));w.geometry.rotateX(-Math.PI/2),w.position.y=-1.2,this.scene.add(w);const g=o*1.15/(2*Math.tan(this.camera.fov*Math.PI/180/2));this.fitDist=Math.max(g,a/(2*Math.tan(this.camera.fov*Math.PI/180/2)*this.camera.aspect)*1.06),this.scene.fog=new Oa(d,this.fitDist*.75,this.fitDist*2.1),this.cam={tx:e.landCX-a/2,tz:e.landCY-o/2,dist:this.fitDist*.72,pitch:es.degToRad(52),yaw:0},this.applyCamera(),window.addEventListener("resize",()=>{this.renderer.setSize(window.innerWidth,window.innerHeight),this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.invalidate()})}elevAtGrid(e,t){const{W:n,H:r}=this.world,s=zn+1;let a=e/(n-1)*zn,o=t/(r-1)*$n;a<0&&(a=0),o<0&&(o=0),a>zn-.001&&(a=zn-.001),o>$n-.001&&(o=$n-.001);const l=a|0,c=o|0,d=a-l,f=o-c,h=c*s+l,_=this.vertElev[h],v=this.vertElev[h+1],A=this.vertElev[h+s],m=this.vertElev[h+s+1];return _+(v-_)*d+(A-_)*f+(_-v-A+m)*d*f}elevAtWorld(e,t){return this.elevAtGrid(e+this.W/2,t+this.H/2)}applyCamera(){const e=this.cam,t=this.elevAtWorld(e.tx,e.tz)*.5,n=Math.cos(e.pitch),r=Math.sin(e.pitch);this.camera.position.set(e.tx+Math.sin(e.yaw)*n*e.dist,t+r*e.dist,e.tz+Math.cos(e.yaw)*n*e.dist),this.camera.lookAt(e.tx,t,e.tz),this.invalidate(),this.onCameraChange&&this.onCameraChange()}clampCamera(){const e=this.cam;e.dist=Math.max(70,Math.min(this.fitDist*1.25,e.dist)),e.pitch=Math.max(es.degToRad(28),Math.min(es.degToRad(80),e.pitch)),e.yaw=Math.max(-1,Math.min(1,e.yaw));const t=this.W*.62,n=this.H*.72;e.tx=Math.max(-t,Math.min(t,e.tx)),e.tz=Math.max(-n,Math.min(n,e.tz))}invalidate(){this.needsRender=!0}setHover(e){const t=this.hlUniforms.hoverId.value;e<0?t.set(-10,-10):t.set(e&255,e>>8&255),this.invalidate()}setSelected(e){const t=this.hlUniforms.selId.value;e<0?t.set(-10,-10):t.set(e&255,e>>8&255),this.invalidate()}setWash(e,t,n){this.washData.set(e),this.washTex.needsUpdate=!0,this.modeUniforms.provDark.value=t,this.modeUniforms.hierK.value=n?1:0,this.invalidate()}render(){this.needsRender&&(this.needsRender=!1,this.renderer.render(this.scene,this.camera))}ndc(e,t){return new Je(e/window.innerWidth*2-1,-(t/window.innerHeight)*2+1)}pickPlane(e,t){const n=new No;n.setFromCamera(this.ndc(e,t),this.camera);const r=-n.ray.origin.y/n.ray.direction.y;return!isFinite(r)||r<=0?null:n.ray.origin.clone().addScaledVector(n.ray.direction,r)}pickGround(e,t){const n=new No;n.setFromCamera(this.ndc(e,t),this.camera);const r=n.ray.origin,s=n.ray.direction;if(s.y>=-1e-5)return null;const a=Math.max(0,(r.y-(this.maxElev+2))/-s.y),o=r.y/-s.y,l=320;let c=a,d=-1;for(let u=0;u<=l;u++){const T=a+(o+4-a)*u/l,R=r.x+s.x*T,x=r.y+s.y*T,b=r.z+s.z*T;if(x<=this.elevAtWorld(R,b)){d=T;break}c=T}if(d<0)return null;let f=c,h=d;for(let u=0;u<18;u++){const T=(f+h)/2,R=r.x+s.x*T,x=r.y+s.y*T,b=r.z+s.z*T;x<=this.elevAtWorld(R,b)?h=T:f=T}const _=r.x+s.x*h,v=r.z+s.z*h,A=_+this.W/2,m=v+this.H/2;return A<0||m<0||A>=this.W||m>=this.H?null:{gx:A,gy:m}}projectGrid(e,t,n=3){const r=new q(e-this.W/2,this.elevAtGrid(e,t)+n,t-this.H/2);return r.clone().sub(this.camera.position).dot(this.camera.getWorldDirection(new q))<=0?null:(r.project(this.camera),[(r.x*.5+.5)*window.innerWidth,(1-(r.y*.5+.5))*window.innerHeight])}}function Pr(i){const e=atob(i),t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n);return t}function Gm(i,e,t){let n=2.6,r=5;return i.startsWith("rock")?(n=1.4,r=3.8):i.startsWith("b")&&(i.endsWith("castle")?(n=4.4,r=4):i.endsWith("temple")?(n=3.9,r=4.4):(n=3.2,r=5)),Math.min(n/Math.max(.001,e),r/Math.max(.001,t))}function ll(i){let e=0;for(const t of i.parts)e=Math.max(e,t.hi[0]-t.lo[0],t.hi[2]-t.lo[2]);return e}async function Vm(i,e){const t=await fetch(i+"map/objects/models.json");if(!t.ok)throw new Error("models.json HTTP "+t.status);const n=await t.json(),r=new $i,s=e.W,a=e.H,o=new Fu,l=new Map,c=S=>{let w=l.get(S);return w||(w=o.load(i+"map/objects/"+S,()=>e.invalidate()),w.colorSpace=Ot,w.anisotropy=4,l.set(S,w)),w},d=new Ou(16773853,9076848,1.9),f=new Hu(16772812,2.1);f.position.set(-.55,1,-.7),r.add(d,f);const h=new Map,_=S=>{let w=h.get(S);if(w)return w;w=[];for(const g of n.models[S].parts){const y=new Uint16Array(Pr(g.v).buffer.slice(0)),L=new Uint16Array(Pr(g.u).buffer.slice(0)),P=Pr(g.x).buffer.slice(0),U=y.length/3,z=new Float32Array(y.length);for(let O=0;O<3;O++){const N=g.lo[O],W=g.hi[O]-g.lo[O];for(let ee=0;ee<U;ee++)z[ee*3+O]=N+y[ee*3+O]/65535*W}const G=new Float32Array(L.length);for(let O=0;O<L.length;O++)G[O]=L[O]/65535;const I=new dn;I.setAttribute("position",new zt(z,3)),I.setAttribute("uv",new zt(G,2)),I.setIndex(new zt(g.x32?new Uint32Array(P):new Uint16Array(P),1)),I.computeVertexNormals(),w.push(I)}return h.set(S,w),w},v=new Map,A=(S,w)=>{const g=S+(w?"|f":"");let y=v.get(g);return y||(y=new Pu({map:c(S),alphaTest:w?.45:.6,side:w?on:wn}),v.set(g,y)),y},m=new mt,u=new ii,T=new q(0,1,0),R=new q,x=new q;for(const[S,w]of Object.entries(n.inst)){const g=n.models[S];if(!g)continue;const y=Pr(w.d),L=w.n,P=!S.startsWith("b")&&!S.startsWith("rock"),U=Gm(S,g.hgt,ll(g)),G=_(S).map((I,O)=>{const N=new Ao(I,A(g.parts[O].tex,P),L);return N.frustumCulled=!1,N});for(let I=0;I<L;I++){const O=I*6,N=y[O]|y[O+1]<<8,W=y[O+2]|y[O+3]<<8,ee=y[O+4]/255*Math.PI*2,oe=(.25+y[O+5]/255*2.75)*U,re=e.elevAtGrid(N,W);u.setFromAxisAngle(T,ee),m.compose(R.set(N-s/2,re,W-a/2),u,x.set(oe,oe,oe));for(const pe of G)pe.setMatrixAt(I,m)}for(const I of G)I.instanceMatrix.needsUpdate=!0,r.add(I)}const b=new Map;for(const S of n.spec)n.models[S.k]&&(b.get(S.k)??b.set(S.k,[]).get(S.k)).push(S);for(const[S,w]of b){const g=n.models[S],y=_(S),L=ll(g),P=4/Math.max(.001,g.hgt),U=Math.min(17/Math.max(.001,g.hgt),22/Math.max(.001,L)),z=y.map((G,I)=>{const O=new Ao(G,A(g.parts[I].tex,!1),w.length);return O.frustumCulled=!1,O});w.forEach((G,I)=>{const O=Math.max(e.elevAtGrid(G.x,G.y),.15),N=Math.min(Math.max(G.s*.5*1.6,P),Math.max(P,U));u.setFromAxisAngle(T,G.r),m.compose(R.set(G.x-s/2,O,G.y-a/2),u,x.set(N,N,N));for(const W of z)W.setMatrixAt(I,m)});for(const G of z)G.instanceMatrix.needsUpdate=!0,r.add(G)}return e.scene.add(r),e.invalidate(),r}function Wm(i){const{np:e,pArea:t,pCX:n,pCY:r,W:s,H:a}=i;function o(u,T,R){const x=new Float64Array(u),b=new Float64Array(u),S=new Float64Array(u),w=new Float64Array(u),g=new Float64Array(u),y=new Float64Array(u);for(let P=0;P<e;P++){const U=T[P];if(U<0)continue;const z=t[P],G=n[P],I=r[P];x[U]+=G*z,b[U]+=I*z,S[U]+=z,w[U]+=G*G*z,g[U]+=I*I*z,y[U]+=G*I*z}const L=[];for(let P=0;P<u;P++){if(S[P]<1)continue;const U=x[P]/S[P],z=b[P]/S[P],G=w[P]/S[P]-U*U,I=g[P]/S[P]-z*z,O=y[P]/S[P]-U*z,N=.5*Math.atan2(2*O,G-I),W=G+I,ee=G*I-O*O,oe=Math.sqrt(Math.max(0,W*W/4-ee));L.push({x:U,y:z,angle:N,ext:Math.sqrt(Math.max(1,W/2+oe)),name:R[P],area:S[P],idx:P})}return L}const l=o(i.nKing,i.kingOf,i.kingName),c=o(i.nEmp,i.empOf,i.empName),d=new Float64Array(i.nCounty),f=new Float64Array(i.nCounty),h=new Float64Array(i.nCounty);for(let u=0;u<e;u++){const T=i.countyOf[u];T<0||(d[T]+=n[u]*t[u],f[T]+=r[u]*t[u],h[T]+=t[u])}const _=(u,T)=>{for(const R of u){const x=T[R.idx];x>=0&&h[x]>0&&(R.capX=d[x]/h[x],R.capY=f[x]/h[x])}};_(l,i.kCapital),_(c,i.eCapital);const v=i.seaLabels.map(u=>({x:u.x,y:u.y,name:u.n,area:u.a,ext:Math.sqrt(u.a)*.9})),A=[],m=Math.max(40,s*a/e*.25);for(let u=0;u<e;u++)t[u]<m||A.push({x:n[u],y:r[u],name:i.provName[u],ext:Math.hypot(i.pMaxX[u]-i.pMinX[u],i.pMaxY[u]-i.pMinY[u])/2,area:t[u]});return{king:l,emp:c,prov:A,sea:v,straits:i.straits}}const Ls='"Iowan Old Style",Palatino,Georgia,serif',Ds=new Map;function Xm(i,e){let t=Ds.get(i);if(t!==void 0)return t&&t.complete&&t.naturalWidth?t:null;const n=new Image;return n.onload=()=>{e&&e()},n.onerror=()=>Ds.set(i,null),n.src=i,Ds.set(i,n),null}function qm(i,e,t,n,r){const s=window.innerWidth,a=window.innerHeight;i.clearRect(0,0,s,a),i.textAlign="center",i.textBaseline="middle";const o=t.cam.dist,l=o>t.fitDist*.55,c=o<680,d=[],f=[];document.querySelectorAll(".panel").forEach(u=>{if(u.classList.contains("hidden"))return;const T=getComputedStyle(u);if(T.display==="none"||T.visibility==="hidden")return;const R=u.getBoundingClientRect();R.width&&R.height&&f.push(R)});const h=44;function _(u,T,R,x){if(u-R<h||u+R>s-h||T-x<h||T+x>a-h)return!0;for(const b of f)if(u+R>b.left-6&&u-R<b.right+6&&T+x>b.top-6&&T-x<b.bottom+6)return!0;return!1}function v(u,T,R,x){if(_(u,T,R,x))return!1;for(const b of d)if(Math.abs(u-b.x)<R+b.hw&&Math.abs(T-b.y)<x+b.hh)return!1;return!0}function A(u){const T=t.projectGrid(u.x,u.y);if(!T)return null;const R=Math.cos(u.angle)*u.ext,x=Math.sin(u.angle)*u.ext,b=t.projectGrid(u.x-R,u.y-x),S=t.projectGrid(u.x+R,u.y+x);if(!b||!S)return null;let w=Math.atan2(S[1]-b[1],S[0]-b[0]);return w>Math.PI/2&&(w-=Math.PI),w<-Math.PI/2&&(w+=Math.PI),{sx:T[0],sy:T[1],screenExt:Math.hypot(S[0]-b[0],S[1]-b[1]),rot:w}}function m(u,T,R,x,b,S,w){const g=A(u);if(!g||g.sx<-320||g.sx>s+320||g.sy<-200||g.sy>a+200)return;i.font=`600 ${T}px ${Ls}`;const y=u.name.toUpperCase();let L=0;const P=[];for(const N of y){const W=i.measureText(N).width;P.push(W),L+=W}let U=y.length>1?(b-L)/(y.length-1):0;U=Math.max(T*.08,Math.min(U,T*.9));const z=L+U*(y.length-1),G=z*.5*.8+8,I=T*.62+5;if(!v(g.sx,g.sy,G,I))return;d.push({x:g.sx,y:g.sy,hw:G,hh:I}),i.save(),i.translate(g.sx,g.sy),i.rotate(g.rot),i.globalAlpha=S,i.lineJoin="round";let O=-z/2;for(let N=0;N<y.length;N++){const W=y[N],ee=P[N],oe=O+ee/2;i.lineWidth=T*.2,i.strokeStyle=x,i.strokeText(W,oe,0),i.fillStyle=R,i.fillText(W,oe,0),O+=ee+U}if(i.restore(),w&&n){const N=Xm(`${n}${w}_${u.idx}.png`,r??null);if(N){const W=Math.max(20,Math.min(T*1.25,46));let ee=g.sx,oe=g.sy-I-W-4;if(u.capX!==void 0&&u.capY!==void 0){const re=t.projectGrid(u.capX,u.capY,4);re&&(ee=re[0],oe=re[1]-W)}i.save(),i.globalAlpha=S,i.shadowColor="rgba(0,0,0,0.55)",i.shadowBlur=6,i.shadowOffsetY=2,i.drawImage(N,ee-W/2,oe,W,W),i.restore()}}}{i.save(),i.setLineDash([7,5]),i.lineWidth=1.6,i.strokeStyle="rgba(146, 44, 30, 0.75)";for(const u of e.straits){const T=t.projectGrid(u[0],u[1],1.5),R=t.projectGrid(u[2],u[3],1.5);if(!T||!R)continue;const x=Math.hypot(R[0]-T[0],R[1]-T[1]);x<7||x>620||Math.max(T[0],R[0])<0||Math.min(T[0],R[0])>s||Math.max(T[1],R[1])<0||Math.min(T[1],R[1])>a||(i.beginPath(),i.moveTo(T[0],T[1]),i.lineTo(R[0],R[1]),i.stroke())}i.restore()}if(l)for(const u of[...e.emp].sort((T,R)=>R.area-T.area)){const T=A(u);if(!T)continue;const R=Math.max(22,Math.min(T.screenExt*2*.15,56));m(u,R,"rgba(26,20,12,0.86)","rgba(238,228,198,0.4)",Math.min(T.screenExt*2*.9,s*.62),.9,"e")}{const u=l?.85:1;for(const T of[...e.king].sort((R,x)=>x.area-R.area)){const R=A(T);if(!R)continue;const x=R.screenExt*2;if(x<62)continue;let b=Math.max(13,Math.min(x*.18,40));b*.62>x*.95/Math.max(3,T.name.length)&&(b=Math.max(12,x*.95/(T.name.length*.62))),m(T,b,"rgba(26,20,12,0.94)","rgba(238,226,192,0.5)",Math.min(x*.86,s*.5),u,l?void 0:"k")}}{i.save(),i.textAlign="center",i.textBaseline="middle";for(const u of e.sea){const T=t.projectGrid(u.x,u.y,1);if(!T)continue;const[R,x]=T;if(R<-60||R>s+60||x<-40||x>a+40)continue;const b=t.projectGrid(u.x+u.ext,u.y,1),S=b?Math.abs(b[0]-R):0,w=Math.max(10,Math.min(S*.3,26));if(w<10)continue;i.font=`italic 600 ${w}px ${Ls}`;const g=i.measureText(u.name).width*.5+6,y=w*.6+3;v(R,x,g,y)&&(d.push({x:R,y:x,hw:g,hh:y}),i.globalAlpha=.78,i.lineWidth=w*.18,i.strokeStyle="rgba(26,34,34,0.5)",i.strokeText(u.name,R,x),i.fillStyle="rgba(205,221,218,0.92)",i.fillText(u.name,R,x))}i.globalAlpha=1,i.restore()}if(c){const u=Math.min(1,(680-o)/220);for(const T of[...e.prov].sort((R,x)=>x.area-R.area)){const R=t.projectGrid(T.x,T.y);if(!R)continue;const[x,b]=R;if(x<0||x>s||b<0||b>a)continue;const S=t.projectGrid(T.x+T.ext,T.y),w=S?Math.abs(S[0]-x):0,g=Math.max(9,Math.min(w*.32,16));if(g<9)continue;i.font=`600 ${g}px ${Ls}`;const y=i.measureText(T.name).width*.5+4,L=g*.6+3;v(x,b,y,L)&&(d.push({x,y:b,hw:y,hh:L}),i.globalAlpha=u,i.lineWidth=g*.28,i.strokeStyle="rgba(242,232,202,0.78)",i.strokeText(T.name,x,b),i.fillStyle="rgba(26,20,10,0.96)",i.fillText(T.name,x,b))}}i.globalAlpha=1}const Sn="/ck3/",Fe=i=>document.getElementById(i),cl=()=>new Promise(i=>requestAnimationFrame(()=>i())),Ym=[["political","Political"],["province","Provinces"],["terrain","Terrain"],["elevation","Elevation"],["culture","Culture"],["faith","Faith"],["development","Development"]];async function $m(){const i=Fe("loading"),e=async D=>{i.style.display="flex",i.textContent=D,await cl(),await cl()},t=new Promise(D=>{const J=new Image;J.onload=()=>D(J),J.onerror=()=>D(null),J.src=Sn+"map/prov8.png"});await e("Loading the map…");const n=await jl(1420,Sn);Fe("date").textContent=`${n.date} · Anno Aldermarki`,await e("Shading the relief…"),ec(n),await e("Baking the map…");const r=tc(n);n.cloud=null;const s=document.createElement("canvas");s.width=n.W,s.height=n.H;const a=s.getContext("2d",{willReadFrequently:!0}),o=a.createImageData(n.W,n.H);let l="political",c=!1;Ja(n,r,l,o),a.putImageData(o,0,0),await e("Raising the terrain…");const d=await t,f=new km(n,s,document.body,d,r.snow),h=f.renderer.domElement,_=new Uint8Array(65536).fill(40);for(let D=0;D<n.np;D++)_[n.rawOf[D]]=n.devOf[D];const v=new Uint8Array(256*256*4);function A(D){v.fill(0);const{rawCounty:J,rawCult:C,rawFaith:xe,rawLand:ue,cDuchy:E,dKing:p,kEmp:F,kColor:H,cultCol:$,faithCol:ce}=n,Z=.16,V=(de,ae,ie)=>{const me=ae[0]*.3+ae[1]*.59+ae[2]*.11,Pe=de*4;v[Pe]=ae[0]+(me-ae[0])*Z,v[Pe+1]=ae[1]+(me-ae[1])*Z,v[Pe+2]=ae[2]+(me-ae[2])*Z,v[Pe+3]=ie*255|0};if(D!=="terrain"&&D!=="elevation"){for(let de=0;de<65536;de++)if(ue[de])if(D==="political"){const ae=J[de],ie=ae>=0?E[ae]:-1,me=ie>=0?p[ie]:-1;me>=0&&V(de,H[me],.52)}else if(D==="province"){const ae=de*2654435761>>>0;V(de,[70+(ae&159),70+(ae>>8&159),70+(ae>>16&159)],.7)}else if(D==="culture"){const ae=C[de];ae>=0&&V(de,$[ae],.5)}else if(D==="faith"){const ae=xe[de];ae>=0&&V(de,ce[ae],.5)}else D==="development"&&V(de,nc(_[de]),.56)}const j=D==="terrain"||D==="elevation";f.setWash(v,j?0:D==="province"?.42:.1,D==="political"||D==="culture"||D==="faith"||D==="development");const he=D==="elevation";he!==c&&(c=he,Ja(n,r,D,o),a.putImageData(o,0,0),f.texture.needsUpdate=!0),f.invalidate()}A(l);let m=null;Vm(Sn,f).then(D=>{m=D;const J=Fe("objs");J&&(J.className="on")}).catch(D=>console.warn("map objects unavailable:",D));const u=Fe("labels"),T=u.getContext("2d"),R=Wm(n);let x=!0;const b=Math.min(2,window.devicePixelRatio||1),S=()=>{u.width=window.innerWidth*b,u.height=window.innerHeight*b,u.style.width=window.innerWidth+"px",u.style.height=window.innerHeight+"px",T.setTransform(b,0,0,b,0,0),x=!0};S(),window.addEventListener("resize",S),f.onCameraChange=()=>{x=!0};const w=["No Holding","Castle","City","Temple","Tribe"],g=(D,...J)=>{const C=D.map(xe=>xe+".png");for(const xe of J){const ue=n.artPools[xe];ue&&C.push(...ue)}return C},y={castle:g(["holding_1","art_fortress"],"castle"),city:g(["art_city1","art_city2"],"city"),port:g(["art_port"],"port"),temple:g(["holding_3"],"temple"),tribal:g(["art_tribal"],"tribal"),terr:{[Ge.BEACH]:g(["terr_beach","art_coast"],"coast","port"),[Ge.PLAINS]:g(["terr_plains"],"plains"),[Ge.FARM]:g(["terr_farm","art_farm"],"farm"),[Ge.FOREST]:g(["terr_forest"],"forest","jungle"),[Ge.HILLS]:g(["terr_hills"],"mountain"),[Ge.DRY]:g(["terr_desert","art_desert","art_ruin","art_river"],"desert","ruin","river"),[Ge.WET]:g(["terr_wet","art_swamp","art_lakes"],"swamp"),[Ge.MTN]:g(["terr_mtn"],"mountain"),[Ge.SNOW]:g(["terr_mtn"],"snow","mountain")}};function L(D){const J=n.holdingOf[D],C=n.pTerr[D],xe=n.countyOf[D],ue=p=>p[D%p.length];if(xe>=0){if(J===1)return ue(y.castle);if(J===2)return C===Ge.BEACH?ue(y.port):ue(y.city);if(J===3)return ue(y.temple);if(J===4)return ue(y.tribal)}const E=y.terr[C];return E?ue(E):"holding_0.png"}const P=D=>`<span class="swatch" style="background:rgb(${D[0]},${D[1]},${D[2]})"></span>`;let U=-1;function z(D){U=D,f.setSelected(D<0?-1:n.rawOf[D]);const J=Fe("sel");if(D<0){J.style.display="none";return}Fe("faith").classList.remove("open");const C=n.countyOf[D],xe=n.duchyOf[D],ue=n.kingOf[D],E=n.empOf[D],p=n.cultureOf[D],F=n.faithOf[D],H=n.holdingOf[D];Fe("selName").textContent=n.provName[D];let $=C>=0?`${w[H]} in the County of ${n.countyName[C]}`:"Uncolonised wasteland";C>=0&&E>=0&&n.eCapital[E]===C?$+=" · Imperial Capital":C>=0&&ue>=0&&n.kCapital[ue]===C&&($+=" · Royal Capital"),Fe("selSub").textContent=$;const ce=[],Z=(ie,me)=>`<img class="coa" src="${Sn}map/ui/coa/${ie}_${me}.png" alt="" onerror="this.remove()">`;xe>=0&&ce.push(`<span class="chip" style="--cc:#8a7f66">${n.duchyName[xe]}</span>`),ue>=0&&ce.push(`<span class="chip flagged rlink" data-realm="k:${ue}" title="About this realm">${Z("k",ue)}${n.kingName[ue]}</span>`),E>=0&&ce.push(`<span class="chip flagged rlink" data-realm="e:${E}" title="About this realm">${Z("e",E)}${n.empName[E]}</span>`),Fe("selChips").innerHTML=ce.join(""),Fe("selChips").querySelectorAll(".rlink").forEach(ie=>{ie.onclick=()=>{const[me,Pe]=ie.dataset.realm.split(":");re(me,+Pe)}});const V=ie=>!ie||/^wasteland/i.test(ie),j=F>=0&&n.faithHasIcon[F]?`<img class="fic" src="${Sn}map/ui/faith_${F}.png" alt="">`:F>=0?P(n.faithCol[F]):"";Fe("selBody").innerHTML=`<div class="k">Terrain</div><div>${ar[n.pTerr[D]]}</div>`+(p>=0&&!V(n.cultName[p])?`<div class="k">Culture</div><div>${P(n.cultCol[p])}<a class="flink" data-culture="${p}" title="About this culture">${n.cultName[p]}</a></div>`:"")+(F>=0&&!V(n.faithName[F])?`<div class="k">Faith</div><div>${j}<a class="flink" data-faith="${F}" title="About this faith">${n.faithName[F]}</a></div>`:"")+`<div class="k">Development</div><div>${n.devOf[D]}</div>`,Fe("selBody").querySelectorAll("a.flink").forEach(ie=>{ie.onclick=me=>{me.preventDefault(),ie.dataset.faith?W(+ie.dataset.faith):ie.dataset.culture&&ee(+ie.dataset.culture)}});const he=(ie,me)=>ie&&me?`<a class="flink" data-char="${ie}" title="About this ruler">${me}</a>`:me??"",de=[];if(C>=0){const ie=n.countyHolder[C];de.push(`<div><span class="k">County Holder:</span> <b>${V(ie)?"uncolonised":he(n.countyHolderKey[C],ie)}</b></div>`)}if(ue>=0&&n.kingHolder[ue]&&de.push(`<div><span class="k">${n.kingName[ue]}:</span> <b>${he(n.kingHolderKey[ue],n.kingHolder[ue])}</b></div>`),E>=0&&n.empHolder[E]&&de.push(`<div><span class="k">${n.empName[E]}:</span> <b>${he(n.empHolderKey[E],n.empHolder[E])}</b></div>`),Fe("selHolders").innerHTML=de.join(""),Fe("selHolders").style.display=de.length?"block":"none",Fe("selHolders").querySelectorAll("a[data-char]").forEach(ie=>{ie.onclick=me=>{me.preventDefault(),oe(ie.dataset.char)}}),C>=0){const ie=[];for(let me=0;me<n.np&&ie.length<40;me++)n.countyOf[me]===C&&ie.push(me===D?`<b>${n.provName[me]}</b>`:`${n.provName[me]}${n.holdingOf[me]?` (${w[n.holdingOf[me]].toLowerCase()})`:""}`);Fe("selBars").innerHTML='<span class="k">Baronies:</span> '+ie.join(" · "),Fe("selBars").style.display="block"}else Fe("selBars").style.display="none";const ae=Fe("selIllu");ae.src=`${Sn}map/ui/${L(D)}`,ae.style.display="block",ae.onerror=()=>{ae.style.display="none"},J.style.display="block"}let G=null;function I(D){let J=-1,C=0;for(let xe=0;xe<n.np;xe++)n.countyOf[xe]===D&&n.pArea[xe]>C&&(C=n.pArea[xe],J=xe);J<0||(f.cam.tx=n.pCX[J]-n.W/2,f.cam.tz=n.pCY[J]-n.H/2,f.cam.dist=Math.min(f.cam.dist,320),f.clampCamera(),f.applyCamera(),z(J))}function O(D,J,C,xe){Fe("sel").style.display="none",G=xe,Fe("faithName").innerHTML=D,Fe("faithSub").textContent=J,Fe("faithBody").innerHTML=C,Fe("faithMode").style.display=xe?"":"none",Fe("faith").classList.add("open"),Fe("faithBody").querySelectorAll("a[data-county]").forEach(ue=>{ue.onclick=E=>{E.preventDefault(),I(+ue.dataset.county)}}),Fe("faithBody").querySelectorAll("a[data-char]").forEach(ue=>{ue.onclick=E=>{E.preventDefault(),oe(ue.dataset.char)}}),Fe("faithBody").querySelectorAll("a[data-culture]").forEach(ue=>{ue.onclick=E=>{E.preventDefault(),ee(+ue.dataset.culture)}}),Fe("faithBody").querySelectorAll("a[data-realm]").forEach(ue=>{ue.onclick=E=>{E.preventDefault();const[p,F]=ue.dataset.realm.split(":");re(p,+F)}})}const N=(D,J)=>D&&J?`<a class="hsite" data-char="${D}">${J}</a>`:J??"vacant";function W(D){const J=n.faithHasIcon[D]?`<img class="fic" src="${Sn}map/ui/faith_${D}.png" alt="">`:P(n.faithCol[D]);let C=0;for(let E=0;E<n.np;E++)n.faithOf[E]===D&&C++;const xe=[n.faithRelig[D],n.faithAdh[D]?`followers: ${n.faithAdh[D]}s`:null,`${C} provinces`].filter(Boolean);let ue="";n.faithDesc[D]&&(ue+=`<div class="desc">${n.faithDesc[D]}</div>`),n.faithTenets[D].length&&(ue+=`<div class="sect"><span class="k">Tenets:</span> <b>${n.faithTenets[D].join("</b> · <b>")}</b></div>`),n.faithSites[D].length&&(ue+='<div class="sect"><span class="k">Holy sites:</span> '+n.faithSites[D].map(E=>`<a class="hsite" data-county="${E.c}">${E.n}</a>`).join(" · ")+"</div>"),O(`${J}${n.faithName[D]}`,xe.join(" · "),ue,"faith")}function ee(D){let J=0;for(let ue=0;ue<n.np;ue++)n.cultureOf[ue]===D&&J++;const C=[n.cultHeritage[D]?`${n.cultHeritage[D]} heritage`:null,n.cultLang[D]?`speaks ${n.cultLang[D]}`:null,`${J} provinces`].filter(Boolean);let xe='<div class="grid" style="display:grid;grid-template-columns:auto 1fr;gap:4px 12px;font-size:13px">';n.cultEthos[D]&&(xe+=`<div class="k">Ethos</div><div><b>${n.cultEthos[D]}</b></div>`),n.cultMartial[D]&&(xe+=`<div class="k">Warriors</div><div>${n.cultMartial[D]}</div>`),xe+="</div>",n.cultTrad[D].length&&(xe+=`<div class="sect"><span class="k">Traditions:</span> <b>${n.cultTrad[D].join("</b> · <b>")}</b></div>`),O(`${P(n.cultCol[D])}${n.cultName[D]}`,C.join(" · "),xe,"culture")}function oe(D){const J=n.chars[D];if(!J)return;const C=["Diplomacy","Martial","Stewardship","Intrigue","Learning"],xe=J.b?`born ${J.b}${J.dd?`, died ${J.dd}`:""} · year is ${n.date}`:"";let ue="";J.mo&&(ue+=`<div class="desc" style="font-style:italic">“${J.mo}”</div>`);const E=J.sk.map((F,H)=>F==null?null:`<div class="k">${C[H]}</div><div><b>${F}</b></div>`).filter(Boolean).join("");E&&(ue+=`<div class="grid" style="display:grid;grid-template-columns:auto 1fr;gap:3px 12px;font-size:13px;margin-top:6px">${E}</div>`),J.tr.length&&(ue+=`<div class="sect"><span class="k">Traits:</span> <b>${J.tr.join("</b> · <b>")}</b></div>`);const p=J.dy?`${J.n} of House ${J.dy}`:J.n;O(p,xe,ue,null)}function re(D,J){const C=`<img class="fic" src="${Sn}map/ui/coa/${D}_${J}.png" alt="" onerror="this.remove()">`;let xe=0;const ue=D==="k"?n.kingOf:n.empOf;for(let p=0;p<n.np;p++)ue[p]===J&&xe++;let E="";if(D==="k"){const p=n.kEmp[J],F=[p>=0?`part of ${n.empName[p]}`:"independent",`${xe} provinces`];E+=`<div class="sect" style="padding-top:0"><span class="k">Ruler:</span> <b>${N(n.kingHolderKey[J],n.kingHolder[J])}</b></div>`,n.kCapital[J]>=0&&(E+=`<div class="sect"><span class="k">Capital:</span> <a class="hsite" data-county="${n.kCapital[J]}">${n.countyName[n.kCapital[J]]}</a></div>`);const H=[];for(let $=0;$<n.nDuchy;$++)n.dKing[$]===J&&H.push($);H.length&&(E+='<div class="sect"><span class="k">De jure duchies:</span> '+H.map($=>`<b>${n.duchyName[$]}</b>`).join(" · ")+"</div>"),O(`${C}${n.kingName[J]}`,F.join(" · "),E,"political")}else{const p=[`${xe} provinces`];E+=`<div class="sect" style="padding-top:0"><span class="k">Ruler:</span> <b>${N(n.empHolderKey[J],n.empHolder[J])}</b></div>`,n.eCapital[J]>=0&&(E+=`<div class="sect"><span class="k">Capital:</span> <a class="hsite" data-county="${n.eCapital[J]}">${n.countyName[n.eCapital[J]]}</a></div>`);const F=[];for(let H=0;H<n.nKing;H++)n.kEmp[H]===J&&F.push(H);F.length&&(E+='<div class="sect"><span class="k">De jure kingdoms:</span> '+F.map(H=>`<a class="hsite" data-realm="k:${H}">${n.kingName[H]}</a>`).join(" · ")+"</div>"),O(`${C}${n.empName[J]}`,p.join(" · "),E,"political")}}Fe("faithClose").onclick=()=>{Fe("faith").classList.remove("open"),U>=0&&(Fe("sel").style.display="block")},Fe("faithMode").onclick=()=>{G&&(l=G,[...Fe("modes").children].forEach(D=>{D.className=D.dataset.mode===G?"on":""}),A(G))};const pe=(D,J)=>{const C=f.pickGround(D,J);return C?n.prov[(C.gy|0)*n.W+(C.gx|0)]:-1};let Oe=!1,je=!1,Be=!1,te=-1,fe=null,le=[0,0],Ie=[0,0];const Ne=Fe("tip"),Re=D=>{D!==te&&(te=D,f.setHover(D<0?-1:n.rawOf[D]))};h.addEventListener("contextmenu",D=>D.preventDefault()),h.addEventListener("pointerdown",D=>{if(Be=!1,Ie=[D.clientX,D.clientY],le=[D.clientX,D.clientY],D.button===2||D.button===1)je=!0;else{Oe=!0;const J=f.pickPlane(D.clientX,D.clientY);fe=J?{x:J.x,z:J.z}:null}h.classList.add("drag"),h.setPointerCapture(D.pointerId)}),h.addEventListener("pointermove",D=>{if(Math.abs(D.clientX-Ie[0])+Math.abs(D.clientY-Ie[1])>4&&(Be=!0),Oe&&fe){const J=f.pickPlane(D.clientX,D.clientY);J&&(f.cam.tx+=fe.x-J.x,f.cam.tz+=fe.z-J.z,f.clampCamera(),f.applyCamera())}else if(je)f.cam.yaw-=(D.clientX-le[0])*.004,f.cam.pitch+=(D.clientY-le[1])*.003,f.clampCamera(),f.applyCamera();else{const J=pe(D.clientX,D.clientY);if(Re(J),J>=0){const C=n.countyOf[J],xe=n.kingOf[J],ue=n.empOf[J],E=n.holdingOf[J],p=E?`<b>${n.provName[J]}</b> · ${w[E]}`:`<b>${n.provName[J]}</b>`,F=C>=0?`${ar[n.pTerr[J]]} · County of ${n.countyName[C]}`:ar[n.pTerr[J]],H=C>=0&&n.countyHolder[C]?`<br><span style="color:#b6a988">Holder:</span> ${n.countyHolder[C]}`:"",$=xe>=0?`${n.kingName[xe]} · <span style="color:#b6a988">${ue>=0?n.empName[ue]:""}</span>`:'<span style="color:#b6a988">Wasteland</span>';Ne.innerHTML=`${p}<br>${F}${H}<br>${$}`,Ne.style.display="block";let ce=D.clientX+16,Z=D.clientY+16;const V=Ne.getBoundingClientRect();ce+V.width>window.innerWidth-8&&(ce=D.clientX-V.width-16),Z+V.height>window.innerHeight-8&&(Z=D.clientY-V.height-16),Ne.style.left=ce+"px",Ne.style.top=Z+"px"}else Ne.style.display="none"}le=[D.clientX,D.clientY]});const st=D=>{const J=(Oe||je)&&!Be&&D.button!==2&&D.button!==1;Oe=!1,je=!1,fe=null,h.classList.remove("drag"),J&&z(pe(D.clientX,D.clientY))};h.addEventListener("pointerup",st),h.addEventListener("pointerleave",()=>{Ne.style.display="none",Re(-1)}),h.addEventListener("wheel",D=>{D.preventDefault();const J=f.pickPlane(D.clientX,D.clientY),C=f.cam.dist;if(f.cam.dist*=Math.exp(D.deltaY*.0011),f.clampCamera(),J){const xe=1-f.cam.dist/C;f.cam.tx+=(J.x-f.cam.tx)*xe,f.cam.tz+=(J.z-f.cam.tz)*xe,f.clampCamera()}f.applyCamera()},{passive:!1});{const D=Fe("search"),J=Fe("results"),C=Z=>Z.normalize("NFD").replace(/[̀-ͯ]/g,"").toLowerCase(),xe=[],ue=(Z,V,j=320)=>{f.cam.tx=Z-n.W/2,f.cam.tz=V-n.H/2,f.cam.dist=Math.min(f.cam.dist,j),f.clampCamera(),f.applyCamera()},E=(Z,V)=>{let j=-1,he=0;for(let de=0;de<n.np;de++)Z[de]===V&&n.pArea[de]>he&&(he=n.pArea[de],j=de);return j},p=(Z,V,j)=>{let he=0,de=0,ae=0;for(let ie=0;ie<n.np;ie++)Z[ie]===V&&(he+=n.pCX[ie]*n.pArea[ie],de+=n.pCY[ie]*n.pArea[ie],ae+=n.pArea[ie]);ae&&ue(he/ae,de/ae,j)};for(let Z=0;Z<n.np;Z++)xe.push({key:C(n.provName[Z]),name:n.provName[Z],type:"Province",go:()=>{ue(n.pCX[Z],n.pCY[Z],260),z(Z)}});n.countyName.forEach((Z,V)=>xe.push({key:C(Z),name:Z,type:"County",go:()=>{const j=E(n.countyOf,V);j>=0&&(ue(n.pCX[j],n.pCY[j],300),z(j))}})),n.duchyName.forEach((Z,V)=>xe.push({key:C(Z),name:Z,type:"Duchy",go:()=>p(n.duchyOf,V,420)})),n.kingName.forEach((Z,V)=>xe.push({key:C(Z),name:Z,type:"Kingdom",go:()=>{p(n.kingOf,V,700),re("k",V)}})),n.empName.forEach((Z,V)=>xe.push({key:C(Z),name:Z,type:"Empire",go:()=>{p(n.empOf,V,1100),re("e",V)}})),n.cultName.forEach((Z,V)=>{/^wasteland/i.test(Z)||xe.push({key:C(Z),name:Z,type:"Culture",go:()=>ee(V)})}),n.faithName.forEach((Z,V)=>{/^wasteland/i.test(Z)||xe.push({key:C(Z),name:Z,type:"Faith",go:()=>W(V)})}),n.seaLabels.forEach(Z=>xe.push({key:C(Z.n),name:Z.n,type:"Sea",go:()=>ue(Z.x,Z.y,900)}));let F=[],H=-1;const $=()=>{J.innerHTML=F.map((Z,V)=>`<div class="res${V===H?" hot":""}" data-i="${V}"><span>${Z.name}</span><span class="t">${Z.type}</span></div>`).join(""),J.style.display=F.length?"block":"none",J.querySelectorAll(".res").forEach(Z=>{Z.onmousedown=V=>{V.preventDefault(),ce(+Z.dataset.i)}})},ce=Z=>{const V=F[Z];V&&(D.value=V.name,F=[],H=-1,$(),D.blur(),V.go())};D.oninput=()=>{const Z=C(D.value.trim());if(H=-1,Z.length<2){F=[],$();return}const V=[],j=[];for(const he of xe)if(he.key.startsWith(Z)?V.push(he):he.key.includes(Z)&&j.push(he),V.length>=12)break;F=[...V,...j].slice(0,12),$()},D.onkeydown=Z=>{Z.key==="ArrowDown"?(H=Math.min(F.length-1,H+1),$(),Z.preventDefault()):Z.key==="ArrowUp"?(H=Math.max(0,H-1),$(),Z.preventDefault()):Z.key==="Enter"?(ce(H>=0?H:0),Z.preventDefault()):Z.key==="Escape"&&(F=[],$(),D.blur()),Z.stopPropagation()},D.onblur=()=>setTimeout(()=>{F=[],$()},150)}const Ve=()=>document.activeElement instanceof HTMLInputElement&&document.activeElement.type==="text",ke={};window.addEventListener("keydown",D=>{Ve()||(ke[D.key.toLowerCase()]=!0)}),window.addEventListener("keyup",D=>{ke[D.key.toLowerCase()]=!1}),setInterval(()=>{const D=f.cam.dist*.02;let J=!1;(ke.w||ke.arrowup)&&(f.cam.tz-=D,J=!0),(ke.s||ke.arrowdown)&&(f.cam.tz+=D,J=!0),(ke.a||ke.arrowleft)&&(f.cam.tx-=D,J=!0),(ke.d||ke.arrowright)&&(f.cam.tx+=D,J=!0),J&&(f.clampCamera(),f.applyCamera())},16);const $e=Fe("modes");for(const[D,J]of Ym){const C=document.createElement("button");C.textContent=J,C.dataset.mode=D,D===l&&(C.className="on"),C.onclick=()=>{l=D,[...$e.children].forEach(xe=>{xe.className=xe.dataset.mode===D?"on":""}),A(D)},$e.appendChild(C)}const qe=Fe("tilt");qe.oninput=()=>{Fe("tiltv").textContent=qe.value,f.cam.pitch=(24+ +qe.value/100*56)*Math.PI/180,f.clampCamera(),f.applyCamera()},Fe("reset").onclick=()=>{f.cam.tx=n.landCX-n.W/2,f.cam.tz=n.landCY-n.H/2,f.cam.dist=f.fitDist*.72,f.cam.yaw=0,f.clampCamera(),f.applyCamera()},Fe("zin").onclick=()=>{f.cam.dist/=1.3,f.clampCamera(),f.applyCamera()},Fe("zout").onclick=()=>{f.cam.dist*=1.3,f.clampCamera(),f.applyCamera()},Fe("clearSel").onclick=()=>z(-1),Fe("center").onclick=()=>{U<0||(f.cam.tx=n.pCX[U]-n.W/2,f.cam.tz=n.pCY[U]-n.H/2,f.cam.dist=Math.min(f.cam.dist,420),f.clampCamera(),f.applyCamera())},Fe("objs").onclick=()=>{m&&(m.visible=!m.visible,Fe("objs").className=m.visible?"on":"",f.invalidate())},Fe("hideui").onclick=()=>{document.querySelectorAll(".panel").forEach(J=>{J.id!=="hideui"&&J.classList.toggle("hidden")});const D=Fe("hideui");D.textContent=D.textContent==="Hide UI"?"Show UI":"Hide UI",x=!0},Fe("dl").onclick=()=>{f.render();const D=document.createElement("canvas");D.width=h.width,D.height=h.height;const J=D.getContext("2d");J.drawImage(h,0,0),J.drawImage(u,0,0,D.width,D.height),Fe("dl").href=D.toDataURL("image/png")},Fe("dljson").onclick=()=>{const D=[];for(let C=0;C<n.np;C++){const xe=n.countyOf[C],ue=n.duchyOf[C],E=n.kingOf[C],p=n.empOf[C],F=n.cultureOf[C],H=n.faithOf[C];D.push({id:C,name:n.provName[C],terrain:ar[n.pTerr[C]],county:xe>=0?n.countyName[xe]:null,duchy:ue>=0?n.duchyName[ue]:null,kingdom:E>=0?n.kingName[E]:null,empire:p>=0?n.empName[p]:null,culture:F>=0?n.cultName[F]:null,faith:H>=0?n.faithName[H]:null,holding:w[n.holdingOf[C]],holder:xe>=0?n.countyHolder[xe]:null,development:n.devOf[C],neighbours:[...n.padj[C]]})}const J={provinces:n.np,counties:n.nCounty,duchies:n.nDuchy,kingdoms:n.nKing,empires:n.nEmp,realms:D};Fe("dljson").href=URL.createObjectURL(new Blob([JSON.stringify(J)],{type:"application/json"}))};const lt=()=>{f.render(),x&&(x=!1,qm(T,R,f,Sn+"map/ui/coa/",()=>{x=!0})),requestAnimationFrame(lt)};requestAnimationFrame(lt),i.style.display="none";const ft=f.terrain.geometry.attributes.position;let ht=1e9,ct=-1e9;for(let D=0;D<ft.count;D++){const J=ft.getY(D);J<ht&&(ht=J),J>ct&&(ct=J)}window.__APP={scene:f,world:n,selectProvince:z,showFaith:W,showCulture:ee,showChar:oe,showRealm:re,info:{webgl2:f.renderer.getContext()instanceof WebGL2RenderingContext,rendererType:"WebGLRenderer",isPerspectiveCamera:f.camera.isPerspectiveCamera===!0,geometryType:f.terrain.geometry.type,terrainMinY:ht,terrainMaxY:ct,provinces:n.np,kingdoms:n.nKing,empires:n.nEmp}},console.log("3D map ready:",JSON.stringify(window.__APP.info))}$m().catch(i=>{console.error("boot failed",i);const e=document.getElementById("loading");e&&(e.textContent="Load error — see console")});
